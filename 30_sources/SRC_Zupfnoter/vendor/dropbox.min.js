(function () {
    var t, e, r, n, i, o, s, a, u, h, l, p = {}.hasOwnProperty, c = [].indexOf || function (t) {
    ...
    if (l = function () {
            ...
            return t
        }(), "undefined" != typeof global && "undefined" != typeof module && "exports"in module)e = global, r = module.require.bind(module), module.exports = l; else if ("undefined" != typeof window && "undefined" != typeof navigator)e = window, r = null, window.Dropbox && !function () {
        var t, e, r, n;
        r = window.Dropbox, n = [];
        for (t in r)p.call(r, t) && (e = r[t], n.push(l[t] = e));
        return n
    }(), window.Dropbox = l; else {
    ...
    if (l.Env = function () {
            ...
            if ("undefined" != typeof chrome && chrome.runtime && chrome.runtime.id)return chrome.tabs && chrome.tabs.create ? t.authDriver(new l.AuthDriver.ChromeExtension) : t.authDriver(new l.AuthDriver.ChromeApp), void 0;
            if ("undefined" != typeof window) {
                if (window.cordova)return t.authDriver(new l.AuthDriver.Cordova), void 0;
            ...
            return d(e, t), e.prototype.url = function () {
                ...
                }, window.addEventListener("message", r, !1), l.AuthDriver.Popup.onMessage.addListener(r)
                ...
                window.addEventListener("load", function () {
                    var t, e, r, n, i, o;
                    if (o = window.location.href, r = JSON.stringify({_dropboxjs_oauth_info: o}), l.AuthDriver.BrowserBase.cleanupLocation(), n = window.opener, window.parent !== window.top && (n || (n = window.parent)), n) {
                        try {
            ...
            return d(e, t), e.prototype.doAuthorize = function (t, e, r, n) {
                ...
                return chrome.identity.launchWebAuthFlow({url: t, interactive: !0}, function (t) {
                    return i.locationStateParam(t) === e ? (e = !1, n(l.Util.Oauth.queryParamsFromUrl(t))) : void 0
                })
            }, e
            ...
            return d(e, t), e.prototype.doAuthorize = function (t, e, r, n) {
                ...
                return o = null, i = function (t, r) {
                    var a;
                    if ((!r || !r.tab || r.tab.url.substring(0, s.receiverUrl.length) === s.receiverUrl) && t.dropbox_oauth_receiver_href)return a = t.dropbox_oauth_receiver_href, s.locationStateParam(a) === e ? (e = !1, o && chrome.tabs.remove(o.id), chrome.runtime.onMessage.removeListener(i), n(l.Util.Oauth.queryParamsFromUrl(a))) : void 0
                ...
                return o = window.open(t, "_blank", "location=yes,closebuttoncaption=Cancel"), a = !1, i = /^[^/]*\/\/[^/]*\//.exec(t)[0], u = !1, s = function (t) {
                    if (t.url && h.locationStateParam(t.url) === e) {
                        ...
                        return o.removeEventListener("loadstart", s), o.removeEventListener("loaderror", s), o.removeEventListener("loadstop", s), o.removeEventListener("exit", s), u = !0, window.setTimeout(function () {
                            return o.close()
                        }, 10), n(l.Util.Oauth.queryParamsFromUrl(t.url)), void 0
                    }
                    if ("exit" === t.type) {
                        if (u)return;
            ...
            function e(t) {
                ...
                }, this._oauth = new l.Util.Oauth(t), this._uid = t.uid || null, this.authStep = this._oauth.step(), this._driver = null, this.authError = null, this._credentials = null, this.setupUrls()
            }
            ...
            return e.prototype.onXhr = null, e.prototype.onError = null, e.prototype.onAuthStepChange = null, e.prototype.authDriver = function (t) {
                ...
                return s = function () {
                    return u.authStep = u._oauth.step(), u.authStep === t.ERROR && (u.authError = u._oauth.error()), u._credentials = null, u.onAuthStepChange.dispatch(u), a()
                }, o = function () {
                    return u.authStep = t.ERROR, u._credentials = null, u.onAuthStepChange.dispatch(u), a()
                }, i = null, a = function () {
                    var e;
                    if (i !== u.authStep && (i = u.authStep, u._driver && u._driver.onAuthStepChange))return u._driver.onAuthStepChange(u, a), void 0;
                    switch (u.authStep) {
                        case t.RESET:
                            return n ? (u._driver.getStateParam && u._driver.getStateParam(function (e) {
                                return u.client.authStep === t.RESET && u._oauth.setAuthStateParam(e), s()
                            }), u._oauth.setAuthStateParam(l.Util.Oauth.randomAuthStateParam()), s()) : (r && r(null, u), void 0);
                        case t.PARAM_SET:
                            return n ? (e = u.authorizeUrl(), u._driver.doAuthorize(e, u._oauth.authStateParam(), u, function (t) {
                                return u._oauth.processRedirectParams(t), t.uid && (u._uid = t.uid), s()
                            })) : (r && r(null, u), void 0);
                        case t.PARAM_LOADED:
                            return u._driver.resumeAuthorize ? u._driver.resumeAuthorize(u._oauth.authStateParam(), u, function (t) {
                                return u._oauth.processRedirectParams(t), t.uid && (u._uid = t.uid), s()
                            }) : (u._oauth.setAuthStateParam(u._oauth.authStateParam()), s(), void 0);
                        case t.AUTHORIZED:
                            return u.getAccessToken(function (t, e) {
                                return t ? (u.authError = t, o()) : (u._oauth.processRedirectParams(e), u._uid = e.uid, s())
                            });
                        case t.DONE:
                            r && r(null, u);
                            break;
                        case t.SIGNED_OUT:
                            return u.authStep = t.RESET, u.reset(), a();
                        case t.ERROR:
                            r && r(u.authError, u)
                    }
                }, a(), this
                ...
                return i = new l.Util.Xhr("POST", this._urls.signOut), i.signWithOauth(this._oauth), this._dispatchXhr(i, function (e) {
                    if (e)if (e.status === l.ApiError.INVALID_TOKEN)e = null; else if (n)return r && r(e), void 0;
                    return o.authStep = t.RESET, o.reset(), o.authStep = t.SIGNED_OUT, o.onAuthStepChange.dispatch(o), o._driver && o._driver.onAuthStepChange ? o._driver.onAuthStepChange(o, function () {
                ...
                var n, i;
                return e ? (n = {offset: e.offset}, e.tag && (n.upload_id = e.tag)) : n = {offset: 0}, i = new l.Util.Xhr("POST", this._urls.chunkedUpload), i.setBody(t).setParams(n).signWithOauth(this._oauth), this._dispatchXhr(i, function (t, e) {
                ...
                var i, o;
                return n || "function" != typeof r || (n = r, r = null), i = {upload_id: e.tag}, r && (r.lastVersionTag ? i.parent_rev = r.lastVersionTag : (r.parentRev || r.parent_rev) && (i.parent_rev = r.parentRev || r.parent_rev), r.noOverwrite && (i.overwrite = "false")), o = new l.Util.Xhr("POST", "" + this._urls.commitChunkedUpload + "/" + this._urlEncodePath(t)), o.setParams(i).signWithOauth(this._oauth), this._dispatchXhr(o, function (t, e) {
                    return n ? n(t, l.File.Stat.parse(e)) : void 0
                })
                ...
                var n, i, o, s, a, u = this;
                return r || "function" != typeof e || (r = e, e = null), i = e && (e["long"] || e.longUrl || e.downloadHack) ? {short_url: "false"} : {}, t = this._urlEncodePath(t), o = "" + this._urls.shares + "/" + t, n = !1, s = !1, e && (e.downloadHack ? (n = !0, s = !0) : e.download && (n = !0, o = "" + this._urls.media + "/" + t)), a = new l.Util.Xhr("POST", o).setParams(i).signWithOauth(this._oauth), this._dispatchXhr(a, function (t, e) {
                    return s && (null != e ? e.url : void 0) && (e.url = e.url.replace(u._authServer, u._downloadServer)), r(t, l.File.ShareUrl.parse(e, n))
                })
                ...
                var r, n;
                return r = {}, e && (e.format ? r.format = e.format : e.png && (r.format = "png"), e.size && (r.size = e.size)), n = new l.Util.Xhr("GET", "" + this._urls.thumbnails + "/" + this._urlEncodePath(t)), n.setParams(r).signWithOauth(this._oauth)
            }, e.prototype.revertFile = function (t, e, r) {
                var n;
                return n = new l.Util.Xhr("POST", "" + this._urls.restore + "/" + this._urlEncodePath(t)), n.setParams({rev: e}).signWithOauth(this._oauth), this._dispatchXhr(n, function (t, e) {
                ...
                var i, o, s;
                return n || "function" != typeof r || (n = r, r = null), o = {query: e}, i = !1, r && (null != r.limit && (o.file_limit = r.limit), (r.removed || r.deleted) && (o.include_deleted = !0), r.httpCache && (i = !0)), s = new l.Util.Xhr("GET", "" + this._urls.search + "/" + this._urlEncodePath(t)), s.setParams(o).signWithOauth(this._oauth, i), this._dispatchXhr(s, function (t, e) {
                    var r, i;
                    return i = e ? function () {
                        var t, n, i;
                ...
                var r, n;
                return e || "function" != typeof t || (e = t, t = null), r = t ? t.cursorTag ? {cursor: t.cursorTag} : {cursor: t} : {}, n = new l.Util.Xhr("POST", this._urls.delta), n.setParams(r).signWithOauth(this._oauth), this._dispatchXhr(n, function (t, r) {
                ...
                var n, i;
                return r || "function" != typeof e || (r = e, e = null), n = t.cursorTag ? {cursor: t.cursorTag} : {cursor: t}, e && "timeout"in e && (n.timeout = e.timeout), i = new l.Util.Xhr("GET", this._urls.longpollDelta), i.setParams(n), this._dispatchXhr(i, function (t, e) {
                    var n;
                ...
                var r;
                return e || "function" != typeof t || (e = t, t = this._oauth.credentials().key), r = new l.Util.Xhr("GET", this._urls.appsInfo), r.setParams({app_key: t}), this._dispatchXhr(r, function (r, n) {
                ...
                var n = this;
                return e.status === l.ApiError.INVALID_TOKEN && this.authStep === t.DONE && (this.authError = e, this.authStep = t.ERROR, this.onAuthStepChange.dispatch(this), this._driver && this._driver.onAuthStepChange) ? (this._driver.onAuthStepChange(this, function () {
                    return n.onError.dispatch(e), r(e)
                }), null) : (this.onError.dispatch(e), r(e), void 0)
            ...
            function t(t, e) {
                this.url = t.url, this.expiresAt = l.Util.parseDate(t.expires), this.isDirect = e === !0 ? !0 : e === !1 ? !1 : "direct"in t ? t.direct : Date.now() - this.expiresAt <= 864e5, this.isPreview = !this.isDirect, this._json = null
            }
            ...
            return e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", r = function (t, r, n) {
                ...
                var n, i, o, s, a, u, h;
                for (a = [], n = 0, o = 0, s = u = 0, h = r.length; (h >= 0 ? h > u : u > h) && (i = r.charAt(s), "=" !== i); s = h >= 0 ? ++u : --u)n = n << 6 | e.indexOf(i), o += 1, 4 === o && (t(n, o, a), n = o = 0);
            ...
            return r = function (t, e, r, n) {
                ...
                for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, y = Array(80), r = 1732584193, i = 4023233417, s = 2562383102, u = 271733878, l = 3285377520, c = 0, f = t.length; f > c;) {
                    for (n = r, o = i, a = s, h = u, p = l, d = m = 0; 80 > m; d = ++m)16 > d ? y[d] = 0 | t[c + d << 2 >> 2] : (_ = (0 | y[d - 3 << 2 >> 2]) ^ (0 | y[d - 8 << 2 >> 2]) ^ (0 | y[d - 14 << 2 >> 2]) ^ (0 | y[d - 16 << 2 >> 2]), y[d] = _ << 1 | _ >>> 31), v = 0 | (0 | (r << 5 | r >>> 27) + l) + y[d << 2 >> 2], v = 20 > d ? 0 | v + (0 | (i & s | ~i & u) + 1518500249) : 40 > d ? 0 | v + (0 | (i ^ s ^ u) + 1859775393) : 60 > d ? 0 | (0 | v + ((i & s | i & u | s & u) - 1894007588)) : 0 | v + (0 | (i ^ s ^ u) - 899497514), l = u, u = s, s = i << 30 | i >>> 2, i = r, r = v;
                    r = 0 | n + r, i = 0 | o + i, s = 0 | a + s, u = 0 | h + u, l = 0 | p + l, c = 0 | c + 16
                }
                return [r, i, s, u, l]
            }, o = function (t, e) {
                var r, n, i, o, u, h, l, p, c, d, f, _, y, v, m, g, w, S, b, A, E, U, C, O, R, P, T, x, k, D, F, B;
                for (t[e >> 2] |= 1 << 31 - ((3 & e) << 3), t[(e + 8 >> 6 << 4) + 15] = e << 3, k = Array(80), r = s[0], i = s[1], u = s[2], p = s[3], d = s[4], _ = s[5], v = s[6], A = s[7], U = 0, O = t.length; O > U;) {
                    for (n = r, o = i, h = u, c = p, f = d, y = _, m = v, E = A, C = B = 0; 64 > B; C = ++B)16 > C ? x = k[C] = 0 | t[U + C << 2 >> 2] : (w = 0 | k[C - 15 << 2 >> 2], g = (w << 25 | w >>> 7) ^ (w << 14 | w >>> 18) ^ w >>> 3, b = 0 | k[C - 2 << 2 >> 2], S = (b << 15 | b >>> 17) ^ (b << 13 | b >>> 19) ^ b >>> 10, x = k[C] = 0 | (0 | g + (0 | k[C - 7 << 2 >> 2])) + (0 | S + (0 | k[C - 16 << 2 >> 2]))), l = d & _ ^ ~d & v, R = r & i ^ r & u ^ i & u, P = (r << 30 | r >>> 2) ^ (r << 19 | r >>> 13) ^ (r << 10 | r >>> 22), T = (d << 26 | d >>> 6) ^ (d << 21 | d >>> 11) ^ (d << 7 | d >>> 25), D = 0 | (0 | (0 | A + T) + (0 | l + x)) + (0 | a[C << 2 >> 2]), F = 0 | P + R, A = v, v = _, _ = d, d = 0 | p + D, p = u, u = i, i = r, r = 0 | D + F;
                    r = 0 | n + r, i = 0 | o + i, u = 0 | h + u, p = 0 | c + p, d = 0 | f + d, _ = 0 | y + _, v = 0 | m + v, A = 0 | E + A, U += 16
                }
                ...
                var e, r, n, i, o;
                for (i = "", e = 0, n = 4 * t.length; n > e;)r = e, o = (255 & t[r >> 2] >> (3 - (3 & r) << 3)) << 16, r += 1, o |= (255 & t[r >> 2] >> (3 - (3 & r) << 3)) << 8, r += 1, o |= 255 & t[r >> 2] >> (3 - (3 & r) << 3), i += p[63 & o >> 18], i += p[63 & o >> 12], e += 1, i += e >= n ? "=" : p[63 & o >> 6], e += 1, i += e >= n ? "=" : p[63 & o], e += 1;
                return i
        ...
        n === Object && (u = !1)
    } else h = !1, u = !0; else n = null, h = !1, u = !1;
    l.Util.Xhr = function () {
        function t(t, e) {
        ...
        return t.Request = a, t.ieXdr = s, t.canSendForms = i, t.doesPreflight = o, t.ArrayBufferView = n, t.sendArrayBufferView = u, t.wrapBlob = h, t.prototype.xhr = null, t.prototype.onError = null, t.prototype.setParams = function (t) {
            ...
            var t, e, r, n, i = this;
            if (e = l.Util.Xhr.ieXdr, this.isGet || null !== this.body || e ? (this.paramsToUrl(), null !== this.body && "string" == typeof this.body && (this.headers["Content-Type"] = "text/plain; charset=utf8")) : this.paramsToBody(), this.xhr = new l.Util.Xhr.Request, e ? (this.xhr.onload = function () {
                    return i.onXdrLoad()
