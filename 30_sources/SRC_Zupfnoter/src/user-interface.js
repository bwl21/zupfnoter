      ...
      items: [
...

        {
          ...
          items: [
            ...
            {text: 'countnotes', tooltip: "specify which voices\n shwow countnotes\n and appeareance of the same"},
            {text: 'barnumbers', tooltip: "specify which voices\n shwow bar numbers\n and appeareance of the same"},
        ...
        {type: 'break'},
        {
          ...
          items: [
            {type: 'button', id: 'tbPrintA3', text: 'A3', icon: 'fa fa-file-pdf-o', tooltip: 'Print A3 Harpnotes'},
            {type: 'button', id: 'tbPrintA4', text: 'A4', icon: 'fa fa-file-pdf-o', tooltip: 'Print A4 Harpnotes'},
        ...
        {type: 'break'},
        {
          ...
          items: [
            ...
            {text: 'medium', id: 'mittel', icon: 'fa fa-dot-circle-o', tooltip: "medium view\nmost commonly used\nautoscroll works"},
        ...
        {type: 'button', id: 'tbPlay', text: 'Play', icon: 'fa fa-play', tooltip: 'Play music'},
        {
          ...
          {text: 'abc Tutorial', icon: 'fa fa-tags', id: "tbAbcTutorial", tooltip: 'Open an ABC tutorial (in German)'},
