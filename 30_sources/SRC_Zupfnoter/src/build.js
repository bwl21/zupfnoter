  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      Opal.defn(self, '$contain', function(other) {
        ...
        $a = Opal.to_ary(self.$coerce(other)), v = ($a[0] == null ? nil : $a[0]), _ = ($a[1] == null ? nil : $a[1]);
        if ((($a = (((($b = v.$x()['$>'](self.$x())) !== false && $b !== nil) ? $b : v.$y()['$>'](self.$y())))) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      Opal.defn(self, '$fit', function(other) {
        ...
        return self['$*'](((function() {if ((($a = (((($b = scale.$y()['$=='](0)) !== false && $b !== nil) ? $b : ((($c = scale.$x()['$>'](0)) ? scale.$x()['$<'](scale.$y()) : $c))))) !== nil && (!$a.$$is_boolean || $a == true))) {
          return scale.$x()
          } else {
          return scale.$y()
        }; return nil; })()));
      ...
      Opal.defn(self, '$fit_either', function(other) {
        ...
        $a = Opal.to_ary(self.$coerce(other)), v = ($a[0] == null ? nil : $a[0]), _ = ($a[1] == null ? nil : $a[1]);
        scale = v.$to_f_vector()['$/'](self);
        if ((($a = ((($b = scale.$x()['$>'](0)) ? scale.$y()['$>'](0) : $b))) !== nil && (!$a.$$is_boolean || $a == true))) {
          scale = (function() {if ((($a = (scale.$x()['$<'](scale.$y()))) !== nil && (!$a.$$is_boolean || $a == true))) {
            return scale.$y()
            } else {
            return scale.$x()
          }; return nil; })();
  ...
  return (function($base, $super) {
    ...
    return (function($base) {
      ...
      Opal.defn(self, '$rotate', function(angle) {
        ...
        return $scope.get('Vector2d').$new(self.$x()['$*']($scope.get('Math').$cos(angle))['$-'](self.$y()['$*']($scope.get('Math').$sin(angle))), self.$x()['$*']($scope.get('Math').$sin(angle))['$+'](self.$y()['$*']($scope.get('Math').$cos(angle))));
      });
...
Opal.modules["consolelogger"] = function(Opal) {
  ...
  return (function($base, $super) {
    ...
    return (def.$write = function(type, msg) {
      ...
      if ((($a = (current_level['$<='](self.loglevel))) !== nil && (!$a.$$is_boolean || $a == true))) {
...
if (beat == null) beat = nil;
          return beat['$*'](self.beat_spacing)['$+'](self.y_offset)}, TMP_27.$$s = self, TMP_27), $b).call($c));
...
if (i == null) i = nil;
                return verses['$[]'](i.$to_i()['$-'](1))}, TMP_39.$$s = self, TMP_39), $a).call($b).$join("\n\n");
...
if (d == null) d = nil;
              ...
              if ((($a = playable['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('SynchPoint')))) !== nil && (!$a.$$is_boolean || $a == true))) {
                ($a = ($c = playable.$notes()).$each_with_index, $a.$$p = (TMP_56 = function(n, index){var self = TMP_56.$$s || this, $a, $b, TMP_57;
                  if ($gvars.log == null) $gvars.log = nil;
...
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_72.$$s = self, TMP_72), $a).call($b);
...
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_75.$$s = self, TMP_75), $a).call($b);
          res = $scope.get('Ellipse').$new([x_offset, y_offset['$-'](size.$last())['$-'](0.5)], [size.$first(), 0.1], fill, false, root);
          if ((($a = root['$visible?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
...
if (p == null) p = nil;
        ...
        return (def.$make_annotated_bezier_path = function(points) {
          ...
          rotate_by = (($scope.get('Math')).$$scope.get('PI'))['$/'](2);
...
Opal.modules["abc_to_harpnotes"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$map', '$lambda', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$/', '$%', '$<', '$+', '$==', '$!', '$*', '$new', '$reset_state', '$reset_measure_accidentals', '$match', '$parse', '$last', '$first', '$<<', '$message', '$error', '$split', '$inject', '$get_metadata', '$select', '$nil?', '$join', '$compact', '$flatten', '$parse_harpnote_config', '$get', '$charpos_to_line_column', '$warning', '$empty?', '$to_i', '$strip', '$set_key', '$each_with_index', '$debug', '$index=', '$flatten!', '$compact!', '$send', '$origin=', '$>', '$start_pos=', '$end_pos=', '$make_jumplines', '$make_notebound_annotations', '$unshift', '$now', '$to_n', '$keys', '$meta_data=', '$harpnote_options=', '$push', '$harpnote_options', '$-', '$to_s', '$pop', '$line_no', '$count', '$length', '$private', '$is_a?', '$_extract_chord_lines', '$origin', '$start_pos_to_s', '$start_pos', '$end_pos', '$===', '$to_f', '$round', '$transform_rest', '$transform_real_note', '$tuplet=', '$tuplet_start=', '$tuplet_end=', '$pitch', '$get_midipitch', '$visible=', '$companion=', '$first_in_part=', '$clear', '$slur_starts=', '$slur_ends=', '$tie_start=', '$tie_end=', '$tie_start?', '$tie_end?', '$_extract_variant_ending', '$gsub']);
  self.$require("native");
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (f == null) f = nil;
        ...
        return (def.$get_midipitch = function(note) {
          ...
          if ((($a = (note_accidental)) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if (pitch_delta['$=='](0)) {
              if ((($a = self.measure_accidentals['$[]'](note_in_octave)['$=='](0)['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                pitch_delta = 0
                } else {
...
if (m == null) m = nil;
            ...
            return line_no = line_no['$+'](1);}, TMP_8.$$s = self, TMP_8), $a).call($b);
...
if (w == null) w = nil;
          wn = self.$Native(w);
            ...
            return $gvars.log.$warning(msg, [line_no, char_pos], [line_no, char_pos['$+'](1)]);}, TMP_15.$$s = self, TMP_15), $a).call($c);
...
if (x == null) x = nil;
                ...
                return voice_no = voice_no['$+'](1);}, TMP_21.$$s = self, TMP_21), $a).call($b)}, TMP_20.$$s = self, TMP_20), $a).call($b);}, TMP_19.$$s = self, TMP_19), $a).call($g);
          voices['$compact!']();
...
if (el == null) el = nil;
            ...
            hn_voice = ($a = ($c = voice.$each_with_index()).$map, $a.$$p = (TMP_25 = function(el, i){var self = TMP_25.$$s || this, $a, $b, TMP_26, type = nil, hn_voice_element = nil;
if (el == null) el = nil;if (i == null) i = nil;
            type = el['$[]']("el_type");
              ...
              if ((($a = ((($b = hn_voice_element['$nil?']()) !== false && $b !== nil) ? $b : hn_voice_element['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
                ...
                ($a = ($b = hn_voice_element).$each, $a.$$p = (TMP_26 = function(e){var self = TMP_26.$$s || this, $a, $b, start_char = nil, end_char = nil;
if (e == null) e = nil;
                (($a = [el]), $b = e, $b['$origin='].apply($b, $a), $a[$a.length-1]);
                  start_char = el['$[]']("startChar");
                  end_char = el['$[]']("endChar");
                  if (start_char['$>'](0)) {
                    (($a = [self.$charpos_to_line_column(start_char)]), $b = e, $b['$start_pos='].apply($b, $a), $a[$a.length-1])};
                  if (end_char['$>'](0)) {
                    return (($a = [self.$charpos_to_line_column(end_char)]), $b = e, $b['$end_pos='].apply($b, $a), $a[$a.length-1])
                    } else {
                    return nil
...
if (e == null) e = nil;
          ...
          meta_data = $hash2(["compile_time", "meter", "key"], {"compile_time": $scope.get('Time').$now(), "meter": meter['$[]']("display"), "key": self.$Native(key)['$[]']("root")['$+'](self.$Native(key)['$[]']("acc"))['$+'](self.$Native(key)['$[]']("mode"))});
...
if (d == null) d = nil;
            return "1/" + ((1)['$/'](d))}, TMP_30.$$s = self, TMP_30), $a).call($j);
...
if (specified_option == null) specified_option = nil;if (index == null) index = nil;
          print_options.$push(specified_option);
            ...
            missing_voices = ($a = ($b = (resulting_options['$[]']("voices")['$-'](resulting_options['$[]']("layoutlines")))).$map, $a.$$p = (TMP_33 = function(i){var self = TMP_33.$$s || this;
if (i == null) i = nil;
            return i['$+'](1)}, TMP_33.$$s = self, TMP_33), $a).call($b);
...
if (result == null) result = nil;if (element == null) element = nil;
        result = result['$+'](element.$first());
          return result = result['$+'](element['$[]']($range(1, -1, false)).$join(" "));}, TMP_6.$$s = self, TMP_6), $a).call($b, "");
        return result;
      };
      ...
      def.$get_elements_by_range = function(from, to) {
        ...
        result = [];
        ($a = ($b = self.elements).$each_key, $a.$$p = (TMP_7 = function(k){var self = TMP_7.$$s || this, $a, $b, $c, TMP_8, origin = nil, el_start = nil, el_end = nil;
        ...
        origin = self.$Native(k.$origin());
          if ((($a = origin['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = (((($b = ((($c = to['$>'](el_start)) ? from['$<'](el_end) : $c))) !== false && $b !== nil) ? $b : (($c = (to['$==='](from)), $c !== false && $c !== nil ?to['$==='](el_end) : $c))))) !== nil && (!$a.$$is_boolean || $a == true))) {
              return ($a = ($b = self.elements['$[]'](k)).$each, $a.$$p = (TMP_8 = function(e){var self = TMP_8.$$s || this;
if (e == null) e = nil;
              return result.$push(e)}, TMP_8.$$s = self, TMP_8), $a).call($b)
              } else {
              return nil
            };
      ...
      def.$draw_ellipse = function(root) {
        ...
        if ((($a = root['$dotted?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          ($a = ($b = e_dot).$on_click, $a.$$p = (TMP_9 = function(){var self = TMP_9.$$s || this, $a, $b, origin = nil;
        ...
        return ($a = ($c = e).$on_click, $a.$$p = (TMP_10 = function(){var self = TMP_10.$$s || this, $a, $b, origin = nil;
          if (self.on_select == null) self.on_select = nil;
      ...
      def.$draw_glyph = function(root) {
        ...
        def.$glyph_to_path_spec = function(glyph) {
          ...
          result = "";
          ($a = ($b = glyph['$[]']("d")).$each, $a.$$p = (TMP_11 = function(part){var self = TMP_11.$$s || this;
if (part == null) part = nil;
          result = result['$+'](part.$first());
            return result = result['$+'](part['$[]']($range(1, -1, false)).$join(" "));}, TMP_11.$$s = self, TMP_11), $a).call($b);
          return result;
        };
      ...
      def.$draw_jumpline = function(root) {
        ...
        ($a = 0, $b = startpoint, $b['$[]=']($a, $b['$[]']($a)['$+']($scope.get('PADDING'))));
        endpoint = root.$to().$center();
        ($a = 0, $b = endpoint, $b['$[]=']($a, $b['$[]']($a)['$+']($scope.get('PADDING'))));
        distance = root.$distance();
        if ((($a = distance['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          depth = (420)['$-']((root.$level()['$*']($scope.get('JUMPLINE_INDENT'))))
          } else {
        ...
        arrow = self.paper.$path("M0,0L" + ($scope.get('ARROW_SIZE')) + "," + ((-0.5)['$*']($scope.get('ARROW_SIZE'))) + "L" + ($scope.get('ARROW_SIZE')) + "," + ((0.5)['$*']($scope.get('ARROW_SIZE'))) + "L0,0");
        arrow['$[]=']("fill", "red");
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$draw_in_segments = function(sheet) {
        ...
        delta = (-12.0)['$*']($scope.get('X_SPACING'));
...
if (child == null) child = nil;
      ...
      def.$draw_cutmarks = function(i, delta, border) {
        ...
        hpos = $scope.get('X_SPACING')['$/'](2.0)['$+'](delta['$*'](i))['$+'](3);
        hdiff = $scope.get('X_SPACING')['$/'](2.0);
        center = self.$Vector2d($scope.get('X_SPACING')['$/'](2.0)['$+'](delta['$*'](i)), vertical_pos);
        size = 1;
...
if (s == null) s = nil;
          $a = Opal.to_ary(s), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
            return a['$+'](b['$*'](1.5));}, TMP_7.$$s = self, TMP_7), $a).call($b), [$scope.get('DOTTED_SIZE'), $scope.get('DOTTED_SIZE')], "F");
          } else {
          return nil
        };
      };
...
if (s == null) s = nil;
        return (2.0)['$*'](s)}, TMP_9.$$s = self, TMP_9), $a).call($b);
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          lines = [];
          return start = [center.$first()['$+']((element['$[]'](1)['$+'](root.$glyph()['$[]']("w")['$/'](2)))['$*'](scale.$first())), center.$last()['$-']((element['$[]'](2)['$+'](root.$glyph()['$[]']("h")['$/'](2)))['$*'](scale.$last()))];}else if ("l"['$===']($case)) {return lines.$push(element['$[]']($range(1, -1, false)))}else if ("c"['$===']($case)) {return lines.$push(element['$[]']($range(1, -1, false)))}else if ("z"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
...
if (s == null) s = nil;
          $a = Opal.to_ary(s), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
            return a['$+'](b['$*'](1.5));}, TMP_13.$$s = self, TMP_13), $a).call($e), [$scope.get('DOTTED_SIZE'), $scope.get('DOTTED_SIZE')], "F");
          } else {
          return nil
        };
      };
      ...
      def.$draw_jumpline = function(root) {
        ...
        ($a = 0, $b = startpoint, $b['$[]=']($a, $b['$[]']($a)['$+']($scope.get('PADDING'))));
        ($a = 1, $b = startpoint, $b['$[]=']($a, $b['$[]']($a)['$-']($scope.get('PADDING')['$/'](4.0))));
        endpoint = root.$to().$center().$clone();
        ($a = 0, $b = endpoint, $b['$[]=']($a, $b['$[]']($a)['$+']($scope.get('PADDING'))));
        ($a = 1, $b = endpoint, $b['$[]=']($a, $b['$[]']($a)['$+']($scope.get('PADDING')['$/'](4.0))));
        distance = root.$distance();
        if ((($a = distance['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          depth = (418.0)['$-']((root.$level()['$*']($scope.get('JUMPLINE_INDENT'))))
          } else {
          depth = endpoint['$[]'](0)['$+'](distance)
        };
...
Opal.modules["controller"] = function(Opal) {
  ...
  Opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$warn', '$clone', '$private', '$attr', '$html', '$find', '$new', '$load_from_loacalstorage', '$on_command', '$save_to_localstorage', '$handle_command', '$info', '$push', '$_init_conf', '$each', '$send', '$select', '$=~', '$methods', '$setup_ui', '$load_demo_tune', '$set_status', '$loglevel', '$render_previews', '$setup_nodewebkit', '$setup_ui_listener', '$run_string', '$error', '$message', '$caller', '$include?', '$get_text', '$Native', '$nil?', '$set_text', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$==', '$play_song', '$play_selection', '$play_from_selection', '$get_abc_part', '$join', '$backtrace', '$debug', '$set_inactive', '$set_annotations', '$annotations', '$load_song', '$send_remote_command', '$setup_tune_preview', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$now', '$clear_annotations', '$get_config_part', '$get_config_position', '$last', '$first', '$count', '$split', '$>', '$keys', '$transform', '$layout', '$pop', '$-', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$merge!', '$inject', '$to_s', '$loglevel=', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$width', '$on', '$play_abc', '$on_change', '$request_refresh', '$on_selection_change', '$get_selection_positions', '$on_cursor_change', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$key', '$newValue', '$prevent', '$css', '$page_x', '$===', '$puts', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
...
if (key == null) key = nil;if (_ == null) _ = nil;
    ...
    def.$render_previews = function() {
      ...
      return self.$handle_command("svg");
    };
    ...
    def.$layout_harpnotes = function(print_variant) {
      ...
      if ((($a = ((($b = config.$keys().$count()['$>'](0)) !== false && $b !== nil) ? $b : outdated_configs['$=='](1))) !== nil && (!$a.$$is_boolean || $a == true))) {
    ...
    def.$highlight_abc_object = function(abcelement) {
      ...
      $gvars.log.$debug("select_abc_element " + (a['$[]']("startChar")) + " (" + ("controller") + " " + (314) + ")");
...
if (r == null) r = nil;if (v == null) v = nil;
      ...
      $gvars.log.$debug("" + (self.systemstatus.$to_s()) + " " + ("controller") + " " + (353));
...
if (harpnote == null) harpnote = nil;
    ...
    def.$setup_tune_preview = function() {
      ...
      $gvars.log.$debug("tune preview-width " + (width) + " " + ("controller") + ":" + (374));
...
if (e == null) e = nil;
      ...
      ($a = ($g = self.editor).$on_selection_change, $a.$$p = (TMP_13 = function(e){var self = TMP_13.$$s || this, a = nil;
...
if (e == null) e = nil;
      ...
      ($a = ($i = self.harpnote_player).$on_noteon, $a.$$p = (TMP_15 = function(e){var self = TMP_15.$$s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteon " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (416) + ")");
      ...
      ($a = ($j = self.harpnote_player).$on_noteoff, $a.$$p = (TMP_16 = function(e){var self = TMP_16.$$s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteoff " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (421) + ")");
...
if (evt == null) evt = nil;
      key = self.$Native(evt['$[]']("originalEvent")).$key();
        ...
        $gvars.log.$debug("got storage event " + (key) + ": " + (value) + " (" + ("controller") + " " + (449) + ")");
...
if (e == null) e = nil;
        $scope.get('Element').$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
    ...
    def.$request_refresh = function(init) {
      ...
      $gvars.log.$debug("request refresh " + (self.systemstatus['$[]']("refresh")) + " " + (init) + " " + ("controller") + " " + (473));
      ...
      if ((($a = self.systemstatus['$[]']("refresh")) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        return (function() {$case = self.systemstatus['$[]']("autorefresh");if ("on"['$===']($case)) {return self.refresh_timer = setTimeout(function(){self.$render_previews()}, 0000)}else if ("off"['$===']($case)) {return self.refresh_timer = setTimeout(function(){self.$render_remote()}, 0)}else if ("remote"['$===']($case)) {return self.refresh_timer = setTimeout(function(){self.$render_previews()}, 500)}else { return nil }})();
        } else {
        return nil
      };
    };
...
if (parameter == null) parameter = nil;
        ...
        return ($a = ($d = command).$as_action, $a.$$p = (TMP_5 = function(args){var self = TMP_5.$$s || this, $a, $b, TMP_6, $c, TMP_7, abc_code = nil, metadata = nil, filebase = nil, rootpath = nil, print_variants = nil, pdfs = nil;
          if (self.editor == null) self.editor = nil;
...
if (c == null) c = nil;
      (($a = [false]), $b = c, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ...
        return ($a = ($c = c).$as_action, $a.$$p = (TMP_66 = function(a){var self = TMP_66.$$s || this, $a, $b, TMP_67;
          ...
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        return $gvars.log.$message("<pre>"['$+'](($a = ($b = self.songbook.$list()).$map, $a.$$p = (TMP_67 = function(k, v){var self = TMP_67.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
...
if (entries == null) entries = nil;
          return $gvars.log.$message("<pre>"['$+'](($a = ($b = entries).$select, $a.$$p = (TMP_92 = function(entry){var self = TMP_92.$$s || this;
...
if (command == null) command = nil;
      return ($a = ($b = command).$as_action, $a.$$p = (TMP_128 = function(args){var self = TMP_128.$$s || this, abc2svg = nil;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        debugger;
          abc2svg = (($scope.get('ABC2SVG')).$$scope.get('Abc2Svg')).$new();
          abc2svg.$translate("abc", self.editor.$get_abc_part());
          return $scope.get('Element').$find("#tunePreview").$html(abc2svg.$get_svg());}, TMP_128.$$s = self, TMP_128), $a).call($b)}, TMP_127.$$s = self, TMP_127), $a).call($h, "svg");
...
if (n == null) n = nil;
            return n['$[]']("delay")['$>='](self.selection.$first()['$[]']("delay"))}, TMP_6.$$s = self, TMP_6), $a).call($b)
            } else {
...
if (p == null) p = nil;
              ...
              if ((($a = root['$tie_start?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                tie_start = to_play};
              return [to_play]['$+']([more_to_play]);}, TMP_12.$$s = self, TMP_12), $a).call($b);}, TMP_11.$$s = self, TMP_11), $a).call($b).$flatten().$compact();
        };
...
if (annotation == null) annotation = nil;
        return $hash2(["row", "text", "type"], {"row": annotation['$[]']("start_pos").$first()['$-'](1), "text": annotation['$[]']("text"), "type": annotation['$[]']("type")})}, TMP_7.$$s = self, TMP_7), $a).call($b);
...
if (marker == null) marker = nil;
      ...
      return (def.$get_config_position = function(charpos) {
        ...
        cp = charpos['$+']((self.$get_abc_part()['$+']($scope.get('CONFIG_SEPARATOR'))).$length());
...
Opal.modules["opal-abc2svg"] = function(Opal) {
  ...
  Opal.add_stubs(['$set_errmsg', '$error', '$set_img_out', '$push', '$to_n', '$join', '$[]=']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.user = def.svgbuf = def.root = nil;
      def.$initialize = function() {
        var $a, $b, TMP_1, $c, TMP_2, self = this;
        ...
        ($a = ($b = self).$set_errmsg, $a.$$p = (TMP_1 = function(message, line_number, column_number){var self = TMP_1.$$s || this;
          if ($gvars.log == null) $gvars.log = nil;
if (message == null) message = nil;if (line_number == null) line_number = nil;if (column_number == null) column_number = nil;
        return $gvars.log.$error(message)}, TMP_1.$$s = self, TMP_1), $a).call($b);
        ($a = ($c = self).$set_img_out, $a.$$p = (TMP_2 = function(svg){var self = TMP_2.$$s || this;
          if (self.svgbuf == null) self.svgbuf = nil;
if (svg == null) svg = nil;
        return self.svgbuf.$push(svg)}, TMP_2.$$s = self, TMP_2), $a).call($c);
      ...
      def.$translate = function(file_name, abc_source) {
        var self = this;

        return self.root.abc_fe(file_name, abc_source);
      };

      def.$set_errmsg = TMP_3 = function() {
        var self = this, $iter = TMP_3.$$p, block = $iter || nil;
      ...
      return (def.$set_img_out = TMP_4 = function() {
        var self = this, $iter = TMP_4.$$p, block = $iter || nil;
