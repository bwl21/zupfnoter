...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$is_a?', '$raise', '$pitch', '$beat', '$duration', '$first_in_part', '$attr_reader', '$first', '$each', '$beat=', '$last', '$companion=', '$visible?', '$class', '$update_beats', '$<<', '$select', '$empty?', '$reject', '$notes', '$compact', '$flatten', '$map', '$[]', '$compact!', '$>', '$length', '$new', '$expanded_beat_maps', '$max', '$keys', '$last_beat', '$private', '$/', '$inject', '$*', '$==', '$tuplet', '$-', '$floor', '$error', '$[]=', '$+', '$index=', '$index', '$dotted', '$include', '$harpnote_options', '$beat_layout_policy', '$compute_beat_compression', '$values', '$<', '$warning', '$min', '$call', '$include?', '$layout_voice', '$each_with_index', '$voices', '$origin', '$build_synch_points', '$layout_note', '$meta_data', '$strftime', '$now', '$layout_playable', '$layout_newpart', '$to', '$nil?', '$first_in_part?', '$tuplet_start?', '$tuplet_end?', '$Vector2d', '$center', '$make_annotated_bezier_path', '$debug', '$push', '$to_a', '$to_s', '$tie_end?', '$make_slur_path', '$tie_start?', '$slur_starts', '$slur_ends', '$policy', '$from', '$beat_maps', '$duration_to_id', '$to_json', '$layout_measure_start', '$layout_accord', '$layout_pause', '$sort_by', '$visible=', '$name', '$to_sym', '$rotate', '$angle', '$reverse', '$x', '$y', '$-@', '$normalize', '$perpendicular']);
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def['$tuplet_end?'] = function() {
          var self = this;
...
if (map == null) map = nil;
        ...
        return (def.$update_beats = function() {
          var $a, $b, TMP_15, self = this, tupletmap = nil;
...
if (e == null) e = nil;
            return e['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_17._s = self, TMP_17), $c).call($d)).$inject, $a._p = (TMP_16 = function(map, playable){var self = TMP_16._s || this, $a, $b, $c, $d, beats = nil, beat_error = nil;
              if ($gvars.log == null) $gvars.log = nil;
...
if (i == null) i = nil;
          ...
          annotations['$<<']((($a = ((($i = ((($j = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $j))._scope).Drawing == null ? $i.cm('Drawing') : $i.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new([150, 292], "rendered " + (datestring) + " by Zupfnoter " + ((($a = $scope.VERSION) == null ? $opal.cm('VERSION') : $a)) + " " + ((($a = $scope.COPYRIGHT) == null ? $opal.cm('COPYRIGHT') : $a)) + " (Host " + (window.location) + ")", "smaller"));
...
if (playable == null) playable = nil;
          ...
          res_tuplets = ($a = ($l = playables).$inject, $a._p = (TMP_46 = function(result, playable){var self = TMP_46._s || this, $a, $b, $c, p1 = nil, p2 = nil, tiepath = nil, anchor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (result == null) result = nil;if (playable == null) playable = nil;
          ...
          res_slurs = ($a = ($n = playables).$inject, $a._p = (TMP_47 = function(result, playable){var self = TMP_47._s || this, $a, $b, $c, $d, TMP_48, TMP_49, TMP_50, p1 = nil, p2 = nil, tiepath = nil;
...
if (result == null) result = nil;if (playable == null) playable = nil;
          if ((($a = playable['$tie_end?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              if ((($a = playable['$is_a?']((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).SynchPoint == null ? $b.cm('SynchPoint') : $b.SynchPoint))) !== nil && (!$a._isBoolean || $a == true))) {
                ($a = ($b = playable.$notes()).$each_with_index, $a._p = (TMP_48 = function(n, index){var self = TMP_48._s || this, $a, $b, $c;
                  if ($gvars.log == null) $gvars.log = nil;
if (n == null) n = nil;if (index == null) index = nil;
            ...
            if ((($a = playable['$tie_start?']()) !== nil && (!$a._isBoolean || $a == true))) {
              tie_start = playable};
            ($a = ($c = playable.$slur_starts()).$each, $a._p = (TMP_49 = function(s){var self = TMP_49._s || this;
              if (self.slur_index == null) self.slur_index = nil;
if (s == null) s = nil;
            return self.slur_index['$[]='](s, playable)}, TMP_49._s = self, TMP_49), $a).call($c);
            self.slur_index['$[]='](playable.$slur_starts().$first(), playable);
            ($a = ($d = playable.$slur_ends()).$each, $a._p = (TMP_50 = function(id){var self = TMP_50._s || this, $a, $b, $c, begin_slur = nil, slurpath = nil;
              if (self.slur_index == null) self.slur_index = nil;
if (id == null) id = nil;
            begin_slur = ((($a = self.slur_index['$[]'](id)) !== false && $a !== nil) ? $a : self.slur_index['$[]']("first_playable"));
              ...
              return result.$push((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Path == null ? $a.cm('Path') : $a.Path).$new(slurpath));}, TMP_50._s = self, TMP_50), $a).call($d);
            return result;}, TMP_47._s = self, TMP_47), $a).call($n, []);
...
if (dacapo == null) dacapo = nil;
        ...
        def.$compute_beat_compression = function(music, layout_lines) {
          var $a, $b, TMP_53, $c, TMP_54, $d, TMP_55, self = this, max_beat = nil, current_beat = nil, last_size = nil, relevant_beat_maps = nil;

          max_beat = ($a = ($b = music.$beat_maps()).$map, $a._p = (TMP_53 = function(map){var self = TMP_53._s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_53._s = self, TMP_53), $a).call($b).$max();
          current_beat = 0;
          last_size = ((($a = $scope.BEAT_RESOULUTION) == null ? $opal.cm('BEAT_RESOULUTION') : $a));
          relevant_beat_maps = ($a = ($c = layout_lines).$inject, $a._p = (TMP_54 = function(r, i){var self = TMP_54._s || this;
if (r == null) r = nil;if (i == null) i = nil;
          return r.$push(music.$beat_maps()['$[]'](i))}, TMP_54._s = self, TMP_54), $a).call($c, []).$compact();
          return (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($d = ($range(0, max_beat, false))).$map, $a._p = (TMP_55 = function(beat){var self = TMP_55._s || this, $a, $b, TMP_56, $c, TMP_57, $d, TMP_58, notes_on_beat = nil, max_duration = nil, has_no_notes_on_beat = nil, is_new_part = nil, size = nil, e = nil, increment = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (beat == null) beat = nil;
          notes_on_beat = ($a = ($b = relevant_beat_maps).$map, $a._p = (TMP_56 = function(bm){var self = TMP_56._s || this;
if (bm == null) bm = nil;
            return bm['$[]'](beat)}, TMP_56._s = self, TMP_56), $a).call($b).$flatten().$compact();
            max_duration = ($a = ($c = notes_on_beat).$map, $a._p = (TMP_57 = function(n){var self = TMP_57._s || this;
if (n == null) n = nil;
            return n.$duration()}, TMP_57._s = self, TMP_57), $a).call($c).$max();
            has_no_notes_on_beat = notes_on_beat['$empty?']();
            is_new_part = ($a = ($d = notes_on_beat).$select, $a._p = (TMP_58 = function(n){var self = TMP_58._s || this;
if (n == null) n = nil;
            return n['$first_in_part?']()}, TMP_58._s = self, TMP_58), $a).call($d);
            ...
            return [beat, current_beat];}, TMP_55._s = self, TMP_55), $a).call($d));
        };
        ...
        def.$layout_note = function(root, beat_layout) {
          var $a, $b, TMP_59, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          ...
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_59 = function(e){var self = TMP_59._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_59._s = self, TMP_59), $a).call($b);
        ...
        def.$layout_accord = function(root, beat_layout) {
          var $a, $b, TMP_60, $c, TMP_61, self = this, notes = nil, resnotes = nil, res = nil;

          notes = ($a = ($b = root.$notes()).$sort_by, $a._p = (TMP_60 = function(a){var self = TMP_60._s || this;
if (a == null) a = nil;
          return a.$pitch()}, TMP_60._s = self, TMP_60), $a).call($b);
          resnotes = ($a = ($c = notes).$map, $a._p = (TMP_61 = function(c){var self = TMP_61._s || this;
if (c == null) c = nil;
          return self.$layout_note(c, beat_layout)}, TMP_61._s = self, TMP_61), $a).call($c);
          res = [];
        ...
        def.$layout_measure_start = function(root, beat_layout) {
          var $a, $b, TMP_62, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;

          x_offset = ((($a = $scope.PITCH_OFFSET) == null ? $opal.cm('PITCH_OFFSET') : $a)['$+'](root.$pitch()))['$*']((($a = $scope.X_SPACING) == null ? $opal.cm('X_SPACING') : $a))['$+']((($a = $scope.X_OFFSET) == null ? $opal.cm('X_OFFSET') : $a));
          y_offset = beat_layout.$call(root.$beat());
          $a = $opal.to_ary((($b = $scope.DURATION_TO_STYLE) == null ? $opal.cm('DURATION_TO_STYLE') : $b)['$[]'](self.$duration_to_id(root.$duration()))), scale = ($a[0] == null ? nil : $a[0]), fill = ($a[1] == null ? nil : $a[1]), dotted = ($a[2] == null ? nil : $a[2]);
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_62 = function(e){var self = TMP_62._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_62._s = self, TMP_62), $a).call($b);
...
(function($opal) {
  ...
  $opal.add_stubs(['$map', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$/', '$%', '$<', '$+', '$==', '$!', '$*', '$new', '$reset_state', '$reset_measure_accidentals', '$match', '$parse', '$last', '$first', '$<<', '$error', '$message', '$split', '$inject', '$get_metadata', '$select', '$nil?', '$join', '$compact', '$flatten', '$parse_harpnote_config', '$count', '$length', '$warning', '$empty?', '$to_i', '$strip', '$set_key', '$each_with_index', '$debug', '$index=', '$flatten!', '$compact!', '$send', '$origin=', '$make_jumplines', '$now', '$to_n', '$keys', '$meta_data=', '$harpnote_options=', '$harpnote_options', '$-', '$to_s', '$private', '$is_a?', '$origin', '$round', '$>', '$transform_rest', '$transform_real_note', '$tuplet=', '$tuplet_start=', '$tuplet_end=', '$push', '$pitch', '$visible=', '$companion=', '$first_in_part=', '$clear', '$get_midipitch', '$slur_starts=', '$slur_ends=', '$tie_start=', '$tie_end=', '$tie_start?', '$tie_end?', '$gsub', '$pop']);
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (f == null) f = nil;
      ...
      (function($base, $super) {
        ...
        def.pitch_transformer = def.tuplet_downcount = def.current_tuplet = def.repetition_stack = def.previous_note = def.next_note_marks_measure = def.next_note_marks_repeat_start = def.previous_new_part = nil;
        def.$initialize = function() {
          var $a, $b, $c, self = this;
...
if (k == null) k = nil;if (v == null) v = nil;
        ...
        def.$transform = function(abc_code) {
          var $a, $b, TMP_12, $c, TMP_13, $d, TMP_14, $e, TMP_15, $f, TMP_16, $g, TMP_20, $h, $i, TMP_24, TMP_25, $j, TMP_26, self = this, harpnote_options = nil, warnings = nil, note_length_rows = nil, note_length = nil, tune = nil, lines = nil, first_staff = nil, key = nil, meter = nil, voices = nil, hn_voices = nil, result = nil, meta_data = nil, duration = nil, bpm = nil, duration_display = nil, meta_data_from_tune = nil;
          ...
          ($a = ($b = warnings).$each, $a._p = (TMP_12 = function(w){var self = TMP_12._s || this, wn = nil, lines = nil, line_no = nil, char_pos = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (w == null) w = nil;
          wn = self.$Native(w);
            ...
            return $gvars.log.$warning("" + (wn['$[]']("message")) + " at line " + (wn['$[]']("line")) + " position " + (line_no) + ":" + (char_pos));}, TMP_12._s = self, TMP_12), $a).call($b);
          note_length_rows = ($a = ($c = abc_code.$split("\n")).$select, $a._p = (TMP_13 = function(row){var self = TMP_13._s || this;
if (row == null) row = nil;
          return row['$[]']($range(0, 1, false))['$==']("L:")}, TMP_13._s = self, TMP_13), $a).call($c);
          if ((($a = note_length_rows['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            note_length_rows = ["L:1/4"]};
          note_length = ($a = ($d = note_length_rows.$first().$strip().$split(":").$last().$split("/")).$map, $a._p = (TMP_14 = function(s){var self = TMP_14._s || this;
if (s == null) s = nil;
          return s.$strip().$to_i()}, TMP_14._s = self, TMP_14), $a).call($d);
          note_length = note_length.$last()['$/'](note_length.$first());
          tune = self.$Native(tune);
          lines = ($a = ($e = tune['$[]']("lines")).$select, $a._p = (TMP_15 = function(l){var self = TMP_15._s || this;
if (l == null) l = nil;
          return self.$Native(l)['$[]']("staff")}, TMP_15._s = self, TMP_15), $a).call($e);
          ...
          voices = [];
          ($a = ($f = lines).$each_with_index, $a._p = (TMP_16 = function(line, line_index){var self = TMP_16._s || this, $a, $b, TMP_17, voice_no = nil;
if (line == null) line = nil;if (line_index == null) line_index = nil;
          voice_no = 1;
            return ($a = ($b = self.$Native(line)['$[]']("staff")).$each_with_index, $a._p = (TMP_17 = function(staff, staff_index){var self = TMP_17._s || this, $a, $b, TMP_18;
if (staff == null) staff = nil;if (staff_index == null) staff_index = nil;
            return ($a = ($b = self.$Native(staff)['$[]']("voices")).$each_with_index, $a._p = (TMP_18 = function(voice, voice_index){var self = TMP_18._s || this, $a, $b, $c, $d, $e, $f, TMP_19;
                if ($gvars.log == null) $gvars.log = nil;
if (voice == null) voice = nil;if (voice_index == null) voice_index = nil;
              $gvars.log.$debug("reading line.staff.voice " + (voice_no) + ":" + (line_index) + " " + (staff_index) + "." + (voice_index) + " (" + ("abc_to_harpnotes") + " " + (226) + ")");
                ...
                voices['$[]'](voice_no)['$<<'](($a = ($b = voice).$map, $a._p = (TMP_19 = function(x){var self = TMP_19._s || this;
if (x == null) x = nil;
                return self.$Native(x)}, TMP_19._s = self, TMP_19), $a).call($b));
                voices['$[]'](voice_no)['$index='](voice_no);
                voices['$[]'](voice_no)['$flatten!']();
                return voice_no = voice_no['$+'](1);}, TMP_18._s = self, TMP_18), $a).call($b)}, TMP_17._s = self, TMP_17), $a).call($b);}, TMP_16._s = self, TMP_16), $a).call($f);
          voices['$compact!']();
          hn_voices = ($a = ($g = voices.$each_with_index()).$map, $a._p = (TMP_20 = function(voice, voice_idx){var self = TMP_20._s || this, $a, $b, TMP_21, $c, TMP_23, hn_voice = nil, jumplines = nil;
if (voice == null) voice = nil;if (voice_idx == null) voice_idx = nil;
          self.$reset_state();
            hn_voice = ($a = ($b = voice).$map, $a._p = (TMP_21 = function(el){var self = TMP_21._s || this, $a, $b, TMP_22, type = nil, hn_voice_element = nil;
if (el == null) el = nil;
            type = el['$[]']("el_type");
              ...
              if ((($a = ((($b = hn_voice_element['$nil?']()) !== false && $b !== nil) ? $b : hn_voice_element['$empty?']())) !== nil && (!$a._isBoolean || $a == true))) {
                ...
                ($a = ($b = hn_voice_element).$each, $a._p = (TMP_22 = function(e){var self = TMP_22._s || this;
if (e == null) e = nil;
                return e['$origin='](el)}, TMP_22._s = self, TMP_22), $a).call($b)
              };
              return hn_voice_element;}, TMP_21._s = self, TMP_21), $a).call($b).$flatten().$compact();
            jumplines = [];
            ($a = ($c = hn_voice).$each, $a._p = (TMP_23 = function(e){var self = TMP_23._s || this;
if (e == null) e = nil;
            return jumplines['$<<'](self.$make_jumplines(e))}, TMP_23._s = self, TMP_23), $a).call($c);
            hn_voice = hn_voice['$+'](jumplines.$flatten().$compact());
            return hn_voice;}, TMP_20._s = self, TMP_20), $a).call($g);
          ...
          if ((($a = tune['$[]']("metaText")['$[]']("tempo")) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            meta_data['$[]=']("tempo", $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm}));
            duration_display = ($a = ($h = duration).$map, $a._p = (TMP_24 = function(d){var self = TMP_24._s || this;
if (d == null) d = nil;
            return "1/" + ((1)['$/'](d))}, TMP_24._s = self, TMP_24), $a).call($h);
          ...
          ($a = ($i = meta_data_from_tune.$keys()).$each, $a._p = (TMP_25 = function(k){var self = TMP_25._s || this;
if (k == null) k = nil;
          return meta_data['$[]='](k, meta_data_from_tune['$[]'](k))}, TMP_25._s = self, TMP_25), $a).call($i);
          result['$meta_data='](meta_data);
          result['$harpnote_options=']($hash2([], {}));
          result.$harpnote_options()['$[]=']("print", ($a = ($j = harpnote_options['$[]']("print")).$map, $a._p = (TMP_26 = function(o){var self = TMP_26._s || this, $a, $b, TMP_27, $c, TMP_28, $d, TMP_30, $e, TMP_31, $f, TMP_32, $g, TMP_33, ro = nil, missing_voices = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (o == null) o = nil;
          ro = $hash2(["title", "voices", "synchlines", "flowlines", "jumplines", "layoutlines"], {"title": o['$[]']("t"), "voices": ($a = ($b = o['$[]']("v")).$map, $a._p = (TMP_27 = function(i){var self = TMP_27._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_27._s = self, TMP_27), $a).call($b), "synchlines": ($a = ($c = o['$[]']("s")).$map, $a._p = (TMP_28 = function(i){var self = TMP_28._s || this, $a, $b, TMP_29;
if (i == null) i = nil;
            return ($a = ($b = i).$map, $a._p = (TMP_29 = function(j){var self = TMP_29._s || this;
if (j == null) j = nil;
              return j['$-'](1)}, TMP_29._s = self, TMP_29), $a).call($b)}, TMP_28._s = self, TMP_28), $a).call($c), "flowlines": ($a = ($d = o['$[]']("f")).$map, $a._p = (TMP_30 = function(i){var self = TMP_30._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_30._s = self, TMP_30), $a).call($d), "jumplines": ($a = ($e = o['$[]']("j")).$map, $a._p = (TMP_31 = function(i){var self = TMP_31._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_31._s = self, TMP_31), $a).call($e), "layoutlines": ($a = ($f = (((($g = o['$[]']("l")) !== false && $g !== nil) ? $g : o['$[]']("v")))).$map, $a._p = (TMP_32 = function(i){var self = TMP_32._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_32._s = self, TMP_32), $a).call($f)});
            missing_voices = ($a = ($g = (ro['$[]']("voices")['$-'](ro['$[]']("layoutlines")))).$map, $a._p = (TMP_33 = function(i){var self = TMP_33._s || this;
if (i == null) i = nil;
            return i['$+'](1)}, TMP_33._s = self, TMP_33), $a).call($g);
            if ((($a = missing_voices['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
              } else {
              $gvars.log.$error("hn.print '" + (ro['$[]']("title")) + "' l: missing voices " + (missing_voices.$to_s()))
            };
            return ro;}, TMP_26._s = self, TMP_26), $a).call($j));
        ...
        def.$make_jumplines = function(entity) {
          var $a, $b, $c, $d, TMP_34, self = this, result = nil, chords = nil;
          ...
          if ((($a = entity['$is_a?']((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).Playable == null ? $b.cm('Playable') : $b.Playable))) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            ($a = ($b = chords).$each, $a._p = (TMP_34 = function(chord){var self = TMP_34._s || this, $a, $b, $c, name = nil, nameparts = nil, target = nil, argument = nil;
...
if (chord == null) chord = nil;
        ...
        def.$transform_note = function(note) {
          var $a, $b, $c, $d, TMP_35, self = this, duration = nil, start_tuplet = nil, end_tuplet = nil, result = nil, jumpstarts = nil, jumpends = nil;
          ...
          if ((($a = result['$empty?']()['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            if ((($a = note['$[]']("chord")['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              jumpstarts = [];
              jumpends = [];
              ($a = ($b = note['$[]']("chord")).$each, $a._p = (TMP_35 = function(chord){var self = TMP_35._s || this, $a, $b, TMP_36, name = nil;
                if (self.jumptargets == null) self.jumptargets = nil;
if (chord == null) chord = nil;
              name = self.$Native(chord)['$[]']("name");
                if (name['$[]'](0)['$=='](":")) {
                  jumpends.$push(name['$[]']($range(1, -1, false)));
                  self.jumptargets['$[]='](name['$[]']($range(1, -1, false)), ($a = ($b = result).$select, $a._p = (TMP_36 = function(n){var self = TMP_36._s || this, $a, $b, $c;
if (n == null) n = nil;
                  return n['$is_a?']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).Playable == null ? $a.cm('Playable') : $a.Playable))}, TMP_36._s = self, TMP_36), $a).call($b).$last());};
                if (name['$[]'](0)['$==']("@")) {
        ...
        def.$transform_rest = function(note, duration) {
          var $a, $b, $c, TMP_37, self = this, pitch = nil, res = nil, result = nil;
          ...
          if ((($a = self.next_note_marks_repeat_start) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            self.next_note_marks_repeat_start = false;};
          ($a = ($b = self.previous_new_part).$each, $a._p = (TMP_37 = function(part){var self = TMP_37._s || this;
if (part == null) part = nil;
          part['$companion='](res);
            return res['$first_in_part='](true);}, TMP_37._s = self, TMP_37), $a).call($b);
          self.previous_new_part.$clear();
          return result;
        };

        def.$transform_real_note = function(note, duration) {
          var $a, $b, TMP_38, $c, $d, TMP_40, $e, TMP_41, $f, TMP_42, $g, TMP_43, self = this, notes = nil, res = nil, synchpoint = nil;

          notes = ($a = ($b = self.$Native(note['$[]']("pitches"))).$map, $a._p = (TMP_38 = function(pitch){var self = TMP_38._s || this, $a, $b, $c, TMP_39, midipitch = nil, native_pitch = nil, thenote = nil;
...
if (pitch == null) pitch = nil;
          midipitch = self.pitch_transformer.$get_midipitch(pitch);
            ...
            thenote['$origin='](note);
            thenote['$slur_starts='](($a = ($b = (((($c = native_pitch['$[]']("startSlur")) !== false && $c !== nil) ? $c : []))).$map, $a._p = (TMP_39 = function(s){var self = TMP_39._s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_39._s = self, TMP_39), $a).call($b));
            ...
            return thenote;}, TMP_38._s = self, TMP_38), $a).call($b);
          res = [];
          if (notes.$length()['$=='](1)) {
            res['$<<'](notes.$first())
            } else {
            ...
            synchpoint['$slur_starts='](($a = ($c = (((($d = note['$[]']("startSlur")) !== false && $d !== nil) ? $d : []))).$map, $a._p = (TMP_40 = function(s){var self = TMP_40._s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_40._s = self, TMP_40), $a).call($c));
            synchpoint['$slur_ends='](((($a = note['$[]']("endSlur")) !== false && $a !== nil) ? $a : []));
            synchpoint['$tie_start='](((($a = (note['$[]']("startTie")['$nil?']()['$!']())) !== false && $a !== nil) ? $a : (($d = ($e = notes).$select, $d._p = (TMP_41 = function(n){var self = TMP_41._s || this;
if (n == null) n = nil;
            return n['$tie_start?']()}, TMP_41._s = self, TMP_41), $d).call($e)['$empty?']()['$!']())));
            synchpoint['$tie_end='](((($a = (note['$[]']("endTie")['$nil?']()['$!']())) !== false && $a !== nil) ? $a : (($d = ($f = notes).$select, $d._p = (TMP_42 = function(n){var self = TMP_42._s || this;
if (n == null) n = nil;
            return n['$tie_end?']()}, TMP_42._s = self, TMP_42), $d).call($f)['$empty?']()['$!']())));
            res['$<<'](synchpoint);
          };
          ...
          if ((($a = self.next_note_marks_repeat_start) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            self.next_note_marks_repeat_start = false;};
          ($a = ($d = self.previous_new_part).$each, $a._p = (TMP_43 = function(part){var self = TMP_43._s || this;
if (part == null) part = nil;
          part['$companion='](notes.$last());
            return notes.$last()['$first_in_part='](true);}, TMP_43._s = self, TMP_43), $a).call($d);
          self.previous_new_part.$clear();
          return res;
        };
        ...
        return (def.$method_missing = function(name, args) {
          ...
          args = $slice.call(arguments, 1);
          $gvars.log.$debug("Missing transformation rule: " + (name) + " (" + ("abc_to_harpnotes") + " " + (524) + ")");
          return nil;
        }, nil) && 'method_missing';
      })(self, null);
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return lines = [];}else {return $gvars.log.$error("unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (150) + ")")}})()}, TMP_11._s = self, TMP_11), $a).call($e);
        self.pdf['$stroke=']([0, 0, 0]);
        if ((($a = root['$dotted?']()) !== nil && (!$a._isBoolean || $a == true))) {
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return lines = [];}else {return $gvars.log.$error("unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (238) + ")")}})()}, TMP_16._s = self, TMP_16), $a).call($c);
...
(function($opal) {
  ...
  $opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$warn', '$clone', '$private', '$attr', '$html', '$find', '$new', '$on_command', '$handle_command', '$info', '$each', '$send', '$select', '$=~', '$methods', '$setup_ui', '$setup_ui_listener', '$load_from_loacalstorage', '$set_status', '$loglevel', '$run_string', '$error', '$message', '$split', '$first', '$===', '$debug', '$then', '$status_code', '$body', '$get', '$HTTP', '$get_text', '$Native', '$nil?', '$set_text', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$==', '$play_song', '$play_selection', '$play_from_selection', '$backtrace', '$set_inactive', '$load_song', '$save_to_localstorage', '$set_active', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$merge!', '$join', '$inject', '$push', '$last', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$on', '$play_abc', '$render_previews', '$on_change', '$on_selection_change', '$get_selection_positions', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
...
if (m == null) m = nil;
    ...
    def.$handle_command = function(command) {
      var $a, $b, TMP_4, $c, self = this, e = nil, command_tokens = nil, $case = nil;
      if ($gvars.log == null) $gvars.log = nil;
      ...
      return ($a = ($b = (($c = $scope.Browser) == null ? $opal.cm('Browser') : $c).$HTTP().$get("http://www.weichel21.de/months.js")).$then, $a._p = (TMP_4 = function(response){var self = TMP_4._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (response == null) response = nil;
      $gvars.log.$debug("returned " + (response.$status_code()));
        return $gvars.log.$debug(response.$body());}, TMP_4._s = self, TMP_4), $a).call($b);}else {return $gvars.log.$error("wrong commnad: " + (command))}})();
    };
    ...
    def.$render_tunepreview_callback = function() {
      ...
      $gvars.log.$debug("finished render tune " + ("controller") + " " + (189));
    ...
    def.$render_harpnotepreview_callback = function() {
      ...
      $gvars.log.$debug("finished rendering Haprnotes " + ("controller") + " " + (205));
...
if (r == null) r = nil;if (v == null) v = nil;
    ...
    def.$setup_ui = function() {
      var $a, $b, TMP_6, $c, $d, TMP_7, self = this, printerparams = nil;
      ...
      ($a = ($b = self.harpnote_preview_printer).$on_select, $a._p = (TMP_6 = function(harpnote){var self = TMP_6._s || this;
if (harpnote == null) harpnote = nil;
      ...
      return ($a = ($c = self.tune_preview_printer).$on_select, $a._p = (TMP_7 = function(abcelement){var self = TMP_7._s || this, a = nil;
if (abcelement == null) abcelement = nil;
      a = self.$Native(abcelement);
        return self.$select_abc_object(abcelement);}, TMP_7._s = self, TMP_7), $a).call($c);
    };
    ...
    def.$setup_ui_listener = function() {
      ...
      ($a = ($f = (($g = $scope.Element) == null ? $opal.cm('Element') : $g).$find("#tbCommand")).$on, $a._p = (TMP_12 = function(event){var self = TMP_12._s || this;
if (event == null) event = nil;
      self.$handle_command(self.$Native(event['$[]']("target"))['$[]']("value"));
        return self.$Native(event['$[]']("target"))['$[]=']("value", "");}, TMP_12._s = self, TMP_12), $a).call($f, "change");
      ($a = ($g = self.editor).$on_change, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this, $a;
...
if (e == null) e = nil;
      self.$set_status($hash2(["song"], {"song": "changed"}));
        ...
        if ((($a = self.systemstatus['$[]']("autorefresh")) !== nil && (!$a._isBoolean || $a == true))) {
          self.refresh_timer = setTimeout(function(){self.$render_previews()}, 2000)};
        return nil;}, TMP_13._s = self, TMP_13), $a).call($g);
      ($a = ($h = self.editor).$on_selection_change, $a._p = (TMP_14 = function(e){var self = TMP_14._s || this, a = nil;
...
if (e == null) e = nil;
      a = self.editor.$get_selection_positions();
        $gvars.log.$debug("editor selecton " + (a.$first()) + " to " + (a.$last()) + " (" + ("controller") + ":" + (339) + ")");
        if (a.$first()['$=='](a.$last())) {
          return nil
          } else {
        ...
        };}, TMP_14._s = self, TMP_14), $a).call($h);
...
if (e == null) e = nil;
      ...
      ($a = ($l = (($m = $scope.Element) == null ? $opal.cm('Element') : $m).$find(window)).$on, $a._p = (TMP_18 = function(evt){var self = TMP_18._s || this, $a;
        if ($gvars.log == null) $gvars.log = nil;
if (evt == null) evt = nil;
      $gvars.log.$debug("key pressed (" + ("controller") + " " + (366) + ")");
        ...
        if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        };}, TMP_18._s = self, TMP_18), $a).call($l, "keydown");
...
(function($opal) {
  ...
  $opal.add_stubs(['$private', '$info', '$add_command', '$undoable=', '$set_help', '$as_action', '$join', '$help_string_style', '$add_parameter', '$set_default', '$loglevel=', '$[]', '$set_status', '$loglevel', '$==', '$undo', '$redo', '$map', '$first', '$name', '$last', '$history', '$undostack', '$redostack', '$parameter_help', '$===', '$play_abc', '$error', '$stop_play_abc', '$gsub', '$raise', '$[]=', '$get_text', '$set_text', '$as_inverse', '$get_metadata', '$update', '$+', '$list', '$retrieve', '$command_tokens', '$new', '$app_name=', '$then', '$app_name', '$authenticate', '$to_s', '$select', '$=~', '$read_dir', '$debug', '$split', '$layout_harpnotes', '$render_previews', '$harpnote_options', '$fail', '$write_file', '$output', '$render_a3', '$render_a4', '$each_with_index', '$each', '$push', '$when', '$add_metadata', '$read_file']);
  return (function($base, $super) {
    function $Controller(){};
    var self = $Controller = $klass($base, $super, 'Controller', $Controller);
...
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_13 = function(){var self = TMP_13._s || this;
          ...
          return "true | false "}, TMP_14._s = self, TMP_14), $a).call($c);}, TMP_12._s = self, TMP_12), $a).call($c, "value", "boolean");
        return ($a = ($d = c).$as_action, $a._p = (TMP_15 = function(args){var self = TMP_15._s || this, $a, result = nil;
if (args == null) args = nil;
        result = ((($a = (args['$[]']("value")['$==']("true"))) !== false && $a !== nil) ? $a : false);
          return self.$set_status($hash2(["autorefresh"], {"autorefresh": result}));}, TMP_15._s = self, TMP_15), $a).call($d);}, TMP_10._s = self, TMP_10), $a).call($d, "autorefresh");
...
if (c == null) c = nil;
    ...
    def.$__ic_02_play_commands = function() {
      var $a, $b, TMP_34, $c, TMP_40, self = this;
...
if (argument == null) argument = nil;
      ...
      return ($a = ($c = self.commands).$add_command, $a._p = (TMP_40 = function(c){var self = TMP_40._s || this, $a, $b, TMP_41, $c, TMP_42;
if (c == null) c = nil;
      c['$undoable='](false);
...
if (a == null) a = nil;
    ...
    def.$__ic_03_create_commands = function() {
      ...
      return ($a = ($b = self.commands).$add_command, $a._p = (TMP_43 = function(c){var self = TMP_43._s || this, $a, $b, TMP_44, $c, TMP_45, $d, TMP_47, $e, TMP_50, $f, TMP_51;
if (c == null) c = nil;
      ($a = ($b = c).$set_help, $a._p = (TMP_44 = function(){var self = TMP_44._s || this;

        return "create song " + (c.$parameter_help(0)) + " " + (c.$parameter_help(1))}, TMP_44._s = self, TMP_44), $a).call($b);
        ($a = ($c = c).$add_parameter, $a._p = (TMP_45 = function(parameter){var self = TMP_45._s || this, $a, $b, TMP_46;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_help, $a._p = (TMP_46 = function(){var self = TMP_46._s || this;

          return "value for X: line, a unique id"}, TMP_46._s = self, TMP_46), $a).call($b)}, TMP_45._s = self, TMP_45), $a).call($c, "id", "string");
        ($a = ($d = c).$add_parameter, $a._p = (TMP_47 = function(parameter){var self = TMP_47._s || this, $a, $b, TMP_48, $c, TMP_49;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_48 = function(){var self = TMP_48._s || this;

          return "untitled"}, TMP_48._s = self, TMP_48), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_49 = function(){var self = TMP_49._s || this;

          return "Title of the song"}, TMP_49._s = self, TMP_49), $a).call($c);}, TMP_47._s = self, TMP_47), $a).call($d, "title", "string");
        ($a = ($e = c).$as_action, $a._p = (TMP_50 = function(args){var self = TMP_50._s || this, song_id = nil, song_title = nil, filename = nil, template = nil;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        song_id = args['$[]']("id");
          ...
          return self.$set_status($hash2(["song"], {"song": "new"}));}, TMP_50._s = self, TMP_50), $a).call($e);
        return ($a = ($f = c).$as_inverse, $a._p = (TMP_51 = function(args){var self = TMP_51._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_51._s = self, TMP_51), $a).call($f);}, TMP_43._s = self, TMP_43), $a).call($b, "c");
    };

    def.$__ic_04_localstore_commands = function() {
      var $a, $b, TMP_52, $c, TMP_55, $d, TMP_59, self = this;

      ($a = ($b = self.commands).$add_command, $a._p = (TMP_52 = function(c){var self = TMP_52._s || this, $a, $b, TMP_53, $c, TMP_54;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_53 = function(){var self = TMP_53._s || this;

        return "save to localstore"}, TMP_53._s = self, TMP_53), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_54 = function(){var self = TMP_54._s || this, abc_code = nil, metadata = nil, filename = nil;
          if (self.editor == null) self.editor = nil;
        ...
        abc_code = self.editor.$get_text();
          ...
          return $gvars.log.$info("saved to '" + (filename) + "'");}, TMP_54._s = self, TMP_54), $a).call($c);}, TMP_52._s = self, TMP_52), $a).call($b, "lsave");
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_55 = function(c){var self = TMP_55._s || this, $a, $b, TMP_56, $c, TMP_57;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_56 = function(){var self = TMP_56._s || this;

        return "list files in localstore"}, TMP_56._s = self, TMP_56), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_57 = function(a){var self = TMP_57._s || this, $a, $b, TMP_58;
          if (self.songbook == null) self.songbook = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        return $gvars.log.$info("<pre>"['$+'](($a = ($b = self.songbook.$list()).$map, $a._p = (TMP_58 = function(k, v){var self = TMP_58._s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return "" + (k) + "_" + (v)}, TMP_58._s = self, TMP_58), $a).call($b).$join("\n"))['$+']("</pre>"))}, TMP_57._s = self, TMP_57), $a).call($c);}, TMP_55._s = self, TMP_55), $a).call($c, "lls");
      return ($a = ($d = self.commands).$add_command, $a._p = (TMP_59 = function(c){var self = TMP_59._s || this, $a, $b, TMP_60, $c, TMP_62, $d, TMP_63, $e, TMP_64;
if (c == null) c = nil;
      c['$undoable='](true);
        ($a = ($b = c).$add_parameter, $a._p = (TMP_60 = function(parameter){var self = TMP_60._s || this, $a, $b, TMP_61;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_help, $a._p = (TMP_61 = function(){var self = TMP_61._s || this;

          return "id of the song to be loaded"}, TMP_61._s = self, TMP_61), $a).call($b)}, TMP_60._s = self, TMP_60), $a).call($b, "id", "string");
        ($a = ($c = c).$set_help, $a._p = (TMP_62 = function(){var self = TMP_62._s || this;

        return "open song from local store  " + (c.$parameter_help(0))}, TMP_62._s = self, TMP_62), $a).call($c);
        ($a = ($d = c).$as_action, $a._p = (TMP_63 = function(args){var self = TMP_63._s || this, $a, payload = nil;
          if (self.songbook == null) self.songbook = nil;
          if (self.editor == null) self.editor = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        if ((($a = args['$[]']("id")) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          }}, TMP_63._s = self, TMP_63), $a).call($d);
        return ($a = ($e = c).$as_inverse, $a._p = (TMP_64 = function(args){var self = TMP_64._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_64._s = self, TMP_64), $a).call($e);}, TMP_59._s = self, TMP_59), $a).call($d, "lopen");
    };

    return (def.$__ic_05_dropbox_commands = function() {
      var $a, $b, TMP_65, $c, TMP_76, $d, TMP_85, $e, TMP_92, $f, TMP_95, $g, TMP_106, self = this;

      ($a = ($b = self.commands).$add_command, $a._p = (TMP_65 = function(command){var self = TMP_65._s || this, $a, $b, TMP_66, $c, TMP_69, $d, TMP_72, $e, TMP_73, $f, TMP_75;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_66 = function(parameter){var self = TMP_66._s || this, $a, $b, TMP_67, $c, TMP_68;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_67 = function(){var self = TMP_67._s || this;

          return "app"}, TMP_67._s = self, TMP_67), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_68 = function(){var self = TMP_68._s || this;

          return "(app | full) app: app only | full: full dropbox"}, TMP_68._s = self, TMP_68), $a).call($c);}, TMP_66._s = self, TMP_66), $a).call($b, "scope", "string");
        ($a = ($c = command).$add_parameter, $a._p = (TMP_69 = function(parameter){var self = TMP_69._s || this, $a, $b, TMP_70, $c, TMP_71;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_70 = function(){var self = TMP_70._s || this;

          return "/"}, TMP_70._s = self, TMP_70), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_71 = function(){var self = TMP_71._s || this;

          return "path to set in dropbox"}, TMP_71._s = self, TMP_71), $a).call($c);}, TMP_69._s = self, TMP_69), $a).call($c, "path", "string");
        ($a = ($d = command).$set_help, $a._p = (TMP_72 = function(){var self = TMP_72._s || this;

        return "dropbox login for " + (command.$parameter_help(0))}, TMP_72._s = self, TMP_72), $a).call($d);
        ($a = ($e = command).$as_action, $a._p = (TMP_73 = function(args){var self = TMP_73._s || this, $a, $b, $c, TMP_74, $case = nil;
...
if (args == null) args = nil;
        $case = args['$[]']("scope");if ("full"['$===']($case)) {self.dropboxclient = (($a = ((($b = ((($c = $scope.Opal) == null ? $opal.cm('Opal') : $c))._scope).DropboxJs == null ? $b.cm('DropboxJs') : $b.DropboxJs))._scope).Client == null ? $a.cm('Client') : $a.Client).$new("us2s6tq6bubk6xh");
          ...
          return ($a = ($b = self.dropboxclient.$authenticate()).$then, $a._p = (TMP_74 = function(){var self = TMP_74._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
            return $gvars.log.$info("logged in at dropbox with " + (args['$[]']("scope")) + " access");}, TMP_74._s = self, TMP_74), $a).call($b);}, TMP_73._s = self, TMP_73), $a).call($e);
        return ($a = ($f = command).$as_inverse, $a._p = (TMP_75 = function(args){var self = TMP_75._s || this;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.$set_status($hash2(["dropbox"], {"dropbox": "logged out"}));
          $gvars.log.$info("logged out from dropbox");
          return self.dropboxclient = nil;}, TMP_75._s = self, TMP_75), $a).call($f);}, TMP_65._s = self, TMP_65), $a).call($b, "dlogin");
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_76 = function(command){var self = TMP_76._s || this, $a, $b, TMP_77, $c, TMP_80, $d, TMP_81;
if (command == null) command = nil;
      command['$undoable='](false);
        ($a = ($b = command).$add_parameter, $a._p = (TMP_77 = function(parameter){var self = TMP_77._s || this, $a, $b, TMP_78, $c, TMP_79;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_78 = function(){var self = TMP_78._s || this, $a;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return ((($a = self.dropboxpath) !== false && $a !== nil) ? $a : "/")}, TMP_78._s = self, TMP_78), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_79 = function(){var self = TMP_79._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path in dropbox " + (self.dropboxclient.$app_name())}, TMP_79._s = self, TMP_79), $a).call($c);}, TMP_77._s = self, TMP_77), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a._p = (TMP_80 = function(){var self = TMP_80._s || this;

        return "list files in " + (command.$parameter_help(0))}, TMP_80._s = self, TMP_80), $a).call($c);
        return ($a = ($d = command).$as_action, $a._p = (TMP_81 = function(args){var self = TMP_81._s || this, $a, $b, TMP_82, $c, $d, TMP_84, rootpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          $gvars.log.$info("" + (self.dropboxclient.$app_name()) + ": " + (args['$[]']("path")) + ":");
          return ($a = ($b = ($c = ($d = self.dropboxclient.$authenticate()).$then, $c._p = (TMP_84 = function(){var self = TMP_84._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return self.dropboxclient.$read_dir(rootpath)}, TMP_84._s = self, TMP_84), $c).call($d)).$then, $a._p = (TMP_82 = function(entries){var self = TMP_82._s || this, $a, $b, TMP_83;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          return $gvars.log.$info("<pre>"['$+'](($a = ($b = entries).$select, $a._p = (TMP_83 = function(entry){var self = TMP_83._s || this;
if (entry == null) entry = nil;
            return entry['$=~'](/\.abc$/)}, TMP_83._s = self, TMP_83), $a).call($b).$join("\n").$to_s())['$+']("</pre>"))}, TMP_82._s = self, TMP_82), $a).call($b);}, TMP_81._s = self, TMP_81), $a).call($d);}, TMP_76._s = self, TMP_76), $a).call($c, "dls");
      ($a = ($d = self.commands).$add_command, $a._p = (TMP_85 = function(command){var self = TMP_85._s || this, $a, $b, TMP_86, $c, TMP_89, $d, TMP_90, $e, TMP_91;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_86 = function(parameter){var self = TMP_86._s || this, $a, $b, TMP_87, $c, TMP_88;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_87 = function(){var self = TMP_87._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_87._s = self, TMP_87), $a).call($b);
        ...
        return "dropbox change dir to " + (command.$parameter_help(0))}, TMP_89._s = self, TMP_89), $a).call($c);
        ($a = ($d = command).$as_action, $a._p = (TMP_90 = function(args){var self = TMP_90._s || this, rootpath = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$info("dropbox path changed to " + (self.dropboxpath));}, TMP_90._s = self, TMP_90), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a._p = (TMP_91 = function(args){var self = TMP_91._s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.dropboxpath = args['$[]']("oldval");
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$info("dropbox path changed back to " + (self.dropboxpath));}, TMP_91._s = self, TMP_91), $a).call($e);}, TMP_85._s = self, TMP_85), $a).call($d, "dcd");
      ($a = ($e = self.commands).$add_command, $a._p = (TMP_92 = function(command){var self = TMP_92._s || this, $a, $b, TMP_93, $c, TMP_94;
if (command == null) command = nil;
      command['$undoable='](false);
        ($a = ($b = command).$set_help, $a._p = (TMP_93 = function(){var self = TMP_93._s || this;

        return "show drobox path"}, TMP_93._s = self, TMP_93), $a).call($b);
        return ($a = ($c = command).$as_action, $a._p = (TMP_94 = function(args){var self = TMP_94._s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        return $gvars.log.$info("" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath))}, TMP_94._s = self, TMP_94), $a).call($c);}, TMP_92._s = self, TMP_92), $a).call($e, "dpwd");
      ($a = ($f = self.commands).$add_command, $a._p = (TMP_95 = function(command){var self = TMP_95._s || this, $a, $b, TMP_96, $c, TMP_99, $d, TMP_100;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_96 = function(parameter){var self = TMP_96._s || this, $a, $b, TMP_97, $c, TMP_98;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_97 = function(){var self = TMP_97._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_97._s = self, TMP_97), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_98 = function(){var self = TMP_98._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_98._s = self, TMP_98), $a).call($c);}, TMP_96._s = self, TMP_96), $a).call($b, "path", "string");
        command['$undoable='](false);
        ($a = ($c = command).$set_help, $a._p = (TMP_99 = function(){var self = TMP_99._s || this;

        return "save to dropbox {" + (command.$parameter_help(0)) + "}"}, TMP_99._s = self, TMP_99), $a).call($c);
        return ($a = ($d = command).$as_action, $a._p = (TMP_100 = function(args){var self = TMP_100._s || this, $a, $b, TMP_101, $c, $d, TMP_102, $e, $f, TMP_103, abc_code = nil, metadata = nil, filebase = nil, print_variants = nil, rootpath = nil;
          if (self.editor == null) self.editor = nil;
          if (self.abc_transformer == null) self.abc_transformer = nil;
...
if (args == null) args = nil;
        abc_code = self.editor.$get_text();
          ...
          rootpath = args['$[]']("path");
          return ($a = ($b = ($c = ($d = ($e = ($f = self.dropboxclient.$authenticate()).$then, $e._p = (TMP_103 = function(){var self = TMP_103._s || this, $a, $b, TMP_104, $c, TMP_105, save_promises = nil, pdfs = nil;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if (self.editor == null) self.editor = nil;

          save_promises = [self.dropboxclient.$write_file("" + (rootpath) + (filebase) + ".abc", self.editor.$get_text())];
            pdfs = $hash2([], {});
            ($a = ($b = print_variants.$each_with_index()).$map, $a._p = (TMP_104 = function(print_variant, index){var self = TMP_104._s || this, filename = nil;
if (print_variant == null) print_variant = nil;if (index == null) index = nil;
            filename = print_variant['$[]']("title").$gsub(/[^a-zA-Z0-9\-\_]/, "_");
              ...
              return pdfs['$[]=']("" + (rootpath) + (filebase) + "_" + (print_variant['$[]']("title")) + "_a4.pdf", self.$render_a4(index).$output("blob"));}, TMP_104._s = self, TMP_104), $a).call($b);
            ($a = ($c = pdfs).$each, $a._p = (TMP_105 = function(name, pdfdata){var self = TMP_105._s || this;
              if (self.dropboxclient == null) self.dropboxclient = nil;
if (name == null) name = nil;if (pdfdata == null) pdfdata = nil;
            return save_promises.$push(self.dropboxclient.$write_file(name, pdfdata))}, TMP_105._s = self, TMP_105), $a).call($c);
            save_promises.$push(self.dropboxclient.$write_file("" + (rootpath) + (filebase) + ".abc", self.editor.$get_text()));
            return (($a = $scope.Promise) == null ? $opal.cm('Promise') : $a).$when(save_promises);}, TMP_103._s = self, TMP_103), $e).call($f)).$then, $c._p = (TMP_102 = function(){var self = TMP_102._s || this;
            if ($gvars.log == null) $gvars.log = nil;

          self.$set_status($hash2(["song"], {"song": "saved to dropbox"}));
            return $gvars.log.$info("all files saved");}, TMP_102._s = self, TMP_102), $c).call($d)).$fail, $a._p = (TMP_101 = function(err){var self = TMP_101._s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("there was an error saving files " + (err))}, TMP_101._s = self, TMP_101), $a).call($b);}, TMP_100._s = self, TMP_100), $a).call($d);}, TMP_95._s = self, TMP_95), $a).call($f, "dsave");
      return ($a = ($g = self.commands).$add_command, $a._p = (TMP_106 = function(command){var self = TMP_106._s || this, $a, $b, TMP_107, $c, TMP_110, $d, TMP_111, $e, TMP_117;
if (command == null) command = nil;
      command.$add_parameter("fileid", "string", "file id");
        ($a = ($b = command).$add_parameter, $a._p = (TMP_107 = function(p){var self = TMP_107._s || this, $a, $b, TMP_108, $c, TMP_109;
if (p == null) p = nil;
        ($a = ($b = p).$set_default, $a._p = (TMP_108 = function(){var self = TMP_108._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_108._s = self, TMP_108), $a).call($b);
          return ($a = ($c = p).$set_help, $a._p = (TMP_109 = function(){var self = TMP_109._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_109._s = self, TMP_109), $a).call($c);}, TMP_107._s = self, TMP_107), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a._p = (TMP_110 = function(){var self = TMP_110._s || this;

        return "read file with " + (command.$parameter_help(0)) + ", from dropbox " + (command.$parameter_help(1))}, TMP_110._s = self, TMP_110), $a).call($c);
        ($a = ($d = command).$as_action, $a._p = (TMP_111 = function(args){var self = TMP_111._s || this, $a, $b, TMP_112, $c, $d, TMP_113, $e, $f, TMP_114, $g, $h, TMP_116, fileid = nil, rootpath = nil;
          if (self.editor == null) self.editor = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        args['$[]=']("oldval", self.editor.$get_text());
          ...
          return ($a = ($b = ($c = ($d = ($e = ($f = ($g = ($h = self.dropboxclient.$authenticate()).$then, $g._p = (TMP_116 = function(error, data){var self = TMP_116._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
if (error == null) error = nil;if (data == null) data = nil;
          return self.dropboxclient.$read_dir(rootpath)}, TMP_116._s = self, TMP_116), $g).call($h)).$then, $e._p = (TMP_114 = function(entries){var self = TMP_114._s || this, $a, $b, TMP_115;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          $gvars.log.$debug(entries);
            fileid = ($a = ($b = entries).$select, $a._p = (TMP_115 = function(entry){var self = TMP_115._s || this;
if (entry == null) entry = nil;
            return entry['$=~']((new RegExp("" + fileid + "_.*\\.abc$")))}, TMP_115._s = self, TMP_115), $a).call($b).$first();
            return self.dropboxclient.$read_file("" + (rootpath) + (fileid));}, TMP_114._s = self, TMP_114), $e).call($f)).$then, $c._p = (TMP_113 = function(abc_text){var self = TMP_113._s || this, filebase = nil;
            if (self.abc_transformer == null) self.abc_transformer = nil;
            if (self.editor == null) self.editor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (abc_text == null) abc_text = nil;
          $gvars.log.$debug("loaded " + (fileid));
            ...
            return self.$set_status($hash2(["song"], {"song": "loaded"}));}, TMP_113._s = self, TMP_113), $c).call($d)).$fail, $a._p = (TMP_112 = function(err){var self = TMP_112._s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("could not load file " + (err))}, TMP_112._s = self, TMP_112), $a).call($b);}, TMP_111._s = self, TMP_111), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a._p = (TMP_117 = function(args){var self = TMP_117._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_117._s = self, TMP_117), $a).call($e);}, TMP_106._s = self, TMP_106), $a).call($g, "dopen");
...
(function($opal) {
  ...
  $opal.add_stubs(['$expose', '$Native', '$jqconsole', '$find', '$on_command', '$Write', '$handler', '$private', '$call', '$+', '$message', '$Prompt', '$lambda']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(container, prompt, message) {
        ...
        self.jqconsole = self.$Native((($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#" + (container)).$jqconsole(message, "zupfnoter>"));
