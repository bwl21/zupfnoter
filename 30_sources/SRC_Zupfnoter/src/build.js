...
(function($opal) {
  ...
  $opal.add_stubs(['$find', '$write', '$strftime', '$now', '$<<', '$[]']);
  ;
  return (function($base, $super) {
    ...
    return (def.$write = function(type, msg) {
      ...
      return self.console.parent().scrollTop(999999);
    }, nil) && 'write';
  })(self, null);
})(Opal);
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$attr_reader', '$is_a?', '$raise', '$duration', '$first', '$each', '$beat=', '$pitch', '$last', '$beat', '$class', '$update_beats', '$<<', '$select', '$empty?', '$reject', '$notes', '$compact', '$flatten', '$map', '$[]', '$compact!', '$>', '$length', '$new', '$expanded_beat_maps', '$max', '$keys', '$last_beat', '$private', '$inject', '$[]=', '$+', '$index=', '$index', '$==', '$dotted', '$include', '$/', '$*', '$-', '$compute_beat_layout', '$compute_beat_compression', '$call', '$layout_voice', '$even?', '$each_with_index', '$voices', '$origin', '$count', '$build_synch_points', '$layout_note', '$join', '$meta_data', '$layout_playables', '$to', '$nil?', '$from', '$level', '$beat_maps', '$duration_to_id', '$layout_measure_start', '$layout_accord', '$layout_pause', '$sort_by', '$to_sym']);
  return (function($base) {
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return self.$attr_accessor("origin")
      })(self, null);
      ...
      (function($base, $super) {
        ...
        return self.$attr_accessor("beat")
...
if (n == null) n = nil;
      ...
      (function($base, $super) {
        ...
        def.companion = nil;
        self.$attr_reader("companion");

        def.$initialize = function(companion) {
          var $a, $b, $c, $d, self = this;
      ...
      (function($base, $super) {
        ...
        self.$attr_reader("from", "to", "level");

        return (def.$initialize = function(from, to, level) {
          var $a, $b, $c, $d, self = this;
...
if (map == null) map = nil;
        ...
        return (def.$update_beats = function() {
          ...
          self.beat_maps = ($a = ($b = self.voices).$map, $a._p = (TMP_8 = function(voice){var self = TMP_8._s || this, $a, $b, TMP_9, $c, $d, TMP_10, current_beat = nil;
if (voice == null) voice = nil;
          current_beat = 0;
            return ($a = ($b = ($c = ($d = voice).$select, $c._p = (TMP_10 = function(e){var self = TMP_10._s || this, $a;
if (e == null) e = nil;
...
if (map == null) map = nil;if (playable == null) playable = nil;
            beats = playable.$duration();
              ...
              return map;}, TMP_9._s = self, TMP_9), $a).call($b, (($c = $scope.BeatMap) == null ? $opal.cm('BeatMap') : $c).$new(voice.$index()));}, TMP_8._s = self, TMP_8), $a).call($b);
          return self.beat_maps;
        }, nil) && 'update_beats';
      })(self, null);
...
if (k == null) k = nil;if (v == null) v = nil;
        ...
        def.$layout_voice = function(voice, beat_layout, show_flowline) {
          var $a, $b, TMP_20, $c, $d, TMP_21, TMP_22, $e, $f, TMP_23, TMP_24, $g, TMP_25, $h, $i, TMP_26, TMP_27, $j, $k, TMP_28, TMP_29, $l, $m, TMP_30, self = this, res_playables = nil, res_measures = nil, note_to_ellipse = nil, previous_note = nil, res_flow = nil, res_dacapo = nil;
...
if (measure == null) measure = nil;
          ...
          note_to_ellipse = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($e = res_playables).$map, $a._p = (TMP_24 = function(e){var self = TMP_24._s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_24._s = self, TMP_24), $a).call($e));
          ($a = ($g = ($h = ($i = res_playables).$select, $h._p = (TMP_26 = function(e){var self = TMP_26._s || this, $a;
if (e == null) e = nil;
          return e['$is_a?']((($a = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $a))}, TMP_26._s = self, TMP_26), $h).call($i)).$each, $a._p = (TMP_25 = function(f){var self = TMP_25._s || this;
if (f == null) f = nil;
          return note_to_ellipse['$[]='](f.$origin(), f.$to())}, TMP_25._s = self, TMP_25), $a).call($g);
          previous_note = nil;
          res_flow = ($a = ($h = ($j = ($k = voice).$select, $j._p = (TMP_28 = function(c){var self = TMP_28._s || this, $a, $b;
if (c == null) c = nil;
          return ((($a = c['$is_a?']((($b = $scope.Playable) == null ? $opal.cm('Playable') : $b))) !== false && $a !== nil) ? $a : c['$is_a?']((($b = $scope.SynchPoint) == null ? $opal.cm('SynchPoint') : $b)))}, TMP_28._s = self, TMP_28), $j).call($k)).$map, $a._p = (TMP_27 = function(playable){var self = TMP_27._s || this, $a, res = nil;
if (playable == null) playable = nil;
          res = nil;
            ...
            return res;}, TMP_27._s = self, TMP_27), $a).call($h).$compact();
          if (show_flowline !== false && show_flowline !== nil) {
            } else {
            res_flow = []
          };
          res_dacapo = ($a = ($j = ($l = ($m = voice).$select, $l._p = (TMP_30 = function(c){var self = TMP_30._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.Dacapo) == null ? $opal.cm('Dacapo') : $a))}, TMP_30._s = self, TMP_30), $l).call($m)).$map, $a._p = (TMP_29 = function(dacapo){var self = TMP_29._s || this, $a;
if (dacapo == null) dacapo = nil;
          return (($a = $scope.JumpLine) == null ? $opal.cm('JumpLine') : $a).$new(note_to_ellipse['$[]'](dacapo.$from()), note_to_ellipse['$[]'](dacapo.$to()), dacapo.$level())}, TMP_29._s = self, TMP_29), $a).call($j);
          return res_flow['$+'](res_playables)['$+'](res_dacapo)['$+'](res_measures);
        };

        self.$private();

        def.$compute_beat_compression = function(music) {
          var $a, $b, TMP_31, $c, TMP_32, self = this, max_beat = nil, current_beat = nil, last_size = nil;

          max_beat = ($a = ($b = music.$beat_maps()).$map, $a._p = (TMP_31 = function(map){var self = TMP_31._s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_31._s = self, TMP_31), $a).call($b).$max();
          current_beat = 0;
          last_size = 32;
          return (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($c = ($range(0, max_beat, false))).$map, $a._p = (TMP_32 = function(beat){var self = TMP_32._s || this, $a, $b, TMP_33, $c, TMP_34, notes_on_beat = nil, max_duration = nil, has_no_notes_on_beat = nil, size = nil, increment = nil;
if (beat == null) beat = nil;
          notes_on_beat = ($a = ($b = music.$beat_maps()).$map, $a._p = (TMP_33 = function(bm){var self = TMP_33._s || this;
if (bm == null) bm = nil;
            return bm['$[]'](beat)}, TMP_33._s = self, TMP_33), $a).call($b).$flatten().$compact();
            max_duration = ($a = ($c = notes_on_beat).$map, $a._p = (TMP_34 = function(n){var self = TMP_34._s || this;
if (n == null) n = nil;
            return n.$duration()}, TMP_34._s = self, TMP_34), $a).call($c).$max();
            ...
            return [beat, current_beat];}, TMP_32._s = self, TMP_32), $a).call($c));
        };
        ...
        def.$layout_note = function(root, beat_layout) {
          var $a, $b, TMP_35, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          ...
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_35 = function(e){var self = TMP_35._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_35._s = self, TMP_35), $a).call($b);
        ...
        def.$layout_accord = function(root, beat_layout) {
          var $a, $b, TMP_36, $c, TMP_37, self = this, notes = nil, resnotes = nil, res = nil;

          notes = ($a = ($b = root.$notes()).$sort_by, $a._p = (TMP_36 = function(a){var self = TMP_36._s || this;
if (a == null) a = nil;
          return a.$pitch()}, TMP_36._s = self, TMP_36), $a).call($b);
          resnotes = ($a = ($c = notes).$map, $a._p = (TMP_37 = function(c){var self = TMP_37._s || this;
if (c == null) c = nil;
          return self.$layout_note(c, beat_layout)}, TMP_37._s = self, TMP_37), $a).call($c);
          res = [];
        ...
        def.$layout_pause = function(root, beat_layout) {
          var $a, $b, TMP_38, $c, $d, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
...
(function($opal) {
  ...
  $opal.add_stubs(['$map', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$/', '$%', '$<', '$+', '$==', '$!', '$*', '$new', '$reset_state', '$reset_measure_accidentals', '$compact', '$warning', '$select', '$split', '$empty?', '$raise', '$to_i', '$strip', '$last', '$first', '$set_key', '$each_with_index', '$<<', '$flatten!', '$compact!', '$flatten', '$send', '$nil?', '$origin=', '$now', '$to_n', '$keys', '$meta_data=', '$round', '$transform_rest', '$transform_real_note', '$pitch', '$get_midipitch', '$length', '$gsub', '$pop']);
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (f == null) f = nil;
      ...
      (function($base, $super) {
        ...
        def.pitch_transformer = def.repetition_stack = def.previous_note = def.next_note_marks_measure = def.next_note_marks_repeat_start = nil;
        def.$initialize = function() {
          var $a, $b, $c, self = this;
        ...
        def.$transform = function(abc_code) {
          var $a, $b, TMP_6, $c, TMP_7, $d, TMP_8, $e, TMP_9, $f, TMP_10, $g, TMP_14, $h, $i, TMP_17, self = this, warnings = nil, note_length_rows = nil, note_length = nil, tune = nil, lines = nil, first_staff = nil, key = nil, meter = nil, voices_in_staff = nil, voices = nil, voices_transformed = nil, result = nil, meta_data = nil, meta_data_from_tune = nil;
...
if (l == null) l = nil;
          ...
          meter = $hash2(["den", "num", "type"], {"den": self.$Native(first_staff['$[]']("meter")['$[]']("value").$first())['$[]']("den"), "num": self.$Native(first_staff['$[]']("meter")['$[]']("value").$first())['$[]']("num"), "type": first_staff['$[]']("meter")['$[]']("type")});
...
if (x == null) x = nil;
          ...
          voices['$compact!']();
          voices_transformed = ($a = ($g = voices.$each_with_index()).$map, $a._p = (TMP_14 = function(voice, voice_idx){var self = TMP_14._s || this, $a, $b, TMP_15, res = nil;
...
if (e == null) e = nil;
          ...
          ($a = ($h = meta_data_from_tune.$keys()).$each, $a._p = (TMP_17 = function(k){var self = TMP_17._s || this;
if (k == null) k = nil;
          return meta_data['$[]='](k, meta_data_from_tune['$[]'](k))}, TMP_17._s = self, TMP_17), $a).call($h);
          result['$meta_data='](meta_data);
          return result;
        };

        def.$transform_note = function(note) {
          var $a, self = this, duration = nil, result = nil;
        ...
        def.$transform_real_note = function(note, duration) {
          var $a, $b, TMP_18, $c, $d, self = this, notes = nil, res = nil;

          notes = ($a = ($b = self.$Native(note['$[]']("pitches"))).$map, $a._p = (TMP_18 = function(pitch){var self = TMP_18._s || this, $a, $b, $c, midipitch = nil, thenote = nil;
...
if (pitch == null) pitch = nil;
          midipitch = self.pitch_transformer.$get_midipitch(pitch);
            ...
            thenote['$origin='](note);
            return thenote;}, TMP_18._s = self, TMP_18), $a).call($b);
          res = [];
          if (notes.$length()['$=='](1)) {
            res['$<<'](notes.$first())
            } else {
        ...
        def.$transform_bar_right_repeat = function(bar) {
          ...
          return [(($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).Dacapo == null ? $a.cm('Dacapo') : $a.Dacapo).$new(start, self.previous_note, self.repetition_stack.$length())];
        };
...
jsPDF.API.setLineDash = function(dashArray, dashPhase) {
  ...
  return (function($base, $super) {
    ...
    def.$line = function(from, to) {
      ...
      return self.native.lines([ [ to[0] - from[0], to[1] - from[1] ] ], from[0], from[1]);
    };
    ...
    def.$ellipse = function(center, size, style) {
      ...
      return self.native.ellipse(center[0], center[1], size[0], size[1], style);
    };
    ...
    def.$rect_like_ellipse = function(center, size, style) {
      ...
      return self.native.rect(center[0], center[1], size[0], size[1], style);
    };
    ...
    def.$rect = function(x1, y1, x2, y2, style) {
      ...
      return self.native.rect(x1, y1, x2, y2, style);
    };
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_reader', '$new', '$enable_pan_zoom', '$clear', '$each', '$is_a?', '$draw_ellipse', '$draw_flowline', '$draw_jumpline', '$draw_rest', '$puts', '$class', '$children', '$private', '$ellipse', '$first', '$center', '$last', '$size', '$[]=', '$==', '$fill', '$dotted?', '$+', '$*', '$on_click', '$origin', '$nil?', '$call', '$-', '$map', '$rect', '$line', '$[]', '$from', '$to', '$style', '$level', '$path', '$translate']);
  ;
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (child == null) child = nil;
      ...
      def.$draw_rest = function(root) {
        var $a, $b, TMP_4, $c, TMP_5, self = this, center = nil, size = nil, e = nil, x = nil, y = nil;

        center = [root.$center().$first()['$-'](root.$size().$first()), root.$center().$last()['$-'](root.$size().$last())];
        size = ($a = ($b = root.$size()).$map, $a._p = (TMP_4 = function(s){var self = TMP_4._s || this;
if (s == null) s = nil;
        return (2)['$*'](s)}, TMP_4._s = self, TMP_4), $a).call($b);
        ...
        if ((($a = root['$dotted?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          y = root.$center().$last()['$+']((root.$size().$last()['$*'](1.2)));
          self.paper.$ellipse(x, y, (($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a), (($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a))['$[]=']("fill", "black");};
        return ($a = ($c = e).$on_click, $a._p = (TMP_5 = function(){var self = TMP_5._s || this, $a, $b, origin = nil;
          if (self.on_select == null) self.on_select = nil;
      ...
      return (def.$draw_jumpline = function(root) {
        var $a, $b, $c, self = this, startpoint = nil, endpoint = nil, depth = nil, path = nil, arrow = nil;
...
(function($opal) {
  ...
  $opal.add_stubs(['$include', '$attr_reader', '$new', '$rect', '$each', '$is_a?', '$draw_ellipse', '$draw_flowline', '$draw_jumpline', '$draw_rest', '$draw_annotation', '$puts', '$class', '$children', '$private', '$text_color=', '$font_size=', '$text', '$first', '$center', '$last', '$filled?', '$fill=', '$map', '$ellipse', '$size', '$dotted?', '$+', '$*', '$zip', '$-', '$rect_like_ellipse', '$dashed?', '$line_dash=', '$line', '$from', '$to', '$use_solid_lines', '$[]=', '$[]', '$/', '$level', '$draw=']);
  ;
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
    ...
    (function($base, $super) {
      ...
      def.$initialize = function() {
        ...
        return self.pdf.$rect(1, 1, 418, 295);
      };

      def.$draw = function(sheet) {
        var $a, $b, TMP_1, self = this;

        ($a = ($b = sheet.$children()).$each, $a._p = (TMP_1 = function(child){var self = TMP_1._s || this, $a, $b, $c, $d;
if (child == null) child = nil;
        if ((($a = child['$is_a?']((($b = $scope.Ellipse) == null ? $opal.cm('Ellipse') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
            return self.$draw_ellipse(child)
          } else if ((($a = child['$is_a?']((($b = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      def.$draw_annotation = function(root) {
        ...
        self.pdf['$text_color='](0);
        self.pdf['$font_size='](10);
        return self.pdf.$text(root.$center().$first(), root.$center().$last(), root.$text());
      };

      def.$draw_ellipse = function(root) {
        var $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, self = this, style = nil;
        ...
        self.pdf['$fill='](($a = ($b = ($range(0, 3, true))).$map, $a._p = (TMP_2 = function(){var self = TMP_2._s || this, $a;
        ...
        if ((($a = root['$dotted?']()) !== nil && (!$a._isBoolean || $a == true))) {
          self.pdf['$fill='](($a = ($c = ($range(0, 3, true))).$map, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;

          return 0}, TMP_3._s = self, TMP_3), $a).call($c));
          return self.pdf.$ellipse(($a = ($d = root.$center().$zip(root.$size())).$map, $a._p = (TMP_4 = function(s){var self = TMP_4._s || this, $a, a = nil, b = nil;
if (s == null) s = nil;
          $a = $opal.to_ary(s), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
            return a['$+'](b['$*'](1.5));}, TMP_4._s = self, TMP_4), $a).call($d), [(($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a), (($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a)], "F");
          } else {
          return nil
        };
      };
      ...
      def.$draw_rest = function(root) {
        var $a, $b, TMP_5, $c, TMP_6, $d, TMP_7, $e, TMP_8, self = this, style = nil, center = nil, size = nil;
        ...
        center = [root.$center().$first()['$-'](root.$size().$first()), root.$center().$last()['$-'](root.$size().$last())];
        size = ($a = ($c = root.$size()).$map, $a._p = (TMP_6 = function(s){var self = TMP_6._s || this;
if (s == null) s = nil;
        return (2.0)['$*'](s)}, TMP_6._s = self, TMP_6), $a).call($c);
        self.pdf.$rect_like_ellipse(center, size, style);
        if ((($a = root['$dotted?']()) !== nil && (!$a._isBoolean || $a == true))) {
          self.pdf['$fill='](($a = ($d = ($range(0, 3, true))).$map, $a._p = (TMP_7 = function(){var self = TMP_7._s || this;

          return 0}, TMP_7._s = self, TMP_7), $a).call($d));
          return self.pdf.$ellipse(($a = ($e = root.$center().$zip(root.$size())).$map, $a._p = (TMP_8 = function(s){var self = TMP_8._s || this, $a, a = nil, b = nil;
if (s == null) s = nil;
          $a = $opal.to_ary(s), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
            return a['$+'](b['$*'](1.5));}, TMP_8._s = self, TMP_8), $a).call($e), [(($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a), (($a = $scope.DOTTED_SIZE) == null ? $opal.cm('DOTTED_SIZE') : $a)], "F");
          } else {
          return nil
        };
      };
      ...
      return (def.$draw_jumpline = function(root) {
        var $a, $b, $c, TMP_9, self = this, startpoint = nil, endpoint = nil, depth = nil;

        startpoint = root.$from().$center();
        ($a = 0, $b = startpoint, $b['$[]=']($a, $b['$[]']($a)['$+']((($c = $scope.PADDING) == null ? $opal.cm('PADDING') : $c))));
        ($a = 1, $b = startpoint, $b['$[]=']($a, $b['$[]']($a)['$-']((($c = $scope.PADDING) == null ? $opal.cm('PADDING') : $c)['$/'](4))));
        endpoint = root.$to().$center();
        ($a = 0, $b = endpoint, $b['$[]=']($a, $b['$[]']($a)['$+']((($c = $scope.PADDING) == null ? $opal.cm('PADDING') : $c))));
        ($a = 1, $b = endpoint, $b['$[]=']($a, $b['$[]']($a)['$+']((($c = $scope.PADDING) == null ? $opal.cm('PADDING') : $c)['$/'](4))));
        depth = (418)['$-']((root.$level()['$*']((($a = $scope.JUMPLINE_INDENT) == null ? $opal.cm('JUMPLINE_INDENT') : $a))));
        self.pdf['$draw='](($a = ($b = ($range(0, 3, true))).$map, $a._p = (TMP_9 = function(){var self = TMP_9._s || this;
...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_10, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $gvars = $opal.gvars;

  $opal.add_stubs(['$new', '$setup_editor', '$setup_ui', '$setup_ui_listener', '$draw', '$layout_harpnotes', '$html', '$find', '$get_abc_code', '$info', '$file', '$output', '$render_pdf', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$alert', '$private', '$on_select', '$select_note', '$on', '$play_abc', '$render_to_canvas', '$Native', '$getSession', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  ;
  ;
  ;
  ;
  ...
  (function($base, $super) {
    ...
    def.inst = def.raphael_engine = def.editor = nil;
    def.$initialize = function() {
      var $a, self = this;
    ...
    ABCJS.renderAbc($("#tunePreview")[0], self.$get_abc_code(), {}, {}, {})
    ...
    def.$layout_harpnotes = function() {
      ...
      song = (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Input == null ? $b.cm('Input') : $b.Input))._scope).ABCToHarpnotes == null ? $a.cm('ABCToHarpnotes') : $a.ABCToHarpnotes).$new().$transform(self.$get_abc_code());
...
if (origin == null) origin = nil;
    ...
    return (def.$setup_ui_listener = function() {
      var $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, TMP_5, $f, TMP_6, $g, TMP_7, $h, self = this;

      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#tbPlay")).$on, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

      return self.$play_abc()}, TMP_2._s = self, TMP_2), $a).call($b, "click");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#tbRender")).$on, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;

      return self.$render_to_canvas()}, TMP_3._s = self, TMP_3), $a).call($c, "click");
      ($a = ($d = self.$Native(self.$Native(self.editor).$getSession())).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this, $a;
      ...
      if ((($a = self.refresh_timer) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        self.refresh_timer = setTimeout(function(){self.$render_to_canvas()}, 300);
        return nil;}, TMP_4._s = self, TMP_4), $a).call($d, "change");
      ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find("#tbPrint")).$on, $a._p = (TMP_5 = function(){var self = TMP_5._s || this, url = nil;

      url = self.$render_pdf().$output("datauristring");
        return window.open(url);}, TMP_5._s = self, TMP_5), $a).call($e, "click");
...
if (evt == null) evt = nil;
      if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        }}, TMP_6._s = self, TMP_6), $a).call($f, "keydown");
      return ($a = ($g = (($h = $scope.Element) == null ? $opal.cm('Element') : $h).$find("#dragbar")).$on, $a._p = (TMP_7 = function(re){var self = TMP_7._s || this, $a, $b, TMP_8, $c, TMP_9, $d;
if (re == null) re = nil;
      re.$prevent();
        ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find(document)).$on, $a._p = (TMP_8 = function(e){var self = TMP_8._s || this, $a;
if (e == null) e = nil;
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
          ...
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#dragbar").$css("left", "" + (e.$page_x()) + "px");}, TMP_8._s = self, TMP_8), $a).call($b, "mousemove");
        return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(document)).$on, $a._p = (TMP_9 = function(){var self = TMP_9._s || this;

        return $(document).unbind('mousemove');}, TMP_9._s = self, TMP_9), $a).call($c, "mouseup");}, TMP_7._s = self, TMP_7), $a).call($g, "mousedown");
    }, nil) && 'setup_ui_listener';
  })(self, null);
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_10 = function(){var self = TMP_10._s || this, $a;

  return (($a = $scope.Controller) == null ? $opal.cm('Controller') : $a).$new()}, TMP_10._s = self, TMP_10), $a).call($b);
})(Opal);
