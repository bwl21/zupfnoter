    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$to_json = function() {
          ...
          return $scope.get('Hash')['$[]']($rb_plus([["class", self.$class()]], ($a = ($b = ($rb_minus(self.$instance_variables(), ["@constructor", "@toString"]))).$map, $a.$$p = (TMP_1 = function(v){var self = TMP_1.$$s || this;
if (v == null) v = nil;
          return [v, self.$instance_variable_get(v)]}, TMP_1.$$s = self, TMP_1), $a).call($b))).$to_json();
        }, nil) && 'to_json';
      })(self, null);
      ...
      (function($base, $super) {
        ...
        self.$attr_accessor("first_in_part", "jump_starts", "jump_ends", "slur_starts", "slur_ends", "tie_start", "tie_end", "duration", "tuplet", "tuplet_start", "tuplet_end", "shift");

        def.$initialize = TMP_2 = function() {var $zuper = $slice.call(arguments, 0);
          var self = this, $iter = TMP_2.$$p, $yield = $iter || nil;
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_3 = function(pitch, duration) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_3.$$p, $yield = $iter || nil;

          TMP_3.$$p = null;
          Opal.find_super_dispatcher(self, 'initialize', TMP_3, $iter).apply(self, $zuper);
          if ((($a = pitch['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_4 = function(notes) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_4.$$p, $yield = $iter || nil;
        ...
        def['$beat='] = function(value) {
          ...
          self.beat = value;
          return ($a = ($b = self.notes).$each, $a.$$p = (TMP_5 = function(n){var self = TMP_5.$$s || this, $a, $b;
if (n == null) n = nil;
          return (($a = [value]), $b = n, $b['$beat='].apply($b, $a), $a[$a.length-1])}, TMP_5.$$s = self, TMP_5), $a).call($b);
        };
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_6 = function(pitch, duration) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_7 = function(companion) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_8 = function(title) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        def.annotations = nil;
        def.$initialize = TMP_9 = function(companion, annotation) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_10 = function(from, to, policy) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_10.$$p, $yield = $iter || nil;
      ...
      (function($base, $super) {
        ...
        def.$build_synch_points = function(selector) {
          var $a, $b, TMP_11, $c, TMP_14, self = this, syncpoints = nil;

          if (selector == null) {
            selector = nil
          }
          syncpoints = ($a = ($b = self.$expanded_beat_maps()).$map, $a.$$p = (TMP_11 = function(playables){var self = TMP_11.$$s || this, $a, $b, TMP_12, $c, TMP_13, the_playables = nil, result = nil;
if (playables == null) playables = nil;
          if (selector !== false && selector !== nil) {
              playables = [playables['$[]'](selector.$first()), playables['$[]'](selector.$last())]};
            the_playables = ($a = ($b = playables).$map, $a.$$p = (TMP_12 = function(p){var self = TMP_12.$$s || this, $a, r = nil;
if (p == null) p = nil;
            if ((($a = p['$is_a?']($scope.get('Playable'))) !== nil && (!$a.$$is_boolean || $a == true))) {
                r = p.$proxy_note()};
              return r;}, TMP_12.$$s = self, TMP_12), $a).call($b);
            result = nil;
            if ($rb_gt(($a = ($c = the_playables.$compact()).$select, $a.$$p = (TMP_13 = function(p){var self = TMP_13.$$s || this;
if (p == null) p = nil;
            return p['$visible?']()}, TMP_13.$$s = self, TMP_13), $a).call($c).$length(), 1)) {
              result = $scope.get('SynchPoint').$new(the_playables)};
            return result;}, TMP_11.$$s = self, TMP_11), $a).call($b).$flatten().$compact();
          syncpoints = ($a = ($c = syncpoints).$select, $a.$$p = (TMP_14 = function(sp){var self = TMP_14.$$s || this, $a, $b, TMP_15;
if (sp == null) sp = nil;
          return ($a = ($b = sp.$notes()).$reject, $a.$$p = (TMP_15 = function(e){var self = TMP_15.$$s || this;
if (e == null) e = nil;
            return e['$is_a?']($scope.get('Playable'))}, TMP_15.$$s = self, TMP_15), $a).call($b)['$empty?']()}, TMP_14.$$s = self, TMP_14), $a).call($c);
          return syncpoints;
        };

        def.$last_beat = function() {
          var $a, $b, TMP_16, self = this, max_beat = nil;

          return max_beat = ($a = ($b = self.beat_maps).$map, $a.$$p = (TMP_16 = function(map){var self = TMP_16.$$s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_16.$$s = self, TMP_16), $a).call($b).$max();
        };

        def.$expanded_beat_maps = function() {
          var $a, $b, TMP_17, self = this;

          return ($a = ($b = ($range(0, self.$last_beat(), false))).$map, $a.$$p = (TMP_17 = function(beat){var self = TMP_17.$$s || this, $a, $b, TMP_18;
            if (self.beat_maps == null) self.beat_maps = nil;
if (beat == null) beat = nil;
          return ($a = ($b = self.beat_maps).$map, $a.$$p = (TMP_18 = function(map){var self = TMP_18.$$s || this;
if (map == null) map = nil;
            return map['$[]'](beat)}, TMP_18.$$s = self, TMP_18), $a).call($b)}, TMP_17.$$s = self, TMP_17), $a).call($b);
        };

        self.$private();

        return (def.$update_beats = function() {
          var $a, $b, TMP_19, self = this, tupletmap = nil;
          ...
          self.beat_maps = ($a = ($b = self.voices).$map, $a.$$p = (TMP_19 = function(voice){var self = TMP_19.$$s || this, $a, $b, TMP_20, $c, $d, TMP_21, current_beat = nil, voice_map = nil;
if (voice == null) voice = nil;
          current_beat = 0;
            voice_map = ($a = ($b = ($c = ($d = voice).$select, $c.$$p = (TMP_21 = function(e){var self = TMP_21.$$s || this;
if (e == null) e = nil;
            return e['$is_a?']($scope.get('Playable'))}, TMP_21.$$s = self, TMP_21), $c).call($d)).$inject, $a.$$p = (TMP_20 = function(map, playable){var self = TMP_20.$$s || this, $a, $b, beats = nil, beat_error = nil, pos = nil;
...
if (map == null) map = nil;if (playable == null) playable = nil;
            beats = $rb_times(playable.$duration(), $gvars.conf.$get("layout.BEAT_PER_DURATION"));
              ...
              return map;}, TMP_20.$$s = self, TMP_20), $a).call($b, $scope.get('BeatMap').$new(voice.$index()));
            return voice_map;}, TMP_19.$$s = self, TMP_19), $a).call($b);
          return nil;
        }, nil) && 'update_beats';
      })(self, null);
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_22 = function() {var $zuper = $slice.call(arguments, 0);
          ...
          return Opal.find_super_dispatcher(self, 'initialize', TMP_22, $iter).apply(self, $zuper);
        };
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$iniitalize = TMP_23 = function() {var $zuper = $slice.call(arguments, 0);
          var self = this, $iter = TMP_23.$$p, $yield = $iter || nil;

          TMP_23.$$p = null;
          return Opal.find_super_dispatcher(self, 'iniitalize', TMP_23, $iter).apply(self, $zuper);
        }, nil) && 'iniitalize'
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_24 = function(from, to, style, origin, center) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_24.$$p, $yield = $iter || nil;
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_25 = function(path, fill, origin) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_26 = function(center, radii, fill, dotted, origin, rect) {var $zuper = $slice.call(arguments, 0);
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_27 = function(center, text, style, origin) {var $zuper = $slice.call(arguments, 0);
          ...
          TMP_27.$$p = null;
          Opal.find_super_dispatcher(self, 'initialize', TMP_27, $iter).apply(self, $zuper);
          self.center = center;
          self.text = text;
          self.style = style;
          return self.origin = origin;
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_28 = function(center, size, glyph_name, dotted, origin) {var $zuper = $slice.call(arguments, 0);
          ...
          TMP_28.$$p = null;
          Opal.find_super_dispatcher(self, 'initialize', TMP_28, $iter).apply(self, $zuper);
          self.center = center;
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$layout = function(music, beat_layout, print_variant_nr) {
          ...
          beat_layout = ((($a = beat_layout) !== false && $a !== nil) ? $a : ($b = ($c = $scope.get('Proc')).$new, $b.$$p = (TMP_29 = function(beat){var self = TMP_29.$$s || this;
            if (self.beat_spacing == null) self.beat_spacing = nil;
            if (self.y_offset == null) self.y_offset = nil;
if (beat == null) beat = nil;
          return beat * self.beat_spacing + self.y_offset;}, TMP_29.$$s = self, TMP_29), $b).call($c));
          compressed_beat_layout_proc = ($a = ($b = $scope.get('Proc')).$new, $a.$$p = (TMP_30 = function(beat){var self = TMP_30.$$s || this;
if (beat == null) beat = nil;
          return beat_layout.$call(beat_compression_map['$[]'](beat))}, TMP_30.$$s = self, TMP_30), $a).call($b);
          required_synchlines = ($a = ($d = print_options['$[]']("synchlines")).$select, $a.$$p = (TMP_31 = function(sl){var self = TMP_31.$$s || this, $a;
if (sl == null) sl = nil;
          return ($a = print_options['$[]']("voices")['$include?'](sl.$first()), $a !== false && $a !== nil ?print_options['$[]']("voices")['$include?'](sl.$last()) : $a)}, TMP_31.$$s = self, TMP_31), $a).call($d);
          synched_notes = ($a = ($e = required_synchlines).$map, $a.$$p = (TMP_32 = function(selector){var self = TMP_32.$$s || this, $a, $b, TMP_33, synch_points_to_show = nil;
if (selector == null) selector = nil;
          synch_points_to_show = music.$build_synch_points(selector);
            return ($a = ($b = synch_points_to_show).$map, $a.$$p = (TMP_33 = function(sp){var self = TMP_33.$$s || this;
if (sp == null) sp = nil;
            return [sp.$notes().$first(), sp.$notes().$last()]}, TMP_33.$$s = self, TMP_33), $a).call($b);}, TMP_32.$$s = self, TMP_32), $a).call($e).$flatten();
          voice_elements = ($a = ($f = music.$voices().$each_with_index()).$map, $a.$$p = (TMP_34 = function(v, index){var self = TMP_34.$$s || this, $a;
if (v == null) v = nil;if (index == null) index = nil;
          if ((($a = print_options['$[]']("voices")['$include?'](index)) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              return nil
            }}, TMP_34.$$s = self, TMP_34), $a).call($f).$flatten().$compact();
          note_to_ellipse = $scope.get('Hash')['$[]'](($a = ($g = ($h = ($i = voice_elements).$select, $h.$$p = (TMP_36 = function(e){var self = TMP_36.$$s || this;
if (e == null) e = nil;
          return e['$is_a?']($scope.get('Symbol'))}, TMP_36.$$s = self, TMP_36), $h).call($i)).$map, $a.$$p = (TMP_35 = function(e){var self = TMP_35.$$s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_35.$$s = self, TMP_35), $a).call($g));
          synch_lines = ($a = ($h = required_synchlines).$map, $a.$$p = (TMP_37 = function(selector){var self = TMP_37.$$s || this, $a, $b, TMP_38, synch_points_to_show = nil;
if (selector == null) selector = nil;
          synch_points_to_show = music.$build_synch_points(selector);
            return ($a = ($b = synch_points_to_show).$map, $a.$$p = (TMP_38 = function(sp){var self = TMP_38.$$s || this;
if (sp == null) sp = nil;
            return $scope.get('FlowLine').$new(note_to_ellipse['$[]'](sp.$notes().$first()), note_to_ellipse['$[]'](sp.$notes().$last()), "dashed", sp)}, TMP_38.$$s = self, TMP_38), $a).call($b);}, TMP_37.$$s = self, TMP_37), $a).call($h).$flatten();
          sheet_marks = ($a = ($j = [79, 55, 43]).$inject, $a.$$p = (TMP_39 = function(result, pitch){var self = TMP_39.$$s || this, markpath = nil;
            if ($gvars.conf == null) $gvars.conf = nil;
if (result == null) result = nil;if (pitch == null) pitch = nil;
          markpath = self.$make_sheetmark_path([$rb_plus($rb_times(($rb_plus($gvars.conf.$get("layout.PITCH_OFFSET"), pitch)), $gvars.conf.$get("layout.X_SPACING")), $gvars.conf.$get("layout.X_OFFSET")), 10]);
            ...
            return result;}, TMP_39.$$s = self, TMP_39), $a).call($j, []);
          annotations = [];
          ...
          annotations['$<<']((((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new([150, 289], "" + (filename) + " - created " + (datestring) + " by Zupfnoter " + ($scope.get('VERSION')), "smaller"));
          annotations['$<<']((((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new([285, 289], "Zupfnoter " + ($scope.get('COPYRIGHT')), "smaller"));
          ...
          if (lyric_text !== false && lyric_text !== nil) {
            ...
            if ((($a = lyrics['$[]']("versepos")) !== nil && (!$a.$$is_boolean || $a == true))) {
              verses = text.$split("\n\n");
              ($a = ($k = lyrics['$[]']("versepos")).$each, $a.$$p = (TMP_40 = function(key, value){var self = TMP_40.$$s || this, $a, $b, TMP_41, the_text = nil;
if (key == null) key = nil;if (value == null) value = nil;
              the_text = ($a = ($b = key.$scan(/\d+/)).$map, $a.$$p = (TMP_41 = function(i){var self = TMP_41.$$s || this;
if (i == null) i = nil;
                return verses['$[]']($rb_minus(i.$to_i(), 1))}, TMP_41.$$s = self, TMP_41), $a).call($b).$join("\n\n");
                return annotations['$<<']((((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new(value, the_text));}, TMP_40.$$s = self, TMP_40), $a).call($k);
              } else {
              pos = lyrics['$[]']("pos");
              annotations['$<<']((((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new(pos, text));
            };};
          ($a = ($l = print_options['$[]']("notes")).$each, $a.$$p = (TMP_42 = function(note){var self = TMP_42.$$s || this;
if (note == null) note = nil;
          return annotations['$<<']((((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new(note['$[]']("pos"), note['$[]']("text"), note['$[]']("style")))}, TMP_42.$$s = self, TMP_42), $a).call($l);
        ...
        def.$layout_voice = function(voice, beat_layout, show_options) {
          var $a, $b, TMP_43, $c, TMP_44, $d, TMP_45, $e, $f, TMP_46, TMP_47, $g, $h, TMP_48, TMP_49, $i, TMP_50, $j, $k, TMP_51, TMP_52, $l, $m, TMP_53, TMP_54, $n, TMP_56, $o, TMP_63, $p, $q, TMP_65, TMP_66, $r, $s, TMP_67, self = this, playables = nil, res_playables = nil, res_measures = nil, res_newparts = nil, lookuptable_drawing_by_playable = nil, previous_note = nil, res_flow = nil, res_sub_flow = nil, tuplet_start = nil, res_tuplets = nil, tie_start = nil, res_slurs = nil, res_gotos = nil, res_annotations = nil, retval = nil;

          playables = ($a = ($b = voice).$select, $a.$$p = (TMP_43 = function(c){var self = TMP_43.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('Playable'))}, TMP_43.$$s = self, TMP_43), $a).call($b);
          res_playables = ($a = ($c = playables).$map, $a.$$p = (TMP_44 = function(playable){var self = TMP_44.$$s || this;
if (playable == null) playable = nil;
          return self.$layout_playable(playable, beat_layout)}, TMP_44.$$s = self, TMP_44), $a).call($c).$flatten();
          res_measures = ($a = ($d = ($e = ($f = voice).$select, $e.$$p = (TMP_46 = function(c){var self = TMP_46.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('MeasureStart'))}, TMP_46.$$s = self, TMP_46), $e).call($f)).$map, $a.$$p = (TMP_45 = function(measure){var self = TMP_45.$$s || this;
if (measure == null) measure = nil;
          return self.$layout_playable(measure, beat_layout)}, TMP_45.$$s = self, TMP_45), $a).call($d);
          res_newparts = ($a = ($e = ($g = ($h = voice).$select, $g.$$p = (TMP_48 = function(c){var self = TMP_48.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('NewPart'))}, TMP_48.$$s = self, TMP_48), $g).call($h)).$map, $a.$$p = (TMP_47 = function(newpart){var self = TMP_47.$$s || this;
if (newpart == null) newpart = nil;
          return self.$layout_newpart(newpart, beat_layout)}, TMP_47.$$s = self, TMP_47), $a).call($e);
          lookuptable_drawing_by_playable = $scope.get('Hash')['$[]'](($a = ($g = res_playables).$map, $a.$$p = (TMP_49 = function(e){var self = TMP_49.$$s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_49.$$s = self, TMP_49), $a).call($g).$reverse());
          previous_note = nil;
          res_flow = ($a = ($i = ($j = ($k = voice).$select, $j.$$p = (TMP_51 = function(c){var self = TMP_51.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('Playable'))}, TMP_51.$$s = self, TMP_51), $j).call($k)).$map, $a.$$p = (TMP_50 = function(playable){var self = TMP_50.$$s || this, $a, $b, res = nil;
            if ($gvars.conf == null) $gvars.conf = nil;
if (playable == null) playable = nil;
          res = nil;
            if ((($a = previous_note['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              if ((($a = previous_note['$visible?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                } else {
                res = nil
              };
            };
            if ((($a = playable['$first_in_part?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              res = nil};
            if ((($a = playable['$visible?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              } else {
              res = nil
            };
            previous_note = playable;
            return res;}, TMP_50.$$s = self, TMP_50), $a).call($i).$compact();
          previous_note = nil;
          res_sub_flow = ($a = ($j = ($l = ($m = voice).$select, $l.$$p = (TMP_53 = function(c){var self = TMP_53.$$s || this, $a;
if (c == null) c = nil;
          return ((($a = c['$is_a?']($scope.get('Playable'))) !== false && $a !== nil) ? $a : c['$is_a?']($scope.get('SynchPoint')))}, TMP_53.$$s = self, TMP_53), $l).call($m)).$map, $a.$$p = (TMP_52 = function(playable){var self = TMP_52.$$s || this, $a, res = nil;
if (playable == null) playable = nil;
          if ((($a = show_options['$[]']("synched_notes")['$include?'](playable.$proxy_note())) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            previous_note = playable;
            return res;}, TMP_52.$$s = self, TMP_52), $a).call($j).$compact();
          ...
          res_tuplets = ($a = ($l = playables).$inject, $a.$$p = (TMP_54 = function(result, playable){var self = TMP_54.$$s || this, $a, $b, TMP_55, p1 = nil, p2 = nil, tiepath = nil, anchor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (result == null) result = nil;if (playable == null) playable = nil;
          if ((($a = playable['$tuplet_start?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            if ((($a = playable['$tuplet_end?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              $gvars.log.$debug("" + ([tiepath, anchor]) + " (" + ("harpnotes") + " " + (1261) + ")");
...
if (d == null) d = nil;
            ...
            return result;}, TMP_54.$$s = self, TMP_54), $a).call($l, []);
          self.slur_index['$[]=']("first_playable", playables.$first());
          tie_start = playables.$first();
          res_slurs = ($a = ($n = playables).$inject, $a.$$p = (TMP_56 = function(result, playable){var self = TMP_56.$$s || this, $a, $b, TMP_57, $c, TMP_58, $d, TMP_60, $e, TMP_61, p1 = nil, p2 = nil, tiepath = nil;
...
if (result == null) result = nil;if (playable == null) playable = nil;
          if ((($a = playable['$tie_end?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              ...
              result.$push(($a = ($b = (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Path')).$new(tiepath)).$tap, $a.$$p = (TMP_57 = function(d){var self = TMP_57.$$s || this, $a, $b;
                if ($gvars.conf == null) $gvars.conf = nil;
if (d == null) d = nil;
              ...
              if ((($a = playable['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('SynchPoint')))) !== nil && (!$a.$$is_boolean || $a == true))) {
                ($a = ($c = playable.$notes()).$each_with_index, $a.$$p = (TMP_58 = function(n, index){var self = TMP_58.$$s || this, $a, $b, TMP_59, e = nil;
                  if ($gvars.log == null) $gvars.log = nil;
if (n == null) n = nil;if (index == null) index = nil;
                try {
                  p1 = tie_start.$notes()['$[]'](index);
                    ...
                    tiepath = self.$make_slur_path(p1, p2);
                    return result.$push(($a = ($b = (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Path')).$new(tiepath)).$tap, $a.$$p = (TMP_59 = function(d){var self = TMP_59.$$s || this, $a, $b;
                      if ($gvars.conf == null) $gvars.conf = nil;
if (d == null) d = nil;
                    return (($a = [$gvars.conf.$get("layout.LINE_MEDIUM")]), $b = d, $b['$line_width='].apply($b, $a), $a[$a.length-1])}, TMP_59.$$s = self, TMP_59), $a).call($b));
                  } catch ($err) {if (Opal.rescue($err, [$scope.get('Exception')])) {e = $err;
                    return $gvars.log.$error("tied chords which doesn't have same number of notes", n.$start_pos())
                    }else { throw $err; }
                  }}, TMP_58.$$s = self, TMP_58), $a).call($c)};};
            if ((($a = playable['$tie_start?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
              tie_start = playable};
            ($a = ($d = playable.$slur_starts()).$each, $a.$$p = (TMP_60 = function(s){var self = TMP_60.$$s || this;
              if (self.slur_index == null) self.slur_index = nil;
if (s == null) s = nil;
            return self.slur_index['$[]='](s, playable)}, TMP_60.$$s = self, TMP_60), $a).call($d);
            self.slur_index['$[]='](playable.$slur_starts().$first(), playable);
            ($a = ($e = playable.$slur_ends()).$each, $a.$$p = (TMP_61 = function(id){var self = TMP_61.$$s || this, $a, $b, TMP_62, begin_slur = nil, slurpath = nil;
              if (self.slur_index == null) self.slur_index = nil;
              if ($gvars.conf == null) $gvars.conf = nil;
if (id == null) id = nil;
            begin_slur = ((($a = self.slur_index['$[]'](id)) !== false && $a !== nil) ? $a : self.slur_index['$[]']("first_playable"));
              ...
              if ((($a = $gvars.conf.$get("layout.SHOW_SLUR")) !== nil && (!$a.$$is_boolean || $a == true))) {
                return result.$push(($a = ($b = (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Path')).$new(slurpath)).$tap, $a.$$p = (TMP_62 = function(d){var self = TMP_62.$$s || this, $a, $b;
                  if ($gvars.conf == null) $gvars.conf = nil;
if (d == null) d = nil;
                return (($a = [$gvars.conf.$get("layout.LINE_MEDIUM")]), $b = d, $b['$line_width='].apply($b, $a), $a[$a.length-1])}, TMP_62.$$s = self, TMP_62), $a).call($b))
                } else {
                return nil
              };}, TMP_61.$$s = self, TMP_61), $a).call($e);
            return result;}, TMP_56.$$s = self, TMP_56), $a).call($n, []);
          res_gotos = ($a = ($o = ($p = ($q = voice).$select, $p.$$p = (TMP_65 = function(c){var self = TMP_65.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('Goto'))}, TMP_65.$$s = self, TMP_65), $p).call($q)).$map, $a.$$p = (TMP_63 = function(goto$){var self = TMP_63.$$s || this, $a, $b, TMP_64, distance = nil, vertical = nil, path = nil;
            if ($gvars.log == null) $gvars.log = nil;
            if ($gvars.conf == null) $gvars.conf = nil;
if (goto$ == null) goto$ = nil;
          distance = goto$.$policy()['$[]']("distance");
            $gvars.log.$debug("vertical line x offset: " + (distance) + " " + ("harpnotes") + ":" + (1317));
            if ($rb_gt(distance, 0)) {
            ...
            return [($a = ($b = (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Path')).$new(path['$[]'](0), nil, goto$.$from())).$tap, $a.$$p = (TMP_64 = function(s){var self = TMP_64.$$s || this, $a, $b;
              if ($gvars.conf == null) $gvars.conf = nil;
if (s == null) s = nil;
            return (($a = [$gvars.conf.$get("layout.LINE_THICK")]), $b = s, $b['$line_width='].apply($b, $a), $a[$a.length-1])}, TMP_64.$$s = self, TMP_64), $a).call($b), (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Path')).$new(path['$[]'](1), "filled", goto$.$from())];}, TMP_63.$$s = self, TMP_63), $a).call($o).$flatten();
          if ((($a = show_options['$[]']("jumpline")) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
            res_gotos = []
          };
          res_annotations = ($a = ($p = ($r = ($s = voice).$select, $r.$$p = (TMP_67 = function(c){var self = TMP_67.$$s || this;
if (c == null) c = nil;
          return c['$is_a?']($scope.get('NoteBoundAnnotation'))}, TMP_67.$$s = self, TMP_67), $r).call($s)).$map, $a.$$p = (TMP_66 = function(annotation){var self = TMP_66.$$s || this, position = nil;
if (annotation == null) annotation = nil;
          position = $rb_plus(self.$Vector2d(lookuptable_drawing_by_playable['$[]'](annotation.$companion()).$center()), annotation.$position());
            return (((($scope.get('Harpnotes')).$$scope.get('Drawing'))).$$scope.get('Annotation')).$new(position.$to_a(), annotation.$text());}, TMP_66.$$s = self, TMP_66), $a).call($p);
        ...
        def.$compute_beat_compression = function(music, layout_lines) {
          var $a, $b, TMP_68, $c, TMP_69, $d, TMP_70, self = this, max_beat = nil, conf_beat_resolution = nil, current_beat = nil, last_size = nil, relevant_beat_maps = nil, duration_to_style = nil, result = nil;
          if ($gvars.conf == null) $gvars.conf = nil;

          max_beat = ($a = ($b = music.$beat_maps()).$map, $a.$$p = (TMP_68 = function(map){var self = TMP_68.$$s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_68.$$s = self, TMP_68), $a).call($b).$max();
          conf_beat_resolution = $gvars.conf.$get("layout.BEAT_RESOLUTION");
          current_beat = 0;
          last_size = 0;
          relevant_beat_maps = ($a = ($c = layout_lines).$inject, $a.$$p = (TMP_69 = function(r, i){var self = TMP_69.$$s || this;
if (r == null) r = nil;if (i == null) i = nil;
          return r.$push(music.$beat_maps()['$[]'](i))}, TMP_69.$$s = self, TMP_69), $a).call($c, []).$compact();
          duration_to_style = $gvars.conf.$get("layout.DURATION_TO_STYLE");
          result = $scope.get('Hash')['$[]'](($a = ($d = ($range(0, max_beat, false))).$map, $a.$$p = (TMP_70 = function(beat){var self = TMP_70.$$s || this, $a, $b, TMP_71, $c, TMP_72, $d, TMP_73, notes_on_beat = nil, max_duration_on_beat = nil, has_no_notes_on_beat = nil, is_new_part = nil, size = nil, e = nil, increment = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (beat == null) beat = nil;
          notes_on_beat = ($a = ($b = relevant_beat_maps).$map, $a.$$p = (TMP_71 = function(bm){var self = TMP_71.$$s || this;
if (bm == null) bm = nil;
            return bm['$[]'](beat)}, TMP_71.$$s = self, TMP_71), $a).call($b).$flatten().$compact();
            max_duration_on_beat = ($a = ($c = notes_on_beat).$map, $a.$$p = (TMP_72 = function(n){var self = TMP_72.$$s || this;
if (n == null) n = nil;
            return n.$duration()}, TMP_72.$$s = self, TMP_72), $a).call($c).$max();
            has_no_notes_on_beat = notes_on_beat['$empty?']();
            is_new_part = ($a = ($d = notes_on_beat).$select, $a.$$p = (TMP_73 = function(n){var self = TMP_73.$$s || this;
if (n == null) n = nil;
            return n['$first_in_part?']()}, TMP_73.$$s = self, TMP_73), $a).call($d);
            if (has_no_notes_on_beat !== false && has_no_notes_on_beat !== nil) {
              } else {
              try {
              size = conf_beat_resolution * duration_to_style['$[]'](self.$duration_to_id(max_duration_on_beat)).$first()
              } catch ($err) {if (Opal.rescue($err, [$scope.get('Exception')])) {e = $err;
            ...
            return [beat, current_beat];}, TMP_70.$$s = self, TMP_70), $a).call($d));
          return result;
        };
        ...
        def.$layout_note = function(root, beat_layout) {
          var $a, $b, TMP_74, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, shift = nil, res = nil;
          if ($gvars.conf == null) $gvars.conf = nil;
          ...
          size = ($a = ($b = $gvars.conf.$get("layout.ELLIPSE_SIZE")).$map, $a.$$p = (TMP_74 = function(e){var self = TMP_74.$$s || this;
if (e == null) e = nil;
          return $rb_times(e, scale)}, TMP_74.$$s = self, TMP_74), $a).call($b);
          shift = 0;
        ...
        def.$layout_accord = function(root, beat_layout) {
          var $a, $b, TMP_75, $c, TMP_76, self = this, resnotes = nil, resnotes_sorted = nil, res = nil;

          resnotes = ($a = ($b = root.$notes()).$map, $a.$$p = (TMP_75 = function(c){var self = TMP_75.$$s || this;
if (c == null) c = nil;
          return self.$layout_note(c, beat_layout)}, TMP_75.$$s = self, TMP_75), $a).call($b);
          resnotes_sorted = ($a = ($c = resnotes).$sort_by, $a.$$p = (TMP_76 = function(n){var self = TMP_76.$$s || this;
if (n == null) n = nil;
          return n.$origin().$pitch()}, TMP_76.$$s = self, TMP_76), $a).call($c);
          res = [];
        ...
        def.$layout_measure_start = function(root, beat_layout) {
          var $a, $b, TMP_77, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          if ($gvars.conf == null) $gvars.conf = nil;
          ...
          size = ($a = ($b = $gvars.conf.$get("layout.ELLIPSE_SIZE")).$map, $a.$$p = (TMP_77 = function(e){var self = TMP_77.$$s || this;
if (e == null) e = nil;
          return $rb_times($rb_times(e, scale), 1.2)}, TMP_77.$$s = self, TMP_77), $a).call($b);
          res = $scope.get('Ellipse').$new([x_offset, $rb_minus($rb_minus(y_offset, size.$last()), 0.5)], [size.$first(), 0.1], "filled", false, root, true);
          if ((($a = root['$visible?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
        ...
        def.$layout_newpart = function(root, beat_layout) {
          ...
          if ((($a = root.$beat()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            $gvars.log.$error("BUG Part without content");
            res = nil;
          };
          return res;
        };
        ...
        def.$make_sheetmark_path = function(note) {
          var $a, $b, TMP_78, self = this, w = nil, h = nil, base = nil, vpath = nil, path = nil;
          ...
          ($a = ($b = vpath).$each, $a.$$p = (TMP_78 = function(p){var self = TMP_78.$$s || this;
if (p == null) p = nil;
          return path['$<<'](["l", p.$x(), p.$y()])}, TMP_78.$$s = self, TMP_78), $a).call($b);
          return path;
        };
...
Opal.modules["abc_to_harpnotes_factory"] = function(Opal) {
  ...
  Opal.add_stubs(['$===', '$new', '$error', '$split', '$[]', '$count', '$length', '$last', '$each', '$match', '$parse', '$[]=', '$first', '$<<', '$message', '$inject', '$get_metadata', '$map', '$select', '$nil?', '$join', '$compact', '$flatten']);
  return (function($base) {
    var self = $module($base, 'Harpnotes');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (Opal.defs(self, '$create_engine', function(engine) {
          var self = this, $case = nil, result = nil;
          if ($gvars.log == null) $gvars.log = nil;

          $case = engine;if ("ABC2SVG"['$===']($case)) {result = (((($scope.get('Harpnotes')).$$scope.get('Input'))).$$scope.get('Abc2svgToHarpnotes')).$new()}else if ("ABCJS"['$===']($case)) {result = (((($scope.get('Harpnotes')).$$scope.get('Input'))).$$scope.get('AbcjsToHarpnotes')).$new()}else {$gvars.log.$error("Undefined abc parser: " + (engine));
      ...
      (function($base, $super) {
        ...
        def.$parse_harpnote_config = function(abc_code) {
          var $a, $b, TMP_1, self = this, hn_config_from_song = nil, line_no = nil;

          hn_config_from_song = $hash2([], {});
          line_no = 1;
          ($a = ($b = abc_code.$split("\n")).$each, $a.$$p = (TMP_1 = function(line){var self = TMP_1.$$s || this, $a, $b, TMP_2, $c, $d, entry = nil, parsed_entry = nil, e = nil, message = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (line == null) line = nil;
          entry = ($a = ($b = line).$match, $a.$$p = (TMP_2 = function(m){var self = TMP_2.$$s || this;
if (m == null) m = nil;
            return [m['$[]'](1), m['$[]'](2)]}, TMP_2.$$s = self, TMP_2), $a).call($b, /^%%%%hn\.(print|legend|note|annotation|lyrics) (.*)/);
            ...
            return line_no = $rb_plus(line_no, 1);}, TMP_1.$$s = self, TMP_1), $a).call($b);
        ...
        def.$get_metadata = function(abc_code) {
          var $a, $b, TMP_3, self = this, retval = nil;

          retval = ($a = ($b = abc_code.$split("\n")).$inject, $a.$$p = (TMP_3 = function(result, line){var self = TMP_3.$$s || this, $a, $b, TMP_4, entry = nil, key = nil;
if (result == null) result = nil;if (line == null) line = nil;
          entry = ($a = ($b = line).$match, $a.$$p = (TMP_4 = function(m){var self = TMP_4.$$s || this;
if (m == null) m = nil;
            return [m['$[]'](1), m['$[]'](2)]}, TMP_4.$$s = self, TMP_4), $a).call($b, /^([A-Z]):\s*(.*)/);
            if (entry !== false && entry !== nil) {
              key = entry.$first();
              if ((($a = result['$[]'](key)) !== nil && (!$a.$$is_boolean || $a == true))) {
                result['$[]'](key)['$<<'](entry.$last())
                } else {
                result['$[]='](key, [entry.$last()])
              };};
            return result;}, TMP_3.$$s = self, TMP_3), $a).call($b, $hash2([], {}));
          return retval;
        };

        return (def.$add_metadata = function(abc_code, new_metadata) {
          var $a, $b, TMP_5, $c, $d, TMP_6, self = this, old_metadata = nil, more_metadata = nil;

          old_metadata = self.$get_metadata(abc_code);
          more_metadata = ($a = ($b = ($c = ($d = new_metadata).$select, $c.$$p = (TMP_6 = function(k, v){var self = TMP_6.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return old_metadata['$[]'](k)['$nil?']()}, TMP_6.$$s = self, TMP_6), $c).call($d)).$map, $a.$$p = (TMP_5 = function(k, v){var self = TMP_5.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return "" + (k) + ":" + (v)}, TMP_5.$$s = self, TMP_5), $a).call($b);
...
/* Generated by Opal 0.8.0 */
Opal.modules["abcjs_to_harpnotes"] = function(Opal) {
  Opal.dynamic_require_severity = "error";
  function $rb_divide(lhs, rhs) {
    return (typeof(lhs) === 'number' && typeof(rhs) === 'number') ? lhs / rhs : lhs['$/'](rhs);
  }
  ...
  Opal.add_stubs(['$require', '$map', '$lambda', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$%', '$clone', '$==', '$!', '$new', '$reset_state', '$reset_measure_accidentals', '$parse_harpnote_config', '$get', '$inject', '$compact', '$flatten', '$charpos_to_line_column', '$warning', '$last', '$get_metadata', '$to_i', '$strip', '$split', '$select', '$first', '$set_key', '$each_with_index', '$debug', '$<<', '$index=', '$flatten!', '$compact!', '$_transform_voices', '$now', '$join', '$to_n', '$keys', '$meta_data=', '$harpnote_options=', '$push', '$harpnote_options', '$empty?', '$error', '$to_s', '$pop', '$line_no', '$send', '$nil?', '$origin=', '$start_pos=', '$end_pos=', '$is_a?', '$notes', '$make_jumplines', '$make_notebound_annotations', '$unshift', '$private', '$_extract_chord_lines', '$origin', '$start_pos_to_s', '$start_pos', '$end_pos', '$match', '$===', '$to_f', '$round', '$transform_rest', '$transform_real_note', '$tuplet=', '$tuplet_start=', '$tuplet_end=', '$pitch', '$get_midipitch', '$visible=', '$companion=', '$first_in_part=', '$clear', '$slur_starts=', '$slur_ends=', '$tie_start=', '$tie_end=', '$length', '$tie_start?', '$tie_end?', '$_extract_variant_ending', '$gsub']);
  self.$require("native");
  return (function($base) {
    var self = $module($base, 'Harpnotes');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        function $AbcjsToHarpnotes(){};
        var self = $AbcjsToHarpnotes = $klass($base, $super, 'AbcjsToHarpnotes', $AbcjsToHarpnotes);
...
if (f == null) f = nil;
        ...
        def.$initialize = TMP_8 = function() {var $zuper = $slice.call(arguments, 0);
          var self = this, $iter = TMP_8.$$p, $yield = $iter || nil;

          TMP_8.$$p = null;
          Opal.find_super_dispatcher(self, 'initialize', TMP_8, $iter).apply(self, $zuper);
          self.pitch_transformer = $scope.get('ABCPitchToMidipitch').$new();
          self.abc_code = nil;
        ...
        def.$transform = function(zupfnoter_abc) {
          var $a, $b, TMP_9, $c, TMP_10, $d, TMP_11, $e, TMP_12, $f, TMP_13, $g, TMP_17, $h, TMP_18, $i, TMP_19, $j, TMP_20, $k, TMP_22, self = this, harpnote_options = nil, warnings = nil, note_length = nil, tune = nil, lines = nil, first_staff = nil, key = nil, meter = nil, voices = nil, result = nil, meta_data = nil, duration = nil, bpm = nil, duration_display = nil, meta_data_from_tune = nil, print_options = nil;
          if ($gvars.conf == null) $gvars.conf = nil;
          ...
          if ($gvars.conf.$get("location")['$==']("song")) {
            ...
            self.annotations = ($a = ($b = self.annotations).$inject, $a.$$p = (TMP_9 = function(hash, entry){var self = TMP_9.$$s || this;
if (hash == null) hash = nil;if (entry == null) entry = nil;
            hash['$[]='](entry['$[]']("id"), entry);
              return hash;}, TMP_9.$$s = self, TMP_9), $a).call($b, $hash2([], {}));
          };
          ...
          ($a = ($c = warnings).$each, $a.$$p = (TMP_10 = function(w){var self = TMP_10.$$s || this, $a, wn = nil, line_no = nil, char_pos = nil, msg = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (w == null) w = nil;
          wn = self.$Native(w);
            ...
            return $gvars.log.$warning(msg, [line_no, char_pos], [line_no, $rb_plus(char_pos, 1)]);}, TMP_10.$$s = self, TMP_10), $a).call($c);
          note_length = (((($a = (((($d = self.$get_metadata(zupfnoter_abc)['$[]']("L")) !== false && $d !== nil) ? $d : [])).$last()) !== false && $a !== nil) ? $a : $gvars.conf.$get("defaults.note_length")));
          note_length = ($a = ($d = note_length.$split("/")).$map, $a.$$p = (TMP_11 = function(s){var self = TMP_11.$$s || this;
if (s == null) s = nil;
          return s.$strip().$to_i()}, TMP_11.$$s = self, TMP_11), $a).call($d);
          tune = self.$Native(tune);
          lines = ($a = ($e = tune['$[]']("lines")).$select, $a.$$p = (TMP_12 = function(l){var self = TMP_12.$$s || this;
if (l == null) l = nil;
          return self.$Native(l)['$[]']("staff")}, TMP_12.$$s = self, TMP_12), $a).call($e);
          ...
          voices = [];
          ($a = ($f = lines).$each_with_index, $a.$$p = (TMP_13 = function(line, line_index){var self = TMP_13.$$s || this, $a, $b, TMP_14, voice_no = nil;
if (line == null) line = nil;if (line_index == null) line_index = nil;
          voice_no = 1;
            return ($a = ($b = self.$Native(line)['$[]']("staff")).$each_with_index, $a.$$p = (TMP_14 = function(staff, staff_index){var self = TMP_14.$$s || this, $a, $b, TMP_15;
if (staff == null) staff = nil;if (staff_index == null) staff_index = nil;
            return ($a = ($b = self.$Native(staff)['$[]']("voices")).$each_with_index, $a.$$p = (TMP_15 = function(voice, voice_index){var self = TMP_15.$$s || this, $a, $b, $c, TMP_16;
                if ($gvars.log == null) $gvars.log = nil;
if (voice == null) voice = nil;if (voice_index == null) voice_index = nil;
              $gvars.log.$debug("reading line.staff.voice " + (voice_no) + ":" + (line_index) + " " + (staff_index) + "." + (voice_index) + " (" + ("abcjs_to_harpnotes") + " " + (210) + ")");
                ($a = voice_no, $b = voices, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Voice')).$new())));
                voices['$[]'](voice_no)['$<<'](($a = ($b = voice).$map, $a.$$p = (TMP_16 = function(x){var self = TMP_16.$$s || this;
if (x == null) x = nil;
                return self.$Native(x)}, TMP_16.$$s = self, TMP_16), $a).call($b));
                (($a = [voice_no]), $c = voices['$[]'](voice_no), $c['$index='].apply($c, $a), $a[$a.length-1]);
                voices['$[]'](voice_no)['$flatten!']();
                return voice_no = $rb_plus(voice_no, 1);}, TMP_15.$$s = self, TMP_15), $a).call($b)}, TMP_14.$$s = self, TMP_14), $a).call($b);}, TMP_13.$$s = self, TMP_13), $a).call($f);
          voices['$compact!']();
          result = self.$_transform_voices(note_length, voices);
          ...
          ($a = ($g = $hash2(["key"], {"key": "K:"})).$each, $a.$$p = (TMP_17 = function(k, v){var self = TMP_17.$$s || this, $a;
...
if (k == null) k = nil;if (v == null) v = nil;
          ...
          if ((($a = tune['$[]']("metaText")['$[]']("tempo")) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            meta_data['$[]=']("tempo", $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm}));
            duration_display = ($a = ($h = duration).$map, $a.$$p = (TMP_18 = function(d){var self = TMP_18.$$s || this;
if (d == null) d = nil;
            return "1/" + ($rb_divide(1, d))}, TMP_18.$$s = self, TMP_18), $a).call($h);
          ...
          ($a = ($i = meta_data_from_tune.$keys()).$each, $a.$$p = (TMP_19 = function(k){var self = TMP_19.$$s || this;
if (k == null) k = nil;
          return meta_data['$[]='](k, meta_data_from_tune['$[]'](k))}, TMP_19.$$s = self, TMP_19), $a).call($i);
          (($a = [meta_data]), $j = result, $j['$meta_data='].apply($j, $a), $a[$a.length-1]);
          (($a = [$hash2([], {})]), $j = result, $j['$harpnote_options='].apply($j, $a), $a[$a.length-1]);
          print_options = $scope.get('Confstack').$new();
          print_options.$push($gvars.conf.$get("defaults.print"));
          result.$harpnote_options()['$[]=']("print", ($a = ($j = (((($k = harpnote_options['$[]']("print")) !== false && $k !== nil) ? $k : [$hash2([], {})])).$each_with_index()).$map, $a.$$p = (TMP_20 = function(specified_option, index){var self = TMP_20.$$s || this, $a, $b, TMP_21, resulting_options = nil, missing_voices = nil, msg = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (specified_option == null) specified_option = nil;if (index == null) index = nil;
          print_options.$push(specified_option);
            ...
            missing_voices = ($a = ($b = ($rb_minus(resulting_options['$[]']("voices"), resulting_options['$[]']("layoutlines")))).$map, $a.$$p = (TMP_21 = function(i){var self = TMP_21.$$s || this;
if (i == null) i = nil;
            return $rb_plus(i, 1)}, TMP_21.$$s = self, TMP_21), $a).call($b);
            ...
            return resulting_options;}, TMP_20.$$s = self, TMP_20), $a).call($j));
          if ($gvars.conf.$get("location")['$==']("song")) {
            result.$harpnote_options()['$[]=']("print", ($a = ($k = $gvars.conf.$get("produce")).$map, $a.$$p = (TMP_22 = function(i){var self = TMP_22.$$s || this, title = nil;
              if ($gvars.conf == null) $gvars.conf = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (i == null) i = nil;
            title = $gvars.conf.$get("extract." + (i) + ".title");
              if (title !== false && title !== nil) {
                ...
                return nil;
              };}, TMP_22.$$s = self, TMP_22), $a).call($k).$compact())};
          print_options = $scope.get('Confstack').$new();
        ...
        def.$_transform_voices = function(note_length, voices) {
          var $a, $b, TMP_23, self = this, hn_voices = nil, result = nil;

          hn_voices = ($a = ($b = voices.$each_with_index()).$map, $a.$$p = (TMP_23 = function(voice, voice_idx){var self = TMP_23.$$s || this, $a, $b, TMP_24, $c, TMP_25, $d, TMP_28, $e, TMP_29, hn_voice = nil, jumplines = nil, notebound_annotations = nil;
            ...
            type = el['$[]']("el_type");
              ...
              if ((($a = el['$[]']("startChar")) !== nil && (!$a.$$is_boolean || $a == true))) {
                ...
                if ((($a = ((($b = hn_voice_element['$nil?']()) !== false && $b !== nil) ? $b : hn_voice_element['$empty?']())) !== nil && (!$a.$$is_boolean || $a == true))) {
                  ...
                  ($a = ($b = hn_voice_element).$each, $a.$$p = (TMP_26 = function(e){var self = TMP_26.$$s || this, $a, $b, TMP_27;
if (e == null) e = nil;
                  (($a = [el]), $b = e, $b['$origin='].apply($b, $a), $a[$a.length-1]);
                    (($a = [start_pos]), $b = e, $b['$start_pos='].apply($b, $a), $a[$a.length-1]);
                    (($a = [end_pos]), $b = e, $b['$end_pos='].apply($b, $a), $a[$a.length-1]);
                    if ((($a = e['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('SynchPoint')))) !== nil && (!$a.$$is_boolean || $a == true))) {
                      return ($a = ($b = e.$notes()).$each, $a.$$p = (TMP_27 = function(synchpoint_note){var self = TMP_27.$$s || this, $a, $b;
if (synchpoint_note == null) synchpoint_note = nil;
                      (($a = [start_pos]), $b = synchpoint_note, $b['$start_pos='].apply($b, $a), $a[$a.length-1]);
                        return (($a = [end_pos]), $b = synchpoint_note, $b['$end_pos='].apply($b, $a), $a[$a.length-1]);}, TMP_27.$$s = self, TMP_27), $a).call($b)
                      } else {
                      return nil
            ...
            jumplines = [];
            ($a = ($d = hn_voice).$each, $a.$$p = (TMP_28 = function(e){var self = TMP_28.$$s || this;
if (e == null) e = nil;
            return jumplines['$<<'](self.$make_jumplines(e))}, TMP_28.$$s = self, TMP_28), $a).call($d);
            hn_voice = $rb_plus(hn_voice, jumplines.$flatten().$compact());
            notebound_annotations = [];
            ($a = ($e = hn_voice).$each, $a.$$p = (TMP_29 = function(e){var self = TMP_29.$$s || this;
if (e == null) e = nil;
            return notebound_annotations['$<<'](self.$make_notebound_annotations(e))}, TMP_29.$$s = self, TMP_29), $a).call($e);
            hn_voice = $rb_plus(hn_voice, notebound_annotations.$flatten().$compact());
            return hn_voice;}, TMP_23.$$s = self, TMP_23), $a).call($b);
          hn_voices.$unshift(hn_voices.$first());
          return result = (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Song')).$new(hn_voices, note_length);
        };

        self.$private();

        def.$_extract_chord_lines = function(entity) {
          var $a, $b, TMP_30, self = this, result = nil;

          result = [];
          if ((($a = entity['$[]']("chord")['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            } else {
            ($a = ($b = entity['$[]']("chord")).$each, $a.$$p = (TMP_30 = function(chord){var self = TMP_30.$$s || this, $a, $b, TMP_31, text = nil;
if (chord == null) chord = nil;
            text = self.$Native(chord)['$[]']("name");
              return ($a = ($b = text.$split("\n")).$each, $a.$$p = (TMP_31 = function(line){var self = TMP_31.$$s || this;
if (line == null) line = nil;
              return result['$<<'](line)}, TMP_31.$$s = self, TMP_31), $a).call($b);}, TMP_30.$$s = self, TMP_30), $a).call($b)
          };
          return result;
        };
        ...
        def.$make_jumplines = function(entity) {
          var $a, $b, TMP_32, self = this, result = nil, chords = nil;
          ...
          if ((($a = entity['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            ($a = ($b = chords).$each, $a.$$p = (TMP_32 = function(name){var self = TMP_32.$$s || this, $a, nameparts = nil, targetname = nil, target = nil, argument = nil;
...
if (name == null) name = nil;
        ...
        def.$make_notebound_annotations = function(entity) {
          var $a, $b, TMP_33, self = this, result = nil, chords = nil;

          result = [];
          if ((($a = entity['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))) !== nil && (!$a.$$is_boolean || $a == true))) {
            chords = self.$_extract_chord_lines(entity.$origin());
            ($a = ($b = chords).$each, $a.$$p = (TMP_33 = function(name){var self = TMP_33.$$s || this, $a, $b, TMP_34, $c, match = nil, semantic = nil, text = nil, pos_x = nil, pos_y = nil, $case = nil, annotation = nil, notepos = nil, position = nil;
              if (self.annotations == null) self.annotations = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (name == null) name = nil;
              ...
              if (match !== false && match !== nil) {
                ...
                if (annotation !== false && annotation !== nil) {
                  if (pos_x !== false && pos_x !== nil) {
                    notepos = ($a = ($b = [pos_x, pos_y]).$map, $a.$$p = (TMP_34 = function(p){var self = TMP_34.$$s || this;
if (p == null) p = nil;
                    return p.$to_f()}, TMP_34.$$s = self, TMP_34), $a).call($b)};
        ...
        def.$transform_note = function(note, index) {
          var $a, $b, TMP_35, self = this, duration = nil, start_tuplet = nil, end_tuplet = nil, result = nil, pitch_note = nil, chords = nil, jumpends = nil;
          if ($gvars.conf == null) $gvars.conf = nil;
          ...
          if ((($a = result['$empty?']()['$!']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            ...
            jumpends = [];
            ($a = ($b = chords).$each, $a.$$p = (TMP_35 = function(name){var self = TMP_35.$$s || this, $a, $b, TMP_36;
              if (self.jumptargets == null) self.jumptargets = nil;
if (name == null) name = nil;
            if (name['$[]'](0)['$=='](":")) {
                jumpends.$push(name['$[]']($range(1, -1, false)));
                self.jumptargets['$[]='](name['$[]']($range(1, -1, false)), ($a = ($b = result).$select, $a.$$p = (TMP_36 = function(n){var self = TMP_36.$$s || this;
if (n == null) n = nil;
                return n['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))}, TMP_36.$$s = self, TMP_36), $a).call($b).$last());};
              if (name['$[]'](0)['$==']("@")) {
                return nil
                } else {
                return nil
              };}, TMP_35.$$s = self, TMP_35), $a).call($b);};
          return result;
        };

        def.$transform_rest = function(note, duration, pitch_note) {
          var $a, $b, TMP_37, self = this, pitch = nil, rest = nil, result = nil;
          ...
          ($a = ($b = self.previous_new_part).$each, $a.$$p = (TMP_37 = function(part){var self = TMP_37.$$s || this, $a, $b;
if (part == null) part = nil;
          (($a = [rest]), $b = part, $b['$companion='].apply($b, $a), $a[$a.length-1]);
            return (($a = [true]), $b = rest, $b['$first_in_part='].apply($b, $a), $a[$a.length-1]);}, TMP_37.$$s = self, TMP_37), $a).call($b);
          self.previous_new_part.$clear();
          return result;
        };

        def.$transform_real_note = function(note, duration) {
          var $a, $b, TMP_38, $c, $d, $e, TMP_40, $f, $g, TMP_41, $h, TMP_42, TMP_43, TMP_44, self = this, notes = nil, result = nil, synchpoint = nil;

          notes = ($a = ($b = self.$Native(note['$[]']("pitches"))).$map, $a.$$p = (TMP_38 = function(pitch){var self = TMP_38.$$s || this, $a, $b, $c, $d, TMP_39, $e, midipitch = nil, native_pitch = nil, thenote = nil;
...
if (pitch == null) pitch = nil;
          midipitch = self.pitch_transformer.$get_midipitch(pitch);
            ...
            (($a = [($c = ($d = (((($e = native_pitch['$[]']("startSlur")) !== false && $e !== nil) ? $e : []))).$map, $c.$$p = (TMP_39 = function(s){var self = TMP_39.$$s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_39.$$s = self, TMP_39), $c).call($d)]), $b = thenote, $b['$slur_starts='].apply($b, $a), $a[$a.length-1]);
            ...
            return thenote;}, TMP_38.$$s = self, TMP_38), $a).call($b);
          result = [];
          if (notes.$length()['$=='](1)) {
            result['$<<'](notes.$first())
            } else {
            synchpoint = (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('SynchPoint')).$new(notes);
            (($a = [($d = ($e = (((($f = note['$[]']("startSlur")) !== false && $f !== nil) ? $f : []))).$map, $d.$$p = (TMP_40 = function(s){var self = TMP_40.$$s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_40.$$s = self, TMP_40), $d).call($e)]), $c = synchpoint, $c['$slur_starts='].apply($c, $a), $a[$a.length-1]);
            (($a = [((($d = note['$[]']("endSlur")) !== false && $d !== nil) ? $d : [])]), $c = synchpoint, $c['$slur_ends='].apply($c, $a), $a[$a.length-1]);
            (($a = [((($d = (note['$[]']("startTie")['$nil?']()['$!']())) !== false && $d !== nil) ? $d : (($f = ($g = notes).$select, $f.$$p = (TMP_41 = function(n){var self = TMP_41.$$s || this;
if (n == null) n = nil;
            return n['$tie_start?']()}, TMP_41.$$s = self, TMP_41), $f).call($g)['$empty?']()['$!']()))]), $c = synchpoint, $c['$tie_start='].apply($c, $a), $a[$a.length-1]);
            (($a = [((($d = (note['$[]']("endTie")['$nil?']()['$!']())) !== false && $d !== nil) ? $d : (($f = ($h = notes).$select, $f.$$p = (TMP_42 = function(n){var self = TMP_42.$$s || this;
if (n == null) n = nil;
            return n['$tie_end?']()}, TMP_42.$$s = self, TMP_42), $f).call($h)['$empty?']()['$!']()))]), $c = synchpoint, $c['$tie_end='].apply($c, $a), $a[$a.length-1]);
            result['$<<'](synchpoint);
          };
          ($a = ($c = self.previous_new_part).$each, $a.$$p = (TMP_43 = function(part){var self = TMP_43.$$s || this, $a, $b;
if (part == null) part = nil;
          (($a = [true]), $b = result.$last(), $b['$first_in_part='].apply($b, $a), $a[$a.length-1]);
            return (($a = [notes.$first()]), $b = part, $b['$companion='].apply($b, $a), $a[$a.length-1]);}, TMP_43.$$s = self, TMP_43), $a).call($c);
          self.previous_new_part.$clear();
          self.previous_note = result.$last();
          if ((($a = self.next_note_marks['$[]']("measure")) !== nil && (!$a.$$is_boolean || $a == true))) {
            ($a = ($d = notes).$each, $a.$$p = (TMP_44 = function(note){var self = TMP_44.$$s || this;
if (note == null) note = nil;
            return result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('MeasureStart')).$new(note))}, TMP_44.$$s = self, TMP_44), $a).call($d);
            self.next_note_marks['$[]=']("measure", false);};
          if ((($a = self.next_note_marks['$[]']("repeat_start")) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        def.$transform_bar_right_repeat = function(bar) {
          var $a, $b, TMP_45, self = this, start = nil, distance = nil;
          ...
          distance = 2;
          ($a = ($b = self.$_extract_chord_lines(bar)).$each, $a.$$p = (TMP_45 = function(line){var self = TMP_45.$$s || this, $a, level = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (line == null) line = nil;
          level = line.$split("@");
            if ((($a = level['$[]'](2)) !== nil && (!$a.$$is_boolean || $a == true))) {
              level = level['$[]'](2);
              $gvars.log.$debug("bar repeat level " + (level) + " " + ("abcjs_to_harpnotes") + ":" + (687));
        ...
        def.$method_missing = function(name, args) {
          ...
          args = $slice.call(arguments, 1);
          $gvars.log.$debug("Missing transformation rule: " + (name) + " (" + ("abcjs_to_harpnotes") + " " + (703) + ")");
          return nil;
        };

        return (def.$mk_origin = function(origin) {
          var self = this;

          return $hash2(["startChar", "endChar", "origin"], {"startChar": origin['$[]']("startChar"), "endChar": origin['$[]']("endChar"), "origin": origin});
        }, nil) && 'mk_origin';
      })(self, $scope.get('AbstractAbcToHarpnotes'))
    })(self)
  })(self);
};
...
Opal.modules["abc2svg_to_harpnotes"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$get', '$_reset_state', '$get_metadata', '$new', '$get_abcmodel', '$_transform_voices', '$meta_data=', '$_make_metadata', '$harpnote_options=', '$_make_harpnote_options', '$[]', '$[]=', '$compact', '$map', '$error', '$_get_key_by_accidentals', '$first', '$==', '$to_i', '$join', '$private', '$each', '$to_s', '$send', '$charpos_to_line_column', '$each_with_index', '$flatten', '$inject', '$<<', '$_make_jumplines', '$_make_notebound_annotations', '$count', '$unshift', '$include?', '$_transform_bar_repeat_end', '$_parse_origin', '$_parse_tuplet_info', '$_convert_duration', '$origin=', '$start_pos=', '$end_pos=', '$tuplet=', '$tuplet_start=', '$tuplet_end=', '$empty?', '$last', '$duration=', '$duration', '$origin', '$start_pos', '$end_pos', '$tuplet', '$tuplet_start', '$tuplet_end', '$tie_end=', '$!', '$nil?', '$tie_start=', '$slur_starts=', '$_push_slur', '$_parse_slur', '$slur_ends=', '$_pop_slur', '$_make_repeats_jumps_annotations', '$min', '$round', '$raise', '$visible=', '$length', '$pop', '$split', '$debug', '$_extract_chord_lines', '$is_a?', '$start_pos_to_s', '$select', '$match', '$===', '$shift=', '$to_f', '$companion=', '$first_in_part=', '$push', '$&', '$>>']);
  self.$require("native");
  return (function($base) {
    var self = $module($base, 'Harpnotes');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.abc_code = def.info_fields = def.abc_model = def.next_note_marks = def.repetition_stack = def.tie_started = def._shortest_note = def.pitch_providers = def.previous_note = def.part_table = def.slurstack = def.tuplet_count = def.tuplet_down_count = nil;
        ...
        def.$transform = function(zupfnoter_abc) {
          var $a, $b, self = this, abc_parser = nil, result = nil;
          if ($gvars.conf == null) $gvars.conf = nil;
          ...
          self.abc_model = abc_parser.$get_abcmodel(zupfnoter_abc);
          result = self.$_transform_voices();
          (($a = [self.$_make_metadata()]), $b = result, $b['$meta_data='].apply($b, $a), $a[$a.length-1]);
          (($a = [self.$_make_harpnote_options()]), $b = result, $b['$harpnote_options='].apply($b, $a), $a[$a.length-1]);
          return result;
        };

        def.$_make_harpnote_options = function() {
          var $a, $b, TMP_2, self = this, result = nil;
          if ($gvars.conf == null) $gvars.conf = nil;

          result = $hash2(["lyrics"], {"lyrics": $hash2(["text"], {"text": self.info_fields['$[]']("W")})});
          result['$[]=']("print", ($a = ($b = $gvars.conf.$get("produce")).$map, $a.$$p = (TMP_2 = function(i){var self = TMP_2.$$s || this, title = nil;
            if ($gvars.conf == null) $gvars.conf = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (i == null) i = nil;
          title = $gvars.conf.$get("extract." + (i) + ".title");
            if (title !== false && title !== nil) {
              ...
              $gvars.log.$error("could not find extract number " + (i), [1, 1], [1000, 1000]);
              return nil;
            };}, TMP_2.$$s = self, TMP_2), $a).call($b).$compact());
          return result;
        };

        def.$_get_key_by_accidentals = function(accidentals) {
          var self = this;

          return $hash(7, "C#", 6, "F#", 5, "B", 4, "E", 3, "A", 2, "D", 1, "G", 0, "C", -1, "F", -2, "Bb", -3, "Eb", -4, "Ab", -5, "Db", -6, "Gb", -7, "Cb")['$[]'](accidentals);
        };

        def.$_make_metadata = function() {
          var $a, $b, TMP_3, $c, TMP_4, $d, TMP_5, self = this, key = nil, o_key = nil, o_key_display = nil, tempo_id = nil, tempo_note = nil, duration = nil, duration_display = nil, bpm = nil, tempo = nil;

          key = self.$_get_key_by_accidentals(self.abc_model['$[]']("voices").$first()['$[]']("voice_properties")['$[]']("key")['$[]']("k_sf"));
          o_key = self.$_get_key_by_accidentals(self.abc_model['$[]']("voices").$first()['$[]']("voice_properties")['$[]']("okey")['$[]']("k_sf"));
          o_key_display = "";
          if (key['$=='](o_key)) {
            } else {
            o_key_display = "(Original in " + (o_key) + ")"
          };
          tempo_id = self.abc_model['$[]']("music_type_ids")['$[]']("tempo");
          tempo_note = (function() {try {return self.abc_model['$[]']("voices").$first()['$[]']("voice_properties")['$[]']("sym")['$[]']("extra")['$[]'](tempo_id) } catch ($err) { return nil }})();
          if (tempo_note !== false && tempo_note !== nil) {
            duration = ($a = ($b = tempo_note['$[]']("tempo_notes")).$map, $a.$$p = (TMP_3 = function(i){var self = TMP_3.$$s || this;
if (i == null) i = nil;
            return $rb_divide(i, $scope.get('ABC2SVG_DURATION_FACTOR'))}, TMP_3.$$s = self, TMP_3), $a).call($b);
            duration_display = ($a = ($c = duration).$map, $a.$$p = (TMP_4 = function(d){var self = TMP_4.$$s || this;
if (d == null) d = nil;
            return "1/" + ($rb_divide(1, d))}, TMP_4.$$s = self, TMP_4), $a).call($c);
            bpm = tempo_note['$[]']("tempo_value").$to_i();
            tempo = $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm});
            } else {
            duration = [0.25];
            duration_display = ($a = ($d = duration).$map, $a.$$p = (TMP_5 = function(d){var self = TMP_5.$$s || this;
if (d == null) d = nil;
            return "1/" + ($rb_divide(1, d))}, TMP_5.$$s = self, TMP_5), $a).call($d);
            bpm = 120;
            tempo = $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm});
          };
          return $hash2(["composer", "title", "filename", "tempo", "tempo_display", "meter", "key"], {"composer": (((($a = self.info_fields['$[]']("C")) !== false && $a !== nil) ? $a : [])).$join("\n"), "title": (((($a = self.info_fields['$[]']("T")) !== false && $a !== nil) ? $a : [])).$join("\n"), "filename": (((($a = self.info_fields['$[]']("F")) !== false && $a !== nil) ? $a : [])).$join("\n"), "tempo": $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm}), "tempo_display": [duration_display, "=", bpm].$join(" "), "meter": self.info_fields['$[]']("M"), "key": "" + (key) + " " + (o_key_display)});
        };

        self.$private();

        def.$_reset_state = function() {
          var self = this;
        ...
        def.$_transform_voices = function() {
          var $a, $b, TMP_6, $c, TMP_7, self = this, part_id = nil, note_id = nil, hn_voices = nil;

          part_id = self.abc_model['$[]']("music_type_ids")['$[]']("part");
          note_id = self.abc_model['$[]']("music_type_ids")['$[]']("note");
          ($a = ($b = self.abc_model['$[]']("voices").$first()['$[]']("symbols")).$each, $a.$$p = (TMP_6 = function(voice_model_element){var self = TMP_6.$$s || this, $a, $b, part = nil;
            if (self.part_table == null) self.part_table = nil;
if (voice_model_element == null) voice_model_element = nil;
          part = (((($a = (((($b = voice_model_element['$[]']("extra")) !== false && $b !== nil) ? $b : $hash2([], {})))['$[]'](part_id)) !== false && $a !== nil) ? $a : $hash2([], {})))['$[]']("text");
            if (part !== false && part !== nil) {
              return self.part_table['$[]='](voice_model_element['$[]']("time").$to_s(), part)
              } else {
              return nil
            };}, TMP_6.$$s = self, TMP_6), $a).call($b);
          hn_voices = ($a = ($c = self.abc_model['$[]']("voices").$each_with_index()).$map, $a.$$p = (TMP_7 = function(voice_model, voice_index){var self = TMP_7.$$s || this, $a, $b, TMP_8, $c, TMP_9, $d, TMP_10, $e, TMP_11, result = nil, jumplines = nil, notebound_annotations = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (voice_model == null) voice_model = nil;if (voice_index == null) voice_index = nil;
          self.$_reset_state();
            self.pitch_providers = ($a = ($b = voice_model['$[]']("symbols")).$map, $a.$$p = (TMP_8 = function(voice_model_element){var self = TMP_8.$$s || this;
if (voice_model_element == null) voice_model_element = nil;
            nil;
              if (voice_model_element['$[]']("type")['$=='](note_id)) {
                return voice_model_element
                } else {
                return nil
              };}, TMP_8.$$s = self, TMP_8), $a).call($b);
            result = ($a = ($c = voice_model['$[]']("symbols").$each_with_index()).$map, $a.$$p = (TMP_9 = function(voice_model_element, index){var self = TMP_9.$$s || this, type = nil, e = nil;
...
if (voice_model_element == null) voice_model_element = nil;if (index == null) index = nil;
            ...
            jumplines = ($a = ($d = result).$inject, $a.$$p = (TMP_10 = function(jumplines, element){var self = TMP_10.$$s || this;
if (jumplines == null) jumplines = nil;if (element == null) element = nil;
            jumplines['$<<'](self.$_make_jumplines(element));
              return jumplines;}, TMP_10.$$s = self, TMP_10), $a).call($d, []);
            notebound_annotations = ($a = ($e = result).$inject, $a.$$p = (TMP_11 = function(notebound_annotations, element){var self = TMP_11.$$s || this;
if (notebound_annotations == null) notebound_annotations = nil;if (element == null) element = nil;
            return notebound_annotations['$<<'](self.$_make_notebound_annotations(element))}, TMP_11.$$s = self, TMP_11), $a).call($e, []);
            result = $rb_plus(result, ($rb_plus(jumplines, notebound_annotations)));
            result = result.$flatten().$compact();
            if ((($a = (result.$count()['$=='](0))) !== nil && (!$a.$$is_boolean || $a == true))) {
              $gvars.log.$error("Empty voice " + (voice_index));
              result = nil;};
            return result;}, TMP_7.$$s = self, TMP_7), $a).call($c).$compact();
          hn_voices.$unshift(hn_voices.$first());
          return (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Song')).$new(hn_voices);
        };

        def.$_transform_bar = function(voice_element) {
          var $a, self = this, result = nil, type = nil;

          result = [];
          type = voice_element['$[]']("bar_type");
          self.next_note_marks['$[]=']("measure", true);
          self.next_note_marks['$[]=']("variant_ending", voice_element['$[]']("text"));
          if ((($a = ["|:", "::"]['$include?'](type)) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.next_note_marks['$[]=']("repeat_start", true)};
          if ((($a = [":|", "::"]['$include?'](type)) !== nil && (!$a.$$is_boolean || $a == true))) {
            return result['$<<'](self.$_transform_bar_repeat_end(voice_element))
            } else {
            return nil
          };
        };

        def.$_transform_note = function(voice_element) {
          var $a, $b, TMP_12, $c, $d, $e, TMP_13, $f, TMP_14, TMP_15, self = this, origin = nil, start_pos = nil, end_pos = nil, tuplet = nil, tuplet_end = nil, tuplet_start = nil, notes = nil, result = nil, synchpoint = nil, first_note = nil, amount_of_slur_ends = nil;

          origin = self.$_parse_origin(voice_element);
          $a = [origin['$[]']("startChar"), origin['$[]']("endChar")], start_pos = $a[0], end_pos = $a[1];
          $a = Opal.to_ary(self.$_parse_tuplet_info(voice_element)), tuplet = ($a[0] == null ? nil : $a[0]), tuplet_end = ($a[1] == null ? nil : $a[1]), tuplet_start = ($a[2] == null ? nil : $a[2]);
          notes = ($a = ($b = voice_element['$[]']("notes")).$map, $a.$$p = (TMP_12 = function(the_note){var self = TMP_12.$$s || this, $a, $b, duration = nil, result = nil;
if (the_note == null) the_note = nil;
          duration = self.$_convert_duration(the_note['$[]']("dur"));
            result = (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Note')).$new(the_note['$[]']("midi"), duration);
            (($a = [origin]), $b = result, $b['$origin='].apply($b, $a), $a[$a.length-1]);
            (($a = [self.$charpos_to_line_column(start_pos)]), $b = result, $b['$start_pos='].apply($b, $a), $a[$a.length-1]);
            (($a = [self.$charpos_to_line_column(end_pos)]), $b = result, $b['$end_pos='].apply($b, $a), $a[$a.length-1]);
            (($a = [tuplet]), $b = result, $b['$tuplet='].apply($b, $a), $a[$a.length-1]);
            (($a = [tuplet_start]), $b = result, $b['$tuplet_start='].apply($b, $a), $a[$a.length-1]);
            (($a = [tuplet_end]), $b = result, $b['$tuplet_end='].apply($b, $a), $a[$a.length-1]);
            return result;}, TMP_12.$$s = self, TMP_12), $a).call($b);
          if ((($a = self.repetition_stack['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          (($a = [($d = ($e = self.$_parse_slur(voice_element['$[]']("slur_start"))).$map, $d.$$p = (TMP_13 = function(i){var self = TMP_13.$$s || this;
if (i == null) i = nil;
          return self.$_push_slur()}, TMP_13.$$s = self, TMP_13), $d).call($e)]), $c = result.$first(), $c['$slur_starts='].apply($c, $a), $a[$a.length-1]);
          amount_of_slur_ends = (((($a = voice_element['$[]']("slur_end")) !== false && $a !== nil) ? $a : 0));
          (($a = [($d = ($f = ($range(1, amount_of_slur_ends, false))).$map, $d.$$p = (TMP_14 = function(){var self = TMP_14.$$s || this;

          return self.$_pop_slur()}, TMP_14.$$s = self, TMP_14), $d).call($f)]), $c = result.$first(), $c['$slur_ends='].apply($c, $a), $a[$a.length-1]);
          if ((($a = self.next_note_marks['$[]']("measure")) !== nil && (!$a.$$is_boolean || $a == true))) {
            ($a = ($c = notes).$each, $a.$$p = (TMP_15 = function(note){var self = TMP_15.$$s || this;
if (note == null) note = nil;
            return result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('MeasureStart')).$new(note))}, TMP_15.$$s = self, TMP_15), $a).call($c);
            self.next_note_marks['$[]=']("measure", false);};
          self.$_make_repeats_jumps_annotations(result, voice_element);
          return result;
        };

        def.$_convert_duration = function(raw_duration) {
        ...
        def.$_transform_rest = function(voice_element, index) {
          var $a, $b, self = this, origin = nil, start_pos = nil, end_pos = nil, pitch_note = nil, pitch = nil, the_note = nil, duration = nil, tuplet = nil, tuplet_end = nil, tuplet_start = nil, result = nil;

          origin = self.$_parse_origin(voice_element);
          $a = [origin['$[]']("startChar"), origin['$[]']("endChar")], start_pos = $a[0], end_pos = $a[1];
          pitch_note = (((($a = self.pitch_providers['$[]']($range(index, -1, false)).$compact().$first()) !== false && $a !== nil) ? $a : self.pitch_providers['$[]']($range(0, $rb_minus(index, 1), false)).$compact().$last()));
          if (pitch_note !== false && pitch_note !== nil) {
          ...
          (($a = [self.$_parse_origin(voice_element)]), $b = result, $b['$origin='].apply($b, $a), $a[$a.length-1]);
          (($a = [self.$charpos_to_line_column(start_pos)]), $b = result, $b['$start_pos='].apply($b, $a), $a[$a.length-1]);
          (($a = [self.$charpos_to_line_column(end_pos)]), $b = result, $b['$end_pos='].apply($b, $a), $a[$a.length-1]);
          (($a = [tuplet]), $b = result, $b['$tuplet='].apply($b, $a), $a[$a.length-1]);
          (($a = [tuplet_start]), $b = result, $b['$tuplet_start='].apply($b, $a), $a[$a.length-1]);
          (($a = [tuplet_end]), $b = result, $b['$tuplet_end='].apply($b, $a), $a[$a.length-1]);
          if ((($a = voice_element['$[]']("invisible")) !== nil && (!$a.$$is_boolean || $a == true))) {
            (($a = [false]), $b = result, $b['$visible='].apply($b, $a), $a[$a.length-1])};
          if ((($a = self.repetition_stack['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.repetition_stack['$<<'](result)};
          result = [result];
          if ((($a = self.next_note_marks['$[]']("measure")) !== nil && (!$a.$$is_boolean || $a == true))) {
            result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('MeasureStart')).$new(result.$first()));
            self.next_note_marks['$[]=']("measure", false);};
          self.$_make_repeats_jumps_annotations(result, voice_element);
          return result;
        };

        def.$_transform_yspace = function(voice_element, index) {
          var self = this;

          return nil;
        };

        def.$_transform_bar_repeat_end = function(bar) {
          var $a, $b, TMP_16, self = this, start = nil, distance = nil;
          ...
          distance = 2;
          ($a = ($b = self.$_extract_chord_lines(bar)).$each, $a.$$p = (TMP_16 = function(line){var self = TMP_16.$$s || this, $a, level = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (line == null) line = nil;
          level = line.$split("@");
            if ((($a = level['$[]'](2)) !== nil && (!$a.$$is_boolean || $a == true))) {
              level = level['$[]'](2);
              $gvars.log.$debug("bar repeat level " + (level) + " " + ("abc2svg_to_harpnotes") + ":" + (360));
              if ((($a = level['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                return nil
                } else {
                return distance = level.$to_i()
        ...
        def.$_transform_format = function(voice_element) {
          var self = this;

          return nil;
        };

        def.$_transform_meter = function(voice_element) {
          var self = this;

          return nil;
        };

        def.$_transform_clef = function(voice_element) {
          var self = this;

          return nil;
        };

        def.$_make_jumplines = function(element) {
          var $a, $b, TMP_17, $c, $d, TMP_18, self = this, chords = nil;

          if ((($a = element['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))) !== nil && (!$a.$$is_boolean || $a == true))) {
            chords = self.$_extract_chord_lines(element.$origin()['$[]']("raw"));
            return ($a = ($b = ($c = ($d = chords).$select, $c.$$p = (TMP_18 = function(c){var self = TMP_18.$$s || this;
if (c == null) c = nil;
            return c['$[]'](0)['$==']("@")}, TMP_18.$$s = self, TMP_18), $c).call($d)).$inject, $a.$$p = (TMP_17 = function(result, chord){var self = TMP_17.$$s || this, $a, nameparts = nil, targetname = nil, target = nil, argument = nil;
              if (self.jumptargets == null) self.jumptargets = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (result == null) result = nil;if (chord == null) chord = nil;
            nameparts = chord.$split("@");
              targetname = nameparts['$[]'](1);
              target = self.jumptargets['$[]'](targetname);
              argument = ((($a = nameparts['$[]'](2)) !== false && $a !== nil) ? $a : 1);
              argument = argument.$to_i();
              if ((($a = target['$nil?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
                $gvars.log.$error("target '" + (targetname) + "' not found in voice at " + (element.$start_pos_to_s()), element.$start_pos(), element.$end_pos())
                } else {
                result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Goto')).$new(element, target, $hash2(["distance"], {"distance": argument})))
              };
        ...
        def.$_make_notebound_annotations = function(entity) {
          var $a, $b, TMP_19, self = this, result = nil, chords = nil;

          result = [];
          if ((($a = entity['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))) !== nil && (!$a.$$is_boolean || $a == true))) {
            chords = self.$_extract_chord_lines(entity.$origin()['$[]']("raw"));
            ($a = ($b = chords).$each, $a.$$p = (TMP_19 = function(name){var self = TMP_19.$$s || this, $a, $b, TMP_20, $c, match = nil, semantic = nil, text = nil, pos_x = nil, pos_y = nil, $case = nil, annotation = nil, notepos = nil, position = nil;
              if (self.annotations == null) self.annotations = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (name == null) name = nil;
            match = name.$match(/^([!#\<\>])([^\@]+)?(\@(\-?[0-9\.]+),(\-?[0-9\.]+))?$/);
              if (match !== false && match !== nil) {
                ...
                if (annotation !== false && annotation !== nil) {
                  ...
                  $gvars.log.$error("could not find annotation " + (text), entity.$start_pos(), entity.$end_pos())
                };}else if ("!"['$===']($case)) {annotation = $hash2(["text"], {"text": text})}else if ("<"['$===']($case)) {(($a = [$hash2(["dir", "size"], {"dir": "left", "size": text})]), $b = entity, $b['$shift='].apply($b, $a), $a[$a.length-1])}else if (">"['$===']($case)) {(($a = [$hash2(["dir", "size"], {"dir": "right", "size": text})]), $b = entity, $b['$shift='].apply($b, $a), $a[$a.length-1])}else {annotation = nil};
                if (annotation !== false && annotation !== nil) {
                  if (pos_x !== false && pos_x !== nil) {
                    notepos = ($a = ($b = [pos_x, pos_y]).$map, $a.$$p = (TMP_20 = function(p){var self = TMP_20.$$s || this;
if (p == null) p = nil;
                    return p.$to_f()}, TMP_20.$$s = self, TMP_20), $a).call($b)};
                  position = ((($a = ((($c = notepos) !== false && $c !== nil) ? $c : annotation['$[]']("pos"))) !== false && $a !== nil) ? $a : [2, -5]);
                  return result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('NoteBoundAnnotation')).$new(entity, $hash2(["pos", "text"], {"pos": position, "text": annotation['$[]']("text")})));
                  } else {
                  return nil
                ...
                return $gvars.log.$error("syntax error in annotation: " + (name))
              };}, TMP_19.$$s = self, TMP_19), $a).call($b);};
          return result;
        };

        def.$_make_repeats_jumps_annotations = function(result, voice_element) {
          var $a, $b, TMP_21, $c, $d, TMP_23, self = this, part_label = nil, part = nil, chords = nil;

          self.previous_note = result.$first();
          if ((($a = part_label = self.part_table['$[]'](voice_element['$[]']("time").$to_s())) !== nil && (!$a.$$is_boolean || $a == true))) {
            part = (((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('NewPart')).$new(part_label);
            (($a = [self.$_parse_origin(voice_element)]), $b = part, $b['$origin='].apply($b, $a), $a[$a.length-1]);
            (($a = [result.$first()]), $b = part, $b['$companion='].apply($b, $a), $a[$a.length-1]);
            (($a = [true]), $b = result.$first(), $b['$first_in_part='].apply($b, $a), $a[$a.length-1]);
            result['$<<'](part);};
          if ((($a = self.next_note_marks['$[]']("repeat_start")) !== nil && (!$a.$$is_boolean || $a == true))) {
            self.repetition_stack['$<<'](result.$first());
            self.next_note_marks['$[]=']("repeat_start", false);};
          if ((($a = self.next_note_marks['$[]']("variant_ending")) !== nil && (!$a.$$is_boolean || $a == true))) {
            result['$<<']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('NoteBoundAnnotation')).$new(result.$first(), $hash2(["pos", "text"], {"pos": [4, -2], "text": self.next_note_marks['$[]']("variant_ending")})));
            self.next_note_marks['$[]=']("variant_ending", nil);};
          chords = self.$_extract_chord_lines(voice_element);
          return ($a = ($b = ($c = ($d = chords).$select, $c.$$p = (TMP_23 = function(chord){var self = TMP_23.$$s || this;
if (chord == null) chord = nil;
          return chord['$[]'](0)['$=='](":")}, TMP_23.$$s = self, TMP_23), $c).call($d)).$each, $a.$$p = (TMP_21 = function(name){var self = TMP_21.$$s || this, $a, $b, TMP_22;
            if (self.jumptargets == null) self.jumptargets = nil;
if (name == null) name = nil;
          return self.jumptargets['$[]='](name['$[]']($range(1, -1, false)), ($a = ($b = result).$select, $a.$$p = (TMP_22 = function(n){var self = TMP_22.$$s || this;
if (n == null) n = nil;
            return n['$is_a?']((((($scope.get('Harpnotes')).$$scope.get('Music'))).$$scope.get('Playable')))}, TMP_22.$$s = self, TMP_22), $a).call($b).$last())}, TMP_21.$$s = self, TMP_21), $a).call($b);
        };

        def.$_push_slur = function() {
          var self = this;

          return self.slurstack = $rb_plus(self.slurstack, 1);
        };

        def.$_pop_slur = function() {
          var self = this, result = nil;

          result = self.slurstack;
          self.slurstack = $rb_minus(self.slurstack, 1);
          if ($rb_lt(self.slurstack, 0)) {
            self.slurstack = 0};
          return result;
        };

        def.$_extract_chord_lines = function(voice_element) {
          var $a, $b, TMP_24, $c, $d, TMP_25, self = this, chords = nil, result = nil;

          chords = voice_element['$[]']("a_gch");
          if (chords !== false && chords !== nil) {
            result = ($a = ($b = ($c = ($d = chords).$select, $c.$$p = (TMP_25 = function(e){var self = TMP_25.$$s || this;
if (e == null) e = nil;
            return e['$[]=']("type", "^")}, TMP_25.$$s = self, TMP_25), $c).call($d)).$map, $a.$$p = (TMP_24 = function(e){var self = TMP_24.$$s || this;
if (e == null) e = nil;
            return e['$[]']("text")}, TMP_24.$$s = self, TMP_24), $a).call($b)
            } else {
            result = []
          };
          return result;
        ...
        def.$_parse_origin = function(voice_element) {
          var self = this;

          return $hash2(["startChar", "endChar", "raw"], {"startChar": voice_element['$[]']("istart"), "endChar": voice_element['$[]']("iend"), "raw": voice_element});
        };

        def.$_parse_slur = function(slurstart) {
          var $a, self = this, startvalue = nil, result = nil;

          startvalue = slurstart;
          result = [];
          while ($rb_gt(startvalue, 0)) {
          result.$push(startvalue['$&'](15));
          startvalue = startvalue['$>>'](4);};
          return result;
        };

        return (def.$_parse_tuplet_info = function(voice_element) {
          var $a, $b, self = this, tuplet_start = nil, tuplet = nil, tuplet_end = nil;

          if ((($a = voice_element['$[]']("in_tuplet")) !== nil && (!$a.$$is_boolean || $a == true))) {
            if ((($a = ($b = voice_element['$[]']("extra"), $b !== false && $b !== nil ?voice_element['$[]']("extra")['$[]'](15) : $b)) !== nil && (!$a.$$is_boolean || $a == true))) {
              self.tuplet_count = (voice_element['$[]']("extra")['$[]'](15)['$[]']("tuplet_p"));
              self.tuplet_down_count = self.tuplet_count;
              tuplet_start = true;
              } else {
              tuplet_start = nil
            };
            tuplet = self.tuplet_count;
            if (self.tuplet_down_count['$=='](1)) {
              self.tuplet_count = 1;
              tuplet_end = true;
              } else {
              self.tuplet_down_count = $rb_minus(self.tuplet_down_count, 1);
              tuplet_end = nil;
            };
            } else {
            tuplet = 1;
...
Opal.modules["opal-jspdf"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$attr_accessor', '$apply_offset_to_point', '$[]', '$nil?', '$apply_offset_to_x', '$map', '$==', '$private', '$first', '$last']);
  self.$require("native");
...
jsPDF.API.setLineDash = function(dashArray, dashPhase) {
  ...
  return (function($base, $super) {
    ...
    def.$ellipse = function(center, radii, style) {
    ...
    def.$rect_like_ellipse = function(center, radii, style) {
      var $a, $b, TMP_1, self = this, ncenter = nil, rsize = nil;

      if (style == null) {
        style = "undefined"
      }
      ncenter = self.$apply_offset_to_point(center);
      rsize = ($a = ($b = radii).$map, $a.$$p = (TMP_1 = function(s){var self = TMP_1.$$s || this;
if (s == null) s = nil;
      return $rb_times(2.0, s)}, TMP_1.$$s = self, TMP_1), $a).call($b);
...
if (e == null) e = nil;
      ...
      def.$draw_glyph = function(root) {
        ...
        e['$[]=']("fill", "black");
        self.$push_element(root.$origin(), e);
        ($a = ($b = e).$on_click, $a.$$p = (TMP_12 = function(){var self = TMP_12.$$s || this, $a, $b, origin = nil;
          if (self.on_select == null) self.on_select = nil;
        ...
        if ((($a = root['$dotted?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          e_dot['$[]=']("fill", "black");
          self.$push_element(root.$origin(), e_dot);
          return ($a = ($c = e_dot).$on_click, $a.$$p = (TMP_13 = function(){var self = TMP_13.$$s || this, $a, $b, origin = nil;
            if (self.on_select == null) self.on_select = nil;
      ...
      def.$draw_annotation = function(root) {
        ...
        $gvars.log.$debug("" + (root.$center().$first()) + ", " + (root.$center().$last()) + " ”" + (text) + "” " + (bbox['$[]']("width")) + ", " + (bbox['$[]']("height")) + " (" + ("raphael_engine") + " " + (275) + ")");
...
Opal.modules["pdf_engine"] = function(Opal) {
  ...
  Opal.add_stubs(['$require', '$include', '$attr_reader', '$new', '$x_offset=', '$each', '$draw_segment', '$rect', '$draw_cutmarks', '$line_width=', '$line_width', '$is_a?', '$visible?', '$draw_ellipse', '$draw_flowline', '$draw_glyph', '$draw_path', '$draw_annotation', '$debug', '$class', '$children', '$private', '$[]', '$get', '$style', '$text_color=', '$font_size=', '$font_style=', '$text', '$first', '$center', '$last', '$Vector2d', '$line', '$to_a', '$-@', '$filled?', '$fill=', '$map', '$rect?', '$rect_like_ellipse', '$size', '$ellipse', '$dotted?', '$zip', '$stroke=', '$glyph', '$===', '$empty?', '$lines', '$push', '$error', '$addPage', '$draw', '$dashed?', '$line_dash=', '$from', '$to', '$use_solid_lines', '$clone', '$[]=', '$distance', '$nil?', '$level', '$left_arrowhead', '$path']);
...
if (child == null) child = nil;
      ...
      def.$draw_ellipse = function(root) {
        ...
        if ((($a = root['$rect?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          self.pdf.$rect_like_ellipse(root.$center(), root.$size(), style)
          } else {
...
if (s == null) s = nil;
          $a = Opal.to_ary(s), a = ($a[0] == null ? nil : $a[0]), b = ($a[1] == null ? nil : $a[1]);
            return $rb_plus($rb_plus(a, b), 0.7);}, TMP_7.$$s = self, TMP_7), $a).call($b), [$scope.get('DOTTED_SIZE'), $scope.get('DOTTED_SIZE')], "F");
          } else {
          return nil
        };
      };
      ...
      def.$draw_glyph = function(root) {
        var $a, $b, $c, $d, TMP_8, TMP_9, $e, $f, TMP_10, TMP_11, $g, $h, TMP_12, TMP_13, self = this, style = nil, center = nil, background_size = nil, scalefactor = nil, scale = nil, lines = nil, start = nil;
        ...
        background_size = ($a = ($b = root.$size()).$map, $a.$$p = (TMP_9 = function(s){var self = TMP_9.$$s || this;
if (s == null) s = nil;
        ...
        scalefactor = $rb_divide(background_size.$last(), root.$glyph()['$[]']("h"));
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return lines = [];}else {return $gvars.log.$error("BUG: unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (152) + ")")}})()}, TMP_11.$$s = self, TMP_11), $a).call($c);
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          return lines = [];}else {return $gvars.log.$error("BUG: unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (247) + ")")}})()}, TMP_16.$$s = self, TMP_16), $a).call($b);
...
Opal.modules["controller"] = function(Opal) {
  ...
  Opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$clone', '$private', '$attr', '$html', '$find', '$new', '$load_from_loacalstorage', '$on_command', '$save_to_localstorage', '$handle_command', '$info', '$push', '$_init_conf', '$each', '$send', '$select', '$=~', '$methods', '$setup_ui', '$load_demo_tune', '$set_status', '$loglevel', '$render_previews', '$setup_nodewebkit', '$setup_ui_listener', '$run_string', '$error', '$message', '$caller', '$include?', '$get_text', '$Native', '$nil?', '$set_text', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$==', '$play_song', '$play_selection', '$play_from_selection', '$setup_tune_preview', '$get_abc_part', '$join', '$backtrace', '$debug', '$set_inactive', '$set_annotations', '$annotations', '$now', '$load_song', '$send_remote_command', '$set_active', '$render_tunepreview_callback', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$clear_annotations', '$get_config_part', '$get_config_position', '$last', '$first', '$count', '$split', '$keys', '$get', '$transform', '$create_engine', '$layout', '$pop', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$merge!', '$inject', '$to_s', '$loglevel=', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$width', '$on', '$play_abc', '$set_file_drop', '$on_change', '$request_refresh', '$on_selection_change', '$get_selection_positions', '$on_cursor_change', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$key', '$newValue', '$prevent', '$css', '$page_x', '$===', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
...
if (cmd == null) cmd = nil;
      ...
      self.dropped_abc = "T: notihing droped yet";
      ...
      self.abc_transformer = (((($scope.get('Harpnotes')).$$scope.get('Input'))).$$scope.get('AbcjsToHarpnotes')).$new();
...
if (m == null) m = nil;
    ...
    def.$handle_command = function(command) {
      ...
      return self.commands.$run_string(command)
        ...
        return $gvars.log.$error("" + (e.$message()) + " in " + (command) + " " + (e.$caller()) + " " + ("controller") + ":" + (135))
        }else { throw $err; }
      };
    };
...
if (key == null) key = nil;if (_ == null) _ = nil;
    ...
    def.$render_tunepreview_callback = function() {
      ...
      $gvars.log.$debug("finished render tune " + ("controller") + " " + (261));
    ...
    def.$render_harpnotepreview_callback = function() {
      var self = this, s = nil, e = nil;
      if ($gvars.log == null) $gvars.log = nil;

      s = $scope.get('Time').$now();
      try {
      $gvars.log.$debug("viewid: " + (self.systemstatus['$[]']("view")) + " " + ("controller") + " " + (274));
      ...
      $gvars.log.$debug("finished rendering Haprnotes inn " + ($rb_minus($scope.get('Time').$now(), s)) + " seconds " + ("controller") + " " + (285));
    ...
    def.$layout_harpnotes = function(print_variant) {
      var $a, $b, self = this, config_part = nil, config = nil, error = nil, line_col = nil, outdated_configs = nil, abc_parser = nil, start = nil, result = nil;
      if ($gvars.log == null) $gvars.log = nil;
      if ($gvars.conf == null) $gvars.conf = nil;
      ...
      self.music_model = (((($scope.get('Harpnotes')).$$scope.get('Input'))).$$scope.get('ABCToHarpnotesFactory')).$create_engine(abc_parser).$transform(self.editor.$get_abc_part());
      $gvars.log.$info("duration transform " + ($rb_minus($scope.get('Time').$now(), start)));
      result = (((($scope.get('Harpnotes')).$$scope.get('Layout'))).$$scope.get('Default')).$new().$layout(self.music_model, nil, print_variant);
      $gvars.log.$info("duration transform + layout " + ($rb_minus($scope.get('Time').$now(), start)));
      if ($gvars.log.$loglevel()['$==']("debug")) {
        $gvars.log.$debug(self.music_model.$to_json())};
      self.editor.$set_annotations($gvars.log.$annotations());
      $gvars.conf.$pop();
      return result;
    };
    ...
    def.$highlight_abc_object = function(abcelement) {
      ...
      $gvars.log.$debug("select_abc_element " + (a['$[]']("startChar")) + " (" + ("controller") + " " + (368) + ")");
...
if (r == null) r = nil;if (v == null) v = nil;
      ...
      $gvars.log.$debug("" + (self.systemstatus.$to_s()) + " " + ("controller") + " " + (409));
...
if (harpnote == null) harpnote = nil;
    ...
    def.$setup_tune_preview = function() {
      ...
      $gvars.log.$debug("tune preview-width " + (width) + " " + ("controller") + ":" + (431));
...
if (abcelement == null) abcelement = nil;
    ...
    def.$set_file_drop = function(dropzone) {
      var self = this;
      if ($gvars.log == null) $gvars.log = nil;
    ...
    function pasteXml(text){
                          ...
                          $gvars.log.$info(result[1])
      self.dropped_abc = result[0]
      self.$handle_command("drop")
    }
...
if (e == null) e = nil;
      a = self.editor.$get_selection_positions();
        $gvars.log.$debug("editor selecton " + (a.$first()) + " to " + (a.$last()) + " (" + ("controller") + ":" + (544) + ")");
...
if (e == null) e = nil;
      ...
      ($a = ($i = self.harpnote_player).$on_noteon, $a.$$p = (TMP_15 = function(e){var self = TMP_15.$$s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteon " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (559) + ")");
      ...
      ($a = ($j = self.harpnote_player).$on_noteoff, $a.$$p = (TMP_16 = function(e){var self = TMP_16.$$s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteoff " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (564) + ")");
...
if (evt == null) evt = nil;
      key = self.$Native(evt['$[]']("originalEvent")).$key();
        ...
        $gvars.log.$debug("got storage event " + (key) + ": " + (value) + " (" + ("controller") + " " + (592) + ")");
...
if (e == null) e = nil;
    ...
    def.$request_refresh = function(init) {
      ...
      $gvars.log.$debug("request refresh " + (self.systemstatus['$[]']("refresh")) + " " + (init) + " " + ("controller") + " " + (616));
    ...
    return (def.$_init_conf = function() {
      ...
      result = $hash2(["produce", "abc_parser", "defaults", "annotations", "extract", "layout"], {"produce": [0], "abc_parser": "ABC2SVG", "defaults": $hash2(["note_length", "print", "legend", "lyrics", "annotation"], {"note_length": "1/4", "print": $hash2(["t", "v", "startpos", "s", "f", "sf", "j", "l"], {"t": "", "v": [1, 2, 3, 4], "startpos": 15, "s": [[1, 2], [2, 3]], "f": [1, 3], "sf": [2, 4], "j": [1, 3], "l": [1, 2, 3, 4]}), "legend": $hash2(["pos"], {"pos": [20, 20]}), "lyrics": $hash2(["pos"], {"pos": [20, 60]}), "annotation": $hash2(["pos"], {"pos": [2, -5]})}), "annotations": $hash2(["vt", "vr", "vl"], {"vt": $hash2(["text", "pos"], {"text": "v", "pos": [-1, -6]}), "vr": $hash2(["text", "pos"], {"text": "v", "pos": [2, -3]}), "vl": $hash2(["text", "pos"], {"text": "v", "pos": [-4, -3]})}), "extract": $hash2(["0", "1", "2"], {"0": $hash2(["line_no", "title", "startpos", "voices", "synchlines", "flowlines", "subflowlines", "jumplines", "layoutlines", "legend", "lyrics", "notes"], {"line_no": 1, "title": "alle Stimmen", "startpos": 15, "voices": [1, 2, 3, 4], "synchlines": [[1, 2], [3, 4]], "flowlines": [1, 3], "subflowlines": [2, 4], "jumplines": [1, 3], "layoutlines": [1, 2, 3, 4], "legend": $hash2(["pos"], {"pos": [320, 20]}), "lyrics": $hash2(["pos"], {"pos": [320, 50]}), "notes": []}), "1": $hash2(["line_no", "title", "voices"], {"line_no": 2, "title": "Sopran, Alt", "voices": [1, 2]}), "2": $hash2(["line_no", "title", "voices"], {"line_no": 1, "title": "Tenor, Bass", "voices": [3, 4]})}), "layout": $hash2(["SHOW_SLUR", "LINE_THIN", "LINE_MEDIUM", "LINE_THICK", "ELLIPSE_SIZE", "REST_SIZE", "X_SPACING", "X_OFFSET", "Y_SCALE", "DRAWING_AREA_SIZE", "BEAT_RESOLUTION", "SHORTEST_NOTE", "BEAT_PER_DURATION", "PITCH_OFFSET", "FONT_STYLE_DEF", "MM_PER_POINT", "DURATION_TO_STYLE", "REST_TO_GLYPH"], {"SHOW_SLUR": false, "LINE_THIN": 0.1, "LINE_MEDIUM": 0.3, "LINE_THICK": 0.5, "ELLIPSE_SIZE": [3.5, 1.7], "REST_SIZE": [4, 2], "X_SPACING": 11.5, "X_OFFSET": 2.8, "Y_SCALE": 4, "DRAWING_AREA_SIZE": [400, 282], "BEAT_RESOLUTION": 192, "SHORTEST_NOTE": 64, "BEAT_PER_DURATION": 3, "PITCH_OFFSET": -43, "FONT_STYLE_DEF": $hash2(["smaller", "small", "regular", "large"], {"smaller": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 6, "font_style": "normal"}), "small": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 9, "font_style": "normal"}), "regular": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 12, "font_style": "normal"}), "large": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 20, "font_style": "bold"})}), "MM_PER_POINT": 0.3, "DURATION_TO_STYLE": $hash2(["err", "d64", "d48", "d32", "d24", "d16", "d12", "d8", "d6", "d4", "d3", "d2", "d1"], {"err": [2, "filled", $scope.get('FALSE')], "d64": [1, "empty", $scope.get('FALSE')], "d48": [0.75, "empty", $scope.get('TRUE')], "d32": [0.75, "empty", $scope.get('FALSE')], "d24": [0.75, "filled", $scope.get('TRUE')], "d16": [0.75, "filled", $scope.get('FALSE')], "d12": [0.5, "filled", $scope.get('TRUE')], "d8": [0.5, "filled", $scope.get('FALSE')], "d6": [0.3, "filled", $scope.get('TRUE')], "d4": [0.3, "filled", $scope.get('FALSE')], "d3": [0.1, "filled", $scope.get('TRUE')], "d2": [0.1, "filled", $scope.get('FALSE')], "d1": [0.05, "filled", $scope.get('FALSE')]}), "REST_TO_GLYPH": $hash2(["err", "d64", "d48", "d32", "d24", "d16", "d12", "d8", "d6", "d4", "d3", "d2", "d1"], {"err": [[2, 2], "rest_1", $scope.get('FALSE')], "d64": [[1, 1], "rest_1", $scope.get('FALSE')], "d48": [[0.5, 0.5], "rest_1", $scope.get('TRUE')], "d32": [[0.5, 0.5], "rest_1", $scope.get('FALSE')], "d24": [[0.4, 1], "rest_4", $scope.get('TRUE')], "d16": [[0.4, 1], "rest_4", $scope.get('FALSE')], "d12": [[0.4, 1], "rest_8", $scope.get('TRUE')], "d8": [[0.4, 1], "rest_8", $scope.get('FALSE')], "d6": [[0.4, 1], "rest_16", $scope.get('TRUE')], "d4": [[0.3, 1], "rest_16", $scope.get('FALSE')], "d3": [[0.3, 0.5], "rest_32", $scope.get('TRUE')], "d2": [[0.3, 0.5], "rest_32", $scope.get('FALSE')], "d1": [[0.3, 0.5], "rest_64", $scope.get('FALSE')]})})});
      return result;
    }, nil) && '_init_conf';
  })(self, null);
...
Opal.modules["controller-nw"] = function(Opal) {
  ...
  Opal.add_stubs(['$info', '$gsub', '$handle_command', '$set_status', '$[]', '$render_previews', '$__ic_06_node_fs_commands', '$debug', '$message', '$join', '$backtrace', '$private', '$add_command', '$add_parameter', '$set_default', '$undoable=', '$set_help', '$parameter_help', '$as_action', '$get_text', '$get_metadata', '$first', '$split', '$raise', '$layout_harpnotes', '$harpnote_options', '$map', '$[]=', '$output', '$render_a3', '$render_a4', '$each_with_index', '$each', '$match', '$set_text', '$error', '$as_inverse']);
  return (function($base, $super) {
    function $Controller(){};
    var self = $Controller = $klass($base, $super, 'Controller', $Controller);
...
if (a == null) a = nil;
    ...
    def.$__ic_03_create_commands = function() {
      var $a, $b, TMP_52, $c, TMP_61, $d, TMP_65, self = this;

      ($a = ($b = self.commands).$add_command, $a.$$p = (TMP_52 = function(c){var self = TMP_52.$$s || this, $a, $b, TMP_53, $c, TMP_54, $d, TMP_56, $e, TMP_59, $f, TMP_60;
if (c == null) c = nil;
...
if (args == null) args = nil;
      ...
      ($a = ($c = self.commands).$add_command, $a.$$p = (TMP_61 = function(command){var self = TMP_61.$$s || this, $a, $b, TMP_62, $c, TMP_63, $d, TMP_64;
if (command == null) command = nil;
      ($a = ($b = command).$set_help, $a.$$p = (TMP_62 = function(){var self = TMP_62.$$s || this;

        return "Load demo tune"}, TMP_62.$$s = self, TMP_62), $a).call($b);
        ($a = ($c = command).$as_action, $a.$$p = (TMP_63 = function(args){var self = TMP_63.$$s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        args['$[]=']("oldval", self.editor.$get_text());
        ...
        return ($a = ($d = command).$as_inverse, $a.$$p = (TMP_64 = function(args){var self = TMP_64.$$s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_64.$$s = self, TMP_64), $a).call($d);}, TMP_61.$$s = self, TMP_61), $a).call($c, "demo");
      return ($a = ($d = self.commands).$add_command, $a.$$p = (TMP_65 = function(command){var self = TMP_65.$$s || this, $a, $b, TMP_66, $c, TMP_67, $d, TMP_68;
if (command == null) command = nil;
      ($a = ($b = command).$set_help, $a.$$p = (TMP_66 = function(){var self = TMP_66.$$s || this;

        return "Load demo tune"}, TMP_66.$$s = self, TMP_66), $a).call($b);
        ($a = ($c = command).$as_action, $a.$$p = (TMP_67 = function(args){var self = TMP_67.$$s || this;
          if (self.editor == null) self.editor = nil;
...
if (args == null) args = nil;
        ...
        return ($a = ($d = command).$as_inverse, $a.$$p = (TMP_68 = function(args){var self = TMP_68.$$s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_68.$$s = self, TMP_68), $a).call($d);}, TMP_65.$$s = self, TMP_65), $a).call($d, "drop");
    };

    def.$__ic_04_localstore_commands = function() {
      var $a, $b, TMP_69, $c, TMP_72, $d, TMP_76, self = this;

      ($a = ($b = self.commands).$add_command, $a.$$p = (TMP_69 = function(c){var self = TMP_69.$$s || this, $a, $b, TMP_70, $c, TMP_71;
if (c == null) c = nil;
      (($a = [false]), $b = c, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = c).$set_help, $a.$$p = (TMP_70 = function(){var self = TMP_70.$$s || this;

        return "save to localstore"}, TMP_70.$$s = self, TMP_70), $a).call($b);
        return ($a = ($c = c).$as_action, $a.$$p = (TMP_71 = function(){var self = TMP_71.$$s || this, abc_code = nil, metadata = nil, filename = nil;
          if (self.editor == null) self.editor = nil;
          if (self.abc_transformer == null) self.abc_transformer = nil;
        ...
        abc_code = self.editor.$get_text();
          ...
          return $gvars.log.$message("saved to '" + (filename) + "'");}, TMP_71.$$s = self, TMP_71), $a).call($c);}, TMP_69.$$s = self, TMP_69), $a).call($b, "lsave");
      ($a = ($c = self.commands).$add_command, $a.$$p = (TMP_72 = function(c){var self = TMP_72.$$s || this, $a, $b, TMP_73, $c, TMP_74;
if (c == null) c = nil;
      (($a = [false]), $b = c, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = c).$set_help, $a.$$p = (TMP_73 = function(){var self = TMP_73.$$s || this;

        return "list files in localstore"}, TMP_73.$$s = self, TMP_73), $a).call($b);
        return ($a = ($c = c).$as_action, $a.$$p = (TMP_74 = function(a){var self = TMP_74.$$s || this, $a, $b, TMP_75;
          if (self.songbook == null) self.songbook = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        return $gvars.log.$message($rb_plus($rb_plus("<pre>", ($a = ($b = self.songbook.$list()).$map, $a.$$p = (TMP_75 = function(k, v){var self = TMP_75.$$s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return "" + (k) + "_" + (v)}, TMP_75.$$s = self, TMP_75), $a).call($b).$join("\n")), "</pre>"))}, TMP_74.$$s = self, TMP_74), $a).call($c);}, TMP_72.$$s = self, TMP_72), $a).call($c, "lls");
      return ($a = ($d = self.commands).$add_command, $a.$$p = (TMP_76 = function(c){var self = TMP_76.$$s || this, $a, $b, TMP_77, $c, TMP_79, $d, TMP_80, $e, TMP_81;
if (c == null) c = nil;
      (($a = [true]), $b = c, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = c).$add_parameter, $a.$$p = (TMP_77 = function(parameter){var self = TMP_77.$$s || this, $a, $b, TMP_78;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_help, $a.$$p = (TMP_78 = function(){var self = TMP_78.$$s || this;

          return "id of the song to be loaded"}, TMP_78.$$s = self, TMP_78), $a).call($b)}, TMP_77.$$s = self, TMP_77), $a).call($b, "id", "string");
        ($a = ($c = c).$set_help, $a.$$p = (TMP_79 = function(){var self = TMP_79.$$s || this;

        return "open song from local store  " + (c.$parameter_help(0))}, TMP_79.$$s = self, TMP_79), $a).call($c);
        ($a = ($d = c).$as_action, $a.$$p = (TMP_80 = function(args){var self = TMP_80.$$s || this, $a, payload = nil;
          if (self.songbook == null) self.songbook = nil;
          if (self.editor == null) self.editor = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        if ((($a = args['$[]']("id")) !== nil && (!$a.$$is_boolean || $a == true))) {
          ...
          }}, TMP_80.$$s = self, TMP_80), $a).call($d);
        return ($a = ($e = c).$as_inverse, $a.$$p = (TMP_81 = function(args){var self = TMP_81.$$s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_81.$$s = self, TMP_81), $a).call($e);}, TMP_76.$$s = self, TMP_76), $a).call($d, "lopen");
    };

    return (def.$__ic_05_dropbox_commands = function() {
      var $a, $b, TMP_82, $c, TMP_93, $d, TMP_102, $e, TMP_109, $f, TMP_112, $g, TMP_123, self = this;

      ($a = ($b = self.commands).$add_command, $a.$$p = (TMP_82 = function(command){var self = TMP_82.$$s || this, $a, $b, TMP_83, $c, TMP_86, $d, TMP_89, $e, TMP_90, $f, TMP_92;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a.$$p = (TMP_83 = function(parameter){var self = TMP_83.$$s || this, $a, $b, TMP_84, $c, TMP_85;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a.$$p = (TMP_84 = function(){var self = TMP_84.$$s || this;

          return "app"}, TMP_84.$$s = self, TMP_84), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a.$$p = (TMP_85 = function(){var self = TMP_85.$$s || this;

          return "(app | full) app: app only | full: full dropbox"}, TMP_85.$$s = self, TMP_85), $a).call($c);}, TMP_83.$$s = self, TMP_83), $a).call($b, "scope", "string");
        ($a = ($c = command).$add_parameter, $a.$$p = (TMP_86 = function(parameter){var self = TMP_86.$$s || this, $a, $b, TMP_87, $c, TMP_88;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a.$$p = (TMP_87 = function(){var self = TMP_87.$$s || this;

          return "/"}, TMP_87.$$s = self, TMP_87), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a.$$p = (TMP_88 = function(){var self = TMP_88.$$s || this;

          return "path to set in dropbox"}, TMP_88.$$s = self, TMP_88), $a).call($c);}, TMP_86.$$s = self, TMP_86), $a).call($c, "path", "string");
        ($a = ($d = command).$set_help, $a.$$p = (TMP_89 = function(){var self = TMP_89.$$s || this;

        return "dropbox login for " + (command.$parameter_help(0))}, TMP_89.$$s = self, TMP_89), $a).call($d);
        ($a = ($e = command).$as_action, $a.$$p = (TMP_90 = function(args){var self = TMP_90.$$s || this, $a, $b, TMP_91, $case = nil;
...
if (args == null) args = nil;
        $case = args['$[]']("scope");if ("full"['$===']($case)) {self.dropboxclient = (((($scope.get('Opal')).$$scope.get('DropboxJs'))).$$scope.get('Client')).$new("us2s6tq6bubk6xh");
          ...
          return ($a = ($b = self.dropboxclient.$authenticate()).$then, $a.$$p = (TMP_91 = function(){var self = TMP_91.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
            return $gvars.log.$message("logged in at dropbox with " + (args['$[]']("scope")) + " access");}, TMP_91.$$s = self, TMP_91), $a).call($b);}, TMP_90.$$s = self, TMP_90), $a).call($e);
        return ($a = ($f = command).$as_inverse, $a.$$p = (TMP_92 = function(args){var self = TMP_92.$$s || this;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.$set_status($hash2(["dropbox"], {"dropbox": "logged out"}));
          $gvars.log.$message("logged out from dropbox");
          return self.dropboxclient = nil;}, TMP_92.$$s = self, TMP_92), $a).call($f);}, TMP_82.$$s = self, TMP_82), $a).call($b, "dlogin");
      ($a = ($c = self.commands).$add_command, $a.$$p = (TMP_93 = function(command){var self = TMP_93.$$s || this, $a, $b, TMP_94, $c, TMP_97, $d, TMP_98;
if (command == null) command = nil;
      (($a = [false]), $b = command, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = command).$add_parameter, $a.$$p = (TMP_94 = function(parameter){var self = TMP_94.$$s || this, $a, $b, TMP_95, $c, TMP_96;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a.$$p = (TMP_95 = function(){var self = TMP_95.$$s || this, $a;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return ((($a = self.dropboxpath) !== false && $a !== nil) ? $a : "/")}, TMP_95.$$s = self, TMP_95), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a.$$p = (TMP_96 = function(){var self = TMP_96.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path in dropbox " + (self.dropboxclient.$app_name())}, TMP_96.$$s = self, TMP_96), $a).call($c);}, TMP_94.$$s = self, TMP_94), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a.$$p = (TMP_97 = function(){var self = TMP_97.$$s || this;

        return "list files in " + (command.$parameter_help(0))}, TMP_97.$$s = self, TMP_97), $a).call($c);
        return ($a = ($d = command).$as_action, $a.$$p = (TMP_98 = function(args){var self = TMP_98.$$s || this, $a, $b, TMP_99, $c, $d, TMP_101, rootpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          $gvars.log.$message("" + (self.dropboxclient.$app_name()) + ": " + (args['$[]']("path")) + ":");
          return ($a = ($b = ($c = ($d = self.dropboxclient.$authenticate()).$then, $c.$$p = (TMP_101 = function(){var self = TMP_101.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return self.dropboxclient.$read_dir(rootpath)}, TMP_101.$$s = self, TMP_101), $c).call($d)).$then, $a.$$p = (TMP_99 = function(entries){var self = TMP_99.$$s || this, $a, $b, TMP_100;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          return $gvars.log.$message($rb_plus($rb_plus("<pre>", ($a = ($b = entries).$select, $a.$$p = (TMP_100 = function(entry){var self = TMP_100.$$s || this;
if (entry == null) entry = nil;
            return entry['$=~'](/\.abc$/)}, TMP_100.$$s = self, TMP_100), $a).call($b).$join("\n").$to_s()), "</pre>"))}, TMP_99.$$s = self, TMP_99), $a).call($b);}, TMP_98.$$s = self, TMP_98), $a).call($d);}, TMP_93.$$s = self, TMP_93), $a).call($c, "dls");
      ($a = ($d = self.commands).$add_command, $a.$$p = (TMP_102 = function(command){var self = TMP_102.$$s || this, $a, $b, TMP_103, $c, TMP_106, $d, TMP_107, $e, TMP_108;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a.$$p = (TMP_103 = function(parameter){var self = TMP_103.$$s || this, $a, $b, TMP_104, $c, TMP_105;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a.$$p = (TMP_104 = function(){var self = TMP_104.$$s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_104.$$s = self, TMP_104), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a.$$p = (TMP_105 = function(){var self = TMP_105.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path in dropbox " + (self.dropboxclient.$app_name())}, TMP_105.$$s = self, TMP_105), $a).call($c);}, TMP_103.$$s = self, TMP_103), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a.$$p = (TMP_106 = function(){var self = TMP_106.$$s || this;

        return "dropbox change dir to " + (command.$parameter_help(0))}, TMP_106.$$s = self, TMP_106), $a).call($c);
        ($a = ($d = command).$as_action, $a.$$p = (TMP_107 = function(args){var self = TMP_107.$$s || this, rootpath = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$message("dropbox path changed to " + (self.dropboxpath));}, TMP_107.$$s = self, TMP_107), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a.$$p = (TMP_108 = function(args){var self = TMP_108.$$s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.dropboxpath = args['$[]']("oldval");
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$message("dropbox path changed back to " + (self.dropboxpath));}, TMP_108.$$s = self, TMP_108), $a).call($e);}, TMP_102.$$s = self, TMP_102), $a).call($d, "dcd");
      ($a = ($e = self.commands).$add_command, $a.$$p = (TMP_109 = function(command){var self = TMP_109.$$s || this, $a, $b, TMP_110, $c, TMP_111;
if (command == null) command = nil;
      (($a = [false]), $b = command, $b['$undoable='].apply($b, $a), $a[$a.length-1]);
        ($a = ($b = command).$set_help, $a.$$p = (TMP_110 = function(){var self = TMP_110.$$s || this;

        return "show drobox path"}, TMP_110.$$s = self, TMP_110), $a).call($b);
        return ($a = ($c = command).$as_action, $a.$$p = (TMP_111 = function(args){var self = TMP_111.$$s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        return $gvars.log.$message("" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath))}, TMP_111.$$s = self, TMP_111), $a).call($c);}, TMP_109.$$s = self, TMP_109), $a).call($e, "dpwd");
      ($a = ($f = self.commands).$add_command, $a.$$p = (TMP_112 = function(command){var self = TMP_112.$$s || this, $a, $b, TMP_113, $c, TMP_116, $d, TMP_117;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a.$$p = (TMP_113 = function(parameter){var self = TMP_113.$$s || this, $a, $b, TMP_114, $c, TMP_115;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a.$$p = (TMP_114 = function(){var self = TMP_114.$$s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_114.$$s = self, TMP_114), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a.$$p = (TMP_115 = function(){var self = TMP_115.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_115.$$s = self, TMP_115), $a).call($c);}, TMP_113.$$s = self, TMP_113), $a).call($b, "path", "string");
        (($a = [false]), $c = command, $c['$undoable='].apply($c, $a), $a[$a.length-1]);
        ($a = ($c = command).$set_help, $a.$$p = (TMP_116 = function(){var self = TMP_116.$$s || this;

        return "save to dropbox {" + (command.$parameter_help(0)) + "}"}, TMP_116.$$s = self, TMP_116), $a).call($c);
        return ($a = ($d = command).$as_action, $a.$$p = (TMP_117 = function(args){var self = TMP_117.$$s || this, $a, $b, TMP_118, $c, TMP_121, $d, $e, TMP_122, $f, abc_code = nil, metadata = nil, filebase = nil, print_variants = nil, rootpath = nil, save_promises = nil;
          if (self.editor == null) self.editor = nil;
          if (self.abc_transformer == null) self.abc_transformer = nil;
          if (self.music_model == null) self.music_model = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
...
if (args == null) args = nil;
        abc_code = self.editor.$get_text();
          metadata = self.abc_transformer.$get_metadata(abc_code);
          filebase = metadata['$[]']("F").$first();
          $gvars.log.$debug("" + (metadata.$to_s()) + " (" + ("controller_command_definitions") + " " + (419) + ")");
          if (filebase !== false && filebase !== nil) {
            filebase = filebase.$split("\n").$first()
            } else {
            self.$raise("Filename not specified in song add an F: instruction")
          ...
          rootpath = args['$[]']("path");
          save_promises = [];
          ($a = ($b = self.dropboxclient.$authenticate()).$then, $a.$$p = (TMP_118 = function(){var self = TMP_118.$$s || this, $a, $b, TMP_119, $c, TMP_120, pdfs = nil;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if (self.editor == null) self.editor = nil;

          save_promises = [self.dropboxclient.$write_file("" + (rootpath) + (filebase) + ".abc", self.editor.$get_text())];
            pdfs = $hash2([], {});
            ($a = ($b = print_variants).$map, $a.$$p = (TMP_119 = function(print_variant){var self = TMP_119.$$s || this, index = nil, filename = nil;
if (print_variant == null) print_variant = nil;
            index = print_variant['$[]']("view_id");
              filename = print_variant['$[]']("title").$gsub(/[^a-zA-Z0-9\-\_]/, "_");
              pdfs['$[]=']("" + (rootpath) + (filebase) + "_" + (print_variant['$[]']("title")) + "_a3.pdf", self.$render_a3(index).$output("blob"));
              return pdfs['$[]=']("" + (rootpath) + (filebase) + "_" + (print_variant['$[]']("title")) + "_a4.pdf", self.$render_a4(index).$output("blob"));}, TMP_119.$$s = self, TMP_119), $a).call($b);
            return ($a = ($c = pdfs).$each, $a.$$p = (TMP_120 = function(name, pdfdata){var self = TMP_120.$$s || this;
              if (self.dropboxclient == null) self.dropboxclient = nil;
if (name == null) name = nil;if (pdfdata == null) pdfdata = nil;
            return save_promises.$push(self.dropboxclient.$write_file(name, pdfdata))}, TMP_120.$$s = self, TMP_120), $a).call($c);}, TMP_118.$$s = self, TMP_118), $a).call($b);
          return ($a = ($c = ($d = ($e = ($f = $scope.get('Promise')).$when.apply($f, [].concat(save_promises))).$then, $d.$$p = (TMP_122 = function(){var self = TMP_122.$$s || this;
            if ($gvars.log == null) $gvars.log = nil;

          self.$set_status($hash2(["music_model"], {"music_model": "saved to dropbox"}));
            return $gvars.log.$message("all files saved");}, TMP_122.$$s = self, TMP_122), $d).call($e)).$fail, $a.$$p = (TMP_121 = function(err){var self = TMP_121.$$s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("there was an error saving files " + (err))}, TMP_121.$$s = self, TMP_121), $a).call($c);}, TMP_117.$$s = self, TMP_117), $a).call($d);}, TMP_112.$$s = self, TMP_112), $a).call($f, "dsave");
      return ($a = ($g = self.commands).$add_command, $a.$$p = (TMP_123 = function(command){var self = TMP_123.$$s || this, $a, $b, TMP_124, $c, TMP_127, $d, TMP_128, $e, TMP_134;
if (command == null) command = nil;
      command.$add_parameter("fileid", "string", "file id");
        ($a = ($b = command).$add_parameter, $a.$$p = (TMP_124 = function(p){var self = TMP_124.$$s || this, $a, $b, TMP_125, $c, TMP_126;
if (p == null) p = nil;
        ($a = ($b = p).$set_default, $a.$$p = (TMP_125 = function(){var self = TMP_125.$$s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_125.$$s = self, TMP_125), $a).call($b);
          return ($a = ($c = p).$set_help, $a.$$p = (TMP_126 = function(){var self = TMP_126.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_126.$$s = self, TMP_126), $a).call($c);}, TMP_124.$$s = self, TMP_124), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a.$$p = (TMP_127 = function(){var self = TMP_127.$$s || this;

        return "read file with " + (command.$parameter_help(0)) + ", from dropbox " + (command.$parameter_help(1))}, TMP_127.$$s = self, TMP_127), $a).call($c);
        ($a = ($d = command).$as_action, $a.$$p = (TMP_128 = function(args){var self = TMP_128.$$s || this, $a, $b, TMP_129, $c, $d, TMP_130, $e, $f, TMP_131, $g, $h, TMP_133, fileid = nil, rootpath = nil;
          if (self.editor == null) self.editor = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        args['$[]=']("oldval", self.editor.$get_text());
          ...
          return ($a = ($b = ($c = ($d = ($e = ($f = ($g = ($h = self.dropboxclient.$authenticate()).$then, $g.$$p = (TMP_133 = function(error, data){var self = TMP_133.$$s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
if (error == null) error = nil;if (data == null) data = nil;
          return self.dropboxclient.$read_dir(rootpath)}, TMP_133.$$s = self, TMP_133), $g).call($h)).$then, $e.$$p = (TMP_131 = function(entries){var self = TMP_131.$$s || this, $a, $b, TMP_132;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          $gvars.log.$debug("" + (entries) + " (" + ("controller_command_definitions") + " " + (477) + ")");
            fileid = ($a = ($b = entries).$select, $a.$$p = (TMP_132 = function(entry){var self = TMP_132.$$s || this;
if (entry == null) entry = nil;
            return entry['$=~']((new RegExp("^" + fileid + "_.*\\.abc$")))}, TMP_132.$$s = self, TMP_132), $a).call($b).$first();
            return self.dropboxclient.$read_file("" + (rootpath) + (fileid));}, TMP_131.$$s = self, TMP_131), $e).call($f)).$then, $c.$$p = (TMP_130 = function(abc_text){var self = TMP_130.$$s || this, filebase = nil;
            if (self.abc_transformer == null) self.abc_transformer = nil;
            if (self.editor == null) self.editor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (abc_text == null) abc_text = nil;
          $gvars.log.$debug("loaded " + (fileid) + " (" + ("controller_command_definitions") + " " + (481) + ")");
            ...
            return self.$set_status($hash2(["music_model"], {"music_model": "loaded"}));}, TMP_130.$$s = self, TMP_130), $c).call($d)).$fail, $a.$$p = (TMP_129 = function(err){var self = TMP_129.$$s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("could not load file " + (err))}, TMP_129.$$s = self, TMP_129), $a).call($b);}, TMP_128.$$s = self, TMP_128), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a.$$p = (TMP_134 = function(args){var self = TMP_134.$$s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_134.$$s = self, TMP_134), $a).call($e);}, TMP_123.$$s = self, TMP_123), $a).call($g, "dopen");
...
Opal.modules["harpnote_player"] = function(Opal) {
  ...
  Opal.add_stubs(['$[]', '$debug', '$[]=', '$on', '$Native', '$call', '$to_s', '$first', '$select', '$error', '$play_notes', '$stop', '$empty?', '$warning', '$last', '$get', '$each', '$clone', '$to_n', '$create_inst', '$each_with_index', '$info', '$backtrace', '$nil?', '$class', '$===', '$push', '$sort', '$<=>', '$reduce', '$meta_data', '$compact', '$flatten', '$map', '$is_a?', '$mk_to_play', '$pitch', '$notes', '$tie_end?', '$==', '$tie_start?', '$voices', '$beat', '$-@', '$duration', '$origin']);
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
Opal.modules["confstack"] = function(Opal) {
  ...
  Opal.add_stubs(['$is_a?', '$push', '$_flatten', '$pop', '$nil?', '$_get_one', '$==', '$[]', '$_resolve_dependencies', '$each', '$call', '$keys', '$uniq', '$flatten', '$compact', '$map', '$_get_keys', '$private', '$inject', '$[]=', '$_get', '$_add_hash', '$split', '$empty?', '$first', '$last', '$join', '$<<', '$has_key?', '$include?', '$index', '$raise', '$class', '$_resolve_value_dependency', '$_resolve_hash_dependency', '$_resolve_array_dependency']);
  return (function($base, $super) {
    function $Confstack(){};
    ...
    def.confstack = def.confresult_flat = def.confresult_cache = def.callstack = nil;
    def.$initialize = function() {
      var self = this;
    ...
    def.$each = TMP_1 = function() {
      ...
      TMP_1.$$p = null;
      return ($a = ($b = self.$keys()).$each, $a.$$p = (TMP_2 = function(k){var self = TMP_2.$$s || this;
if (k == null) k = nil;
      return block.$call(k, self['$[]'](k))}, TMP_2.$$s = self, TMP_2), $a).call($b);
    };
...
if (s == null) s = nil;
      return self.$_get_keys(s)}, TMP_3.$$s = self, TMP_3), $a).call($b).$compact().$flatten().$uniq();
    };

    self.$private();

    def.$_resolve = function(key) {
      var self = this;
    ...
    def.$_flatten = function() {
      var $a, $b, TMP_4, self = this, the_keys = nil;

      the_keys = self.$keys();
      self.confresult_flat = ($a = ($b = the_keys).$inject, $a.$$p = (TMP_4 = function(result, element){var self = TMP_4.$$s || this;
if (result == null) result = nil;if (element == null) element = nil;
      result['$[]='](element, self.$_get(element));
        self.$_add_hash(result, element.$split("."), self.$_get(element), nil);
        return result;}, TMP_4.$$s = self, TMP_4), $a).call($b, $hash2([], {}));
    ...
    def.$_add_hash = function(hash, keys, value, current_key) {
      ...
      if ((($a = keys['$empty?']()) !== nil && (!$a.$$is_boolean || $a == true))) {
        ...
        self.$_add_hash(hash['$[]'](current_key), keys['$[]']($range(1, -1, false)), value, keys.$first());
      };
      return hash;
    };
    ...
    def.$_get = function(key) {
      ...
      return ($a = ($b = self.confstack).$map, $a.$$p = (TMP_5 = function(s){var self = TMP_5.$$s || this;
if (s == null) s = nil;
      return self.$_get_one(s, key)}, TMP_5.$$s = self, TMP_5), $a).call($b).$compact().$last();
    };

    def.$_get_one = function(hash, key) {
      var $a, $b, TMP_6, self = this, keys = nil, retval = nil;

      keys = key.$split(".");
      retval = ($a = ($b = keys).$inject, $a.$$p = (TMP_6 = function(result, element){var self = TMP_6.$$s || this, $a;
if (result == null) result = nil;if (element == null) element = nil;
      if ((($a = result['$is_a?']($scope.get('Hash'))) !== nil && (!$a.$$is_boolean || $a == true))) {
          } else {
          return ($breaker.$v = nil, $breaker)
        };
        return result['$[]'](element);}, TMP_6.$$s = self, TMP_6), $a).call($b, hash);
      return retval;
    };

    def.$_get_keys = function(hash, path) {
      var $a, $b, TMP_7, self = this, retval = nil;

      if (path == null) {
        path = nil
      }
      retval = ($a = ($b = hash.$keys()).$inject, $a.$$p = (TMP_7 = function(result, key){var self = TMP_7.$$s || this, $a, newpath = nil, newhash = nil;
if (result == null) result = nil;if (key == null) key = nil;
    ...
    def.$_resolve_value_dependency = function(key, value) {
      var $a, $b, TMP_8, self = this, result = nil, loop = nil;

      if ((($a = self.confresult_cache['$has_key?'](value)) !== nil && (!$a.$$is_boolean || $a == true))) {
        result = self.confresult_cache['$[]'](value)
        } else {
        if ((($a = self.callstack['$include?'](key)) !== nil && (!$a.$$is_boolean || $a == true))) {
          loop = self.callstack['$[]']($range(($a = ($b = self.callstack).$index, $a.$$p = (TMP_8 = function(x){var self = TMP_8.$$s || this;
if (x == null) x = nil;
          return x['$=='](key)}, TMP_8.$$s = self, TMP_8), $a).call($b), -1, false));
          self.callstack = [];
    ...
    def.$_resolve_array_dependency = function(key, array) {
      var $a, $b, TMP_9, self = this;

      return ($a = ($b = array).$map, $a.$$p = (TMP_9 = function(f){var self = TMP_9.$$s || this;
if (f == null) f = nil;
      return self.$_resolve_dependencies(nil, f)}, TMP_9.$$s = self, TMP_9), $a).call($b);
    };

    def.$_resolve_hash_dependency = function(key, hash) {
      var $a, $b, TMP_10, self = this, result = nil;

      result = ($a = ($b = hash).$inject, $a.$$p = (TMP_10 = function(r, v){var self = TMP_10.$$s || this;
if (r == null) r = nil;if (v == null) v = nil;
      r['$[]='](v.$first(), self.$_resolve_dependencies([key, v.$first()], v.$last()));
        return r;}, TMP_10.$$s = self, TMP_10), $a).call($b, $hash2([], {}));
      return result;
    };

    return (def.$_resolve_dependencies = function(key, result) {
      var self = this;
...
Opal.modules["opal-abc2svg"] = function(Opal) {
  ...
  Opal.add_stubs(['$lambda', '$set_callback', '$error', '$[]', '$===', '$_anno_start', '$_anno_stop', '$push', '$_get_abcmodel', '$to_n', '$unhighlight_all', '$range_highlight_more', '$each', '$find', '$join', '$uniq', '$flatten', '$split', '$attr', '$get_elements_by_range', '$gsub', '$_set_on_select', '$_translate', '$html', '$get_svg', '$[]=', '$sort', '$map', '$first', '$last', '$private', '$to_s', '$class', '$inject', '$_clone_abc2svg_object', '$Native', '$_get_extra', '$clone', '$<<', '$to_a', '$each_with_index', '$==', '$loglevel', '$debug', '$to_json', '$length', '$_mk_id', '$on', '$stop_propagation', '$call', '$id', '$current_target']);
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.user = def.printer = def.root = def.abc_model = def.svgbuf = def.element_to_position = def.object_map = def.abc_source = nil;
      def.$initialize = function(div, options) {
        var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, $f, TMP_5, $g, TMP_6, $h, TMP_7, self = this, $case = nil;
        if ($gvars.log == null) $gvars.log = nil;
...
if (message == null) message = nil;if (line_number == null) line_number = nil;if (column_number == null) column_number = nil;
        return $gvars.log.$error(message, [$rb_plus(line_number, 1), $rb_plus(column_number, 1)])}, TMP_2.$$s = self, TMP_2), $a).call($c, "errmsg");
...
if (type == null) type = nil;if (start == null) start = nil;if (stop == null) stop = nil;if (x == null) x = nil;if (y == null) y = nil;if (w == null) w = nil;if (h == null) h = nil;
        return self.$_anno_start(type, start, stop, x, y, w, h)}, TMP_3.$$s = self, TMP_3), $a).call($d, "anno_start");
        ($a = ($e = self).$set_callback, $a.$$p = (TMP_4 = function(type, start, stop, x, y, w, h){var self = TMP_4.$$s || this;
if (type == null) type = nil;if (start == null) start = nil;if (stop == null) stop = nil;if (x == null) x = nil;if (y == null) y = nil;if (w == null) w = nil;if (h == null) h = nil;
        return self.$_anno_stop(type, start, stop, x, y, w, h)}, TMP_4.$$s = self, TMP_4), $a).call($e, "anno_stop");
        ($a = ($f = self).$set_callback, $a.$$p = (TMP_5 = function(svg){var self = TMP_5.$$s || this;
          if (self.svgbuf == null) self.svgbuf = nil;
if (svg == null) svg = nil;
        return self.svgbuf.$push(svg)}, TMP_5.$$s = self, TMP_5), $a).call($f, "img_out");
...
if (tsfirst == null) tsfirst = nil;if (voice_tb == null) voice_tb = nil;if (anno_type == null) anno_type = nil;
        return nil}, TMP_6.$$s = self, TMP_6), $a).call($g, "get_abcmodel");}else if ("model"['$===']($case)) {($a = ($h = self).$set_callback, $a.$$p = (TMP_7 = function(tsfirst, voice_tb, anno_type, info){var self = TMP_7.$$s || this;
if (tsfirst == null) tsfirst = nil;if (voice_tb == null) voice_tb = nil;if (anno_type == null) anno_type = nil;if (info == null) info = nil;
        return self.$_get_abcmodel(tsfirst, voice_tb, anno_type, info)}, TMP_7.$$s = self, TMP_7), $a).call($h, "get_abcmodel")}else {$gvars.log.$error("BUG: unsupported mode for abc2svg")};
      ...
      def.$range_highlight_more = function(from, to) {
        ...
        ($a = ($b = self.$get_elements_by_range(from, to)).$each, $a.$$p = (TMP_8 = function(id){var self = TMP_8.$$s || this, element = nil, classes = nil;
if (id == null) id = nil;
        element = $scope.get('Element').$find("#" + (id));
          ...
          return element.$attr("class", classes);}, TMP_8.$$s = self, TMP_8), $a).call($b);
        return nil;
      };
      ...
      def.$range_unhighlight_more = function(from, to) {
        ...
        return ($a = ($b = self.$get_elements_by_range(from, to)).$each, $a.$$p = (TMP_9 = function(id){var self = TMP_9.$$s || this, foo = nil, classes = nil;
if (id == null) id = nil;
        foo = $scope.get('Element').$find("#" + (id));
          classes = foo.$attr("class").$gsub("highlight", "");
          return foo.$attr("class", classes);}, TMP_9.$$s = self, TMP_9), $a).call($b);
      };
      ...
      def.$get_abcmodel = function(abc_code) {
        var self = this;
      ...
      def.$set_callback = TMP_11 = function(event) {
        var self = this, $iter = TMP_11.$$p, block = $iter || nil;
      ...
      def.$get_elements_by_range = function(from, to) {
        var $a, $b, TMP_12, self = this, range = nil, result = nil;

        range = [from, to].$sort();
        result = [];
        ($a = ($b = self.element_to_position).$each, $a.$$p = (TMP_12 = function(k, value){var self = TMP_12.$$s || this, $a, $b, TMP_13, noterange = nil;
if (k == null) k = nil;if (value == null) value = nil;
        noterange = ($a = ($b = ["startChar", "endChar"]).$map, $a.$$p = (TMP_13 = function(c){var self = TMP_13.$$s || this;
if (c == null) c = nil;
          return value['$[]'](c)}, TMP_13.$$s = self, TMP_13), $a).call($b).$sort();
          if ($rb_gt($rb_times(($rb_minus(range.$first(), noterange.$last())), ($rb_minus(noterange.$first(), range.$last()))), 0)) {
      ...
      def.$_clone_abc2svg_object = function(object) {
        var $a, $b, TMP_14, $c, TMP_15, self = this, dropkeys = nil, $case = nil, keys = nil, result = nil;

        dropkeys = ["next", "prev", "ts_next", "ts_prev", "extra"];
        $case = object.$class().$to_s();if ("Object"['$===']($case)) {keys = $rb_minus(Object.keys(object.$to_n()), dropkeys);
        result = ($a = ($b = keys).$inject, $a.$$p = (TMP_14 = function(r1, key){var self = TMP_14.$$s || this;
if (r1 == null) r1 = nil;if (key == null) key = nil;
        r1['$[]='](key, self.$_clone_abc2svg_object(self.$Native(object['$[]'](key))));
          return r1;}, TMP_14.$$s = self, TMP_14), $a).call($b, $hash2([], {}));
        if ((($a = object['$[]']("extra")) !== nil && (!$a.$$is_boolean || $a == true))) {
          result['$[]=']("extra", self.$_get_extra(object))};
        self.object_map['$[]='](object['$[]']("__id__"), result);}else if ("Array"['$===']($case)) {result = ($a = ($c = object).$map, $a.$$p = (TMP_15 = function(element){var self = TMP_15.$$s || this;
if (element == null) element = nil;
        return self.$_clone_abc2svg_object(self.$Native(element))}, TMP_15.$$s = self, TMP_15), $a).call($c)}else {result = object};
        return result;
      };

      def.$_get_extra = function(object) {
        var $a, self = this, result = nil, next_object = nil, cloned_extra = nil;

        result = $hash2([], {});
        next_object = object['$[]']("extra");
        while (next_object !== false && next_object !== nil) {
        cloned_extra = self.$_clone_abc2svg_object(next_object);
        result['$[]='](cloned_extra['$[]']("type"), cloned_extra);
        next_object = next_object['$[]']("next");};
        return result;
      };

      def.$_get_abcmodel = function(tsfirst, voice_tb, music_types, info) {
        var $a, $b, TMP_16, self = this, tune = nil, info_clone = nil;
        if ($gvars.log == null) $gvars.log = nil;
      ...
      ;
        tune = $hash2([], {});
        tune['$[]=']("music_types", self.$Native(music_types).$clone());
        tune['$[]=']("voices", ($a = ($b = self.$Native(voice_tb)).$map, $a.$$p = (TMP_16 = function(v){var self = TMP_16.$$s || this, $a, result = nil, curnote = nil, nextnote = nil, cloned_note = nil;
if (v == null) v = nil;
        result = $hash2(["voice_properties", "symbols"], {"voice_properties": self.$_clone_abc2svg_object(self.$Native(v)), "symbols": []});
          curnote = self.$Native(self.$Native(v)['$[]']("sym"));
          while (curnote !== false && curnote !== nil) {
          nextnote = curnote['$[]']("next");
          cloned_note = self.$_clone_abc2svg_object(curnote);
          result['$[]']("symbols")['$<<'](cloned_note);
          curnote = nextnote;};
          return result;}, TMP_16.$$s = self, TMP_16), $a).call($b));
        info_clone = self.$_clone_abc2svg_object(self.$Native(info));
        self.abc_model = $hash2(["music_types", "music_type_ids", "info", "voices"], {"music_types": music_types, "music_type_ids": $scope.get('Hash')['$[]'](music_types.$each_with_index().$to_a()), "info": info_clone, "voices": tune['$[]']("voices")});
        if ($gvars.log.$loglevel()['$==']("debug")) {
          $gvars.log.$debug(self.abc_model.$to_json())};
        return self.abc_model;
      };

      def.$_get_charpos = function(abc_source, line, column) {
        var $a, $b, TMP_17, self = this, lines = nil, result = nil;

        lines = self.abc_source.$split("\n");
        result = ($a = ($b = lines['$[]']($range(0, line, false))).$inject, $a.$$p = (TMP_17 = function(r, v){var self = TMP_17.$$s || this;
if (r == null) r = nil;if (v == null) v = nil;
        return r = $rb_plus(r, v.$length())}, TMP_17.$$s = self, TMP_17), $a).call($b, 0);
      ...
      def.$_set_on_select = function() {
        ...
        return ($a = ($b = $scope.get('Element').$find(".abcref")).$on, $a.$$p = (TMP_18 = function(evt){var self = TMP_18.$$s || this;
          if (self.on_select == null) self.on_select = nil;
...
if (evt == null) evt = nil;
        evt.$stop_propagation();
          ...
          return nil;}, TMP_18.$$s = self, TMP_18), $a).call($b, "click");
      };
      ...
      self.root.tosvg(file_name, self.abc_source);
      ;
      }, nil) && '_translate';
    })(self, null)
  })(self)
...
(function(Opal) {
  ...
  self.$require("abcjs_to_harpnotes");
