...
(function($opal) {
  ...
  $opal.add_stubs(['$find', '$[]', '$write', '$to_sym', '$info', '$invert', '$private', '$<=', '$strftime', '$now', '$<<', '$puts']);
  ;
  return (function($base, $super) {
    ...
    def.$initialize = function(element_id) {
      ...
      self.console = (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#" + (element_id));
    ...
    return (def.$write = function(type, msg) {
      ...
      if ((($a = (current_level['$<='](self.loglevel))) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        self.console['$<<']("<li class='" + (type) + "'><i class=\"" + ((($a = $scope.LOGICONS) == null ? $opal.cm('LOGICONS') : $a)['$[]'](type)) + "\"><span class='time'>" + (time) + "</span><span class='msg'>" + (msg) + "</span></li>");
...
(function($opal) {
  ...
  $opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$warn', '$clone', '$private', '$attr', '$html', '$find', '$new', '$each', '$send', '$select', '$=~', '$methods', '$setup_ui', '$setup_ui_listener', '$load_from_loacalstorage', '$set_status', '$loglevel', '$run_string', '$error', '$message', '$split', '$first', '$===', '$debug', '$then', '$status_code', '$body', '$get', '$HTTP', '$get_text', '$Native', '$nil?', '$set_text', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$==', '$play_song', '$play_selection', '$play_from_selection', '$backtrace', '$set_inactive', '$load_song', '$info', '$save_to_localstorage', '$set_active', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$merge!', '$join', '$inject', '$push', '$last', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$on', '$play_abc', '$render_previews', '$handle_command', '$on_change', '$on_selection_change', '$get_selection_positions', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
  ...
  (function($base, $super) {
    ...
    def.commands = def.editor = def.harpnote_player = def.tune_preview_printer = def.song = def.harpnote_preview_printer = def.song_harpnotes = def.systemstatus = nil;
...
if (response == null) response = nil;
    ...
    def.$render_tunepreview_callback = function() {
      ...
      $gvars.log.$debug("finished render tune " + ("controller") + " " + (184));
    ...
    def.$render_harpnotepreview_callback = function() {
      ...
      $gvars.log.$debug("finished rendering Haprnotes " + ("controller") + " " + (200));
...
if (r == null) r = nil;if (v == null) v = nil;
    ...
    def.$setup_ui = function() {
      var $a, $b, TMP_5, $c, $d, TMP_6, self = this, printerparams = nil;
      ...
      ($a = ($b = self.harpnote_preview_printer).$on_select, $a._p = (TMP_5 = function(harpnote){var self = TMP_5._s || this;
if (harpnote == null) harpnote = nil;
      ...
      return ($a = ($c = self.tune_preview_printer).$on_select, $a._p = (TMP_6 = function(abcelement){var self = TMP_6._s || this, a = nil;
if (abcelement == null) abcelement = nil;
      a = self.$Native(abcelement);
        return self.$select_abc_object(abcelement);}, TMP_6._s = self, TMP_6), $a).call($c);
    };
    ...
    def.$setup_ui_listener = function() {
      ...
      ($a = ($f = (($g = $scope.Element) == null ? $opal.cm('Element') : $g).$find("#tbCommand")).$on, $a._p = (TMP_11 = function(event){var self = TMP_11._s || this;
if (event == null) event = nil;
      self.$handle_command(self.$Native(event['$[]']("target"))['$[]']("value"));
        return self.$Native(event['$[]']("target"))['$[]=']("value", "");}, TMP_11._s = self, TMP_11), $a).call($f, "change");
      ($a = ($g = self.editor).$on_change, $a._p = (TMP_12 = function(e){var self = TMP_12._s || this, $a;
...
if (e == null) e = nil;
      self.$set_status($hash2(["song"], {"song": "changed"}));
        ...
        return nil;}, TMP_12._s = self, TMP_12), $a).call($g);
      ($a = ($h = self.editor).$on_selection_change, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this, a = nil;
...
if (e == null) e = nil;
      a = self.editor.$get_selection_positions();
        $gvars.log.$debug("editor selecton " + (a.$first()) + " to " + (a.$last()) + " (" + ("controller") + ":" + (334) + ")");
        if (a.$first()['$=='](a.$last())) {
          return nil
          } else {
        ...
        };}, TMP_13._s = self, TMP_13), $a).call($h);
      ($a = ($i = self.harpnote_player).$on_noteon, $a._p = (TMP_14 = function(e){var self = TMP_14._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteon " + (self.$Native(e)['$[]']("startChar")));
        return self.$highlight_abc_object(e);}, TMP_14._s = self, TMP_14), $a).call($i);
      ($a = ($j = self.harpnote_player).$on_noteoff, $a._p = (TMP_15 = function(e){var self = TMP_15._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteoff " + (self.$Native(e)['$[]']("startChar")));
        return self.$unhighlight_abc_object(e);}, TMP_15._s = self, TMP_15), $a).call($j);
      ($a = ($k = self.harpnote_player).$on_songoff, $a._p = (TMP_16 = function(){var self = TMP_16._s || this;

      return self.$stop_play_abc()}, TMP_16._s = self, TMP_16), $a).call($k);
      ($a = ($l = (($m = $scope.Element) == null ? $opal.cm('Element') : $m).$find(window)).$on, $a._p = (TMP_17 = function(evt){var self = TMP_17._s || this, $a;
        if ($gvars.log == null) $gvars.log = nil;
if (evt == null) evt = nil;
      $gvars.log.$debug("key pressed (" + ("controller") + " " + (361) + ")");
        console.log(event);
        if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        };}, TMP_17._s = self, TMP_17), $a).call($l, "keydown");
