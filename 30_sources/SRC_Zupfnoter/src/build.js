...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_9, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $gvars = $opal.gvars;

  $opal.add_stubs(['$new', '$setup_editor', '$setup_ui', '$setup_ui_listener', '$draw', '$layout_harpnotes', '$html', '$find', '$get_abc_code', '$info', '$file', '$output', '$render_pdf', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$alert', '$private', '$on_select', '$select_note', '$on', '$play_abc', '$render_to_canvas', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  ;
  ;
  ;
  ;
...
if (origin == null) origin = nil;
    ...
    return (def.$setup_ui_listener = function() {
      var $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, TMP_5, $f, TMP_6, $g, self = this;
      ...
      ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find(window)).$on, $a._p = (TMP_5 = function(evt){var self = TMP_5._s || this, $a;
if (evt == null) evt = nil;
      if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        }}, TMP_5._s = self, TMP_5), $a).call($e, "keydown");
      return ($a = ($f = (($g = $scope.Element) == null ? $opal.cm('Element') : $g).$find("#dragbar")).$on, $a._p = (TMP_6 = function(re){var self = TMP_6._s || this, $a, $b, TMP_7, $c, TMP_8, $d;
if (re == null) re = nil;
      re.$prevent();
        ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find(document)).$on, $a._p = (TMP_7 = function(e){var self = TMP_7._s || this, $a;
if (e == null) e = nil;
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
          ...
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#dragbar").$css("left", "" + (e.$page_x()) + "px");}, TMP_7._s = self, TMP_7), $a).call($b, "mousemove");
        return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(document)).$on, $a._p = (TMP_8 = function(){var self = TMP_8._s || this;

        return $(document).unbind('mousemove');}, TMP_8._s = self, TMP_8), $a).call($c, "mouseup");}, TMP_6._s = self, TMP_6), $a).call($f, "mousedown");
    }, nil) && 'setup_ui_listener';
  })(self, null);
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_9 = function(){var self = TMP_9._s || this, $a;

  return (($a = $scope.Controller) == null ? $opal.cm('Controller') : $a).$new()}, TMP_9._s = self, TMP_9), $a).call($b);
})(Opal);
