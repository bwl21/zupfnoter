...
(function($opal) {
  ...
  $opal.add_stubs(['$new', '$setup_editor', '$setup_ui', '$setup_ui_listener', '$draw', '$layout_harpnotes', '$draw_in_segments', '$html', '$find', '$get_abc_code', '$info', '$error', '$message', '$file', '$output', '$render_pdf', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$alert', '$private', '$on_select', '$select_note', '$on', '$play_abc', '$render_previews', '$render_a3', '$render_a4', '$Native', '$getSession', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  ;
  ;
  ;
  ;
...
if (origin == null) origin = nil;
    ...
    return (def.$setup_ui_listener = function() {
      var $a, $b, TMP_2, $c, TMP_3, $d, TMP_4, $e, TMP_5, $f, TMP_6, $g, TMP_7, $h, TMP_8, $i, self = this;
      ...
      ($a = ($d = (($e = $scope.Element) == null ? $opal.cm('Element') : $e).$find("#tbPrintA3")).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this, url = nil;

      url = self.$render_a3().$output("datauristring");
        return window.open(url);}, TMP_4._s = self, TMP_4), $a).call($d, "click");
      ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find("#tbPrintA4")).$on, $a._p = (TMP_5 = function(){var self = TMP_5._s || this, url = nil;

      url = self.$render_a4().$output("datauristring");
        return window.open(url);}, TMP_5._s = self, TMP_5), $a).call($e, "click");
      ($a = ($f = self.$Native(self.$Native(self.editor).$getSession())).$on, $a._p = (TMP_6 = function(e){var self = TMP_6._s || this, $a;
...
if (e == null) e = nil;
      if ((($a = self.refresh_timer) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        return nil;}, TMP_6._s = self, TMP_6), $a).call($f, "change");
      ($a = ($g = (($h = $scope.Element) == null ? $opal.cm('Element') : $h).$find(window)).$on, $a._p = (TMP_7 = function(evt){var self = TMP_7._s || this, $a;
if (evt == null) evt = nil;
      if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        }}, TMP_7._s = self, TMP_7), $a).call($g, "keydown");
      return ($a = ($h = (($i = $scope.Element) == null ? $opal.cm('Element') : $i).$find("#dragbar")).$on, $a._p = (TMP_8 = function(re){var self = TMP_8._s || this, $a, $b, TMP_9, $c, TMP_10, $d;
if (re == null) re = nil;
      re.$prevent();
        ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find(document)).$on, $a._p = (TMP_9 = function(e){var self = TMP_9._s || this, $a;
if (e == null) e = nil;
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
          ...
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#dragbar").$css("left", "" + (e.$page_x()) + "px");}, TMP_9._s = self, TMP_9), $a).call($b, "mousemove");
        return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(document)).$on, $a._p = (TMP_10 = function(){var self = TMP_10._s || this;

        return $(document).unbind('mousemove');}, TMP_10._s = self, TMP_10), $a).call($c, "mouseup");}, TMP_8._s = self, TMP_8), $a).call($h, "mousedown");
    }, nil) && 'setup_ui_listener';
  })(self, null);
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_11 = function(){var self = TMP_11._s || this, $a;

  return (($a = $scope.Controller) == null ? $opal.cm('Controller') : $a).$new()}, TMP_11._s = self, TMP_11), $a).call($b);
})(Opal);
