...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$attr_reader', '$is_a?', '$raise', '$duration', '$first', '$each', '$beat=', '$update_beats', '$<<', '$max', '$map', '$keys', '$select', '$empty?', '$reject', '$notes', '$compact', '$flatten', '$[]', '$>', '$length', '$new', '$private', '$inject', '$to_i', '$round', '$*', '$/', '$[]=', '$+', '$last', '$dotted', '$include', '$each_with_index', '$compute_beat_layout', '$layout_voice', '$voices', '$origin', '$build_synch_points', '$layout_playables', '$to', '$nil?', '$from', '$level', '$layout_note', '$layout_accord', '$layout_pause', '$pitch', '$call', '$beat', '$duration_to_id', '$to_sym']);
  return (function($base) {
...
if (n == null) n = nil;
      ...
      (function($base, $super) {
        ...
        def.$build_synch_points = function() {
          var $a, $b, TMP_2, $c, TMP_3, $d, $e, TMP_5, self = this, max_beat = nil;

          max_beat = ($a = ($b = self.beat_maps).$map, $a._p = (TMP_2 = function(map){var self = TMP_2._s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_2._s = self, TMP_2), $a).call($b).$max();
          return ($a = ($c = ($d = ($e = ($range(0, max_beat, false))).$map, $d._p = (TMP_5 = function(beat){var self = TMP_5._s || this, $a, $b, TMP_6, playables = nil;
            if (self.beat_maps == null) self.beat_maps = nil;
if (beat == null) beat = nil;
          playables = ($a = ($b = self.beat_maps).$map, $a._p = (TMP_6 = function(map){var self = TMP_6._s || this;
if (map == null) map = nil;
            return map['$[]'](beat)}, TMP_6._s = self, TMP_6), $a).call($b).$compact();
            if (playables.$length()['$>'](1)) {
              return (($a = $scope.SynchPoint) == null ? $opal.cm('SynchPoint') : $a).$new(playables)
              } else {
              return nil
            };}, TMP_5._s = self, TMP_5), $d).call($e).$flatten().$compact()).$select, $a._p = (TMP_3 = function(sp){var self = TMP_3._s || this, $a, $b, TMP_4;
if (sp == null) sp = nil;
          return ($a = ($b = sp.$notes()).$reject, $a._p = (TMP_4 = function(e){var self = TMP_4._s || this, $a;
if (e == null) e = nil;
            return e['$is_a?']((($a = $scope.Note) == null ? $opal.cm('Note') : $a))}, TMP_4._s = self, TMP_4), $a).call($b)['$empty?']()}, TMP_3._s = self, TMP_3), $a).call($c);
        };
        ...
        return (def.$update_beats = function() {
          ...
          self.beat_maps = ($a = ($b = self.voices).$map, $a._p = (TMP_7 = function(voice){var self = TMP_7._s || this, $a, $b, TMP_8, $c, $d, TMP_9, current_beat = nil;
...
if (map == null) map = nil;if (playable == null) playable = nil;
            beats = (((1.0)['$/'](playable.$duration()))['$*'](self.note_length_in_beats)).$round().$to_i();
              ...
              return map;}, TMP_8._s = self, TMP_8), $a).call($b, $hash2([], {}));}, TMP_7._s = self, TMP_7), $a).call($b);
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = function(from, to, style, origin) {
          var self = this;
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        $opal.cdecl($scope, 'ELLIPSE_SIZE', [10, 7]);
...
if (value == null) value = nil;if (index == null) index = nil;
        ...
        def.$compute_beat_layout = function(music) {
          ...
          return ($a = ($b = (($c = $scope.Proc) == null ? $opal.cm('Proc') : $c)).$new, $a._p = (TMP_11 = function(beat){var self = TMP_11._s || this;
if (beat == null) beat = nil;
          return beat['$*'](10)['$+'](10)}, TMP_11._s = self, TMP_11), $a).call($b);
        };

        def.$layout = function(music, beat_layout) {
          var $a, $b, TMP_12, $c, TMP_13, $d, $e, TMP_14, TMP_15, $f, $g, self = this, sheet_elements = nil, note_to_ellipse = nil, synch_lines = nil;

          if (beat_layout == null) {
            beat_layout = nil
          }
          beat_layout = ((($a = beat_layout) !== false && $a !== nil) ? $a : self.$compute_beat_layout(music));
          sheet_elements = ($a = ($b = music.$voices()).$map, $a._p = (TMP_12 = function(v){var self = TMP_12._s || this;
if (v == null) v = nil;
          return self.$layout_voice(v, beat_layout)}, TMP_12._s = self, TMP_12), $a).call($b).$flatten();
          note_to_ellipse = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($c = ($d = ($e = sheet_elements).$select, $d._p = (TMP_14 = function(e){var self = TMP_14._s || this, $a;
if (e == null) e = nil;
          return e['$is_a?']((($a = $scope.Ellipse) == null ? $opal.cm('Ellipse') : $a))}, TMP_14._s = self, TMP_14), $d).call($e)).$map, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_13._s = self, TMP_13), $a).call($c));
          synch_lines = ($a = ($d = music.$build_synch_points()).$map, $a._p = (TMP_15 = function(sp){var self = TMP_15._s || this, $a;
if (sp == null) sp = nil;
          return (($a = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $a).$new(note_to_ellipse['$[]'](sp.$notes().$first()), note_to_ellipse['$[]'](sp.$notes().$last()), "dashed", sp)}, TMP_15._s = self, TMP_15), $a).call($d);
          sheet_elements = synch_lines['$+'](sheet_elements);
          return (($a = ((($f = ((($g = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $g))._scope).Drawing == null ? $f.cm('Drawing') : $f.Drawing))._scope).Sheet == null ? $a.cm('Sheet') : $a.Sheet).$new(sheet_elements);
        };
...
if (dacapo == null) dacapo = nil;
        ...
        def.$layout_note = function(root, beat_layout) {
          var $a, $b, TMP_26, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          ...
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_26 = function(e){var self = TMP_26._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_26._s = self, TMP_26), $a).call($b);
        ...
        def.$layout_accord = function(root, beat_layout) {
          var $a, $b, TMP_27, self = this, res = nil;

          res = ($a = ($b = root.$notes()).$map, $a._p = (TMP_27 = function(c){var self = TMP_27._s || this;
if (c == null) c = nil;
          return self.$layout_note(c, beat_layout)}, TMP_27._s = self, TMP_27), $a).call($b, [])['$[]']($range(0, 1, false));
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$transform = function(abc_code) {
          var $a, $b, TMP_1, $c, TMP_2, $d, TMP_3, $e, TMP_4, $f, TMP_7, $g, $h, self = this, note_length_rows = nil, note_length = nil, tune = nil, lines = nil, voices = nil, voices_transformed = nil;
...
if (row == null) row = nil;
          return row['$[]']($range(0, 1, false))['$==']("L:")}, TMP_1._s = self, TMP_1), $a).call($b);
          if ((($a = note_length_rows['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            self.$raise("ABC code does not contain a unit note length (L)")};
          note_length = ($a = ($c = note_length_rows.$first().$strip().$split(":").$last().$split("/")).$map, $a._p = (TMP_2 = function(s){var self = TMP_2._s || this;
if (s == null) s = nil;
          return s.$strip().$to_i()}, TMP_2._s = self, TMP_2), $a).call($c);
          note_length = note_length.$last()['$/'](note_length.$first());
          tune = self.$Native(tune);
          lines = ($a = ($d = tune['$[]']("lines")).$map, $a._p = (TMP_3 = function(l){var self = TMP_3._s || this;
if (l == null) l = nil;
          return self.$Native(l)['$[]']("staff")}, TMP_3._s = self, TMP_3), $a).call($d).$flatten();
          voices = ($a = ($e = lines).$inject, $a._p = (TMP_4 = function(m, l){var self = TMP_4._s || this, $a, $b, TMP_5;
if (m == null) m = nil;if (l == null) l = nil;
          ($a = ($b = self.$Native(l)['$[]']("voices")).$each_with_index, $a._p = (TMP_5 = function(v, idx){var self = TMP_5._s || this, $a, $b, $c, TMP_6;
if (v == null) v = nil;if (idx == null) idx = nil;
            ($a = idx, $b = m, ((($c = $b['$[]']($a)) !== false && $c !== nil) ? $c : $b['$[]=']($a, [])));
              m['$[]'](idx)['$<<'](($a = ($b = v).$map, $a._p = (TMP_6 = function(x){var self = TMP_6._s || this;
if (x == null) x = nil;
              return self.$Native(x)}, TMP_6._s = self, TMP_6), $a).call($b));
              return m['$[]'](idx)['$flatten!']();}, TMP_5._s = self, TMP_5), $a).call($b);
            return m;}, TMP_4._s = self, TMP_4), $a).call($e, []);
          voices_transformed = ($a = ($f = voices.$each_with_index()).$map, $a._p = (TMP_7 = function(voice, voice_idx){var self = TMP_7._s || this, $a, $b, TMP_8, res = nil;
if (voice == null) voice = nil;if (voice_idx == null) voice_idx = nil;
          self.$reset_state();
            res = ($a = ($b = voice).$map, $a._p = (TMP_8 = function(el){var self = TMP_8._s || this, $a, $b, TMP_9, type = nil;
if (el == null) el = nil;
            type = el['$[]']("el_type");
              ...
              if ((($a = ((($b = res['$nil?']()) !== false && $b !== nil) ? $b : res['$empty?']())) !== nil && (!$a._isBoolean || $a == true))) {
                ...
                ($a = ($b = res).$each, $a._p = (TMP_9 = function(e){var self = TMP_9._s || this;
if (e == null) e = nil;
                return e['$origin='](el)}, TMP_9._s = self, TMP_9), $a).call($b);
              };
              return res;}, TMP_8._s = self, TMP_8), $a).call($b).$flatten().$compact();
            return res;}, TMP_7._s = self, TMP_7), $a).call($f);
        ...
        def.$transform_rest = function(duration) {
          ...
          return [(($a = $scope.Pause) == null ? $opal.cm('Pause') : $a).$new(duration)];
        };
...
if (pitch == null) pitch = nil;
          ...
          if ((($a = self.next_note_marks_measure) !== nil && (!$a._isBoolean || $a == true))) {
            res['$<<']((($a = $scope.MeasureStart) == null ? $opal.cm('MeasureStart') : $a).$new(notes.$last()));
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$line = function(from, to) {
      ...
      return self.native.lines(to, from[0], from[1]);
    };
    ...
    def['$fill='] = function(rgba) {
      var self = this;

      return self.native.setFillColor(rgba[0], rgba[1], rgba[2], rgba[3]);
    };

    def['$draw='] = function(rgba) {
      var self = this;

      return self.native.setDrawColor(rgba[0], rgba[1], rgba[2], rgba[3]);
    };

    def['$text_color='] = function(rgb) {
      var self = this;

      return self.native.setTetColor(rgba[0], rgba[1], rgba[2]);
    };
...
(function($opal) {
  ...
  $opal.add_stubs(['$transform', '$new', '$layout', '$draw', '$ready?', '$include', '$on', '$reload_harp_notes', '$find']);
  ;
  ;
  ;
  ;
  ;
  ;
  $opal.Object._proto.$reload_harp_notes = function() {
    var $a, $b, $c, self = this, song = nil, sheet = nil;

    
  var abc = editor.getSession().getValue();
  
    song = (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Input == null ? $b.cm('Input') : $b.Input))._scope).ABCToHarpnotes == null ? $a.cm('ABCToHarpnotes') : $a.ABCToHarpnotes).$new().$transform(abc);
    console.log(song);
    sheet = (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Layout == null ? $b.cm('Layout') : $b.Layout))._scope).Default == null ? $a.cm('Default') : $a.Default).$new().$layout(song);
    console.log(sheet);
    return (($a = ((($b = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $b))._scope).RaphaelEngine == null ? $a.cm('RaphaelEngine') : $a.RaphaelEngine).$new("harpPreview").$draw(sheet);
  };
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_1 = function(){var self = TMP_1._s || this, $a, $b, TMP_2, $c;

  self.$include((($a = ((($b = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $b))._scope).Music == null ? $a.cm('Music') : $a.Music));
    return ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#tbRender")).$on, $a._p = (TMP_2 = function(){var self = TMP_2._s || this;

    return self.$reload_harp_notes()}, TMP_2._s = self, TMP_2), $a).call($b, "click");}, TMP_1._s = self, TMP_1), $a).call($b);
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/playground.js.map
;
/* Generated by Opal 0.6.2 */
(function($opal) {
  var self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice;
