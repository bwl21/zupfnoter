...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_reader', '$[]', '$clear_annotations', '$add_annotation', '$write', '$to_sym', '$message', '$invert', '$private', '$first', '$+', '$last', '$<<', '$<=', '$strftime', '$now', '$write_html', '$puts']);
  ;
  return (function($base, $super) {
    ...
    def.$initialize = function(element_id) {
      ...
      self.loglevel = (($a = $scope.LOGLEVELS) == null ? $opal.cm('LOGLEVELS') : $a)['$[]']("info");
    ...
    def.$loglevel = function() {
      ...
      return (($a = $scope.LOGLEVELS) == null ? $opal.cm('LOGLEVELS') : $a).$invert()['$[]'](self.loglevel);
    };
    ...
    def.$add_annotation = function(msg, start_pos, end_pos, type) {
      ...
      if (start_pos !== false && start_pos !== nil) {
        the_start = start_pos;
        the_end = ((($a = end_pos) !== false && $a !== nil) ? $a : [the_start.$first(), the_start.$last()['$+'](1)]);
    ...
    return (def.$write = function(type, msg) {
      var $a, $b, self = this, current_level = nil, time = nil;

      current_level = ((($a = (($b = $scope.LOGLEVELS) == null ? $opal.cm('LOGLEVELS') : $b)['$[]'](type)) !== false && $a !== nil) ? $a : (($b = $scope.LOGLEVELS) == null ? $opal.cm('LOGLEVELS') : $b)['$[]']("warning"));
      if ((($a = (current_level['$<='](self.loglevel))) !== nil && (!$a._isBoolean || $a == true))) {
        time = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now().$strftime("%H:%M:%S");
        self.console.$write_html("<li class='" + (type) + "'><i class=\"" + ((($a = $scope.LOGICONS) == null ? $opal.cm('LOGICONS') : $a)['$[]'](type)) + "\"><span class='time'>" + (time) + "</span><span class='msg'>" + (msg) + "</span></li>");
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$first', '$start_pos', '$last', '$is_a?', '$raise', '$pitch', '$beat', '$duration', '$first_in_part', '$attr_reader', '$each', '$beat=', '$companion=', '$visible?', '$[]', '$class', '$update_beats', '$<<', '$compact', '$flatten', '$map', '$proxy_note', '$>', '$length', '$new', '$expanded_beat_maps', '$select', '$empty?', '$reject', '$notes', '$max', '$keys', '$last_beat', '$private', '$/', '$inject', '$*', '$==', '$tuplet', '$-', '$floor', '$error', '$[]=', '$+', '$index=', '$index', '$center', '$dotted', '$include', '$harpnote_options', '$warning', '$compute_beat_compression', '$values', '$<', '$min', '$call', '$include?', '$build_synch_points', '$layout_voice', '$each_with_index', '$voices', '$origin', '$make_sheetmark_path', '$meta_data', '$strftime', '$now', '$join', '$split', '$to_i', '$scan', '$layout_playable', '$layout_newpart', '$reverse', '$nil?', '$line_width=', '$first_in_part?', '$tuplet_start?', '$tuplet_end?', '$Vector2d', '$make_annotated_bezier_path', '$debug', '$push', '$to_a', '$to_s', '$tie_end?', '$make_slur_path', '$tie_start?', '$slur_starts', '$slur_ends', '$policy', '$make_path_from_jumpline', '$from', '$to', '$tap', '$companion', '$position', '$text', '$beat_maps', '$duration_to_id', '$to_json', '$layout_note', '$layout_measure_start', '$layout_accord', '$layout_pause', '$check_duration', '$sort_by', '$visible=', '$x', '$y', '$normalize', '$+@', '$-@', '$name', '$to_sym', '$===', '$start_pos_to_s', '$end_pos', '$rotate', '$angle', '$perpendicular']);
  return (function($base) {
...
if (n == null) n = nil;
      ...
      (function($base, $super) {
        ...
        return (def.$initialize = TMP_9 = function(from, to, policy) {var $zuper = $slice.call(arguments, 0);
          var $a, $b, $c, $d, self = this, $iter = TMP_9._p, $yield = $iter || nil;
      ...
      (function($base, $super) {
        ...
        def.$build_synch_points = function(selector) {
          ...
          syncpoints = ($a = ($b = self.$expanded_beat_maps()).$map, $a._p = (TMP_10 = function(playables){var self = TMP_10._s || this, $a, $b, TMP_11, the_playables = nil;
if (playables == null) playables = nil;
          if (selector !== false && selector !== nil) {
              playables = [playables['$[]'](selector.$first()), playables['$[]'](selector.$last())]};
            the_playables = ($a = ($b = playables).$map, $a._p = (TMP_11 = function(p){var self = TMP_11._s || this, $a, $b, r = nil;
if (p == null) p = nil;
            if ((($a = p['$is_a?']((($b = $scope.Playable) == null ? $opal.cm('Playable') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
                r = p.$proxy_note()};
              return r;}, TMP_11._s = self, TMP_11), $a).call($b);
            if (the_playables.$length()['$>'](1)) {
              return (($a = $scope.SynchPoint) == null ? $opal.cm('SynchPoint') : $a).$new(the_playables)
              } else {
              return nil
            };}, TMP_10._s = self, TMP_10), $a).call($b).$flatten().$compact();
          syncpoints = ($a = ($c = syncpoints).$select, $a._p = (TMP_12 = function(sp){var self = TMP_12._s || this, $a, $b, TMP_13;
if (sp == null) sp = nil;
          return ($a = ($b = sp.$notes()).$reject, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this, $a;
if (e == null) e = nil;
            return e['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_13._s = self, TMP_13), $a).call($b)['$empty?']()}, TMP_12._s = self, TMP_12), $a).call($c);
          return syncpoints;
        };
        ...
        def.$last_beat = function() {
          ...
          return max_beat = ($a = ($b = self.beat_maps).$map, $a._p = (TMP_14 = function(map){var self = TMP_14._s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_14._s = self, TMP_14), $a).call($b).$max();
        };

        def.$expanded_beat_maps = function() {
          var $a, $b, TMP_15, self = this;

          return ($a = ($b = ($range(0, self.$last_beat(), false))).$map, $a._p = (TMP_15 = function(beat){var self = TMP_15._s || this, $a, $b, TMP_16;
            if (self.beat_maps == null) self.beat_maps = nil;
if (beat == null) beat = nil;
          return ($a = ($b = self.beat_maps).$map, $a._p = (TMP_16 = function(map){var self = TMP_16._s || this;
if (map == null) map = nil;
            return map['$[]'](beat)}, TMP_16._s = self, TMP_16), $a).call($b)}, TMP_15._s = self, TMP_15), $a).call($b);
        };
        ...
        return (def.$update_beats = function() {
          ...
          tupletmap = $hash(1, 1, 2, (3)['$/'](2), 3, (2)['$/'](3), 4, (3)['$/'](4), 5, (2)['$/'](5), 6, (2)['$/'](6), 7, (2)['$/'](7), 8, (3)['$/'](8), 9, (2)['$/'](9));
          self.beat_maps = ($a = ($b = self.voices).$map, $a._p = (TMP_17 = function(voice){var self = TMP_17._s || this, $a, $b, TMP_18, $c, $d, TMP_19, current_beat = nil, voice_map = nil;
if (voice == null) voice = nil;
          current_beat = 0;
            voice_map = ($a = ($b = ($c = ($d = voice).$select, $c._p = (TMP_19 = function(e){var self = TMP_19._s || this, $a;
if (e == null) e = nil;
            return e['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_19._s = self, TMP_19), $c).call($d)).$inject, $a._p = (TMP_18 = function(map, playable){var self = TMP_18._s || this, $a, $b, $c, $d, beats = nil, beat_error = nil, pos = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (map == null) map = nil;if (playable == null) playable = nil;
            beats = playable.$duration()['$*']((($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).BEAT_PER_DURATION == null ? $a.cm('BEAT_PER_DURATION') : $a.BEAT_PER_DURATION));
              ...
              return map;}, TMP_18._s = self, TMP_18), $a).call($b, (($c = $scope.BeatMap) == null ? $opal.cm('BeatMap') : $c).$new(voice.$index()));
            return voice_map;}, TMP_17._s = self, TMP_17), $a).call($b);
          return nil;
        }, nil) && 'update_beats';
      })(self, null);
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        def.$initialize = function() {
          ...
          self.visible = true;
          return self.line_width = (($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).LINE_THIN == null ? $a.cm('LINE_THIN') : $a.LINE_THIN);
        };
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_22 = function(from, to, style, origin, center) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_22._p, $yield = $iter || nil;
      ...
      (function($base, $super) {
        ...
        def.$initialize = TMP_24 = function(center, size, fill, dotted, origin) {var $zuper = $slice.call(arguments, 0);
          var self = this, $a, $iter = TMP_24._p, $yield = $iter || nil;
      ...
      })(self, (($a = $scope.Symbol) == null ? $opal.cm('Symbol') : $a));

      (function($base, $super) {
        function $Annotation(){};
        var self = $Annotation = $klass($base, $super, 'Annotation', $Annotation);

        var def = self._proto, $scope = self._scope, TMP_25;
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, TMP_26;
        ...
        def.$initialize = TMP_26 = function(center, size, glyph_name, dotted, origin) {var $zuper = $slice.call(arguments, 0);
          var $a, self = this, $iter = TMP_26._p, $yield = $iter || nil;
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        $opal.cdecl($scope, 'LINE_THIN', 0.1);

        $opal.cdecl($scope, 'LINE_MEDIUM', 0.3);

        $opal.cdecl($scope, 'LINE_THICK', 0.5);
        ...
        def.$layout = function(music, beat_layout, print_variant_nr) {
          var $a, $b, $c, TMP_27, $d, TMP_28, TMP_29, $e, TMP_30, $f, TMP_32, $g, TMP_33, $h, $i, TMP_34, TMP_35, $j, TMP_37, $k, $l, TMP_38, $m, TMP_40, $n, self = this, print_options = nil, beat_compression_map = nil, maximal_beat = nil, full_beat_spacing = nil, factor = nil, compressed_beat_layout_proc = nil, required_synchlines = nil, synched_notes = nil, voice_elements = nil, note_to_ellipse = nil, synch_lines = nil, sheet_marks = nil, annotations = nil, title_pos = nil, legend_pos = nil, title = nil, meter = nil, key = nil, composer = nil, tempo = nil, print_variant_title = nil, legend = nil, datestring = nil, lyrics = nil, text = nil, verses = nil, pos = nil, sheet_elements = nil;
          if ($gvars.log == null) $gvars.log = nil;
          ...
          full_beat_spacing = ((($a = $scope.DRAWING_AREA_SIZE) == null ? $opal.cm('DRAWING_AREA_SIZE') : $a).$last()['$-'](self.y_offset))['$/'](maximal_beat);
          ...
          beat_layout = ((($a = beat_layout) !== false && $a !== nil) ? $a : ($b = ($c = (($d = $scope.Proc) == null ? $opal.cm('Proc') : $d)).$new, $b._p = (TMP_27 = function(beat){var self = TMP_27._s || this;
            if (self.beat_spacing == null) self.beat_spacing = nil;
            if (self.y_offset == null) self.y_offset = nil;
if (beat == null) beat = nil;
          return beat['$*'](self.beat_spacing)['$+'](self.y_offset)}, TMP_27._s = self, TMP_27), $b).call($c));
          compressed_beat_layout_proc = ($a = ($b = (($d = $scope.Proc) == null ? $opal.cm('Proc') : $d)).$new, $a._p = (TMP_28 = function(beat){var self = TMP_28._s || this;
if (beat == null) beat = nil;
          return beat_layout.$call(beat_compression_map['$[]'](beat))}, TMP_28._s = self, TMP_28), $a).call($b);
          required_synchlines = ($a = ($d = print_options['$[]']("synchlines")).$select, $a._p = (TMP_29 = function(sl){var self = TMP_29._s || this, $a;
if (sl == null) sl = nil;
          return ($a = print_options['$[]']("voices")['$include?'](sl.$first()), $a !== false && $a !== nil ?print_options['$[]']("voices")['$include?'](sl.$last()) : $a)}, TMP_29._s = self, TMP_29), $a).call($d);
          synched_notes = ($a = ($e = required_synchlines).$map, $a._p = (TMP_30 = function(selector){var self = TMP_30._s || this, $a, $b, TMP_31, synch_points_to_show = nil;
if (selector == null) selector = nil;
          synch_points_to_show = music.$build_synch_points(selector);
            return ($a = ($b = synch_points_to_show).$map, $a._p = (TMP_31 = function(sp){var self = TMP_31._s || this;
if (sp == null) sp = nil;
            return [sp.$notes().$first(), sp.$notes().$last()]}, TMP_31._s = self, TMP_31), $a).call($b);}, TMP_30._s = self, TMP_30), $a).call($e).$flatten();
          voice_elements = ($a = ($f = music.$voices().$each_with_index()).$map, $a._p = (TMP_32 = function(v, index){var self = TMP_32._s || this, $a;
if (v == null) v = nil;if (index == null) index = nil;
          if ((($a = print_options['$[]']("voices")['$include?'](index)) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              return nil
            }}, TMP_32._s = self, TMP_32), $a).call($f).$flatten().$compact();
          note_to_ellipse = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($g = ($h = ($i = voice_elements).$select, $h._p = (TMP_34 = function(e){var self = TMP_34._s || this, $a;
if (e == null) e = nil;
          return e['$is_a?']((($a = $scope.Symbol) == null ? $opal.cm('Symbol') : $a))}, TMP_34._s = self, TMP_34), $h).call($i)).$map, $a._p = (TMP_33 = function(e){var self = TMP_33._s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_33._s = self, TMP_33), $a).call($g));
          synch_lines = ($a = ($h = required_synchlines).$map, $a._p = (TMP_35 = function(selector){var self = TMP_35._s || this, $a, $b, TMP_36, synch_points_to_show = nil;
if (selector == null) selector = nil;
          synch_points_to_show = music.$build_synch_points(selector);
            return ($a = ($b = synch_points_to_show).$map, $a._p = (TMP_36 = function(sp){var self = TMP_36._s || this, $a;
if (sp == null) sp = nil;
            return (($a = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $a).$new(note_to_ellipse['$[]'](sp.$notes().$first()), note_to_ellipse['$[]'](sp.$notes().$last()), "dashed", sp)}, TMP_36._s = self, TMP_36), $a).call($b);}, TMP_35._s = self, TMP_35), $a).call($h).$flatten();
          sheet_marks = ($a = ($j = [79, 55, 43]).$inject, $a._p = (TMP_37 = function(result, pitch){var self = TMP_37._s || this, $a, $b, $c, markpath = nil;
if (result == null) result = nil;if (pitch == null) pitch = nil;
          markpath = self.$make_sheetmark_path([((($a = $scope.PITCH_OFFSET) == null ? $opal.cm('PITCH_OFFSET') : $a)['$+'](pitch))['$*']((($a = $scope.X_SPACING) == null ? $opal.cm('X_SPACING') : $a))['$+']((($a = $scope.X_OFFSET) == null ? $opal.cm('X_OFFSET') : $a)), 10]);
            result['$<<']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Path == null ? $a.cm('Path') : $a.Path).$new(markpath, "filled"));
            return result;}, TMP_37._s = self, TMP_37), $a).call($j, []);
          annotations = [];
          title_pos = [20, 20];
          legend_pos = [20, 30];
          ...
          annotations['$<<']((($a = ((($k = ((($l = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $l))._scope).Drawing == null ? $k.cm('Drawing') : $k.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(title_pos, title, "large"));
          annotations['$<<']((($a = ((($k = ((($l = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $l))._scope).Drawing == null ? $k.cm('Drawing') : $k.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(legend_pos, legend, "regular"));
          datestring = (($a = $scope.Time) == null ? $opal.cm('Time') : $a).$now().$strftime("%Y-%m-%d %H:%M:%S %Z");
          annotations['$<<']((($a = ((($k = ((($l = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $l))._scope).Drawing == null ? $k.cm('Drawing') : $k.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new([150, 288], "rendered " + (datestring) + " by Zupfnoter " + ((($a = $scope.VERSION) == null ? $opal.cm('VERSION') : $a)) + " " + ((($a = $scope.COPYRIGHT) == null ? $opal.cm('COPYRIGHT') : $a)) + " (Host " + (window.location) + ")", "smaller"));
          lyrics = music.$harpnote_options()['$[]']("lyrics");
          if (lyrics !== false && lyrics !== nil) {
            text = lyrics['$[]']("text").$join("\n");
            if ((($a = lyrics['$[]']("versepos")) !== nil && (!$a._isBoolean || $a == true))) {
              verses = text.$split("\n\n");
              ($a = ($k = lyrics['$[]']("versepos")).$each, $a._p = (TMP_38 = function(key, value){var self = TMP_38._s || this, $a, $b, TMP_39, $c, $d, the_text = nil;
if (key == null) key = nil;if (value == null) value = nil;
              the_text = ($a = ($b = key.$scan(/\d+/)).$map, $a._p = (TMP_39 = function(i){var self = TMP_39._s || this;
if (i == null) i = nil;
                return verses['$[]'](i.$to_i()['$-'](1))}, TMP_39._s = self, TMP_39), $a).call($b).$join("\n\n");
                return annotations['$<<']((($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Drawing == null ? $c.cm('Drawing') : $c.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(value, the_text));}, TMP_38._s = self, TMP_38), $a).call($k);
              } else {
              pos = lyrics['$[]']("pos");
              annotations['$<<']((($a = ((($l = ((($m = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $m))._scope).Drawing == null ? $l.cm('Drawing') : $l.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(pos, text));
            };};
          ($a = ($l = music.$harpnote_options()['$[]']("notes")).$each, $a._p = (TMP_40 = function(note){var self = TMP_40._s || this, $a, $b, $c;
if (note == null) note = nil;
          return annotations['$<<']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(note['$[]']("pos"), note['$[]']("text"), note['$[]']("style")))}, TMP_40._s = self, TMP_40), $a).call($l);
          sheet_elements = synch_lines['$+'](voice_elements)['$+'](sheet_marks)['$+'](annotations);
          return (($a = ((($m = ((($n = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $n))._scope).Drawing == null ? $m.cm('Drawing') : $m.Drawing))._scope).Sheet == null ? $a.cm('Sheet') : $a.Sheet).$new(sheet_elements);
        };

        def.$layout_voice = function(voice, beat_layout, show_options) {
          var $a, $b, TMP_41, $c, TMP_42, $d, TMP_43, $e, $f, TMP_44, TMP_45, $g, $h, TMP_46, TMP_47, $i, TMP_48, $j, $k, TMP_49, TMP_50, $l, $m, TMP_51, TMP_52, $n, TMP_53, $o, TMP_57, $p, $q, TMP_59, TMP_60, $r, $s, TMP_61, self = this, playables = nil, res_playables = nil, res_measures = nil, res_newparts = nil, lookuptable_drawing_by_playable = nil, previous_note = nil, res_flow = nil, res_sub_flow = nil, tuplet_start = nil, res_tuplets = nil, tie_start = nil, res_slurs = nil, res_gotos = nil, res_annotations = nil, retval = nil;

          playables = ($a = ($b = voice).$select, $a._p = (TMP_41 = function(c){var self = TMP_41._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_41._s = self, TMP_41), $a).call($b);
          res_playables = ($a = ($c = playables).$map, $a._p = (TMP_42 = function(playable){var self = TMP_42._s || this;
if (playable == null) playable = nil;
          return self.$layout_playable(playable, beat_layout)}, TMP_42._s = self, TMP_42), $a).call($c).$flatten();
          res_measures = ($a = ($d = ($e = ($f = voice).$select, $e._p = (TMP_44 = function(c){var self = TMP_44._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.MeasureStart) == null ? $opal.cm('MeasureStart') : $a))}, TMP_44._s = self, TMP_44), $e).call($f)).$map, $a._p = (TMP_43 = function(measure){var self = TMP_43._s || this;
if (measure == null) measure = nil;
          return self.$layout_playable(measure, beat_layout)}, TMP_43._s = self, TMP_43), $a).call($d);
          res_newparts = ($a = ($e = ($g = ($h = voice).$select, $g._p = (TMP_46 = function(c){var self = TMP_46._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.NewPart) == null ? $opal.cm('NewPart') : $a))}, TMP_46._s = self, TMP_46), $g).call($h)).$map, $a._p = (TMP_45 = function(newpart){var self = TMP_45._s || this;
if (newpart == null) newpart = nil;
          return self.$layout_newpart(newpart, beat_layout)}, TMP_45._s = self, TMP_45), $a).call($e);
          lookuptable_drawing_by_playable = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($g = res_playables).$map, $a._p = (TMP_47 = function(e){var self = TMP_47._s || this;
if (e == null) e = nil;
          return [e.$origin(), e]}, TMP_47._s = self, TMP_47), $a).call($g).$reverse());
          previous_note = nil;
          res_flow = ($a = ($i = ($j = ($k = voice).$select, $j._p = (TMP_49 = function(c){var self = TMP_49._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_49._s = self, TMP_49), $j).call($k)).$map, $a._p = (TMP_48 = function(playable){var self = TMP_48._s || this, $a, res = nil;
if (playable == null) playable = nil;
          res = nil;
            if ((($a = previous_note['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              res['$line_width=']((($a = $scope.LINE_MEDIUM) == null ? $opal.cm('LINE_MEDIUM') : $a));
            };
            if ((($a = playable['$first_in_part?']()) !== nil && (!$a._isBoolean || $a == true))) {
              res = nil};
            previous_note = playable;
            return res;}, TMP_48._s = self, TMP_48), $a).call($i).$compact();
          previous_note = nil;
          res_sub_flow = ($a = ($j = ($l = ($m = voice).$select, $l._p = (TMP_51 = function(c){var self = TMP_51._s || this, $a, $b;
if (c == null) c = nil;
          return ((($a = c['$is_a?']((($b = $scope.Playable) == null ? $opal.cm('Playable') : $b))) !== false && $a !== nil) ? $a : c['$is_a?']((($b = $scope.SynchPoint) == null ? $opal.cm('SynchPoint') : $b)))}, TMP_51._s = self, TMP_51), $l).call($m)).$map, $a._p = (TMP_50 = function(playable){var self = TMP_50._s || this, $a, res = nil;
if (playable == null) playable = nil;
          if ((($a = show_options['$[]']("synched_notes")['$include?'](playable.$proxy_note())) !== nil && (!$a._isBoolean || $a == true))) {
              } else {
              res = nil;
              if ((($a = previous_note['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
                } else {
                res = (($a = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $a).$new(lookuptable_drawing_by_playable['$[]'](previous_note), lookuptable_drawing_by_playable['$[]'](playable), "dotted")
              };
              if ((($a = playable['$first_in_part?']()) !== nil && (!$a._isBoolean || $a == true))) {
                res = nil};
            };
            previous_note = playable;
            return res;}, TMP_50._s = self, TMP_50), $a).call($j).$compact();
          if ((($a = show_options['$[]']("subflowline")) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            res_sub_flow = []
          };
          ...
          res_tuplets = ($a = ($l = playables).$inject, $a._p = (TMP_52 = function(result, playable){var self = TMP_52._s || this, $a, $b, $c, p1 = nil, p2 = nil, tiepath = nil, anchor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (result == null) result = nil;if (playable == null) playable = nil;
          if ((($a = playable['$tuplet_start?']()) !== nil && (!$a._isBoolean || $a == true))) {
              tuplet_start = playable};
            if ((($a = playable['$tuplet_end?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              $gvars.log.$debug("" + ([tiepath, anchor]) + " (" + ("harpnotes") + " " + (1179) + ")");
              ...
              result.$push((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(anchor.$to_a(), playable.$tuplet().$to_s(), "small"));};
            return result;}, TMP_52._s = self, TMP_52), $a).call($l, []);
          self.slur_index['$[]=']("first_playable", playables.$first());
          tie_start = playables.$first();
          res_slurs = ($a = ($n = playables).$inject, $a._p = (TMP_53 = function(result, playable){var self = TMP_53._s || this, $a, $b, $c, $d, TMP_54, TMP_55, TMP_56, p1 = nil, p2 = nil, tiepath = nil;
...
if (result == null) result = nil;if (playable == null) playable = nil;
          if ((($a = playable['$tie_end?']()) !== nil && (!$a._isBoolean || $a == true))) {
              ...
              if ((($a = playable['$is_a?']((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).SynchPoint == null ? $b.cm('SynchPoint') : $b.SynchPoint))) !== nil && (!$a._isBoolean || $a == true))) {
                ($a = ($b = playable.$notes()).$each_with_index, $a._p = (TMP_54 = function(n, index){var self = TMP_54._s || this, $a, $b, $c;
                  if ($gvars.log == null) $gvars.log = nil;
if (n == null) n = nil;if (index == null) index = nil;
            ...
            if ((($a = playable['$tie_start?']()) !== nil && (!$a._isBoolean || $a == true))) {
              tie_start = playable};
            ($a = ($c = playable.$slur_starts()).$each, $a._p = (TMP_55 = function(s){var self = TMP_55._s || this;
              if (self.slur_index == null) self.slur_index = nil;
if (s == null) s = nil;
            return self.slur_index['$[]='](s, playable)}, TMP_55._s = self, TMP_55), $a).call($c);
            self.slur_index['$[]='](playable.$slur_starts().$first(), playable);
            ($a = ($d = playable.$slur_ends()).$each, $a._p = (TMP_56 = function(id){var self = TMP_56._s || this, $a, $b, $c, begin_slur = nil, slurpath = nil;
              if (self.slur_index == null) self.slur_index = nil;
if (id == null) id = nil;
            begin_slur = ((($a = self.slur_index['$[]'](id)) !== false && $a !== nil) ? $a : self.slur_index['$[]']("first_playable"));
              ...
              return result.$push((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Path == null ? $a.cm('Path') : $a.Path).$new(slurpath));}, TMP_56._s = self, TMP_56), $a).call($d);
            return result;}, TMP_53._s = self, TMP_53), $a).call($n, []);
          res_gotos = ($a = ($o = ($p = ($q = voice).$select, $p._p = (TMP_59 = function(c){var self = TMP_59._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.Goto) == null ? $opal.cm('Goto') : $a))}, TMP_59._s = self, TMP_59), $p).call($q)).$map, $a._p = (TMP_57 = function(goto$){var self = TMP_57._s || this, $a, $b, TMP_58, $c, $d, $e, distance = nil, vertical = nil, path = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (goto$ == null) goto$ = nil;
          distance = goto$.$policy()['$[]']("distance");
            $gvars.log.$debug("vertical line x offset: " + (distance) + " " + ("harpnotes") + ":" + (1235));
            if (distance['$>'](0)) {
              distance = distance['$-'](1)};
            if (distance !== false && distance !== nil) {
              vertical = (distance['$+'](0.5))['$*']((($a = $scope.X_SPACING) == null ? $opal.cm('X_SPACING') : $a))
              } else {
              vertical = (0.5)['$*']((($a = $scope.X_SPACING) == null ? $opal.cm('X_SPACING') : $a))
            };
            ...
            return [($a = ($b = (($c = ((($d = ((($e = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $e))._scope).Drawing == null ? $d.cm('Drawing') : $d.Drawing))._scope).Path == null ? $c.cm('Path') : $c.Path).$new(path['$[]'](0), nil, goto$.$from())).$tap, $a._p = (TMP_58 = function(s){var self = TMP_58._s || this, $a, $b, $c, $d;
if (s == null) s = nil;
            return s['$line_width=']((($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).LINE_THICK == null ? $a.cm('LINE_THICK') : $a.LINE_THICK))}, TMP_58._s = self, TMP_58), $a).call($b), (($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Drawing == null ? $c.cm('Drawing') : $c.Drawing))._scope).Path == null ? $a.cm('Path') : $a.Path).$new(path['$[]'](1), "filled", goto$.$from())];}, TMP_57._s = self, TMP_57), $a).call($o).$flatten();
          if ((($a = show_options['$[]']("jumpline")) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            res_gotos = []
          };
          res_annotations = ($a = ($p = ($r = ($s = voice).$select, $r._p = (TMP_61 = function(c){var self = TMP_61._s || this, $a;
if (c == null) c = nil;
          return c['$is_a?']((($a = $scope.NoteBoundAnnotation) == null ? $opal.cm('NoteBoundAnnotation') : $a))}, TMP_61._s = self, TMP_61), $r).call($s)).$map, $a._p = (TMP_60 = function(annotation){var self = TMP_60._s || this, $a, $b, $c, position = nil;
if (annotation == null) annotation = nil;
          position = self.$Vector2d(lookuptable_drawing_by_playable['$[]'](annotation.$companion()).$center())['$+'](annotation.$position());
            return (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Drawing == null ? $b.cm('Drawing') : $b.Drawing))._scope).Annotation == null ? $a.cm('Annotation') : $a.Annotation).$new(position.$to_a(), annotation.$text());}, TMP_60._s = self, TMP_60), $a).call($p);
          return retval = (res_flow['$+'](res_sub_flow)['$+'](res_slurs)['$+'](res_tuplets)['$+'](res_playables)['$+'](res_gotos)['$+'](res_measures)['$+'](res_newparts)['$+'](res_annotations)).$compact();
        };

        self.$private();

        def.$compute_beat_compression = function(music, layout_lines) {
          var $a, $b, TMP_62, $c, TMP_63, $d, TMP_64, self = this, max_beat = nil, current_beat = nil, last_size = nil, relevant_beat_maps = nil, result = nil;

          max_beat = ($a = ($b = music.$beat_maps()).$map, $a._p = (TMP_62 = function(map){var self = TMP_62._s || this;
if (map == null) map = nil;
          return map.$keys().$max()}, TMP_62._s = self, TMP_62), $a).call($b).$max();
          current_beat = 0;
          last_size = 0;
          relevant_beat_maps = ($a = ($c = layout_lines).$inject, $a._p = (TMP_63 = function(r, i){var self = TMP_63._s || this;
if (r == null) r = nil;if (i == null) i = nil;
          return r.$push(music.$beat_maps()['$[]'](i))}, TMP_63._s = self, TMP_63), $a).call($c, []).$compact();
          result = (($a = $scope.Hash) == null ? $opal.cm('Hash') : $a)['$[]'](($a = ($d = ($range(0, max_beat, false))).$map, $a._p = (TMP_64 = function(beat){var self = TMP_64._s || this, $a, $b, TMP_65, $c, TMP_66, $d, TMP_67, notes_on_beat = nil, max_duration_on_beat = nil, has_no_notes_on_beat = nil, is_new_part = nil, size = nil, e = nil, increment = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (beat == null) beat = nil;
          notes_on_beat = ($a = ($b = relevant_beat_maps).$map, $a._p = (TMP_65 = function(bm){var self = TMP_65._s || this;
if (bm == null) bm = nil;
            return bm['$[]'](beat)}, TMP_65._s = self, TMP_65), $a).call($b).$flatten().$compact();
            max_duration_on_beat = ($a = ($c = notes_on_beat).$map, $a._p = (TMP_66 = function(n){var self = TMP_66._s || this;
if (n == null) n = nil;
            return n.$duration()}, TMP_66._s = self, TMP_66), $a).call($c).$max();
            has_no_notes_on_beat = notes_on_beat['$empty?']();
            is_new_part = ($a = ($d = notes_on_beat).$select, $a._p = (TMP_67 = function(n){var self = TMP_67._s || this;
if (n == null) n = nil;
            return n['$first_in_part?']()}, TMP_67._s = self, TMP_67), $a).call($d);
            if (has_no_notes_on_beat !== false && has_no_notes_on_beat !== nil) {
              } else {
              try {
              size = (($a = $scope.BEAT_RESOULUTION) == null ? $opal.cm('BEAT_RESOULUTION') : $a)['$*']((($a = $scope.DURATION_TO_STYLE) == null ? $opal.cm('DURATION_TO_STYLE') : $a)['$[]'](self.$duration_to_id(max_duration_on_beat)).$first())
              } catch ($err) {if ($opal.$rescue($err, [(($a = $scope.Exception) == null ? $opal.cm('Exception') : $a)])) {e = $err;
            ...
            return [beat, current_beat];}, TMP_64._s = self, TMP_64), $a).call($d));
          return result;
        };
        ...
        def.$layout_note = function(root, beat_layout) {
          var $a, $b, TMP_68, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          ...
          $a = $opal.to_ary((($b = $scope.DURATION_TO_STYLE) == null ? $opal.cm('DURATION_TO_STYLE') : $b)['$[]'](self.$check_duration(root))), scale = ($a[0] == null ? nil : $a[0]), fill = ($a[1] == null ? nil : $a[1]), dotted = ($a[2] == null ? nil : $a[2]);
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_68 = function(e){var self = TMP_68._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_68._s = self, TMP_68), $a).call($b);
          res = (($a = $scope.Ellipse) == null ? $opal.cm('Ellipse') : $a).$new([x_offset, y_offset], size, fill, dotted, root);
          res['$line_width=']((($a = $scope.LINE_THICK) == null ? $opal.cm('LINE_THICK') : $a));
          return res;
        };

        def.$layout_accord = function(root, beat_layout) {
          var $a, $b, TMP_69, $c, TMP_70, self = this, resnotes = nil, resnotes_sorted = nil, res = nil;

          resnotes = ($a = ($b = root.$notes()).$map, $a._p = (TMP_69 = function(c){var self = TMP_69._s || this;
if (c == null) c = nil;
          return self.$layout_note(c, beat_layout)}, TMP_69._s = self, TMP_69), $a).call($b);
          resnotes_sorted = ($a = ($c = resnotes).$sort_by, $a._p = (TMP_70 = function(n){var self = TMP_70._s || this;
if (n == null) n = nil;
          return n.$origin().$pitch()}, TMP_70._s = self, TMP_70), $a).call($c);
          res = [];
          res['$<<']((($a = $scope.FlowLine) == null ? $opal.cm('FlowLine') : $a).$new(resnotes_sorted.$first(), resnotes_sorted.$last(), "dashed", root, resnotes.$first().$center()));
          res['$<<'](resnotes);
          return res;
        };
        ...
        def.$layout_pause = function(root, beat_layout) {
          ...
          $a = $opal.to_ary((($b = $scope.REST_TO_GLYPH) == null ? $opal.cm('REST_TO_GLYPH') : $b)['$[]'](self.$check_duration(root))), scale = ($a[0] == null ? nil : $a[0]), glyph = ($a[1] == null ? nil : $a[1]), dotted = ($a[2] == null ? nil : $a[2]);
        ...
        def.$layout_measure_start = function(root, beat_layout) {
          var $a, $b, TMP_71, $c, self = this, x_offset = nil, y_offset = nil, scale = nil, fill = nil, dotted = nil, size = nil, res = nil;
          ...
          size = ($a = ($b = (($c = $scope.ELLIPSE_SIZE) == null ? $opal.cm('ELLIPSE_SIZE') : $c)).$map, $a._p = (TMP_71 = function(e){var self = TMP_71._s || this;
if (e == null) e = nil;
          return e['$*'](scale)}, TMP_71._s = self, TMP_71), $a).call($b);
        ...
        def.$make_path_from_jumpline = function(from, to, north_east_offset, policy) {
          ...
          start_of_vertical = self.$Vector2d(from.$x()['$+'](policy), from.$y());
          end_of_vertical = self.$Vector2d(from.$x()['$+'](policy), to.$y());
          start_orientation = self.$Vector2d((((start_of_vertical['$-'](from))['$*']([1, 0])).$normalize()).$x(), 0);
          end_orientation = self.$Vector2d((((end_of_vertical['$-'](to))['$*']([1, 0])).$normalize()).$x(), 0);
        ...
        def.$layout_newpart = function(root, beat_layout) {
          var $a, $b, $c, $d, self = this, x_offset = nil, y_offset = nil, res = nil;
          if ($gvars.log == null) $gvars.log = nil;
          ...
          if ((($a = root.$beat()) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            y_offset = beat_layout.$call(root.$beat())['$-']((($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).FONT_STYLE_DEF == null ? $a.cm('FONT_STYLE_DEF') : $a.FONT_STYLE_DEF)['$[]']("regular")['$[]']("font_size")['$*'](2)['$/'](3));
        ...
        def.$duration_to_id = function(duration) {
          ...
          if ((($a = (($b = $scope.DURATION_TO_STYLE) == null ? $opal.cm('DURATION_TO_STYLE') : $b)['$[]'](result)['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
            result = "err"};
          return result;
        };
        ...
        def.$check_duration = function(root) {
          ...
          if ((($a = result['$===']("err")) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$make_sheetmark_path = function(note) {
          var $a, $b, TMP_72, self = this, w = nil, h = nil, base = nil, vpath = nil, path = nil;

          w = 0.5;
          h = 5;
          base = self.$Vector2d(note)['$-']([w, h['$/'](2)]);
          vpath = [self.$Vector2d(w, (w)['$-@']()), self.$Vector2d(w, (2)['$*'](w)), self.$Vector2d(0, h), self.$Vector2d((w)['$-@'](), (2)['$*'](w)), self.$Vector2d((w)['$-@'](), (-2)['$*']((w))), self.$Vector2d(0, h['$-@']())];
          path = [["M", base.$x(), base.$y()]];
          ($a = ($b = vpath).$each, $a._p = (TMP_72 = function(p){var self = TMP_72._s || this;
if (p == null) p = nil;
          return path['$<<'](["l", p.$x(), p.$y()])}, TMP_72._s = self, TMP_72), $a).call($b);
          return path;
        };
        ...
        def.$make_slur_path = function(p1, p2) {
          ...
          deltap = p2['$-'](p1);
          cp_template = self.$Vector2d((0.3)['$*'](deltap.$length()), 0).$rotate(deltap.$angle());
        ...
        return (def.$make_annotated_bezier_path = function(points) {
          var $a, $b, self = this, p1 = nil, p2 = nil, deltap = nil, cp_template = nil, rotate_by = nil, cp1 = nil, cp2 = nil, cpa1 = nil, cpa2 = nil, cpm1 = nil, cpm2 = nil, cpmm = nil, cpmm1 = nil, cpmm2 = nil, annotation_anchor = nil, slurpath = nil;

          p1 = points.$first();
          p2 = points.$last();
          deltap = p2['$-'](p1);
          cp_template = self.$Vector2d(5, 0).$rotate(deltap.$angle());
          rotate_by = (($a = ((($b = $scope.Math) == null ? $opal.cm('Math') : $b))._scope).PI == null ? $a.cm('PI') : $a.PI)['$/'](2);
          ...
          annotation_anchor = annotation_anchor['$+']([0, -4]);
...
(function($opal) {
  ...
  $opal.add_stubs(['$map', '$lambda', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$/', '$%', '$<', '$+', '$==', '$!', '$*', '$new', '$reset_state', '$reset_measure_accidentals', '$match', '$parse', '$last', '$first', '$<<', '$message', '$error', '$split', '$inject', '$get_metadata', '$select', '$nil?', '$join', '$compact', '$flatten', '$parse_harpnote_config', '$charpos_to_line_column', '$warning', '$empty?', '$to_i', '$strip', '$set_key', '$each_with_index', '$debug', '$index=', '$flatten!', '$compact!', '$send', '$origin=', '$>', '$start_pos=', '$end_pos=', '$make_jumplines', '$make_notebound_annotations', '$now', '$to_n', '$keys', '$meta_data=', '$harpnote_options=', '$push', '$get', '$harpnote_options', '$-', '$to_s', '$pop', '$line_no', '$count', '$length', '$private', '$is_a?', '$_extract_chord_lines', '$origin', '$start_pos_to_s', '$start_pos', '$end_pos', '$===', '$to_f', '$round', '$transform_rest', '$transform_real_note', '$tuplet=', '$tuplet_start=', '$tuplet_end=', '$pitch', '$get_midipitch', '$visible=', '$companion=', '$first_in_part=', '$clear', '$slur_starts=', '$slur_ends=', '$tie_start=', '$tie_end=', '$tie_start?', '$tie_end?', '$_extract_variant_ending', '$gsub']);
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (f == null) f = nil;
          ...
          self.on_error = ($a = ($d = self).$lambda, $a._p = (TMP_3 = function(line, message){var self = TMP_3._s || this;
if (line == null) line = nil;if (message == null) message = nil;
          return nil}, TMP_3._s = self, TMP_3), $a).call($d);
        ...
        def.$set_key = function(key) {
          ...
          self.voice_accidentals = ($a = ($b = ($range(0, 6, false))).$map, $a._p = (TMP_5 = function(f){var self = TMP_5._s || this;
if (f == null) f = nil;
          return 0}, TMP_5._s = self, TMP_5), $a).call($b);
          nkey = self.$Native(key);
          accidentals = self.$Native(key)['$[]']("accidentals");
          ($a = ($c = accidentals).$each, $a._p = (TMP_6 = function(accidental){var self = TMP_6._s || this, a = nil;
...
if (accidental == null) accidental = nil;
          a = self.$Native(accidental);
            ...
            return self;}, TMP_6._s = self, TMP_6), $a).call($c);
          return self;
        };
        ...
        def.$reset_measure_accidentals = function() {
          ...
          return self.measure_accidentals = ($a = ($b = self.measure_accidentals).$map, $a._p = (TMP_7 = function(f){var self = TMP_7._s || this;
if (f == null) f = nil;
          return 0}, TMP_7._s = self, TMP_7), $a).call($b);
        };
      ...
      (function($base, $super) {
        ...
        def.pitch_transformer = def.abc_code = def.tuplet_downcount = def.pitch_providers = def.current_tuplet = def.repetition_stack = def.previous_note = def.next_note_marks = def.previous_new_part = nil;
        def.$initialize = function() {
          var $a, $b, $c, self = this;
        ...
        def.$parse_harpnote_config = function(abc_code) {
          ...
          line_no = 1;
          ($a = ($b = abc_code.$split("\n")).$each, $a._p = (TMP_8 = function(line){var self = TMP_8._s || this, $a, $b, TMP_9, $c, $d, entry = nil, parsed_entry = nil, e = nil, message = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (line == null) line = nil;
          entry = ($a = ($b = line).$match, $a._p = (TMP_9 = function(m){var self = TMP_9._s || this;
if (m == null) m = nil;
            return [m['$[]'](1), m['$[]'](2)]}, TMP_9._s = self, TMP_9), $a).call($b, /^%%%%hn\.(print|legend|note|annotation|lyrics) (.*)/);
        ...
        def.$get_metadata = function(abc_code) {
          ...
          retval = ($a = ($b = abc_code.$split("\n")).$inject, $a._p = (TMP_10 = function(result, line){var self = TMP_10._s || this, $a, $b, TMP_11, entry = nil;
if (result == null) result = nil;if (line == null) line = nil;
          entry = ($a = ($b = line).$match, $a._p = (TMP_11 = function(m){var self = TMP_11._s || this;
if (m == null) m = nil;
            return [m['$[]'](1), m['$[]'](2)]}, TMP_11._s = self, TMP_11), $a).call($b, /^(X|T|F):\s*(.*)/);
            if (entry !== false && entry !== nil) {
              result['$[]='](entry.$first(), entry.$last())};
            return result;}, TMP_10._s = self, TMP_10), $a).call($b, $hash2([], {}));
          return retval;
        };
        ...
        def.$add_metadata = function(abc_code, new_metadata) {
          ...
          more_metadata = ($a = ($b = ($c = ($d = new_metadata).$select, $c._p = (TMP_13 = function(k, v){var self = TMP_13._s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return old_metadata['$[]'](k)['$nil?']()}, TMP_13._s = self, TMP_13), $c).call($d)).$map, $a._p = (TMP_12 = function(k, v){var self = TMP_12._s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return "" + (k) + ":" + (v)}, TMP_12._s = self, TMP_12), $a).call($b);
          return [more_metadata, abc_code].$flatten().$compact().$join("\n");
        };

        def.$transform = function(abc_code) {
          var $a, $b, TMP_14, $c, TMP_15, $d, TMP_16, $e, TMP_17, $f, TMP_18, $g, TMP_19, $h, TMP_23, $i, $j, TMP_29, TMP_30, $k, TMP_31, $l, TMP_32, $m, self = this, harpnote_options = nil, warnings = nil, note_length_rows = nil, note_length = nil, tune = nil, lines = nil, first_staff = nil, key = nil, meter = nil, voices = nil, hn_voices = nil, result = nil, meta_data = nil, duration = nil, bpm = nil, duration_display = nil, meta_data_from_tune = nil, print_options = nil;
          if ($gvars.conf == null) $gvars.conf = nil;

          self.abc_code = abc_code;
          harpnote_options = self.$parse_harpnote_config(abc_code);
          self.annotations = ($a = ($b = (((($c = harpnote_options['$[]']("annotation")) !== false && $c !== nil) ? $c : []))).$inject, $a._p = (TMP_14 = function(hash, entry){var self = TMP_14._s || this;
if (hash == null) hash = nil;if (entry == null) entry = nil;
          hash['$[]='](entry['$[]']("id"), entry);
            return hash;}, TMP_14._s = self, TMP_14), $a).call($b, $hash2([], {}));
          ...
          ($a = ($c = warnings).$each, $a._p = (TMP_15 = function(w){var self = TMP_15._s || this, $a, wn = nil, line_no = nil, char_pos = nil, msg = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (w == null) w = nil;
          wn = self.$Native(w);
            ...
            return $gvars.log.$warning(msg, [line_no, char_pos], [line_no, char_pos['$+'](1)]);}, TMP_15._s = self, TMP_15), $a).call($c);
          note_length_rows = ($a = ($d = abc_code.$split("\n")).$select, $a._p = (TMP_16 = function(row){var self = TMP_16._s || this;
if (row == null) row = nil;
          return row['$[]']($range(0, 1, false))['$==']("L:")}, TMP_16._s = self, TMP_16), $a).call($d);
          if ((($a = note_length_rows['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            note_length_rows = ["L:1/4"]};
          note_length = ($a = ($e = note_length_rows.$first().$strip().$split(":").$last().$split("/")).$map, $a._p = (TMP_17 = function(s){var self = TMP_17._s || this;
if (s == null) s = nil;
          return s.$strip().$to_i()}, TMP_17._s = self, TMP_17), $a).call($e);
          note_length = note_length.$last()['$/'](note_length.$first());
          tune = self.$Native(tune);
          lines = ($a = ($f = tune['$[]']("lines")).$select, $a._p = (TMP_18 = function(l){var self = TMP_18._s || this;
if (l == null) l = nil;
          return self.$Native(l)['$[]']("staff")}, TMP_18._s = self, TMP_18), $a).call($f);
          ...
          voices = [];
          ($a = ($g = lines).$each_with_index, $a._p = (TMP_19 = function(line, line_index){var self = TMP_19._s || this, $a, $b, TMP_20, voice_no = nil;
if (line == null) line = nil;if (line_index == null) line_index = nil;
          voice_no = 1;
            return ($a = ($b = self.$Native(line)['$[]']("staff")).$each_with_index, $a._p = (TMP_20 = function(staff, staff_index){var self = TMP_20._s || this, $a, $b, TMP_21;
if (staff == null) staff = nil;if (staff_index == null) staff_index = nil;
            return ($a = ($b = self.$Native(staff)['$[]']("voices")).$each_with_index, $a._p = (TMP_21 = function(voice, voice_index){var self = TMP_21._s || this, $a, $b, $c, $d, $e, $f, TMP_22;
                if ($gvars.log == null) $gvars.log = nil;
if (voice == null) voice = nil;if (voice_index == null) voice_index = nil;
              $gvars.log.$debug("reading line.staff.voice " + (voice_no) + ":" + (line_index) + " " + (staff_index) + "." + (voice_index) + " (" + ("abc_to_harpnotes") + " " + (247) + ")");
                ...
                voices['$[]'](voice_no)['$<<'](($a = ($b = voice).$map, $a._p = (TMP_22 = function(x){var self = TMP_22._s || this;
if (x == null) x = nil;
                return self.$Native(x)}, TMP_22._s = self, TMP_22), $a).call($b));
                voices['$[]'](voice_no)['$index='](voice_no);
                voices['$[]'](voice_no)['$flatten!']();
                return voice_no = voice_no['$+'](1);}, TMP_21._s = self, TMP_21), $a).call($b)}, TMP_20._s = self, TMP_20), $a).call($b);}, TMP_19._s = self, TMP_19), $a).call($g);
          voices['$compact!']();
          hn_voices = ($a = ($h = voices.$each_with_index()).$map, $a._p = (TMP_23 = function(voice, voice_idx){var self = TMP_23._s || this, $a, $b, TMP_24, $c, TMP_25, $d, TMP_27, $e, TMP_28, hn_voice = nil, jumplines = nil, notebound_annotations = nil;
if (voice == null) voice = nil;if (voice_idx == null) voice_idx = nil;
          self.$reset_state();
            self.pitch_providers = ($a = ($b = voice).$map, $a._p = (TMP_24 = function(el){var self = TMP_24._s || this, $a, result = nil;
if (el == null) el = nil;
            result = nil;
              if ((($a = el['$[]']("pitches")) !== nil && (!$a._isBoolean || $a == true))) {
                return result = el
                } else {
                return nil
              };}, TMP_24._s = self, TMP_24), $a).call($b);
            hn_voice = ($a = ($c = voice.$each_with_index()).$map, $a._p = (TMP_25 = function(el, i){var self = TMP_25._s || this, $a, $b, TMP_26, type = nil, hn_voice_element = nil;
if (el == null) el = nil;if (i == null) i = nil;
            type = el['$[]']("el_type");
              ...
              if ((($a = ((($b = hn_voice_element['$nil?']()) !== false && $b !== nil) ? $b : hn_voice_element['$empty?']())) !== nil && (!$a._isBoolean || $a == true))) {
                ...
                ($a = ($b = hn_voice_element).$each, $a._p = (TMP_26 = function(e){var self = TMP_26._s || this, start_char = nil, end_char = nil;
if (e == null) e = nil;
                e['$origin='](el);
                  start_char = el['$[]']("startChar");
                  end_char = el['$[]']("endChar");
                  if (start_char['$>'](0)) {
                    e['$start_pos='](self.$charpos_to_line_column(start_char))};
                  if (end_char['$>'](0)) {
                    return e['$end_pos='](self.$charpos_to_line_column(end_char))
                    } else {
                    return nil
                  };}, TMP_26._s = self, TMP_26), $a).call($b)
              };
              return hn_voice_element;}, TMP_25._s = self, TMP_25), $a).call($c).$flatten().$compact();
            jumplines = [];
            ($a = ($d = hn_voice).$each, $a._p = (TMP_27 = function(e){var self = TMP_27._s || this;
if (e == null) e = nil;
            return jumplines['$<<'](self.$make_jumplines(e))}, TMP_27._s = self, TMP_27), $a).call($d);
            hn_voice = hn_voice['$+'](jumplines.$flatten().$compact());
            notebound_annotations = [];
            ($a = ($e = hn_voice).$each, $a._p = (TMP_28 = function(e){var self = TMP_28._s || this;
if (e == null) e = nil;
            return notebound_annotations['$<<'](self.$make_notebound_annotations(e))}, TMP_28._s = self, TMP_28), $a).call($e);
            hn_voice = hn_voice['$+'](notebound_annotations.$flatten().$compact());
            return hn_voice;}, TMP_23._s = self, TMP_23), $a).call($h);
          result = (($a = ((($i = ((($j = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $j))._scope).Music == null ? $i.cm('Music') : $i.Music))._scope).Song == null ? $a.cm('Song') : $a.Song).$new(hn_voices, note_length);
          ...
          ($a = ($i = $hash2(["key"], {"key": "K:"})).$each, $a._p = (TMP_29 = function(k, v){var self = TMP_29._s || this, $a;
            if (self.annotations == null) self.annotations = nil;
if (k == null) k = nil;if (v == null) v = nil;
          if ((($a = self.annotations['$[]'](v)) !== nil && (!$a._isBoolean || $a == true))) {
              return meta_data['$[]='](k, meta_data['$[]'](k)['$+']((((($a = self.annotations['$[]'](v)['$[]']("text")) !== false && $a !== nil) ? $a : ""))))
              } else {
              return nil
            }}, TMP_29._s = self, TMP_29), $a).call($i);
          duration = 0.25;
          bpm = 120;
          ...
          if ((($a = tune['$[]']("metaText")['$[]']("tempo")) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            meta_data['$[]=']("tempo", $hash2(["duration", "bpm"], {"duration": duration, "bpm": bpm}));
            duration_display = ($a = ($j = duration).$map, $a._p = (TMP_30 = function(d){var self = TMP_30._s || this;
if (d == null) d = nil;
            return "1/" + ((1)['$/'](d))}, TMP_30._s = self, TMP_30), $a).call($j);
          ...
          ($a = ($k = meta_data_from_tune.$keys()).$each, $a._p = (TMP_31 = function(k){var self = TMP_31._s || this;
if (k == null) k = nil;
          return meta_data['$[]='](k, meta_data_from_tune['$[]'](k))}, TMP_31._s = self, TMP_31), $a).call($k);
          result['$meta_data='](meta_data);
          result['$harpnote_options=']($hash2([], {}));
          print_options = (($a = $scope.Confstack) == null ? $opal.cm('Confstack') : $a).$new();
          print_options.$push($gvars.conf.$get("defaults.print"));
          result.$harpnote_options()['$[]=']("print", ($a = ($l = (((($m = harpnote_options['$[]']("print")) !== false && $m !== nil) ? $m : [$hash2([], {})]))).$map, $a._p = (TMP_32 = function(specified_option){var self = TMP_32._s || this, $a, $b, TMP_33, $c, TMP_34, $d, TMP_36, $e, TMP_37, $f, TMP_38, $g, TMP_39, $h, TMP_40, resulting_options = nil, missing_voices = nil, msg = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (specified_option == null) specified_option = nil;
          print_options.$push(specified_option);
            resulting_options = $hash2(["line_no", "title", "startpos", "voices", "synchlines", "flowlines", "subflowlines", "jumplines", "layoutlines"], {"line_no": 1, "title": print_options.$get("t"), "startpos": print_options.$get("startpos"), "voices": ($a = ($b = (print_options.$get("v"))).$map, $a._p = (TMP_33 = function(i){var self = TMP_33._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_33._s = self, TMP_33), $a).call($b), "synchlines": ($a = ($c = (print_options.$get("s"))).$map, $a._p = (TMP_34 = function(i){var self = TMP_34._s || this, $a, $b, TMP_35;
if (i == null) i = nil;
            return ($a = ($b = i).$map, $a._p = (TMP_35 = function(j){var self = TMP_35._s || this;
if (j == null) j = nil;
              return j['$-'](1)}, TMP_35._s = self, TMP_35), $a).call($b)}, TMP_34._s = self, TMP_34), $a).call($c), "flowlines": ($a = ($d = (print_options.$get("f"))).$map, $a._p = (TMP_36 = function(i){var self = TMP_36._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_36._s = self, TMP_36), $a).call($d), "subflowlines": ($a = ($e = (print_options.$get("sf"))).$map, $a._p = (TMP_37 = function(i){var self = TMP_37._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_37._s = self, TMP_37), $a).call($e), "jumplines": ($a = ($f = (print_options.$get("j"))).$map, $a._p = (TMP_38 = function(i){var self = TMP_38._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_38._s = self, TMP_38), $a).call($f), "layoutlines": ($a = ($g = (((($h = print_options.$get("l")) !== false && $h !== nil) ? $h : print_options.$get("v")))).$map, $a._p = (TMP_39 = function(i){var self = TMP_39._s || this;
if (i == null) i = nil;
            return i['$-'](1)}, TMP_39._s = self, TMP_39), $a).call($g)});
            missing_voices = ($a = ($h = (resulting_options['$[]']("voices")['$-'](resulting_options['$[]']("layoutlines")))).$map, $a._p = (TMP_40 = function(i){var self = TMP_40._s || this;
if (i == null) i = nil;
            return i['$+'](1)}, TMP_40._s = self, TMP_40), $a).call($h);
            ...
            return resulting_options;}, TMP_32._s = self, TMP_32), $a).call($l));
          print_options = (($a = $scope.Confstack) == null ? $opal.cm('Confstack') : $a).$new();
          print_options.$push($gvars.conf.$get("defaults.legend"));
          if ((($a = harpnote_options['$[]']("legend")) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          if ((($a = harpnote_options['$[]']("lyrics")) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        def.$_extract_chord_lines = function(entity) {
          var $a, $b, TMP_41, self = this, result = nil;

          result = [];
          if ((($a = entity['$[]']("chord")['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            ($a = ($b = entity['$[]']("chord")).$each, $a._p = (TMP_41 = function(chord){var self = TMP_41._s || this, $a, $b, TMP_42, text = nil;
if (chord == null) chord = nil;
            text = self.$Native(chord)['$[]']("name");
              return ($a = ($b = text.$split("\n")).$each, $a._p = (TMP_42 = function(line){var self = TMP_42._s || this;
if (line == null) line = nil;
              return result['$<<'](line)}, TMP_42._s = self, TMP_42), $a).call($b);}, TMP_41._s = self, TMP_41), $a).call($b)
          };
          return result;
        };
        ...
        def.$_extract_variant_ending = function(entity) {
          ...
          result = nil;
          if ((($a = entity['$[]']("startEnding")) !== nil && (!$a._isBoolean || $a == true))) {
            result = entity['$[]']("startEnding")};
          return result;
        };

        def.$make_jumplines = function(entity) {
          var $a, $b, $c, $d, TMP_43, self = this, result = nil, chords = nil;
          ...
          if ((($a = entity['$is_a?']((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).Playable == null ? $b.cm('Playable') : $b.Playable))) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            ($a = ($b = chords).$each, $a._p = (TMP_43 = function(name){var self = TMP_43._s || this, $a, $b, $c, nameparts = nil, targetname = nil, target = nil, argument = nil;
...
if (name == null) name = nil;
            if (name['$[]'](0)['$==']("@")) {
                ...
                if ((($a = target['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
                  ...
                  return result['$<<']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).Goto == null ? $a.cm('Goto') : $a.Goto).$new(entity, target, $hash2(["distance"], {"distance": argument})))
                };
                } else {
                return nil
        ...
        def.$make_notebound_annotations = function(entity) {
          var $a, $b, $c, $d, TMP_44, self = this, result = nil, chords = nil;

          result = [];
          if ((($a = entity['$is_a?']((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).Playable == null ? $b.cm('Playable') : $b.Playable))) !== nil && (!$a._isBoolean || $a == true))) {
            chords = self.$_extract_chord_lines(entity.$origin());
            ($a = ($b = chords).$each, $a._p = (TMP_44 = function(name){var self = TMP_44._s || this, $a, $b, TMP_45, $c, $d, match = nil, semantic = nil, text = nil, pos_x = nil, pos_y = nil, $case = nil, annotation = nil, notepos = nil, position = nil;
              if (self.annotations == null) self.annotations = nil;
              if ($gvars.log == null) $gvars.log = nil;
if (name == null) name = nil;
            match = name.$match(/^([!#])([^\@]+)(\@(\-?[0-9\.]+),(\-?[0-9\.]+))?$/);
              if (match !== false && match !== nil) {
                semantic = match['$[]'](1);
                text = match['$[]'](2);
                if ((($a = match['$[]'](4)) !== nil && (!$a._isBoolean || $a == true))) {
                  pos_x = match['$[]'](4)};
                if ((($a = match['$[]'](5)) !== nil && (!$a._isBoolean || $a == true))) {
                  pos_y = match['$[]'](5)};
                ...
                if (annotation !== false && annotation !== nil) {
                  if (pos_x !== false && pos_x !== nil) {
                    notepos = ($a = ($b = [pos_x, pos_y]).$map, $a._p = (TMP_45 = function(p){var self = TMP_45._s || this;
if (p == null) p = nil;
                    return p.$to_f()}, TMP_45._s = self, TMP_45), $a).call($b)};
                  position = ((($a = ((($c = notepos) !== false && $c !== nil) ? $c : annotation['$[]']("pos"))) !== false && $a !== nil) ? $a : [2, -5]);
                  return result['$<<']((($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).NoteBoundAnnotation == null ? $a.cm('NoteBoundAnnotation') : $a.NoteBoundAnnotation).$new(entity, $hash2(["pos", "text"], {"pos": position, "text": annotation['$[]']("text")})));
                  } else {
                  return nil
                };
                } else {
        ...
        def.$transform_note = function(note, index) {
          var $a, $b, $c, $d, TMP_46, self = this, duration = nil, start_tuplet = nil, end_tuplet = nil, result = nil, pitch_note = nil, chords = nil, jumpends = nil;

          if (index == null) {
            index = 0
          }
          duration = ((($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).SHORTEST_NOTE == null ? $a.cm('SHORTEST_NOTE') : $a.SHORTEST_NOTE)['$*'](note['$[]']("duration"))).$round();
          if ((($a = note['$[]']("startTriplet")) !== nil && (!$a._isBoolean || $a == true))) {
            start_tuplet = true};
          if ((($a = note['$[]']("endTriplet")) !== nil && (!$a._isBoolean || $a == true))) {
            end_tuplet = true};
          if (self.tuplet_downcount['$>'](1)) {
            self.tuplet_downcount = self.tuplet_downcount['$-'](1)
            } else {
          ...
          if ((($a = result['$empty?']()['$!']()) !== nil && (!$a._isBoolean || $a == true))) {
            result.$first()['$tuplet='](self.current_tuplet);
            ...
            jumpends = [];
            ($a = ($b = chords).$each, $a._p = (TMP_46 = function(name){var self = TMP_46._s || this, $a, $b, TMP_47;
              if (self.jumptargets == null) self.jumptargets = nil;
if (name == null) name = nil;
            if (name['$[]'](0)['$=='](":")) {
                jumpends.$push(name['$[]']($range(1, -1, false)));
                self.jumptargets['$[]='](name['$[]']($range(1, -1, false)), ($a = ($b = result).$select, $a._p = (TMP_47 = function(n){var self = TMP_47._s || this, $a, $b, $c;
if (n == null) n = nil;
                return n['$is_a?']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).Playable == null ? $a.cm('Playable') : $a.Playable))}, TMP_47._s = self, TMP_47), $a).call($b).$last());};
              if (name['$[]'](0)['$==']("@")) {
                return nil
                } else {
                return nil
        ...
        def.$transform_rest = function(note, duration, pitch_note) {
          var $a, $b, $c, TMP_48, self = this, pitch = nil, rest = nil, result = nil;
          ...
          if ((($a = pitch_note['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            pitch = self.pitch_transformer.$get_midipitch(self.$Native(pitch_note['$[]']("pitches")).$first())
          };
          rest = (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).Pause == null ? $a.cm('Pause') : $a.Pause).$new(pitch, duration);
          rest['$origin='](note);
          if (note['$[]']("rest")['$[]']("type")['$==']("invisible")) {
            rest['$visible='](false)};
          self.previous_note = rest;
          result = [rest];
          if ((($a = self.next_note_marks['$[]']("measure")) !== nil && (!$a._isBoolean || $a == true))) {
            result['$<<']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).MeasureStart == null ? $a.cm('MeasureStart') : $a.MeasureStart).$new(rest));
            self.next_note_marks['$[]=']("measure", false);};
          if ((($a = self.next_note_marks['$[]']("repeat_start")) !== nil && (!$a._isBoolean || $a == true))) {
            self.repetition_stack['$<<'](rest);
            self.next_note_marks['$[]=']("repeat_start", false);};
          if ((($a = self.next_note_marks['$[]']("variant_ending")) !== nil && (!$a._isBoolean || $a == true))) {
            result['$<<']((($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Music == null ? $b.cm('Music') : $b.Music))._scope).NoteBoundAnnotation == null ? $a.cm('NoteBoundAnnotation') : $a.NoteBoundAnnotation).$new(self.previous_note, $hash2(["pos", "text"], {"pos": [0, 0], "text": self.next_note_marks['$[]']("variant_ending")})));
            self.next_note_marks['$[]']("variant_ending");};
          ($a = ($b = self.previous_new_part).$each, $a._p = (TMP_48 = function(part){var self = TMP_48._s || this;
if (part == null) part = nil;
          part['$companion='](rest);
            return rest['$first_in_part='](true);}, TMP_48._s = self, TMP_48), $a).call($b);
          self.previous_new_part.$clear();
          return result;
        };

        def.$transform_real_note = function(note, duration) {
          var $a, $b, TMP_49, $c, $d, TMP_51, $e, TMP_52, $f, TMP_53, $g, TMP_54, self = this, notes = nil, result = nil, synchpoint = nil;

          notes = ($a = ($b = self.$Native(note['$[]']("pitches"))).$map, $a._p = (TMP_49 = function(pitch){var self = TMP_49._s || this, $a, $b, $c, TMP_50, midipitch = nil, native_pitch = nil, thenote = nil;
...
if (pitch == null) pitch = nil;
          midipitch = self.pitch_transformer.$get_midipitch(pitch);
            ...
            thenote['$origin='](note);
            thenote['$slur_starts='](($a = ($b = (((($c = native_pitch['$[]']("startSlur")) !== false && $c !== nil) ? $c : []))).$map, $a._p = (TMP_50 = function(s){var self = TMP_50._s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_50._s = self, TMP_50), $a).call($b));
            ...
            return thenote;}, TMP_49._s = self, TMP_49), $a).call($b);
          result = [];
          if (notes.$length()['$=='](1)) {
            result['$<<'](notes.$first())
            } else {
            ...
            synchpoint['$slur_starts='](($a = ($c = (((($d = note['$[]']("startSlur")) !== false && $d !== nil) ? $d : []))).$map, $a._p = (TMP_51 = function(s){var self = TMP_51._s || this;
if (s == null) s = nil;
            return self.$Native(s)['$[]']("label")}, TMP_51._s = self, TMP_51), $a).call($c));
            synchpoint['$slur_ends='](((($a = note['$[]']("endSlur")) !== false && $a !== nil) ? $a : []));
            synchpoint['$tie_start='](((($a = (note['$[]']("startTie")['$nil?']()['$!']())) !== false && $a !== nil) ? $a : (($d = ($e = notes).$select, $d._p = (TMP_52 = function(n){var self = TMP_52._s || this;
if (n == null) n = nil;
            return n['$tie_start?']()}, TMP_52._s = self, TMP_52), $d).call($e)['$empty?']()['$!']())));
            synchpoint['$tie_end='](((($a = (note['$[]']("endTie")['$nil?']()['$!']())) !== false && $a !== nil) ? $a : (($d = ($f = notes).$select, $d._p = (TMP_53 = function(n){var self = TMP_53._s || this;
if (n == null) n = nil;
            return n['$tie_end?']()}, TMP_53._s = self, TMP_53), $d).call($f)['$empty?']()['$!']())));
            result['$<<'](synchpoint);
          };
          self.previous_note = result.$last();
          if ((($a = self.next_note_marks['$[]']("measure")) !== nil && (!$a._isBoolean || $a == true))) {
            result['$<<']((($a = ((($d = ((($g = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $g))._scope).Music == null ? $d.cm('Music') : $d.Music))._scope).MeasureStart == null ? $a.cm('MeasureStart') : $a.MeasureStart).$new(notes.$last()));
            self.next_note_marks['$[]=']("measure", false);};
          if ((($a = self.next_note_marks['$[]']("repeat_start")) !== nil && (!$a._isBoolean || $a == true))) {
            self.repetition_stack['$<<'](notes.$last());
            self.next_note_marks['$[]=']("repeat_start", false);};
          if ((($a = self.next_note_marks['$[]']("variant_ending")) !== nil && (!$a._isBoolean || $a == true))) {
            result['$<<']((($a = ((($d = ((($g = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $g))._scope).Music == null ? $d.cm('Music') : $d.Music))._scope).NoteBoundAnnotation == null ? $a.cm('NoteBoundAnnotation') : $a.NoteBoundAnnotation).$new(self.previous_note, $hash2(["pos", "text"], {"pos": [4, -2], "text": self.next_note_marks['$[]']("variant_ending")})));
            self.next_note_marks['$[]=']("variant_ending", nil);};
          ($a = ($d = self.previous_new_part).$each, $a._p = (TMP_54 = function(part){var self = TMP_54._s || this;
if (part == null) part = nil;
          part['$companion='](notes.$last());
            return notes.$last()['$first_in_part='](true);}, TMP_54._s = self, TMP_54), $a).call($d);
          self.previous_new_part.$clear();
          return result;
        };
        ...
        def.$transform_bar_right_repeat = function(bar) {
          var $a, $b, TMP_55, $c, $d, self = this, start = nil, distance = nil;
          ...
          distance = 2;
          ($a = ($b = self.$_extract_chord_lines(bar)).$each, $a._p = (TMP_55 = function(line){var self = TMP_55._s || this, $a, level = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (line == null) line = nil;
          level = line.$split("@");
            if ((($a = level['$[]'](2)) !== nil && (!$a._isBoolean || $a == true))) {
              level = level['$[]'](2);
              $gvars.log.$debug("bar repeat level " + (level) + " " + ("abc_to_harpnotes") + ":" + (697));
          ...
          return [(($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).Goto == null ? $a.cm('Goto') : $a.Goto).$new(self.previous_note, start, $hash2(["distance"], {"distance": distance}))];
        };
        ...
        return (def.$method_missing = function(name, args) {
          ...
          args = $slice.call(arguments, 1);
          $gvars.log.$debug("Missing transformation rule: " + (name) + " (" + ("abc_to_harpnotes") + " " + (713) + ")");
          return nil;
        }, nil) && 'method_missing';
      })(self, null);
...
if (child == null) child = nil;
        self.paper['$line_width='](child.$line_width());
          if ((($a = child['$is_a?']((($b = $scope.Ellipse) == null ? $opal.cm('Ellipse') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            $gvars.log.$debug("BUG:don't know how to draw " + (child.$class()) + " (" + ("raphael_engine") + " " + (48) + ")");
            return nil;
...
if (part == null) part = nil;
      ...
      def.$draw_annotation = function(root) {
        var $a, $b, $c, $d, $e, self = this, style = nil, mm_per_point = nil, text = nil, element = nil, scaley = nil, scalex = nil, bbox = nil, dx = nil, dy = nil, translation = nil;
        if ($gvars.log == null) $gvars.log = nil;

        style = ((($a = (($b = ((($c = ((($d = ((($e = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $e))._scope).Layout == null ? $d.cm('Layout') : $d.Layout))._scope).Default == null ? $c.cm('Default') : $c.Default))._scope).FONT_STYLE_DEF == null ? $b.cm('FONT_STYLE_DEF') : $b.FONT_STYLE_DEF)['$[]'](root.$style())) !== false && $a !== nil) ? $a : (($b = ((($c = ((($d = ((($e = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $e))._scope).Layout == null ? $d.cm('Layout') : $d.Layout))._scope).Default == null ? $c.cm('Default') : $c.Default))._scope).FONT_STYLE_DEF == null ? $b.cm('FONT_STYLE_DEF') : $b.FONT_STYLE_DEF)['$[]']("regular"));
        mm_per_point = (($a = ((($b = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Layout == null ? $c.cm('Layout') : $c.Layout))._scope).Default == null ? $b.cm('Default') : $b.Default))._scope).MM_PER_POINT == null ? $a.cm('MM_PER_POINT') : $a.MM_PER_POINT);
        text = root.$text().$gsub("\n\n", "\n \n");
        ...
        scaley = style['$[]']("font_size")['$/'](3);
        scalex = scaley['$*'](45)['$/'](42.5);
        element.$transform("s" + (scalex) + "," + (scaley));
        bbox = element.$get_bbox();
        $gvars.log.$debug("" + (root.$center().$first()) + ", " + (root.$center().$last()) + " ”" + (text) + "” " + (bbox['$[]']("width")) + ", " + (bbox['$[]']("height")) + " (" + ("raphael_engine") + " " + (279) + ")");
...
if (border == null) border = nil;
          return self.$draw_cutmarks(i, delta, border)}, TMP_3._s = self, TMP_3), $a).call($b)}, TMP_2._s = self, TMP_2), $a).call($b);
        ($a = ($c = sheet.$children()).$each, $a._p = (TMP_4 = function(child){var self = TMP_4._s || this, $a, $b, $c, $d;
          if (self.pdf == null) self.pdf = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (child == null) child = nil;
        self.pdf['$line_width='](child.$line_width());
          if ((($a = child['$is_a?']((($b = $scope.Ellipse) == null ? $opal.cm('Ellipse') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
            if ((($a = child['$visible?']()) !== nil && (!$a._isBoolean || $a == true))) {
              return self.$draw_ellipse(child)
              } else {
      ...
      def.$draw_annotation = function(root) {
        var $a, $b, $c, $d, $e, self = this, style = nil, mm_per_point = nil;
        ...
        return self.pdf.$text(root.$center().$first(), root.$center().$last()['$+'](style['$[]']("font_size")['$*'](mm_per_point)), root.$text());
      };

      def.$draw_cutmarks = function(i, delta, border) {
        var $a, self = this, vertical_pos = nil, hpos = nil, hdiff = nil, center = nil, size = nil;
        ...
        center = self.$Vector2d((($a = $scope.X_SPACING) == null ? $opal.cm('X_SPACING') : $a)['$/'](2.0)['$+'](delta['$*'](i)), vertical_pos);
        size = 1;
        self.pdf.$line((center['$+']([size['$-@'](), size['$-@']()])).$to_a(), (center['$+']([size, size])).$to_a());
        return self.pdf.$line((center['$+']([size['$-@'](), size])).$to_a(), (center['$+']([size, size['$-@']()])).$to_a());
      };
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return lines = [];}else {return $gvars.log.$error("BUG: unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (147) + ")")}})()}, TMP_11._s = self, TMP_11), $a).call($e);
        self.pdf['$stroke=']([0, 0, 0]);
        if ((($a = root['$dotted?']()) !== nil && (!$a._isBoolean || $a == true))) {
...
if (s == null) s = nil;
      ...
      return (def.$draw_path = function(root) {
        ...
        self.pdf['$fill='](($a = ($b = ($range(1, 3, false))).$map, $a._p = (TMP_15 = function(){var self = TMP_15._s || this, $a;
...
if (element == null) element = nil;
        return (function() {$case = element.$first();if ("M"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          lines = [];
          return start = element['$[]']($range(1, 2, false));}else if ("L"['$===']($case)) {if ((($a = lines['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            self.pdf.$lines(lines, start.$first(), start.$last(), scale, style, false)
          };
          lines = [];
          ...
          return lines = [];}else {return $gvars.log.$error("BUG: unsupported command '" + (element.$first()) + "' in glyph (" + ("pdf_engine") + " " + (242) + ")")}})()}, TMP_16._s = self, TMP_16), $a).call($c);
...
if (s == null) s = nil;
        return ($a = ($b = s).$select, $a._p = (TMP_15 = function(x){var self = TMP_15._s || this;
if (x == null) x = nil;
          return x['$nil?']()['$!']()}, TMP_15._s = self, TMP_15), $a).call($b).$first()}, TMP_14._s = self, TMP_14), $a).call($b);
      };
      ...
      def.$run_string = function(command) {
        ...
        parts = ($a = ($b = parts).$map, $a._p = (TMP_16 = function(p){var self = TMP_16._s || this;
if (p == null) p = nil;
        return p.$gsub("\\\\", "\\")}, TMP_16._s = self, TMP_16), $a).call($b);
        the_command = self.commands['$[]'](parts.$first().$to_sym());
        if (the_command !== false && the_command !== nil) {
          } else {
          self.$raise("wrong command: " + (command))
        };
        ($a = ($c = parts['$[]']($range(1, -1, false))).$each_with_index, $a._p = (TMP_17 = function(argument, index){var self = TMP_17._s || this;
if (argument == null) argument = nil;if (index == null) index = nil;
      ...
      def.$undostack = function() {
        ...
        return ($a = ($b = self.undo_stack).$map, $a._p = (TMP_18 = function(c){var self = TMP_18._s || this;
if (c == null) c = nil;
        return c.$clone().$unshift("undo")}, TMP_18._s = self, TMP_18), $a).call($b);
      };

      def.$redostack = function() {
        var $a, $b, TMP_19, self = this;

        return ($a = ($b = self.redo_stack).$map, $a._p = (TMP_19 = function(c){var self = TMP_19._s || this;
if (c == null) c = nil;
        return c.$clone().$unshift("redo")}, TMP_19._s = self, TMP_19), $a).call($b);
      };

      return (def.$help_string_style = function() {
        var $a, $b, TMP_20, $c, $d, TMP_22, self = this;

        return ($a = ($b = ($c = ($d = self.commands.$to_a()).$select, $c._p = (TMP_22 = function(c){var self = TMP_22._s || this;
if (c == null) c = nil;
        return c.$last()['$is_public?']()}, TMP_22._s = self, TMP_22), $c).call($d)).$map, $a._p = (TMP_20 = function(k, c){var self = TMP_20._s || this, $a, $b, TMP_21, parameter_names = nil;
if (k == null) k = nil;if (c == null) c = nil;
        parameter_names = ($a = ($b = c.$parameters()).$map, $a._p = (TMP_21 = function(p){var self = TMP_21._s || this;
if (p == null) p = nil;
          return "{" + (p.$name()) + "}"}, TMP_21._s = self, TMP_21), $a).call($b).$join(" ");
          return "" + (c.$name()) + " " + (parameter_names) + " : " + (c.$get_help());}, TMP_20._s = self, TMP_20), $a).call($b);
...
(function($opal) {
  ...
  $opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$warn', '$clone', '$private', '$attr', '$html', '$find', '$new', '$load_from_loacalstorage', '$on_command', '$save_to_localstorage', '$handle_command', '$info', '$push', '$_init_conf', '$each', '$send', '$select', '$=~', '$methods', '$setup_ui', '$load_demo_tune', '$set_status', '$loglevel', '$render_previews', '$setup_nodewebkit', '$setup_ui_listener', '$run_string', '$error', '$message', '$caller', '$include?', '$get_text', '$Native', '$nil?', '$set_text', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$==', '$play_song', '$play_selection', '$play_from_selection', '$backtrace', '$debug', '$set_inactive', '$load_song', '$send_remote_command', '$setup_tune_preview', '$set_active', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$now', '$clear_annotations', '$transform', '$layout', '$set_annotations', '$annotations', '$-', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$merge!', '$join', '$inject', '$first', '$last', '$to_s', '$loglevel=', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$width', '$on', '$play_abc', '$on_change', '$===', '$on_selection_change', '$get_selection_positions', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$key', '$newValue', '$systemstatus', '$prevent', '$css', '$page_x', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
  ...
  (function($base, $super) {
    ...
    def.console = def.commands = def.systemstatus = def.editor = def.harpnote_player = def.tune_preview_printer = def.song = def.harpnote_preview_printer = def.song_harpnotes = nil;
    self.$attr("editor", "harpnote_preview_printer", "tune_preview_printer", "systemstatus");

    def.$initialize = function() {
      var $a, $b, TMP_1, $c, $d, TMP_2, $e, TMP_3, self = this;
      if ($gvars.log == null) $gvars.log = nil;
      if ($gvars.conf == null) $gvars.conf = nil;

      (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#lbZupfnoter").$html("Zupfnoter " + ((($a = $scope.VERSION) == null ? $opal.cm('VERSION') : $a)));
      self.console = (($a = ((($b = $scope.JqConsole) == null ? $opal.cm('JqConsole') : $b))._scope).JqConsole == null ? $a.cm('JqConsole') : $a.JqConsole).$new("commandconsole", "zupfnoter> ");
      self.console.$load_from_loacalstorage();
      ($a = ($b = self.console).$on_command, $a._p = (TMP_1 = function(cmd){var self = TMP_1._s || this;
        if (self.console == null) self.console = nil;
if (cmd == null) cmd = nil;
      self.console.$save_to_localstorage();
        return self.$handle_command(cmd);}, TMP_1._s = self, TMP_1), $a).call($b);
      $gvars.log = (($a = $scope.ConsoleLogger) == null ? $opal.cm('ConsoleLogger') : $a).$new(self.console);
      $gvars.log.$info("Welcome to Zupfnoter " + ((($a = $scope.VERSION) == null ? $opal.cm('VERSION') : $a)));
      $gvars.conf = (($a = $scope.Confstack) == null ? $opal.cm('Confstack') : $a).$new();
      $gvars.conf.$push(self.$_init_conf());
      self.editor = (($a = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).TextPane == null ? $a.cm('TextPane') : $a.TextPane).$new("abcEditor");
      self.harpnote_player = (($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Music == null ? $c.cm('Music') : $c.Music))._scope).HarpnotePlayer == null ? $a.cm('HarpnotePlayer') : $a.HarpnotePlayer).$new();
      self.songbook = (($a = $scope.LocalStore) == null ? $opal.cm('LocalStore') : $a).$new("songbook");
      self.abc_transformer = (($a = ((($c = ((($d = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $d))._scope).Input == null ? $c.cm('Input') : $c.Input))._scope).ABCToHarpnotes == null ? $a.cm('ABCToHarpnotes') : $a.ABCToHarpnotes).$new();
      self.dropboxclient = (($a = ((($c = ((($d = $scope.Opal) == null ? $opal.cm('Opal') : $d))._scope).DropboxJs == null ? $c.cm('DropboxJs') : $c.DropboxJs))._scope).NilClient == null ? $a.cm('NilClient') : $a.NilClient).$new();
      self.systemstatus = $hash2([], {});
      self.commands = (($a = ((($c = $scope.CommandController) == null ? $opal.cm('CommandController') : $c))._scope).CommandStack == null ? $a.cm('CommandStack') : $a.CommandStack).$new();
      ($a = ($c = ($d = ($e = self.$methods()).$select, $d._p = (TMP_3 = function(n){var self = TMP_3._s || this;
if (n == null) n = nil;
      return n['$=~'](/__ic.*/)}, TMP_3._s = self, TMP_3), $d).call($e)).$each, $a._p = (TMP_2 = function(m){var self = TMP_2._s || this;
if (m == null) m = nil;
      return self.$send(m)}, TMP_2._s = self, TMP_2), $a).call($c);
      self.$setup_ui();
      self.$load_demo_tune();
      self.$set_status($hash2(["dropbox", "song", "loglevel", "autorefresh", "view"], {"dropbox": "not connected", "song": "unchanged", "loglevel": $gvars.log.$loglevel(), "autorefresh": "on", "view": 0}));
    ...
    def.$handle_command = function(command) {
      ...
      return self.commands.$run_string(command)
        ...
        return $gvars.log.$error("" + (e.$message()) + " in " + (command) + " " + (e.$caller()) + " " + ("controller") + ":" + (134))
        }else { throw $err; }
      };
    };
...
if (key == null) key = nil;if (_ == null) _ = nil;
    ...
    def.$load_from_loacalstorage = function() {
      ...
      envelope = (($a = $scope.JSON) == null ? $opal.cm('JSON') : $a).$parse(localStorage.getItem('systemstatus'));
      if (envelope !== false && envelope !== nil) {
    ...
    def.$render_tunepreview_callback = function() {
      ...
      $gvars.log.$debug("finished render tune " + ("controller") + " " + (212));
    ...
    def.$render_harpnotepreview_callback = function() {
      ...
      try {
      $gvars.log.$debug("viewid: " + (self.systemstatus['$[]']("view")) + " " + ("controller") + " " + (221));
      ...
      $gvars.log.$debug("finished rendering Haprnotes " + ("controller") + " " + (229));
    ...
    def.$layout_harpnotes = function(print_variant) {
      ...
      result = (($a = ((($b = ((($c = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $c))._scope).Layout == null ? $b.cm('Layout') : $b.Layout))._scope).Default == null ? $a.cm('Default') : $a.Default).$new().$layout(self.song, nil, print_variant);
    ...
    def.$highlight_abc_object = function(abcelement) {
      ...
      $gvars.log.$debug("select_abc_element " + (a['$[]']("startChar")) + " (" + ("controller") + " " + (282) + ")");
...
if (r == null) r = nil;if (v == null) v = nil;
      ...
      $gvars.log.$debug("" + (self.systemstatus.$to_s()) + " " + ("controller") + " " + (321));
    ...
    def.$setup_ui = function() {
      ...
      return ($a = ($b = self.harpnote_preview_printer).$on_select, $a._p = (TMP_6 = function(harpnote){var self = TMP_6._s || this;
if (harpnote == null) harpnote = nil;
      return self.$select_abc_object(harpnote.$origin())}, TMP_6._s = self, TMP_6), $a).call($b);
    };

    def.$setup_tune_preview = function() {
      var $a, $b, $c, TMP_7, self = this, width = nil, printerparams = nil;
      if ($gvars.log == null) $gvars.log = nil;

      width = self.$Native((($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#tunePreviewContainer").$width())['$-'](50);
      $gvars.log.$debug("tune preview-width " + (width) + " " + ("controller") + ":" + (342));
...
if (abcelement == null) abcelement = nil;
      a = self.$Native(abcelement);
        return self.$select_abc_object(abcelement);}, TMP_7._s = self, TMP_7), $a).call($b);
    };

    def.$setup_ui_listener = function() {
      var $a, $b, TMP_8, $c, TMP_9, $d, TMP_10, $e, TMP_11, $f, TMP_12, $g, TMP_13, $h, TMP_14, $i, TMP_15, $j, TMP_16, $k, TMP_17, $l, TMP_18, $m, self = this;

      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#tbPlay")).$on, $a._p = (TMP_8 = function(){var self = TMP_8._s || this;

      return self.$play_abc("selection_ff")}, TMP_8._s = self, TMP_8), $a).call($b, "click");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#tbRender")).$on, $a._p = (TMP_9 = function(){var self = TMP_9._s || this;

      return self.$render_previews()}, TMP_9._s = self, TMP_9), $a).call($c, "click");
      ($a = ($d = (($e = $scope.Element) == null ? $opal.cm('Element') : $e).$find("#tbPrintA3")).$on, $a._p = (TMP_10 = function(){var self = TMP_10._s || this, url = nil;

      url = self.$render_a3().$output("datauristring");
        return window.open(url);}, TMP_10._s = self, TMP_10), $a).call($d, "click");
      ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find("#tbPrintA4")).$on, $a._p = (TMP_11 = function(){var self = TMP_11._s || this, url = nil;

      url = self.$render_a4().$output("datauristring");
        return window.open(url);}, TMP_11._s = self, TMP_11), $a).call($e, "click");
      ($a = ($f = self.editor).$on_change, $a._p = (TMP_12 = function(e){var self = TMP_12._s || this, $a, $case = nil;
...
if (e == null) e = nil;
      self.$set_status($hash2(["song"], {"song": "changed"}));
        ...
        return nil;}, TMP_12._s = self, TMP_12), $a).call($f);
      ($a = ($g = self.editor).$on_selection_change, $a._p = (TMP_13 = function(e){var self = TMP_13._s || this, a = nil;
...
if (e == null) e = nil;
      a = self.editor.$get_selection_positions();
        ...
        };}, TMP_13._s = self, TMP_13), $a).call($g);
      ($a = ($h = self.harpnote_player).$on_noteon, $a._p = (TMP_14 = function(e){var self = TMP_14._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteon " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (400) + ")");
        return self.$highlight_abc_object(e);}, TMP_14._s = self, TMP_14), $a).call($h);
      ($a = ($i = self.harpnote_player).$on_noteoff, $a._p = (TMP_15 = function(e){var self = TMP_15._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteoff " + (self.$Native(e)['$[]']("startChar")) + " (" + ("controller") + " " + (405) + ")");
        return self.$unhighlight_abc_object(e);}, TMP_15._s = self, TMP_15), $a).call($i);
      ($a = ($j = self.harpnote_player).$on_songoff, $a._p = (TMP_16 = function(){var self = TMP_16._s || this;

      return self.$stop_play_abc()}, TMP_16._s = self, TMP_16), $a).call($j);
      ($a = ($k = (($l = $scope.Element) == null ? $opal.cm('Element') : $l).$find(window)).$on, $a._p = (TMP_17 = function(evt){var self = TMP_17._s || this, $a, $b, $c, key = nil, value = nil;
        if ($gvars.log == null) $gvars.log = nil;
if (evt == null) evt = nil;
      key = self.$Native(evt['$[]']("originalEvent")).$key();
        value = self.$Native(evt['$[]']("originalEvent")).$newValue();
        $gvars.log.$debug("got storage event " + (key) + ": " + (value) + " (" + ("controller") + " " + (433) + ")");
        if ((($a = ($b = (($c = self.$systemstatus()['$[]']("autorefresh")['$==']("remote")) ? key['$==']("command") : $c), $b !== false && $b !== nil ?value['$==']("render") : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        };}, TMP_17._s = self, TMP_17), $a).call($k, "storage");
      return ($a = ($l = (($m = $scope.Element) == null ? $opal.cm('Element') : $m).$find("#dragbar")).$on, $a._p = (TMP_18 = function(re){var self = TMP_18._s || this, $a, $b, TMP_19, $c, TMP_20, $d;
if (re == null) re = nil;
      re.$prevent();
        ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find(document)).$on, $a._p = (TMP_19 = function(e){var self = TMP_19._s || this, $a;
if (e == null) e = nil;
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
          ...
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#dragbar").$css("left", "" + (e.$page_x()) + "px");}, TMP_19._s = self, TMP_19), $a).call($b, "mousemove");
        return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(document)).$on, $a._p = (TMP_20 = function(){var self = TMP_20._s || this;

        return $(document).unbind('mousemove');}, TMP_20._s = self, TMP_20), $a).call($c, "mouseup");}, TMP_18._s = self, TMP_18), $a).call($l, "mousedown");
    };
    ...
    return (def.$_init_conf = function() {
      ...
      return $hash2(["defaults", "active"], {"defaults": $hash2(["print", "legend", "lyrics"], {"print": $hash2(["t", "v", "startpos", "s", "f", "sf", "j", "l"], {"t": "", "v": [1, 2, 3, 4], "startpos": 15, "s": [[1, 2], [2, 3]], "f": [1, 3], "sf": [2, 4], "j": [1, 3], "l": [1, 2, 3, 4]}), "legend": $hash2(["pos"], {"pos": [20, 20]}), "lyrics": $hash2(["pos"], {"pos": [20, 60]})}), "active": $hash2(["LINE_THIN", "LINE_MEDIUM", "LINE_THICK", "ELLIPSE_SIZE", "REST_SIZE", "X_SPACING", "X_OFFSET", "Y_SCALE", "DRAWING_AREA_SIZE", "BEAT_RESOULUTION", "SHORTEST_NOTE", "BEAT_PER_DURATION", "PITCH_OFFSET", "FONT_STYLE_DEF", "MM_PER_POINT", "DURATION_TO_STYLE", "REST_TO_GLYPH"], {"LINE_THIN": 0.1, "LINE_MEDIUM": 0.3, "LINE_THICK": 0.5, "ELLIPSE_SIZE": [2.8, 1.7], "REST_SIZE": [2.8, 2.8], "X_SPACING": 11.5, "X_OFFSET": 2.8, "Y_SCALE": 4, "DRAWING_AREA_SIZE": [400, 282], "BEAT_RESOULUTION": 192, "SHORTEST_NOTE": 64, "BEAT_PER_DURATION": 3, "PITCH_OFFSET": -43, "FONT_STYLE_DEF": $hash2(["smaller", "small", "regular", "large"], {"smaller": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 6, "font_style": "normal"}), "small": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 9, "font_style": "normal"}), "regular": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 12, "font_style": "normal"}), "large": $hash2(["text_color", "font_size", "font_style"], {"text_color": [0, 0, 0], "font_size": 20, "font_style": "bold"})}), "MM_PER_POINT": 0.3, "DURATION_TO_STYLE": $hash2(["err", "d64", "d48", "d32", "d24", "d16", "d12", "d8", "d6", "d4", "d3", "d2", "d1"], {"err": [2, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d64": [0.9, "empty", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d48": [0.7, "empty", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d32": [0.7, "empty", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d24": [0.7, "filled", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d16": [0.7, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d12": [0.5, "filled", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d8": [0.5, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d6": [0.3, "filled", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d4": [0.3, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d3": [0.1, "filled", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d2": [0.1, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d1": [0.05, "filled", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)]}), "REST_TO_GLYPH": $hash2(["err", "d64", "d48", "d32", "d24", "d16", "d12", "d8", "d6", "d4", "d3", "d2", "d1"], {"err": [[2, 2], "rest_1", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d64": [[0.9, 0.9], "rest_1", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d48": [[0.5, 0.5], "rest_1", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d32": [[0.5, 0.5], "rest_1", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d24": [[0.4, 0.7], "rest_4", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d16": [[0.4, 0.7], "rest_4", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d12": [[0.3, 0.5], "rest_8", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d8": [[0.3, 0.5], "rest_8", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d6": [[0.3, 0.4], "rest_16", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d4": [[0.3, 0.5], "rest_16", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d3": [[0.3, 0.5], "rest_32", (($a = $scope.TRUE) == null ? $opal.cm('TRUE') : $a)], "d2": [[0.3, 0.5], "rest_32", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)], "d1": [[0.3, 0.5], "rest_64", (($a = $scope.FALSE) == null ? $opal.cm('FALSE') : $a)]})})});
    }, nil) && '_init_conf';
  })(self, null);
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_21 = function(){var self = TMP_21._s || this, $a;

  return (($a = $scope.Controller) == null ? $opal.cm('Controller') : $a).$new()}, TMP_21._s = self, TMP_21), $a).call($b);
})(Opal);
...
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    return (def.$__ic_06_node_fs_commands = function() {
      ...
      ($a = ($b = self.commands).$add_command, $a._p = (TMP_1 = function(command){var self = TMP_1._s || this, $a, $b, TMP_2, $c, TMP_4, $d, TMP_5;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_2 = function(parameter){var self = TMP_2._s || this, $a, $b, TMP_3;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_default, $a._p = (TMP_3 = function(){var self = TMP_3._s || this;
            if (self.node_fs_path == null) self.node_fs_path = nil;

          return self.node_fs_path}, TMP_3._s = self, TMP_3), $a).call($b)}, TMP_2._s = self, TMP_2), $a).call($b, "path", "string");
        command['$undoable='](false);
        ($a = ($c = command).$set_help, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

        return "save to local file system {" + (command.$parameter_help(0)) + "}"}, TMP_4._s = self, TMP_4), $a).call($c);
        return ($a = ($d = command).$as_action, $a._p = (TMP_5 = function(args){var self = TMP_5._s || this, $a, $b, TMP_6, $c, TMP_7, abc_code = nil, metadata = nil, filebase = nil, rootpath = nil, print_variants = nil, pdfs = nil;
          if (self.editor == null) self.editor = nil;
...
if (args == null) args = nil;
        abc_code = self.editor.$get_text();
          ...
          pdfs = $hash2([], {});
          ($a = ($b = print_variants.$each_with_index()).$map, $a._p = (TMP_6 = function(print_variant, index){var self = TMP_6._s || this, filename = nil;
if (print_variant == null) print_variant = nil;if (index == null) index = nil;
          filename = print_variant['$[]']("title").$gsub(/[^a-zA-Z0-9\-\_]/, "_");
            ...
            return pdfs['$[]=']("" + (rootpath) + "/" + (filebase) + "_" + (print_variant['$[]']("title")) + "_a4.pdf", self.$render_a4(index).$output("blob"));}, TMP_6._s = self, TMP_6), $a).call($b);
          var fs = require('fs');
          ($a = ($c = pdfs).$each, $a._p = (TMP_7 = function(name, pdfdata){var self = TMP_7._s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (name == null) name = nil;if (pdfdata == null) pdfdata = nil;
          
            fs.writeFileSync(name, pdfdata)
          ;
            return $gvars.log.$info(name);}, TMP_7._s = self, TMP_7), $a).call($c);
          name = "" + (rootpath) + "/" + (filebase) + ".abc";
          fs.writeFileSync(name, self.editor.$get_text())  ;
          return $gvars.log.$info("save abco to " + (name));}, TMP_5._s = self, TMP_5), $a).call($d);}, TMP_1._s = self, TMP_1), $a).call($b, "_fsave");
      return ($a = ($c = self.commands).$add_command, $a._p = (TMP_8 = function(command){var self = TMP_8._s || this, $a, $b, TMP_9, $c, TMP_11, $d, TMP_12, $e, TMP_13;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_9 = function(p){var self = TMP_9._s || this, $a, $b, TMP_10;
if (p == null) p = nil;
        return ($a = ($b = p).$set_help, $a._p = (TMP_10 = function(){var self = TMP_10._s || this;

          return "path to open"}, TMP_10._s = self, TMP_10), $a).call($b)}, TMP_9._s = self, TMP_9), $a).call($b, "path", "string");
...
if (args == null) args = nil;
        args['$[]=']("oldval", $hash2(["text", "nwworkdir"], {"text": self.editor.$get_text(), "nwworkdir": self.systemstatus['$[]']("nwworkingdir")}));
          ...
          };}, TMP_12._s = self, TMP_12), $a).call($d);
...
//# sourceMappingURL=/__opal_source_maps__/controller-nw.js.map
;
/* Generated by Opal 0.6.3 */
(function($opal) {
...
if (c == null) c = nil;
      ...
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_4 = function(command){var self = TMP_4._s || this, $a, $b, TMP_5, $c, TMP_8, $d, TMP_9;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_5 = function(p){var self = TMP_5._s || this, $a, $b, TMP_6, $c, TMP_7;
if (p == null) p = nil;
        ($a = ($b = p).$set_default, $a._p = (TMP_6 = function(){var self = TMP_6._s || this;
            if (self.systemstatus == null) self.systemstatus = nil;

          return self.systemstatus['$[]']("view")}, TMP_6._s = self, TMP_6), $a).call($b);
          return ($a = ($c = p).$set_help, $a._p = (TMP_7 = function(){var self = TMP_7._s || this;
            if (self.systemstatus == null) self.systemstatus = nil;

          return "id of the view to be used for preview [" + (self.systemstatus['$[]']("view")) + "]"}, TMP_7._s = self, TMP_7), $a).call($c);}, TMP_5._s = self, TMP_5), $a).call($b, "view", "integer");
        ($a = ($c = command).$set_help, $a._p = (TMP_8 = function(){var self = TMP_8._s || this;

        return "set current view  " + (command.$parameter_help(0)) + " and redisplay"}, TMP_8._s = self, TMP_8), $a).call($c);
        command['$undoable='](false);
        return ($a = ($d = command).$as_action, $a._p = (TMP_9 = function(args){var self = TMP_9._s || this;
if (args == null) args = nil;
        self.$set_status($hash2(["view"], {"view": args['$[]']("view").$to_i()}));
          return self.$render_previews();}, TMP_9._s = self, TMP_9), $a).call($d);}, TMP_4._s = self, TMP_4), $a).call($c, "view");
      ($a = ($d = self.commands).$add_command, $a._p = (TMP_10 = function(c){var self = TMP_10._s || this, $a, $b, TMP_11, $c, TMP_12, $d, TMP_15;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_11 = function(){var self = TMP_11._s || this;

        return "set log level to " + (c.$parameter_help(0))}, TMP_11._s = self, TMP_11), $a).call($b);
        ($a = ($c = c).$add_parameter, $a._p = (TMP_12 = function(parameter){var self = TMP_12._s || this, $a, $b, TMP_13, $c, TMP_14;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_13 = function(){var self = TMP_13._s || this;

          return "warning"}, TMP_13._s = self, TMP_13), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_14 = function(){var self = TMP_14._s || this;

          return "error | warning | info | debug"}, TMP_14._s = self, TMP_14), $a).call($c);}, TMP_12._s = self, TMP_12), $a).call($c, "level", "string");
        return ($a = ($d = c).$as_action, $a._p = (TMP_15 = function(args){var self = TMP_15._s || this;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        $gvars.log['$loglevel='](args['$[]']("level"));
          return self.$set_status($hash2(["loglevel"], {"loglevel": $gvars.log.$loglevel()}));}, TMP_15._s = self, TMP_15), $a).call($d);}, TMP_10._s = self, TMP_10), $a).call($d, "loglevel");
      ($a = ($e = self.commands).$add_command, $a._p = (TMP_16 = function(c){var self = TMP_16._s || this, $a, $b, TMP_17, $c, TMP_18, $d, TMP_21, values = nil;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_17 = function(){var self = TMP_17._s || this;

        return "turnon autorefresh"}, TMP_17._s = self, TMP_17), $a).call($b);
        values = $hash2(["on", "off", "remote"], {"on": "on", "off": "off", "remote": "remote"});
        ($a = ($c = c).$add_parameter, $a._p = (TMP_18 = function(parameter){var self = TMP_18._s || this, $a, $b, TMP_19, $c, TMP_20;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_19 = function(){var self = TMP_19._s || this;

          return "true"}, TMP_19._s = self, TMP_19), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_20 = function(){var self = TMP_20._s || this;

          return "" + (values.$keys().$join(" | "))}, TMP_20._s = self, TMP_20), $a).call($c);}, TMP_18._s = self, TMP_18), $a).call($c, "value", "string");
        return ($a = ($d = c).$as_action, $a._p = (TMP_21 = function(args){var self = TMP_21._s || this, result = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        result = values['$[]'](args['$[]']("value"));
          ...
          };}, TMP_21._s = self, TMP_21), $a).call($d);}, TMP_16._s = self, TMP_16), $a).call($e, "autorefresh");
      ($a = ($f = self.commands).$add_command, $a._p = (TMP_22 = function(c){var self = TMP_22._s || this, $a, $b, TMP_23, $c, TMP_24;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_23 = function(){var self = TMP_23._s || this;

        return "undo last command"}, TMP_23._s = self, TMP_23), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_24 = function(a){var self = TMP_24._s || this;
          if (self.commands == null) self.commands = nil;
if (a == null) a = nil;
        return self.commands.$undo()}, TMP_24._s = self, TMP_24), $a).call($c);}, TMP_22._s = self, TMP_22), $a).call($f, "undo");
      ($a = ($g = self.commands).$add_command, $a._p = (TMP_25 = function(c){var self = TMP_25._s || this, $a, $b, TMP_26, $c, TMP_27;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_26 = function(){var self = TMP_26._s || this;

        return "redo last command"}, TMP_26._s = self, TMP_26), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_27 = function(a){var self = TMP_27._s || this;
          if (self.commands == null) self.commands = nil;
if (a == null) a = nil;
        return self.commands.$redo()}, TMP_27._s = self, TMP_27), $a).call($c);}, TMP_25._s = self, TMP_25), $a).call($g, "redo");
      ($a = ($h = self.commands).$add_command, $a._p = (TMP_28 = function(c){var self = TMP_28._s || this, $a, $b, TMP_29, $c, TMP_30;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_29 = function(){var self = TMP_29._s || this;

        return "show history"}, TMP_29._s = self, TMP_29), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_30 = function(a){var self = TMP_30._s || this, $a, $b, TMP_31, history = nil;
          if (self.commands == null) self.commands = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        history = ($a = ($b = self.commands.$history()).$map, $a._p = (TMP_31 = function(c){var self = TMP_31._s || this;
if (c == null) c = nil;
          return "" + (c.$first()) + ": " + (c['$[]'](1).$name()) + "(" + (c.$last()) + ")"}, TMP_31._s = self, TMP_31), $a).call($b);
          return $gvars.log.$message("<pre>" + (history.$join("\n")) + "</pre>");}, TMP_30._s = self, TMP_30), $a).call($c);}, TMP_28._s = self, TMP_28), $a).call($h, "history");
      ($a = ($i = self.commands).$add_command, $a._p = (TMP_32 = function(c){var self = TMP_32._s || this, $a, $b, TMP_33, $c, TMP_34;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_33 = function(){var self = TMP_33._s || this;

        return "show undo stack"}, TMP_33._s = self, TMP_33), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_34 = function(a){var self = TMP_34._s || this, $a, $b, TMP_35, history = nil;
          if (self.commands == null) self.commands = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        history = ($a = ($b = self.commands.$undostack()).$map, $a._p = (TMP_35 = function(c){var self = TMP_35._s || this;
if (c == null) c = nil;
          return "" + (c.$first()) + ": " + (c['$[]'](1).$name()) + "(" + (c.$last()) + ")"}, TMP_35._s = self, TMP_35), $a).call($b);
          return $gvars.log.$message("<pre>" + (history.$join("\n")) + "</pre>");}, TMP_34._s = self, TMP_34), $a).call($c);}, TMP_32._s = self, TMP_32), $a).call($i, "showundo");
      return ($a = ($j = self.commands).$add_command, $a._p = (TMP_36 = function(c){var self = TMP_36._s || this, $a, $b, TMP_37, $c, TMP_38;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_37 = function(){var self = TMP_37._s || this;

        return "show redo stack"}, TMP_37._s = self, TMP_37), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_38 = function(a){var self = TMP_38._s || this, $a, $b, TMP_39, history = nil;
          if (self.commands == null) self.commands = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        history = ($a = ($b = self.commands.$redostack()).$map, $a._p = (TMP_39 = function(c){var self = TMP_39._s || this;
if (c == null) c = nil;
          return "" + (c.$first()) + ": " + (c['$[]'](1).$name()) + "(" + (c.$last()) + ")"}, TMP_39._s = self, TMP_39), $a).call($b);
          return $gvars.log.$message("<pre>" + (history.$join("\n")) + "</pre>");}, TMP_38._s = self, TMP_38), $a).call($c);}, TMP_36._s = self, TMP_36), $a).call($j, "showredo");
    };

    def.$__ic_02_play_commands = function() {
      var $a, $b, TMP_40, $c, TMP_46, $d, TMP_49, self = this;

      ($a = ($b = self.commands).$add_command, $a._p = (TMP_40 = function(c){var self = TMP_40._s || this, $a, $b, TMP_41, $c, TMP_42, $d, TMP_45;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_41 = function(){var self = TMP_41._s || this;

        return "play song " + (c.$parameter_help(0))}, TMP_41._s = self, TMP_41), $a).call($b);
        ($a = ($c = c).$add_parameter, $a._p = (TMP_42 = function(parameter){var self = TMP_42._s || this, $a, $b, TMP_43, $c, TMP_44;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_43 = function(){var self = TMP_43._s || this;

          return "ff"}, TMP_43._s = self, TMP_43), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_44 = function(){var self = TMP_44._s || this;

          return "r(all | ff | sel): range to play"}, TMP_44._s = self, TMP_44), $a).call($c);}, TMP_42._s = self, TMP_42), $a).call($c, "range", "string");
        return ($a = ($d = c).$as_action, $a._p = (TMP_45 = function(argument){var self = TMP_45._s || this, $case = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (argument == null) argument = nil;
        return (function() {$case = argument['$[]']("range");if ("sel"['$===']($case)) {return self.$play_abc("selection")}else if ("ff"['$===']($case)) {return self.$play_abc("selection_ff")}else if ("all"['$===']($case)) {return self.$play_abc()}else {return $gvars.log.$error("wrong range to play")}})()}, TMP_45._s = self, TMP_45), $a).call($d);}, TMP_40._s = self, TMP_40), $a).call($b, "p");
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_46 = function(c){var self = TMP_46._s || this, $a, $b, TMP_47, $c, TMP_48;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_47 = function(){var self = TMP_47._s || this;

        return "stop playing"}, TMP_47._s = self, TMP_47), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_48 = function(a){var self = TMP_48._s || this;
if (a == null) a = nil;
        return self.$stop_play_abc()}, TMP_48._s = self, TMP_48), $a).call($c);}, TMP_46._s = self, TMP_46), $a).call($c, "stop");
      return ($a = ($d = self.commands).$add_command, $a._p = (TMP_49 = function(c){var self = TMP_49._s || this, $a, $b, TMP_50, $c, TMP_51;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_50 = function(){var self = TMP_50._s || this;

        return "refresh"}, TMP_50._s = self, TMP_50), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_51 = function(a){var self = TMP_51._s || this;
if (a == null) a = nil;
        return self.$render_previews()}, TMP_51._s = self, TMP_51), $a).call($c);}, TMP_49._s = self, TMP_49), $a).call($d, "render");
    };

    def.$__ic_03_create_commands = function() {
      var $a, $b, TMP_52, self = this;

      return ($a = ($b = self.commands).$add_command, $a._p = (TMP_52 = function(c){var self = TMP_52._s || this, $a, $b, TMP_53, $c, TMP_54, $d, TMP_56, $e, TMP_59, $f, TMP_60;
if (c == null) c = nil;
      ($a = ($b = c).$set_help, $a._p = (TMP_53 = function(){var self = TMP_53._s || this;

        return "create song " + (c.$parameter_help(0)) + " " + (c.$parameter_help(1))}, TMP_53._s = self, TMP_53), $a).call($b);
        ($a = ($c = c).$add_parameter, $a._p = (TMP_54 = function(parameter){var self = TMP_54._s || this, $a, $b, TMP_55;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_help, $a._p = (TMP_55 = function(){var self = TMP_55._s || this;

          return "value for X: line, a unique id"}, TMP_55._s = self, TMP_55), $a).call($b)}, TMP_54._s = self, TMP_54), $a).call($c, "id", "string");
        ($a = ($d = c).$add_parameter, $a._p = (TMP_56 = function(parameter){var self = TMP_56._s || this, $a, $b, TMP_57, $c, TMP_58;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_57 = function(){var self = TMP_57._s || this;

          return "untitled"}, TMP_57._s = self, TMP_57), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_58 = function(){var self = TMP_58._s || this;

          return "Title of the song"}, TMP_58._s = self, TMP_58), $a).call($c);}, TMP_56._s = self, TMP_56), $a).call($d, "title", "string");
        ($a = ($e = c).$as_action, $a._p = (TMP_59 = function(args){var self = TMP_59._s || this, song_id = nil, song_title = nil, filename = nil, template = nil;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        song_id = args['$[]']("id");
          ...
          return self.$set_status($hash2(["song"], {"song": "new"}));}, TMP_59._s = self, TMP_59), $a).call($e);
        return ($a = ($f = c).$as_inverse, $a._p = (TMP_60 = function(args){var self = TMP_60._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_60._s = self, TMP_60), $a).call($f);}, TMP_52._s = self, TMP_52), $a).call($b, "c");
    };

    def.$__ic_04_localstore_commands = function() {
      var $a, $b, TMP_61, $c, TMP_64, $d, TMP_68, self = this;

      ($a = ($b = self.commands).$add_command, $a._p = (TMP_61 = function(c){var self = TMP_61._s || this, $a, $b, TMP_62, $c, TMP_63;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_62 = function(){var self = TMP_62._s || this;

        return "save to localstore"}, TMP_62._s = self, TMP_62), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_63 = function(){var self = TMP_63._s || this, abc_code = nil, metadata = nil, filename = nil;
          if (self.editor == null) self.editor = nil;
          if (self.abc_transformer == null) self.abc_transformer = nil;
        ...
        abc_code = self.editor.$get_text();
          ...
          return $gvars.log.$message("saved to '" + (filename) + "'");}, TMP_63._s = self, TMP_63), $a).call($c);}, TMP_61._s = self, TMP_61), $a).call($b, "lsave");
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_64 = function(c){var self = TMP_64._s || this, $a, $b, TMP_65, $c, TMP_66;
if (c == null) c = nil;
      c['$undoable='](false);
        ($a = ($b = c).$set_help, $a._p = (TMP_65 = function(){var self = TMP_65._s || this;

        return "list files in localstore"}, TMP_65._s = self, TMP_65), $a).call($b);
        return ($a = ($c = c).$as_action, $a._p = (TMP_66 = function(a){var self = TMP_66._s || this, $a, $b, TMP_67;
          if (self.songbook == null) self.songbook = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (a == null) a = nil;
        return $gvars.log.$message("<pre>"['$+'](($a = ($b = self.songbook.$list()).$map, $a._p = (TMP_67 = function(k, v){var self = TMP_67._s || this;
if (k == null) k = nil;if (v == null) v = nil;
          return "" + (k) + "_" + (v)}, TMP_67._s = self, TMP_67), $a).call($b).$join("\n"))['$+']("</pre>"))}, TMP_66._s = self, TMP_66), $a).call($c);}, TMP_64._s = self, TMP_64), $a).call($c, "lls");
      return ($a = ($d = self.commands).$add_command, $a._p = (TMP_68 = function(c){var self = TMP_68._s || this, $a, $b, TMP_69, $c, TMP_71, $d, TMP_72, $e, TMP_73;
if (c == null) c = nil;
      c['$undoable='](true);
        ($a = ($b = c).$add_parameter, $a._p = (TMP_69 = function(parameter){var self = TMP_69._s || this, $a, $b, TMP_70;
if (parameter == null) parameter = nil;
        return ($a = ($b = parameter).$set_help, $a._p = (TMP_70 = function(){var self = TMP_70._s || this;

          return "id of the song to be loaded"}, TMP_70._s = self, TMP_70), $a).call($b)}, TMP_69._s = self, TMP_69), $a).call($b, "id", "string");
        ($a = ($c = c).$set_help, $a._p = (TMP_71 = function(){var self = TMP_71._s || this;

        return "open song from local store  " + (c.$parameter_help(0))}, TMP_71._s = self, TMP_71), $a).call($c);
        ($a = ($d = c).$as_action, $a._p = (TMP_72 = function(args){var self = TMP_72._s || this, $a, payload = nil;
          if (self.songbook == null) self.songbook = nil;
          if (self.editor == null) self.editor = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        if ((($a = args['$[]']("id")) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          }}, TMP_72._s = self, TMP_72), $a).call($d);
        return ($a = ($e = c).$as_inverse, $a._p = (TMP_73 = function(args){var self = TMP_73._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_73._s = self, TMP_73), $a).call($e);}, TMP_68._s = self, TMP_68), $a).call($d, "lopen");
    };

    return (def.$__ic_05_dropbox_commands = function() {
      var $a, $b, TMP_74, $c, TMP_85, $d, TMP_94, $e, TMP_101, $f, TMP_104, $g, TMP_115, self = this;

      ($a = ($b = self.commands).$add_command, $a._p = (TMP_74 = function(command){var self = TMP_74._s || this, $a, $b, TMP_75, $c, TMP_78, $d, TMP_81, $e, TMP_82, $f, TMP_84;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_75 = function(parameter){var self = TMP_75._s || this, $a, $b, TMP_76, $c, TMP_77;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_76 = function(){var self = TMP_76._s || this;

          return "app"}, TMP_76._s = self, TMP_76), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_77 = function(){var self = TMP_77._s || this;

          return "(app | full) app: app only | full: full dropbox"}, TMP_77._s = self, TMP_77), $a).call($c);}, TMP_75._s = self, TMP_75), $a).call($b, "scope", "string");
        ($a = ($c = command).$add_parameter, $a._p = (TMP_78 = function(parameter){var self = TMP_78._s || this, $a, $b, TMP_79, $c, TMP_80;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_79 = function(){var self = TMP_79._s || this;

          return "/"}, TMP_79._s = self, TMP_79), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_80 = function(){var self = TMP_80._s || this;

          return "path to set in dropbox"}, TMP_80._s = self, TMP_80), $a).call($c);}, TMP_78._s = self, TMP_78), $a).call($c, "path", "string");
        ($a = ($d = command).$set_help, $a._p = (TMP_81 = function(){var self = TMP_81._s || this;

        return "dropbox login for " + (command.$parameter_help(0))}, TMP_81._s = self, TMP_81), $a).call($d);
        ($a = ($e = command).$as_action, $a._p = (TMP_82 = function(args){var self = TMP_82._s || this, $a, $b, $c, TMP_83, $case = nil;
...
if (args == null) args = nil;
        $case = args['$[]']("scope");if ("full"['$===']($case)) {self.dropboxclient = (($a = ((($b = ((($c = $scope.Opal) == null ? $opal.cm('Opal') : $c))._scope).DropboxJs == null ? $b.cm('DropboxJs') : $b.DropboxJs))._scope).Client == null ? $a.cm('Client') : $a.Client).$new("us2s6tq6bubk6xh");
          ...
          self.dropboxpath = args['$[]']("path");}else if ("app"['$===']($case)) {self.dropboxclient = (($a = ((($b = ((($c = $scope.Opal) == null ? $opal.cm('Opal') : $c))._scope).DropboxJs == null ? $b.cm('DropboxJs') : $b.DropboxJs))._scope).Client == null ? $a.cm('Client') : $a.Client).$new("xr3zna7wrp75zax");
          self.dropboxclient['$app_name=']("App folder only");
          self.dropboxpath = args['$[]']("path");}else {$gvars.log.$error("select app | full")};
          return ($a = ($b = self.dropboxclient.$authenticate()).$then, $a._p = (TMP_83 = function(){var self = TMP_83._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
            return $gvars.log.$message("logged in at dropbox with " + (args['$[]']("scope")) + " access");}, TMP_83._s = self, TMP_83), $a).call($b);}, TMP_82._s = self, TMP_82), $a).call($e);
        return ($a = ($f = command).$as_inverse, $a._p = (TMP_84 = function(args){var self = TMP_84._s || this;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.$set_status($hash2(["dropbox"], {"dropbox": "logged out"}));
          $gvars.log.$message("logged out from dropbox");
          return self.dropboxclient = nil;}, TMP_84._s = self, TMP_84), $a).call($f);}, TMP_74._s = self, TMP_74), $a).call($b, "dlogin");
      ($a = ($c = self.commands).$add_command, $a._p = (TMP_85 = function(command){var self = TMP_85._s || this, $a, $b, TMP_86, $c, TMP_89, $d, TMP_90;
if (command == null) command = nil;
      command['$undoable='](false);
        ($a = ($b = command).$add_parameter, $a._p = (TMP_86 = function(parameter){var self = TMP_86._s || this, $a, $b, TMP_87, $c, TMP_88;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_87 = function(){var self = TMP_87._s || this, $a;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return ((($a = self.dropboxpath) !== false && $a !== nil) ? $a : "/")}, TMP_87._s = self, TMP_87), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_88 = function(){var self = TMP_88._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path in dropbox " + (self.dropboxclient.$app_name())}, TMP_88._s = self, TMP_88), $a).call($c);}, TMP_86._s = self, TMP_86), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a._p = (TMP_89 = function(){var self = TMP_89._s || this;

        return "list files in " + (command.$parameter_help(0))}, TMP_89._s = self, TMP_89), $a).call($c);
        return ($a = ($d = command).$as_action, $a._p = (TMP_90 = function(args){var self = TMP_90._s || this, $a, $b, TMP_91, $c, $d, TMP_93, rootpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          $gvars.log.$message("" + (self.dropboxclient.$app_name()) + ": " + (args['$[]']("path")) + ":");
          return ($a = ($b = ($c = ($d = self.dropboxclient.$authenticate()).$then, $c._p = (TMP_93 = function(){var self = TMP_93._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return self.dropboxclient.$read_dir(rootpath)}, TMP_93._s = self, TMP_93), $c).call($d)).$then, $a._p = (TMP_91 = function(entries){var self = TMP_91._s || this, $a, $b, TMP_92;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          return $gvars.log.$message("<pre>"['$+'](($a = ($b = entries).$select, $a._p = (TMP_92 = function(entry){var self = TMP_92._s || this;
if (entry == null) entry = nil;
            return entry['$=~'](/\.abc$/)}, TMP_92._s = self, TMP_92), $a).call($b).$join("\n").$to_s())['$+']("</pre>"))}, TMP_91._s = self, TMP_91), $a).call($b);}, TMP_90._s = self, TMP_90), $a).call($d);}, TMP_85._s = self, TMP_85), $a).call($c, "dls");
      ($a = ($d = self.commands).$add_command, $a._p = (TMP_94 = function(command){var self = TMP_94._s || this, $a, $b, TMP_95, $c, TMP_98, $d, TMP_99, $e, TMP_100;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_95 = function(parameter){var self = TMP_95._s || this, $a, $b, TMP_96, $c, TMP_97;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_96 = function(){var self = TMP_96._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_96._s = self, TMP_96), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_97 = function(){var self = TMP_97._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path in dropbox " + (self.dropboxclient.$app_name())}, TMP_97._s = self, TMP_97), $a).call($c);}, TMP_95._s = self, TMP_95), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a._p = (TMP_98 = function(){var self = TMP_98._s || this;

        return "dropbox change dir to " + (command.$parameter_help(0))}, TMP_98._s = self, TMP_98), $a).call($c);
        ($a = ($d = command).$as_action, $a._p = (TMP_99 = function(args){var self = TMP_99._s || this, rootpath = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        rootpath = args['$[]']("path");
          ...
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$message("dropbox path changed to " + (self.dropboxpath));}, TMP_99._s = self, TMP_99), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a._p = (TMP_100 = function(args){var self = TMP_100._s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        self.dropboxpath = args['$[]']("oldval");
          self.$set_status($hash2(["dropbox"], {"dropbox": "" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath)}));
          return $gvars.log.$message("dropbox path changed back to " + (self.dropboxpath));}, TMP_100._s = self, TMP_100), $a).call($e);}, TMP_94._s = self, TMP_94), $a).call($d, "dcd");
      ($a = ($e = self.commands).$add_command, $a._p = (TMP_101 = function(command){var self = TMP_101._s || this, $a, $b, TMP_102, $c, TMP_103;
if (command == null) command = nil;
      command['$undoable='](false);
        ($a = ($b = command).$set_help, $a._p = (TMP_102 = function(){var self = TMP_102._s || this;

        return "show drobox path"}, TMP_102._s = self, TMP_102), $a).call($b);
        return ($a = ($c = command).$as_action, $a._p = (TMP_103 = function(args){var self = TMP_103._s || this;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if (self.dropboxpath == null) self.dropboxpath = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        return $gvars.log.$message("" + (self.dropboxclient.$app_name()) + ": " + (self.dropboxpath))}, TMP_103._s = self, TMP_103), $a).call($c);}, TMP_101._s = self, TMP_101), $a).call($e, "dpwd");
      ($a = ($f = self.commands).$add_command, $a._p = (TMP_104 = function(command){var self = TMP_104._s || this, $a, $b, TMP_105, $c, TMP_108, $d, TMP_109;
if (command == null) command = nil;
      ($a = ($b = command).$add_parameter, $a._p = (TMP_105 = function(parameter){var self = TMP_105._s || this, $a, $b, TMP_106, $c, TMP_107;
if (parameter == null) parameter = nil;
        ($a = ($b = parameter).$set_default, $a._p = (TMP_106 = function(){var self = TMP_106._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_106._s = self, TMP_106), $a).call($b);
          return ($a = ($c = parameter).$set_help, $a._p = (TMP_107 = function(){var self = TMP_107._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_107._s = self, TMP_107), $a).call($c);}, TMP_105._s = self, TMP_105), $a).call($b, "path", "string");
        command['$undoable='](false);
        ($a = ($c = command).$set_help, $a._p = (TMP_108 = function(){var self = TMP_108._s || this;

        return "save to dropbox {" + (command.$parameter_help(0)) + "}"}, TMP_108._s = self, TMP_108), $a).call($c);
        return ($a = ($d = command).$as_action, $a._p = (TMP_109 = function(args){var self = TMP_109._s || this, $a, $b, TMP_110, $c, $d, TMP_111, $e, $f, TMP_112, abc_code = nil, metadata = nil, filebase = nil, print_variants = nil, rootpath = nil;
          if (self.editor == null) self.editor = nil;
          if (self.abc_transformer == null) self.abc_transformer = nil;
          if (self.song == null) self.song = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
...
if (args == null) args = nil;
        abc_code = self.editor.$get_text();
          metadata = self.abc_transformer.$get_metadata(abc_code);
          filebase = metadata['$[]']("F");
          $gvars.log.$debug("" + (metadata.$to_s()) + " (" + ("controller_command_definitions") + " " + (389) + ")");
          if (filebase !== false && filebase !== nil) {
            filebase = filebase.$split("\n").$first()
            } else {
            self.$raise("Filename not specified in song add an F: instruction")
          ...
          print_variants = self.song.$harpnote_options()['$[]']("print");
          rootpath = args['$[]']("path");
          return ($a = ($b = ($c = ($d = ($e = ($f = self.dropboxclient.$authenticate()).$then, $e._p = (TMP_112 = function(){var self = TMP_112._s || this, $a, $b, TMP_113, $c, TMP_114, save_promises = nil, pdfs = nil;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if (self.editor == null) self.editor = nil;

          save_promises = [self.dropboxclient.$write_file("" + (rootpath) + (filebase) + ".abc", self.editor.$get_text())];
            pdfs = $hash2([], {});
            ($a = ($b = print_variants.$each_with_index()).$map, $a._p = (TMP_113 = function(print_variant, index){var self = TMP_113._s || this, filename = nil;
if (print_variant == null) print_variant = nil;if (index == null) index = nil;
            filename = print_variant['$[]']("title").$gsub(/[^a-zA-Z0-9\-\_]/, "_");
              pdfs['$[]=']("" + (rootpath) + (filebase) + "_" + (print_variant['$[]']("title")) + "_a3.pdf", self.$render_a3(index).$output("blob"));
              return pdfs['$[]=']("" + (rootpath) + (filebase) + "_" + (print_variant['$[]']("title")) + "_a4.pdf", self.$render_a4(index).$output("blob"));}, TMP_113._s = self, TMP_113), $a).call($b);
            ($a = ($c = pdfs).$each, $a._p = (TMP_114 = function(name, pdfdata){var self = TMP_114._s || this;
              if (self.dropboxclient == null) self.dropboxclient = nil;
if (name == null) name = nil;if (pdfdata == null) pdfdata = nil;
            return save_promises.$push(self.dropboxclient.$write_file(name, pdfdata))}, TMP_114._s = self, TMP_114), $a).call($c);
            save_promises.$push(self.dropboxclient.$write_file("" + (rootpath) + (filebase) + ".abc", self.editor.$get_text()));
            return (($a = $scope.Promise) == null ? $opal.cm('Promise') : $a).$when(save_promises);}, TMP_112._s = self, TMP_112), $e).call($f)).$then, $c._p = (TMP_111 = function(){var self = TMP_111._s || this;
            if ($gvars.log == null) $gvars.log = nil;

          self.$set_status($hash2(["song"], {"song": "saved to dropbox"}));
            return $gvars.log.$message("all files saved");}, TMP_111._s = self, TMP_111), $c).call($d)).$fail, $a._p = (TMP_110 = function(err){var self = TMP_110._s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("there was an error saving files " + (err))}, TMP_110._s = self, TMP_110), $a).call($b);}, TMP_109._s = self, TMP_109), $a).call($d);}, TMP_104._s = self, TMP_104), $a).call($f, "dsave");
      return ($a = ($g = self.commands).$add_command, $a._p = (TMP_115 = function(command){var self = TMP_115._s || this, $a, $b, TMP_116, $c, TMP_119, $d, TMP_120, $e, TMP_126;
if (command == null) command = nil;
      command.$add_parameter("fileid", "string", "file id");
        ($a = ($b = command).$add_parameter, $a._p = (TMP_116 = function(p){var self = TMP_116._s || this, $a, $b, TMP_117, $c, TMP_118;
if (p == null) p = nil;
        ($a = ($b = p).$set_default, $a._p = (TMP_117 = function(){var self = TMP_117._s || this;
            if (self.dropboxpath == null) self.dropboxpath = nil;

          return self.dropboxpath}, TMP_117._s = self, TMP_117), $a).call($b);
          return ($a = ($c = p).$set_help, $a._p = (TMP_118 = function(){var self = TMP_118._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;

          return "path to save in " + (self.dropboxclient.$app_name())}, TMP_118._s = self, TMP_118), $a).call($c);}, TMP_116._s = self, TMP_116), $a).call($b, "path", "string");
        ($a = ($c = command).$set_help, $a._p = (TMP_119 = function(){var self = TMP_119._s || this;

        return "read file with " + (command.$parameter_help(0)) + ", from dropbox " + (command.$parameter_help(1))}, TMP_119._s = self, TMP_119), $a).call($c);
        ($a = ($d = command).$as_action, $a._p = (TMP_120 = function(args){var self = TMP_120._s || this, $a, $b, TMP_121, $c, $d, TMP_122, $e, $f, TMP_123, $g, $h, TMP_125, fileid = nil, rootpath = nil;
          if (self.editor == null) self.editor = nil;
          if (self.dropboxclient == null) self.dropboxclient = nil;
          if ($gvars.log == null) $gvars.log = nil;
if (args == null) args = nil;
        args['$[]=']("oldval", self.editor.$get_text());
          ...
          return ($a = ($b = ($c = ($d = ($e = ($f = ($g = ($h = self.dropboxclient.$authenticate()).$then, $g._p = (TMP_125 = function(error, data){var self = TMP_125._s || this;
            if (self.dropboxclient == null) self.dropboxclient = nil;
if (error == null) error = nil;if (data == null) data = nil;
          return self.dropboxclient.$read_dir(rootpath)}, TMP_125._s = self, TMP_125), $g).call($h)).$then, $e._p = (TMP_123 = function(entries){var self = TMP_123._s || this, $a, $b, TMP_124;
            if (self.dropboxclient == null) self.dropboxclient = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (entries == null) entries = nil;
          $gvars.log.$debug("" + (entries) + " (" + ("controller_command_definitions") + " " + (448) + ")");
            fileid = ($a = ($b = entries).$select, $a._p = (TMP_124 = function(entry){var self = TMP_124._s || this;
if (entry == null) entry = nil;
            return entry['$=~']((new RegExp("" + fileid + "_.*\\.abc$")))}, TMP_124._s = self, TMP_124), $a).call($b).$first();
            return self.dropboxclient.$read_file("" + (rootpath) + (fileid));}, TMP_123._s = self, TMP_123), $e).call($f)).$then, $c._p = (TMP_122 = function(abc_text){var self = TMP_122._s || this, filebase = nil;
            if (self.abc_transformer == null) self.abc_transformer = nil;
            if (self.editor == null) self.editor = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (abc_text == null) abc_text = nil;
          $gvars.log.$debug("loaded " + (fileid) + " (" + ("controller_command_definitions") + " " + (452) + ")");
            ...
            return self.$set_status($hash2(["song"], {"song": "loaded"}));}, TMP_122._s = self, TMP_122), $c).call($d)).$fail, $a._p = (TMP_121 = function(err){var self = TMP_121._s || this;
            if ($gvars.log == null) $gvars.log = nil;
if (err == null) err = nil;
          return $gvars.log.$error("could not load file " + (err))}, TMP_121._s = self, TMP_121), $a).call($b);}, TMP_120._s = self, TMP_120), $a).call($d);
        return ($a = ($e = command).$as_inverse, $a._p = (TMP_126 = function(args){var self = TMP_126._s || this;
          if (self.editor == null) self.editor = nil;
if (args == null) args = nil;
        return self.editor.$set_text(args['$[]']("oldval"))}, TMP_126._s = self, TMP_126), $a).call($e);}, TMP_115._s = self, TMP_115), $a).call($g, "dopen");
...
(function($opal) {
  ...
  $opal.add_stubs(['$[]', '$[]=', '$on', '$Native', '$call', '$debug', '$to_s', '$first', '$select', '$>=', '$error', '$play_notes', '$stop', '$empty?', '$warn', '$last', '$*', '$+', '$-', '$each', '$clone', '$to_n', '$create_inst', '$each_with_index', '$info', '$backtrace', '$nil?', '$class', '$>', '$<', '$===', '$push', '$sort', '$<=>', '$reduce', '$meta_data', '$/', '$compact', '$flatten', '$map', '$is_a?', '$mk_to_play', '$pitch', '$notes', '$tie_end?', '$==', '$tie_start?', '$voices', '$beat', '$-@', '$duration', '$origin']);
  return (function($base) {
    var self = $module($base, 'Harpnotes');
    ...
    (function($base) {
      ...
      (function($base, $super) {
        ...
        var def = self._proto, $scope = self._scope, TMP_3, TMP_4, TMP_5;
        ...
        def.$create_inst = function(instrument_id) {
          ...
          if ((($a = self.inst['$[]'](instrument_id)) !== nil && (!$a._isBoolean || $a == true))) {
            } else {
            self.inst['$[]='](instrument_id, new Instrument("piano"));
            ($a = ($b = self.$Native(self.inst['$[]'](instrument_id))).$on, $a._p = (TMP_1 = function(element){var self = TMP_1._s || this, abc_element = nil;
...
if (element == null) element = nil;
            abc_element = self.$Native(element)['$[]']("origin");
              ...
              return nil;}, TMP_1._s = self, TMP_1), $a).call($b, "noteon");
            ($a = ($c = self.$Native(self.inst['$[]'](instrument_id))).$on, $a._p = (TMP_2 = function(element){var self = TMP_2._s || this, abc_element = nil;
              if (self.noteoff_callback == null) self.noteoff_callback = nil;
if (element == null) element = nil;
            abc_element = self.$Native(element)['$[]']("origin");
              self.noteoff_callback.$call(abc_element);
              return nil;}, TMP_2._s = self, TMP_2), $a).call($c, "noteoff");
          };
        ...
        def.$play_from_selection = function() {
          ...
          $gvars.log.$debug("" + (self.selection.$to_s()) + " (" + ("harpnote_player") + " " + (54) + ")");
...
if (n == null) n = nil;
        ...
        def.$play_notes = function(the_notes) {
          ...
          if ((($a = the_notes['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
            ...
            ($a = ($b = the_notes).$each, $a._p = (TMP_7 = function(the_note){var self = TMP_7._s || this, $a, $b, the_note_to_play = nil, note = nil, index = nil, inst = nil;
if (the_note == null) the_note = nil;
        ...
        def.$stop = function() {
          ...
          ($a = ($b = self.inst).$each_with_index, $a._p = (TMP_8 = function(inst, index){var self = TMP_8._s || this, $a, e = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (inst == null) inst = nil;if (index == null) index = nil;
        ...
        def.$range_highlight = function(from, to) {
          ...
          self.selection = [];
          return ($a = ($b = ($c = ($d = self.voice_elements).$sort, $c._p = (TMP_10 = function(a, b){var self = TMP_10._s || this;
if (a == null) a = nil;if (b == null) b = nil;
          return a['$[]']("delay")['$<=>'](b['$[]']("delay"))}, TMP_10._s = self, TMP_10), $c).call($d)).$each, $a._p = (TMP_9 = function(element){var self = TMP_9._s || this, $a, $b, $c, origin = nil, el_start = nil, el_end = nil;
            if (self.selection == null) self.selection = nil;
            if ($gvars.log == null) $gvars.log = nil;
if (element == null) element = nil;
        ...
        def.$load_song = function(music) {
          var $a, $b, $c, $d, TMP_11, self = this, specduration = nil, specbpm = nil, spectf = nil, tf = nil;
          if ($gvars.log == null) $gvars.log = nil;
          ...
          $gvars.log.$debug("playing with tempo: " + (tf) + " ticks per quarter " + ("harpnote_player") + " " + (158));
          return self.voice_elements = ($a = ($b = music.$voices().$each_with_index()).$map, $a._p = (TMP_11 = function(voice, index){var self = TMP_11._s || this, $a, $b, TMP_12, $c, $d, TMP_14, tie_start = nil;
if (voice == null) voice = nil;if (index == null) index = nil;
          tie_start = $hash2([], {});
            return ($a = ($b = ($c = ($d = voice).$select, $c._p = (TMP_14 = function(c){var self = TMP_14._s || this, $a;
if (c == null) c = nil;
            return c['$is_a?']((($a = $scope.Playable) == null ? $opal.cm('Playable') : $a))}, TMP_14._s = self, TMP_14), $c).call($d)).$map, $a._p = (TMP_12 = function(root){var self = TMP_12._s || this, $a, $b, TMP_13, $c, velocity = nil, to_play = nil, more_to_play = nil, result = nil;
if (root == null) root = nil;
            velocity = 0.5;
              ...
              more_to_play = [];
              if ((($a = root['$is_a?']((($b = $scope.SynchPoint) == null ? $opal.cm('SynchPoint') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
                more_to_play = ($a = ($b = root.$notes().$each()).$map, $a._p = (TMP_13 = function(note){var self = TMP_13._s || this, $a;
if (note == null) note = nil;
                if ((($a = note.$pitch()['$==='](root.$pitch())) !== nil && (!$a._isBoolean || $a == true))) {
                    return nil
                    } else {
                    return self.$mk_to_play(note, velocity, index)
                  }}, TMP_13._s = self, TMP_13), $a).call($b)};
              if ((($a = root['$tie_end?']()) !== nil && (!$a._isBoolean || $a == true))) {
                if (tie_start['$[]']("pitch")['$=='](to_play['$[]']("pitch"))) {
                  ($a = "duration", $c = to_play, $c['$[]=']($a, $c['$[]']($a)['$+'](tie_start['$[]']("duration"))));
                  to_play['$[]=']("delay", tie_start['$[]']("delay"));
                  result = to_play;
                  } else {
                  result = [tie_start, to_play]
                }};
              if ((($a = root['$tie_start?']()) !== nil && (!$a._isBoolean || $a == true))) {
                tie_start = to_play;
                result = nil;};
              return [to_play]['$+']([more_to_play]);}, TMP_12._s = self, TMP_12), $a).call($b);}, TMP_11._s = self, TMP_11), $a).call($b).$flatten().$compact();
        };

        return (def.$mk_to_play = function(note, velocity, index) {
          var self = this;

          return $hash2(["delay", "pitch", "duration", "velocity", "origin", "index"], {"delay": note.$beat()['$*'](self.beat_timefactor), "pitch": note.$pitch()['$-@'](), "duration": note.$duration()['$*'](self.duration_timefactor), "velocity": velocity, "origin": note.$origin(), "index": index});
        }, nil) && 'mk_to_play';
      })(self, null)
...
(function($opal) {
  ...
  $opal.add_stubs(['$attr_accessor', '$on', '$clear_markers', '$call', '$Native', '$getSession', '$[]', '$debug', '$map', '$-', '$first', '$set_markers', '$to_n', '$each', '$add_marker', '$last', '$<<', '$clear']);
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (e == null) e = nil;
      ...
      def.$select_range_by_position = function(selection_start, selection_end) {
        ...
        $gvars.log.$debug("set editor selection to " + (selection_start) + ", " + (selection_end) + " (" + ("text_pane") + " " + (87) + ") ");
      ...
      def.$set_annotations = function(annotations) {
        var $a, $b, TMP_5, self = this, editor_annotations = nil;

        editor_annotations = ($a = ($b = annotations).$map, $a._p = (TMP_5 = function(annotation){var self = TMP_5._s || this;
if (annotation == null) annotation = nil;
        return $hash2(["row", "text", "type"], {"row": annotation['$[]']("start_pos").$first()['$-'](1), "text": annotation['$[]']("text"), "type": annotation['$[]']("type")})}, TMP_5._s = self, TMP_5), $a).call($b);
      ...
      def.$set_markers = function(annotations) {
        ...
        self.$clear_markers();
        return ($a = ($b = annotations).$each, $a._p = (TMP_6 = function(annotation){var self = TMP_6._s || this;
if (annotation == null) annotation = nil;
        return self.$add_marker(annotation)}, TMP_6._s = self, TMP_6), $a).call($b);
      };
      ...
      def.$add_marker = function(annotation) {
        ...
        id = self.editor.getSession().addMarker(new self.range(marker_start['$[]']("row")['$-'](1), marker_start['$[]']("col")['$-'](1),
      ...
      return (def.$clear_markers = function() {
        var $a, $b, TMP_7, self = this;

        ($a = ($b = self.markers).$each, $a._p = (TMP_7 = function(marker){var self = TMP_7._s || this;
          if (self.editor == null) self.editor = nil;
if (marker == null) marker = nil;
        return self.editor.session.removeMarker(marker['$[]']("id"));}, TMP_7._s = self, TMP_7), $a).call($b);
  ...
  return (function($base) {
    ...
    (function($base, $super) {
      ...
      def.$initialize = function(container, prompt, message) {
        ...
        self.jqconsole = self.$Native((($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#" + (container)).$jqconsole(message, prompt));
        ($a = ($b = self).$on_command, $a._p = (TMP_1 = function(cmd){var self = TMP_1._s || this;
...
if (cmd == null) cmd = nil;
      ...
      def.$load_from_loacalstorage = function() {
        ...
        if ((($a = history['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
          return nil
          } else {
          history = (($a = $scope.JSON) == null ? $opal.cm('JSON') : $a).$parse(history);
          if ((($a = history['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
            return nil
            } else {
      ...
      return (def.$handler = function(cmd) {
        ...
        if ((($a = (($b = cmd !== false && cmd !== nil) ? cmd != undefined : $b)) !== nil && (!$a._isBoolean || $a == true))) {
          try {
        ...
        return self.jqconsole.$Prompt(true, ($a = ($b = self).$lambda, $a._p = (TMP_3 = function(c){var self = TMP_3._s || this;
if (c == null) c = nil;
        return self.$handler(c)}, TMP_3._s = self, TMP_3), $a).call($b), ($a = ($c = self).$lambda, $a._p = (TMP_4 = function(c){var self = TMP_4._s || this;
if (c == null) c = nil;
        return false}, TMP_4._s = self, TMP_4), $a).call($c));
      }, nil) && 'handler';
    })(self, null)
...
//# sourceMappingURL=/__opal_source_maps__/opal-jqconsole.js.map
;
/* Generated by Opal 0.6.3 */
(function($opal) {
  ...
  return (function($base, $super) {
    ...
    def.$push = function(hash) {
      ...
      if ((($a = hash['$is_a?']((($b = $scope.Hash) == null ? $opal.cm('Hash') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    def.$get = function(key) {
      ...
      if ((($a = key['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
    ...
    def.$keys = function() {
      ...
      return ($a = ($b = self.confstack).$map, $a._p = (TMP_1 = function(s){var self = TMP_1._s || this;
if (s == null) s = nil;
      return self.$_get_keys(s)}, TMP_1._s = self, TMP_1), $a).call($b).$compact().$flatten().$uniq();
    };
    ...
    def.$_flatten = function() {
      ...
      the_keys = self.$keys();
      self.confresult_flat = ($a = ($b = the_keys).$inject, $a._p = (TMP_2 = function(result, element){var self = TMP_2._s || this;
if (result == null) result = nil;if (element == null) element = nil;
      result['$[]='](element, self.$_get(element));
        self.$_add_hash(result, element.$split("."), self.$_get(element), nil);
        return result;}, TMP_2._s = self, TMP_2), $a).call($b, $hash2([], {}));
    ...
    def.$_add_hash = function(hash, keys, value, current_key) {
      ...
      if ((($a = hash['$nil?']()) !== nil && (!$a._isBoolean || $a == true))) {
        hash = $hash2([], {})};
      if ((($a = keys['$empty?']()) !== nil && (!$a._isBoolean || $a == true))) {
        hash['$[]='](current_key, value)
        } else {
        if ((($a = hash['$[]'](current_key)['$is_a?']((($b = $scope.Hash) == null ? $opal.cm('Hash') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
    ...
    def.$_get = function(key) {
      ...
      return ($a = ($b = self.confstack).$map, $a._p = (TMP_3 = function(s){var self = TMP_3._s || this;
if (s == null) s = nil;
      return self.$_get_one(s, key)}, TMP_3._s = self, TMP_3), $a).call($b).$compact().$last();
    };
    ...
    def.$_get_one = function(hash, key) {
      ...
      keys = key.$split(".");
      retval = ($a = ($b = keys).$inject, $a._p = (TMP_4 = function(result, element){var self = TMP_4._s || this, $a, $b;
if (result == null) result = nil;if (element == null) element = nil;
      if ((($a = result['$is_a?']((($b = $scope.Hash) == null ? $opal.cm('Hash') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
          } else {
          return ($breaker.$v = nil, $breaker)
        };
        return ((($a = result['$[]'](element)) !== false && $a !== nil) ? $a : result['$[]'](element.$to_sym()));}, TMP_4._s = self, TMP_4), $a).call($b, hash);
      return retval;
    };
    ...
    return (def.$_get_keys = function(hash, path) {
      ...
      retval = ($a = ($b = hash.$keys()).$inject, $a._p = (TMP_5 = function(result, key){var self = TMP_5._s || this, $a, $b, newpath = nil, newhash = nil;
if (result == null) result = nil;if (key == null) key = nil;
      newpath = [path, key].$compact().$join(".");
        newhash = hash['$[]'](key);
        result['$<<'](newpath);
        if ((($a = newhash['$is_a?']((($b = $scope.Hash) == null ? $opal.cm('Hash') : $b))) !== nil && (!$a._isBoolean || $a == true))) {
          result['$<<'](self.$_get_keys(newhash, newpath))};
        return result;}, TMP_5._s = self, TMP_5), $a).call($b, []);
      return retval.$compact().$flatten();
    }, nil) && '_get_keys';
  })(self, null)
})(Opal);

//# sourceMappingURL=/__opal_source_maps__/confstack.js.map
;
/* Generated by Opal 0.6.3 */
(function($opal) {
  ...
  $opal.cdecl($scope, 'VERSION', "0.9.6");
