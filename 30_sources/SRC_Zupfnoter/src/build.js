...
if (abcelement == null) abcelement = nil;
    ...
    def.$setup_ui_listener = function() {
      var $a, $b, TMP_7, $c, TMP_8, $d, TMP_9, $e, TMP_10, $f, TMP_11, $g, TMP_12, $h, TMP_13, $i, TMP_14, $j, TMP_15, $k, TMP_16, $l, TMP_17, $m, self = this;
      ...
      ($a = ($f = self.editor).$on_change, $a._p = (TMP_11 = function(e){var self = TMP_11._s || this, $a;
...
if (evt == null) evt = nil;
      ...
      return ($a = ($l = (($m = $scope.Element) == null ? $opal.cm('Element') : $m).$find("#dragbar")).$on, $a._p = (TMP_17 = function(re){var self = TMP_17._s || this, $a, $b, TMP_18, $c, TMP_19, $d;
if (re == null) re = nil;
      re.$prevent();
...
if (e == null) e = nil;
        ...
        return $(document).unbind('mousemove');}, TMP_19._s = self, TMP_19), $a).call($c, "mouseup");}, TMP_17._s = self, TMP_17), $a).call($l, "mousedown");
    };
...
(function($opal) {
  ...
  $opal.add_stubs(['$private', '$info', '$add_command', '$undoable=', '$set_help', '$as_action', '$join', '$help_string_style', '$add_parameter', '$set_default', '$loglevel=', '$[]', '$set_status', '$loglevel', '$==', '$undo', '$redo', '$map', '$first', '$name', '$last', '$history', '$undostack', '$redostack', '$parameter_help', '$===', '$play_abc', '$error', '$stop_play_abc', '$render_previews', '$gsub', '$raise', '$[]=', '$get_text', '$set_text', '$as_inverse', '$get_metadata', '$update', '$+', '$list', '$retrieve', '$command_tokens', '$new', '$app_name=', '$then', '$app_name', '$authenticate', '$to_s', '$select', '$=~', '$read_dir', '$debug', '$split', '$layout_harpnotes', '$harpnote_options', '$fail', '$write_file', '$output', '$render_a3', '$render_a4', '$each_with_index', '$each', '$push', '$when', '$add_metadata', '$read_file']);
  return (function($base, $super) {
    function $Controller(){};
    var self = $Controller = $klass($base, $super, 'Controller', $Controller);
