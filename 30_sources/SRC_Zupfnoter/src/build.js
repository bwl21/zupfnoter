...
(function($opal) {
  ...
  (function($base, $super) {
    ...
    def.inst = def.harpnote_preview_printer = def.tune_preview_printer = def.editor = nil;
    def.$initialize = function() {
      var $a, self = this;
    ...
    def.$setup_ui = function() {
      var $a, $b, TMP_1, $c, $d, self = this, printerparams = nil;

      self.harpnote_preview_printer = (($a = ((($b = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $b))._scope).RaphaelEngine == null ? $a.cm('RaphaelEngine') : $a.RaphaelEngine).$new("harpPreview");
      ($a = ($b = self.harpnote_preview_printer).$on_select, $a._p = (TMP_1 = function(origin){var self = TMP_1._s || this;
if (origin == null) origin = nil;
      return self.$select_note(origin, "harpnotes")}, TMP_1._s = self, TMP_1), $a).call($b);
      printerparams = $hash2([], {});
      return self.tune_preview_printer = (($a = ((($c = ((($d = $scope.ABCJS) == null ? $opal.cm('ABCJS') : $d))._scope).Write == null ? $c.cm('Write') : $c.Write))._scope).Printer == null ? $a.cm('Printer') : $a.Printer).$new("tunePreview");
    };
    ...
    return (def.$setup_ui_listener = function() {
      ...
      return self.$render_previews()}, TMP_3._s = self, TMP_3), $a).call($c, "click");
      ($a = ($d = (($e = $scope.Element) == null ? $opal.cm('Element') : $e).$find("#tbPrint")).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this, url = nil;
