...
(function($opal) {
  ...
  $opal.add_stubs(['$attr', '$new', '$setup_editor', '$setup_ui', '$setup_ui_listener', '$draw', '$layout_harpnotes', '$draw_in_segments', '$html', '$find', '$get_abc_code', '$info', '$error', '$message', '$backtrace', '$file', '$output', '$render_a4', '$render_a3', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$debug', '$disable_editor_seletion_change_event', '$enable_editor_selection_change_event', '$Native', '$select_range_by_position', '$[]', '$range_highlight', '$private', '$on_select', '$select_abc_object', '$origin', '$on', '$get_selection_positions', '$==', '$first', '$last', '$play_abc', '$render_previews', '$getSession', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  (function($base, $super) {
    function $Controller(){};
    ...
    def.$select_range_by_position = function(selection_start, selection_end) {
      ...
      $gvars.log.$debug("set editor selection to " + (selection_start) + ", " + (selection_end));
      self.$disable_editor_seletion_change_event();
      ...
      return self.$enable_editor_selection_change_event();
    };
    ...
    def.$select_abc_object = function(abcelement) {
      ...
      $gvars.log.$debug("select_abc_element");
...
if (abcelement == null) abcelement = nil;
    ...
    def.$enable_editor_selection_change_event = function() {
      var $a, $b, TMP_3, self = this;
      if ($gvars.log == null) $gvars.log = nil;

      $gvars.log.$debug("seclectionChange enabled");
      return ($a = ($b = self.$Native(self.$Native(self.editor)['$[]']("selection"))).$on, $a._p = (TMP_3 = function(e){var self = TMP_3._s || this, a = nil;
...
if (e == null) e = nil;
      a = self.$get_selection_positions();
        $gvars.log.$debug("editor selection changed " + (a));
        if (a.$first()['$=='](a.$last())) {
          } else {
          self.tune_preview_printer.$range_highlight(a.$first(), a.$last());
          self.harpnote_preview_printer.$range_highlight(a.$first(), a.$last());
        };
        return nil;}, TMP_3._s = self, TMP_3), $a).call($b, "changeSelection");
    };

    def.$disable_editor_seletion_change_event = function() {
      var self = this;
      if ($gvars.log == null) $gvars.log = nil;

      $gvars.log.$debug("seclectionChange disabled");
      return self.editor.getSession().removeAllListeners('changeSelection');
    };

    return (def.$setup_ui_listener = function() {
      var $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, $e, TMP_7, $f, TMP_8, $g, TMP_9, $h, TMP_10, $i, self = this;

      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#tbPlay")).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

      return self.$play_abc()}, TMP_4._s = self, TMP_4), $a).call($b, "click");
      ...
      ($a = ($f = self.$Native(self.$Native(self.editor).$getSession())).$on, $a._p = (TMP_8 = function(e){var self = TMP_8._s || this, $a;
...
if (e == null) e = nil;
      if ((($a = self.refresh_timer) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        return nil;}, TMP_8._s = self, TMP_8), $a).call($f, "change");
      self.$enable_editor_selection_change_event();
      ($a = ($g = (($h = $scope.Element) == null ? $opal.cm('Element') : $h).$find(window)).$on, $a._p = (TMP_9 = function(evt){var self = TMP_9._s || this, $a;
if (evt == null) evt = nil;
      if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        }}, TMP_9._s = self, TMP_9), $a).call($g, "keydown");
      return ($a = ($h = (($i = $scope.Element) == null ? $opal.cm('Element') : $i).$find("#dragbar")).$on, $a._p = (TMP_10 = function(re){var self = TMP_10._s || this, $a, $b, TMP_11, $c, TMP_12, $d;
if (re == null) re = nil;
      re.$prevent();
...
if (e == null) e = nil;
        ...
        return $(document).unbind('mousemove');}, TMP_12._s = self, TMP_12), $a).call($c, "mouseup");}, TMP_10._s = self, TMP_10), $a).call($h, "mousedown");
