...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_18, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass, $hash2 = $opal.hash2, $gvars = $opal.gvars, $range = $opal.range;

  $opal.add_stubs(['$load_dir', '$save_dir', '$[]', '$warning', '$update', '$to_json', '$[]=', '$parse', '$warn', '$clone', '$private', '$attr', '$new', '$setup_ui', '$setup_ui_listener', '$load_from_loacalstorage', '$split', '$first', '$===', '$get_text', '$get_metadata', '$info', '$debug', '$get', '$status_code', '$body', '$play_abc', '$retrieve', '$set_text', '$error', '$last', '$join', '$create', '$list', '$output', '$render_a3', '$nil?', '$draw', '$layout_harpnotes', '$draw_in_segments', '$is_playing?', '$stop', '$html', '$find', '$==', '$play_song', '$play_selection', '$play_from_selection', '$message', '$backtrace', '$set_inactive', '$load_song', '$save_to_localstorage', '$set_active', '$file', '$get_abc_code', '$render_a4', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$Native', '$select_range_by_position', '$range_highlight_more', '$range_highlight', '$range_unhighlight_more', '$range_unhighlight', '$unhighlight_all', '$highlight_abc_object', '$set_view_box', '$on_select', '$select_abc_object', '$origin', '$on', '$render_previews', '$handle_command', '$on_change', '$on_selection_change', '$get_selection_positions', '$on_noteon', '$on_noteoff', '$unhighlight_abc_object', '$on_songoff', '$stop_play_abc', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  (function($base, $super) {
    function $LocalStore(){};
  ...
  (function($base, $super) {
    ...
    def.editor = def.abc_transformer = def.songbook = def.harpnote_player = def.tune_preview_printer = def.song = def.harpnote_preview_printer = def.song_harpnotes = nil;
    ...
    def.$handle_command = function(command) {
      var $a, $b, TMP_1, $c, $d, self = this, c = nil, $case = nil, abc_code = nil, metadata = nil, payload = nil, song_id = nil, song_title = nil, template = nil, url = nil;
      if ($gvars.log == null) $gvars.log = nil;
...
if (response == null) response = nil;
      $gvars.log.$debug("returned " + (response.$status_code()));
        return $gvars.log.$debug(response.$body());}, TMP_1._s = self, TMP_1), $a).call($b, "https://cloud.weichel21.de:61670/remote.php/webdav/xx/", $hash2(["username", "password"], {"username": "zupfnoter", "password": "zupfnoter"}));}else if ("ps"['$===']($case)) {return self.$play_abc("selection")}else if ("pf"['$===']($case)) {return self.$play_abc("selection_ff")}else if ("pa"['$===']($case)) {return self.$play_abc()}else if ("r"['$===']($case)) {if ((($a = c['$[]'](1)) !== nil && (!$a._isBoolean || $a == true))) {
      ...
      };}else if ("l"['$===']($case)) {return $gvars.log.$info(self.songbook.$list())}else if ("drop"['$===']($case)) {$gvars.log.$info("saving to Dropbox");
      url = self.$render_a3().$output("datauristring");
      return self.dropboxclient = (($a = ((($c = ((($d = $scope.Opal) == null ? $opal.cm('Opal') : $d))._scope).DropboxJs == null ? $c.cm('DropboxJs') : $c.DropboxJs))._scope).Client == null ? $a.cm('Client') : $a.Client).$new("xr3zna7wrp75zax");}else {return $gvars.log.$error("wrong commnad: " + (command))}})();
    };
    ...
    def.$setup_ui = function() {
      var $a, $b, TMP_2, $c, $d, TMP_3, self = this, printerparams = nil;
      ...
      ($a = ($b = self.harpnote_preview_printer).$on_select, $a._p = (TMP_2 = function(harpnote){var self = TMP_2._s || this;
if (harpnote == null) harpnote = nil;
      return self.$select_abc_object(harpnote.$origin())}, TMP_2._s = self, TMP_2), $a).call($b);
      ...
      return ($a = ($c = self.tune_preview_printer).$on_select, $a._p = (TMP_3 = function(abcelement){var self = TMP_3._s || this, a = nil;
if (abcelement == null) abcelement = nil;
      a = self.$Native(abcelement);
        return self.$select_abc_object(abcelement);}, TMP_3._s = self, TMP_3), $a).call($c);
    };

    def.$setup_ui_listener = function() {
      var $a, $b, TMP_4, $c, TMP_5, $d, TMP_6, $e, TMP_7, $f, TMP_8, $g, TMP_9, $h, TMP_10, $i, TMP_11, $j, TMP_12, $k, TMP_13, $l, TMP_14, $m, TMP_15, $n, self = this;

      ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find("#tbPlay")).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

      return self.$play_abc("selection_ff")}, TMP_4._s = self, TMP_4), $a).call($b, "click");
      ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find("#tbRender")).$on, $a._p = (TMP_5 = function(){var self = TMP_5._s || this;

      return self.$render_previews()}, TMP_5._s = self, TMP_5), $a).call($c, "click");
      ($a = ($d = (($e = $scope.Element) == null ? $opal.cm('Element') : $e).$find("#tbPrintA3")).$on, $a._p = (TMP_6 = function(){var self = TMP_6._s || this, url = nil;

      url = self.$render_a3().$output("datauristring");
        return window.open(url);}, TMP_6._s = self, TMP_6), $a).call($d, "click");
      ($a = ($e = (($f = $scope.Element) == null ? $opal.cm('Element') : $f).$find("#tbPrintA4")).$on, $a._p = (TMP_7 = function(){var self = TMP_7._s || this, url = nil;

      url = self.$render_a4().$output("datauristring");
        return window.open(url);}, TMP_7._s = self, TMP_7), $a).call($e, "click");
      ($a = ($f = (($g = $scope.Element) == null ? $opal.cm('Element') : $g).$find("#tbCommand")).$on, $a._p = (TMP_8 = function(event){var self = TMP_8._s || this;
if (event == null) event = nil;
      self.$handle_command(self.$Native(event['$[]']("target"))['$[]']("value"));
        return self.$Native(event['$[]']("target"))['$[]=']("value", "");}, TMP_8._s = self, TMP_8), $a).call($f, "change");
      ($a = ($g = self.editor).$on_change, $a._p = (TMP_9 = function(e){var self = TMP_9._s || this, $a;
...
if (e == null) e = nil;
      if ((($a = self.refresh_timer) !== nil && (!$a._isBoolean || $a == true))) {
        ...
        return nil;}, TMP_9._s = self, TMP_9), $a).call($g);
      ($a = ($h = self.editor).$on_selection_change, $a._p = (TMP_10 = function(e){var self = TMP_10._s || this, a = nil;
...
if (e == null) e = nil;
      a = self.editor.$get_selection_positions();
        ...
        };}, TMP_10._s = self, TMP_10), $a).call($h);
      ($a = ($i = self.harpnote_player).$on_noteon, $a._p = (TMP_11 = function(e){var self = TMP_11._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteon " + (self.$Native(e)['$[]']("startChar")));
        return self.$highlight_abc_object(e);}, TMP_11._s = self, TMP_11), $a).call($i);
      ($a = ($j = self.harpnote_player).$on_noteoff, $a._p = (TMP_12 = function(e){var self = TMP_12._s || this;
        if ($gvars.log == null) $gvars.log = nil;
if (e == null) e = nil;
      $gvars.log.$debug("noteoff " + (self.$Native(e)['$[]']("startChar")));
        return self.$unhighlight_abc_object(e);}, TMP_12._s = self, TMP_12), $a).call($j);
      ($a = ($k = self.harpnote_player).$on_songoff, $a._p = (TMP_13 = function(){var self = TMP_13._s || this;

      return self.$stop_play_abc()}, TMP_13._s = self, TMP_13), $a).call($k);
      ($a = ($l = (($m = $scope.Element) == null ? $opal.cm('Element') : $m).$find(window)).$on, $a._p = (TMP_14 = function(evt){var self = TMP_14._s || this, $a;
        if ($gvars.log == null) $gvars.log = nil;
if (evt == null) evt = nil;
      $gvars.log.$debug("key pressed (" + ("controller") + " " + (415) + ")");
        console.log(event);
        if ((($a = evt.keyCode == 13 && evt.shiftKey) !== nil && (!$a._isBoolean || $a == true))) {
          ...
          return nil
        };}, TMP_14._s = self, TMP_14), $a).call($l, "keydown");
      return ($a = ($m = (($n = $scope.Element) == null ? $opal.cm('Element') : $n).$find("#dragbar")).$on, $a._p = (TMP_15 = function(re){var self = TMP_15._s || this, $a, $b, TMP_16, $c, TMP_17, $d;
if (re == null) re = nil;
      re.$prevent();
        ($a = ($b = (($c = $scope.Element) == null ? $opal.cm('Element') : $c).$find(document)).$on, $a._p = (TMP_16 = function(e){var self = TMP_16._s || this, $a;
if (e == null) e = nil;
        (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#leftColumn").$css("right", "" + ((window.innerWidth)['$-'](e.$page_x())) + "px");
          ...
          return (($a = $scope.Element) == null ? $opal.cm('Element') : $a).$find("#dragbar").$css("left", "" + (e.$page_x()) + "px");}, TMP_16._s = self, TMP_16), $a).call($b, "mousemove");
        return ($a = ($c = (($d = $scope.Element) == null ? $opal.cm('Element') : $d).$find(document)).$on, $a._p = (TMP_17 = function(){var self = TMP_17._s || this;

        return $(document).unbind('mousemove');}, TMP_17._s = self, TMP_17), $a).call($c, "mouseup");}, TMP_15._s = self, TMP_15), $a).call($m, "mousedown");
    };
  ...
  return ($a = ($b = (($c = $scope.Document) == null ? $opal.cm('Document') : $c))['$ready?'], $a._p = (TMP_18 = function(){var self = TMP_18._s || this, $a;

  return (($a = $scope.Controller) == null ? $opal.cm('Controller') : $a).$new()}, TMP_18._s = self, TMP_18), $a).call($b);
})(Opal);
