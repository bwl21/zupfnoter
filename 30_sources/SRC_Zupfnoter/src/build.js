...
(function($opal) {
  ...
  $opal.add_stubs(['$map', '$Native', '$[]', '$each', '$[]=', '$downcase', '$floor', '$/', '$%', '$<', '$+', '$==', '$!', '$*', '$new', '$reset_state', '$reset_measure_accidentals', '$select', '$split', '$empty?', '$raise', '$to_i', '$strip', '$last', '$first', '$set_key', '$each_with_index', '$<<', '$flatten!', '$compact!', '$compact', '$flatten', '$send', '$nil?', '$origin=', '$now', '$to_n', '$keys', '$meta_data=', '$round', '$transform_rest', '$transform_real_note', '$pitch', '$get_midipitch', '$length', '$gsub', '$pop']);
  ;
  return (function($base) {
    var self = $module($base, 'Harpnotes');
...
if (f == null) f = nil;
      ...
      (function($base, $super) {
        ...
        def.$transform = function(abc_code) {
          var $a, $b, TMP_6, $c, TMP_7, $d, TMP_8, $e, TMP_9, $f, TMP_13, $g, $h, TMP_16, self = this, note_length_rows = nil, note_length = nil, tune = nil, lines = nil, first_staff = nil, key = nil, meter = nil, voices_in_staff = nil, voices = nil, voices_transformed = nil, result = nil, meta_data = nil, meta_data_from_tune = nil;
...
if (s == null) s = nil;
          ...
          lines = ($a = ($d = tune['$[]']("lines")).$select, $a._p = (TMP_8 = function(l){var self = TMP_8._s || this;
if (l == null) l = nil;
          return self.$Native(l)['$[]']("staff")}, TMP_8._s = self, TMP_8), $a).call($d);
          ...
          voices = [];
          ($a = ($e = lines).$each, $a._p = (TMP_9 = function(line){var self = TMP_9._s || this, $a, $b, TMP_10;
if (line == null) line = nil;
          return ($a = ($b = self.$Native(line)['$[]']("staff")).$each_with_index, $a._p = (TMP_10 = function(staff, staff_index){var self = TMP_10._s || this, $a, $b, TMP_11;
if (staff == null) staff = nil;if (staff_index == null) staff_index = nil;
            return ($a = ($b = self.$Native(staff)['$[]']("voices")).$each_with_index, $a._p = (TMP_11 = function(voice, voice_index){var self = TMP_11._s || this, $a, $b, $c, TMP_12, idx = nil;
if (voice == null) voice = nil;if (voice_index == null) voice_index = nil;
              idx = voices_in_staff['$[]'](staff_index)['$[]'](voice_index);
                ...
                voices['$[]'](idx)['$<<'](($a = ($b = voice).$map, $a._p = (TMP_12 = function(x){var self = TMP_12._s || this;
if (x == null) x = nil;
                return self.$Native(x)}, TMP_12._s = self, TMP_12), $a).call($b));
                return voices['$[]'](idx)['$flatten!']();}, TMP_11._s = self, TMP_11), $a).call($b)}, TMP_10._s = self, TMP_10), $a).call($b)}, TMP_9._s = self, TMP_9), $a).call($e);
          voices['$compact!']();
          voices_transformed = ($a = ($f = voices.$each_with_index()).$map, $a._p = (TMP_13 = function(voice, voice_idx){var self = TMP_13._s || this, $a, $b, TMP_14, res = nil;
if (voice == null) voice = nil;if (voice_idx == null) voice_idx = nil;
          self.$reset_state();
            res = ($a = ($b = voice).$map, $a._p = (TMP_14 = function(el){var self = TMP_14._s || this, $a, $b, TMP_15, type = nil;
if (el == null) el = nil;
            type = el['$[]']("el_type");
              res = self.$send("transform_" + (type), el);
              if ((($a = ((($b = res['$nil?']()) !== false && $b !== nil) ? $b : res['$empty?']())) !== nil && (!$a._isBoolean || $a == true))) {
                } else {
                ($a = ($b = res).$each, $a._p = (TMP_15 = function(e){var self = TMP_15._s || this;
if (e == null) e = nil;
                return e['$origin='](el)}, TMP_15._s = self, TMP_15), $a).call($b)
              };
              return res;}, TMP_14._s = self, TMP_14), $a).call($b).$flatten().$compact();
            return res;}, TMP_13._s = self, TMP_13), $a).call($f);
          result = (($a = ((($g = ((($h = $scope.Harpnotes) == null ? $opal.cm('Harpnotes') : $h))._scope).Music == null ? $g.cm('Music') : $g.Music))._scope).Song == null ? $a.cm('Song') : $a.Song).$new(voices_transformed, note_length);
          ...
          ($a = ($g = meta_data_from_tune.$keys()).$each, $a._p = (TMP_16 = function(k){var self = TMP_16._s || this;
if (k == null) k = nil;
          return meta_data['$[]='](k, meta_data_from_tune['$[]'](k))}, TMP_16._s = self, TMP_16), $a).call($g);
        ...
        def.$transform_real_note = function(note, duration) {
          var $a, $b, TMP_17, $c, $d, self = this, notes = nil, res = nil;

          notes = ($a = ($b = self.$Native(note['$[]']("pitches"))).$map, $a._p = (TMP_17 = function(pitch){var self = TMP_17._s || this, $a, $b, $c, midipitch = nil, thenote = nil;
...
if (pitch == null) pitch = nil;
          midipitch = self.pitch_transformer.$get_midipitch(pitch);
            ...
            thenote['$origin='](note);
            return thenote;}, TMP_17._s = self, TMP_17), $a).call($b);
          res = [];
          if (notes.$length()['$=='](1)) {
            res['$<<'](notes.$first())
            } else {
...
/* Generated by Opal 0.6.2 */
(function($opal) {
  var $a, $b, TMP_10, $c, self = $opal.top, $scope = $opal, nil = $opal.nil, $breaker = $opal.breaker, $slice = $opal.slice, $klass = $opal.klass;

  $opal.add_stubs(['$setup_editor', '$setup_ui', '$setup_ui_listener', '$draw', '$new', '$layout_harpnotes', '$html', '$find', '$get_abc_code', '$file', '$output', '$render_pdf', '$to_blob', '$strftime', '$now', '$transform', '$layout', '$alert', '$private', '$on_select', '$select_note', '$on', '$play_abc', '$render_to_canvas', '$Native', '$prevent_default', '$save_file', '$prevent', '$css', '$-', '$page_x', '$ready?']);
  ;
  ;
  ;
  ;
...
if (origin == null) origin = nil;
    ...
    return (def.$setup_ui_listener = function() {
      ...
      ($a = ($d = self.$Native(self.editor)).$on, $a._p = (TMP_4 = function(){var self = TMP_4._s || this;

      return self.$render_to_canvas()}, TMP_4._s = self, TMP_4), $a).call($d, "change");
