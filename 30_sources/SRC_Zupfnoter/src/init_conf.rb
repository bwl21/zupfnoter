        ...
        {produce:      [0],
         ...
         layout:   {
             ...
             DECORATIIONS_AS_ANNOTATIONS: {
                 '<(':          {text: 'lauter werden', pos: [5, 0], style: :small_italic},
                 '<)':          {text: '<|', pos: [5, 0], style: :small_italic},
                 '>(':          {text: 'leiser werden', pos: [5, 0], style: :small_italic},
                 '>)':          {text: '>|', pos: [5, 0], style: :small_italic},
                 'arpeggio':    {text: "arpeggio ", pos: [-20, 0], style: :small_italic},
                 'coda':        {text: 'Coda', pos: [0, -5], style: :bold, align: :center},
                 'crescendo(':  {text: 'lauter werden', pos: [5, 0], style: :small_italic},
                 'crescendo)':  {text: '<|', pos: [5, 0], style: :small_italic},
                 ...
                 'diminuendo(': {text: 'leiser werden', pos: [5, 0], style: :small_italic},
                 'diminuendo)': {text: '>|', pos: [5, 0], style: :small_italic},
