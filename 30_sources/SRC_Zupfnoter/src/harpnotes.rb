...
=end
      ...
      def layout_playable(root, beat_layout)
        ...
        unless root.decorations.empty?
          ...
          decoration_center   = [decoration_root.center.first, decoration_root.center.last - decoration_root.size.last/decoration_scale - decoration_distance]
          decorations         = [Harpnotes::Drawing::Glyph.new(decoration_center, decoration_size, root.decorations.first, false, root)]
        end
