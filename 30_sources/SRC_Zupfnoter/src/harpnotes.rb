...
module Harpnotes
  ...
  module Drawing
    ...
    class Glyph
      ...
      GLYPHS = {
        rest_1:   {d:[["M", 0.06, 0.03], ["l", 0.09, -0.06], ["l", 5.46, 0], ["l", 5.49, 0], ["l", 0.09, 0.06], ["l", 0.06, 0.09], ["l", 0, 2.19], ["l", 0, 2.19], ["l", -0.06, 0.09], ["l", -0.09, 0.06], ["l", -5.49, 0], ["l", -5.46, 0], ["l", -0.09, -0.06], ["l", -0.06, -0.09], ["l", 0, -2.19], ["l", 0, -2.19], ["z"]], w: 11.25, h: 4.68},
        rest_2:   {d:[["m", 0.06, -4.62], ["l", 0.09, -0.06], ["l", 5.46, 0], ["l", 5.49, 0], ["l", 0.09, 0.06], ["l", 0.06, 0.09], ["l", 0, 2.19], ["l", 0, 2.19], ["l", -0.06, 0.09], ["l", -0.09, 0.06], ["l", -5.49, 0], ["l", -5.46, 0], ["l", -0.09, -0.06], ["l", -0.06, -0.09], ["l", 0, -2.19], ["l", 0, -2.19], ["z"]], w: 11.25, h: 4.68},
  ...
  module Layout
    ...
    class Default
      ...
      REST_TO_GLYPH = {
          ...
          :d48 => [ [0.5, 0.5],   :rest_2,       TRUE],     # 1/2 *
          :d32 => [ [0.5, 0.5],   :rest_2,       FALSE],    # 1/2
          :d24 => [ [0.9, 0.6],   :rest_4,       TRUE],     # 1/4 *
          :d16 => [ [0.9, 0.6],   :rest_4,       FALSE],    # 1/4
          :d12 => [ [0.7, 0.5],   :rest_8,       TRUE],     # 1/8 *
          :d8  => [ [0.7, 0.5],   :rest_8,       FALSE],    # 1/8
          :d6  => [ [0.7, 0.5],   :rest_16,      TRUE],     # 1/16 *
          :d4  => [ [0.7, 0.5],   :rest_16,      FALSE],    # 1/16
          :d3  => [ [0.5, 0.3],   :rest_32,      TRUE],     # 1/32 *
          :d2  => [ [0.5, 0.3],   :rest_32,      FALSE],    # 1/32
          :d1  => [ [0.5, 0.3],    :rest_64,      FALSE],    # 1/64
      }
